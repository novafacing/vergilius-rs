...
struct _MI_RESAVAIL_TRACKER {
  ...
  ULONG AllocateHotRemove;                      // offset: 0x10c (268)
  ULONG FreeHotAdd;                             // offset: 0x110 (272)
  ULONG AllocateBoot;                           // offset: 0x114 (276)
  ULONG FreeLoaderBlock;                        // offset: 0x118 (280)
  ULONG AllocateNonPagedSpecialPool;            // offset: 0x11c (284)
  ULONG FreeNonPagedSpecialPoolError;           // offset: 0x120 (288)
  ULONG FreeNonPagedSpecialPool;                // offset: 0x124 (292)
  ULONG AllocateSharedSegmentPage;              // offset: 0x128 (296)
  ULONG FreeSharedSegmentPage;                  // offset: 0x12c (300)
  ULONG AllocateZeroPage;                       // offset: 0x130 (304)
  ULONG FreeZeroPage;                           // offset: 0x134 (308)
  ULONG AllocateForPo;                          // offset: 0x138 (312)
  ULONG AllocateForPoForce;                     // offset: 0x13c (316)
  ULONG FreeForPo;                              // offset: 0x140 (320)
  ULONG AllocateThreadHardFaultBehavior;        // offset: 0x144 (324)
  ULONG FreeThreadHardFaultBehavior;            // offset: 0x148 (328)
  ULONG ObtainFaultCharges;                     // offset: 0x14c (332)
  ULONG FreeFaultCharges;                       // offset: 0x150 (336)
  ULONG AllocateStoreCharges;                   // offset: 0x154 (340)
  ULONG FreeStoreCharges;                       // offset: 0x158 (344)
...
struct _MMSUPPORT {
  ...
  ULONG Reserved0;                             // offset: 0x6c (108)
...
struct _CMP_SILO_CONTEXT {
  ...
  UCHAR LockListUnderCleanup;       // offset: 0x8 (8)
  struct _EX_PUSH_LOCK ContextLock; // offset: 0xc (12)
};
...
struct _MI_VAD_ALLOCATION_CELL {
  ...
  ULONG BitMapHint;                      // offset: 0x8 (8)
  ULONG LastAllocationSize;              // offset: 0xc (12)
  ULONG LastAllocationSizeHint;          // offset: 0x10 (16)
  ULONG LowestBottomUpVadBit;            // offset: 0x14 (20)
  VOID *LowestBottomUpAllocationAddress; // offset: 0x18 (24)
};
...
struct _MI_PARTITION_CORE {
  ...
  ULONG MemoryBlockReferences;                        // offset: 0x24 (36)
  struct _WORK_QUEUE_ITEM PfnUnmapWorkItem;           // offset: 0x28 (40)
  UCHAR PfnUnmapActive;                               // offset: 0x38 (56)
  ULONG PfnUnmapCount;                                // offset: 0x3c (60)
  VOID *PfnUnmapWaitList;                             // offset: 0x40 (64)
  struct _PHYSICAL_MEMORY_DESCRIPTOR *MemoryRuns;     // offset: 0x44 (68)
  struct _KEVENT ExitEvent;                           // offset: 0x48 (72)
  VOID *SystemThreadHandles[5];                       // offset: 0x58 (88)
  VOID *PartitionObject;                              // offset: 0x6c (108)
  VOID *PartitionObjectHandle;                        // offset: 0x70 (112)
  struct _EX_PUSH_LOCK DynamicMemoryPushLock;         // offset: 0x74 (116)
  volatile LONG DynamicMemoryLock;                    // offset: 0x78 (120)
  struct _KEVENT TemporaryMemoryEvent;                // offset: 0x7c (124)
...
struct _TOKEN {
  ...
  ULONG VariablePart;                              // offset: 0x294 (660)
};
...
struct _MI_SYSTEM_IMAGE_STATE {
  ...
  struct _MMPTE *ErrataPte;                    // offset: 0x64 (100)
  ULONG ErrataPteMapped;                       // offset: 0x68 (104)
};
...
struct _MI_VISIBLE_STATE {
  ...
  ULONG PagefileHashPages;                     // offset: 0x284 (644)
  struct _SYSPTES_HEADER PteHeader;            // offset: 0x288 (648)
  struct _MI_SPECIAL_POOL *SessionSpecialPool; // offset: 0x314 (788)
  ULONG SystemVaTypeCount[15];                 // offset: 0x318 (792)
  UCHAR SystemVaType[1024];                    // offset: 0x354 (852)
  ULONG SystemVaTypeCountFailures[15];         // offset: 0x754 (1876)
  ULONG SystemVaTypeCountLimit[15];            // offset: 0x790 (1936)
  ULONG SystemVaTypeCountPeak[15];             // offset: 0x7cc (1996)
  ULONG SystemAvailableVa;                     // offset: 0x808 (2056)
};
...
struct _MI_PARTITION_ZEROING {
  ...
  volatile LONG ThreadCount;                         // offset: 0x2c (44)
  struct _KGATE Gate;                                // offset: 0x30 (48)
};
...
struct _SUBSECTION {
  ...
  union {
    ...
    struct _MI_SUBSECTION_WAIT_BLOCK *CreationWaitList; // offset: 0xc (12)
...
struct _MI_PARTITION_PAGE_LISTS {
  ...
  UCHAR RebuildLargePagesInitialized;                   // offset: 0x709 (1801)
  struct _MI_REBUILD_LARGE_PAGES RebuildLargePagesItem; // offset: 0x70c (1804)
  VOID *MirrorListLocks;                                // offset: 0x740 (1856)
};
...
struct _MM_SESSION_SPACE {
  ...
  struct _EJOB *ServerSilo;                      // offset: 0x1fc0 (8128)
...
struct _POP_THERMAL_ZONE {
  ...
  struct _UNICODE_STRING Description;                     // offset: 0x2b8 (696)
};
...
struct _ETW_GUID_ENTRY {
  ...
  UCHAR HostSilo;                               // offset: 0x15c (348)
...
struct _EPROCESS {
  ...
  union {
    ...
    struct {
      ...
      ULONG ProhibitRemoteImageMap : 1;    // offset: 0x2e0 (736)
      ULONG ProhibitLowILImageMap : 1;     // offset: 0x2e0 (736)
      ULONG SignatureMitigationOptIn : 1;  // offset: 0x2e0 (736)
    };
  };
  ...
  ULONGLONG SequenceNumber;                    // offset: 0x328 (808)
  ULONGLONG CreateInterruptTime;               // offset: 0x330 (816)
  ULONGLONG CreateUnbiasedInterruptTime;       // offset: 0x338 (824)
  ULONGLONG TotalUnbiasedFrozenTime;           // offset: 0x340 (832)
  ULONGLONG LastAppStateUpdateTime;            // offset: 0x348 (840)
  ULONGLONG LastAppStateUptime : 61;           // offset: 0x350 (848)
  ULONGLONG LastAppState : 3;                  // offset: 0x350 (848)
  volatile ULONG SharedCommitCharge;           // offset: 0x358 (856)
  struct _EX_PUSH_LOCK SharedCommitLock;       // offset: 0x35c (860)
  struct _LIST_ENTRY SharedCommitLinks;        // offset: 0x360 (864)
  union {
    struct {
      ULONG AllowedCpuSets; // offset: 0x368 (872)
      ULONG DefaultCpuSets; // offset: 0x36c (876)
    };
    struct {
      ULONG *AllowedCpuSetsIndirect; // offset: 0x368 (872)
      ULONG *DefaultCpuSetsIndirect; // offset: 0x36c (876)
    };
  };
};
...
struct _MI_USER_VA_INFO {
  ...
  VOID *HighestTopDownAllocationAddress;           // offset: 0x4 (4)
  struct _MI_VAD_ALLOCATION_CELL VadCell[2];       // offset: 0x8 (8)
  ULONG VadBitMapCommitment;                       // offset: 0x40 (64)
  ULONG MaximumLastVadBit;                         // offset: 0x44 (68)
  LONG VadsBeingDeleted;                           // offset: 0x48 (72)
  LONG NumberOfDebugEnclaves;                      // offset: 0x4c (76)
  ULONG PhysicalMappingCount;                      // offset: 0x50 (80)
  struct _KEVENT *LastVadDeletionEvent;            // offset: 0x54 (84)
  struct _LIST_ENTRY SubVadRanges[1];              // offset: 0x58 (88)
  UCHAR NumaAware;                                 // offset: 0x60 (96)
  ULONGLONG CloneNestingLevel;                     // offset: 0x68 (104)
  ULONG PrivateFixupVadCount;                      // offset: 0x70 (112)
  struct _MI_CFG_BITMAP_INFO CfgBitMap[1];         // offset: 0x74 (116)
  ULONG CommittedPageTableBufferForTopLevel[48];   // offset: 0x80 (128)
  struct _RTL_BITMAP CommittedPageTableBitmaps[1]; // offset: 0x140 (320)
  USHORT UsedPageTableEntries[1536];               // offset: 0x148 (328)
};
...
struct _MI_PARTITION {
  ...
  struct _MI_PARTITION_MODWRITES Modwriter;      // offset: 0xb8 (184)
  struct _MI_PARTITION_STORES Store;             // offset: 0x288 (648)
...
struct _MI_SYSTEM_INFORMATION {
  ...
  struct _MI_SHUTDOWN_STATE Shutdowns;        // offset: 0x2d10 (11536)
...
struct _EJOB {
  ...
  struct _SILO_CONTEXT *Container;              // offset: 0x2d0 (720)
  ...
  union {
    ...
    struct {
      ...
      ULONG DisallowNewProcesses : 1;          // offset: 0x2e8 (744)
...
struct _ETHREAD {
  ...
  union {
    ...
    struct {
      ...
      ULONG StoreLockThread : 1;                 // offset: 0x3cc (972)
      ...
      ULONG ReservedSameThreadPassiveFlags : 25; // offset: 0x3cc (972)
    };
  };
  union {
  ...
  struct _EJOB *Silo; // offset: 0x450 (1104)
};
