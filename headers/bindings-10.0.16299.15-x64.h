...
struct _ETW_SYSTEM_LOGGER_SETTINGS {
  ...
  struct _PERFINFO_GROUPMASK EtwpGroupMasks[9];   // offset: 0x34 (52)
};
...
struct _PPM_ENGINE_SETTINGS {
  ...
  UCHAR HeteroDecreaseThreshold[1280];                // offset: 0x70 (112)
  UCHAR HeteroIncreaseThreshold[1280];                // offset: 0x570 (1392)
  UCHAR Class0FloorPerformance;                       // offset: 0xa70 (2672)
  UCHAR Class1InitialPerformance;                     // offset: 0xa71 (2673)
...
struct _HV_X64_HYPERVISOR_FEATURES {
  ...
  ULONG Reserved1 : 7;                           // offset: 0xc (12)
};
...
struct _MI_PROCESS_STATE {
  ...
  ULONGLONG VadSecureCookie;                   // offset: 0x30 (48)
};
...
struct _MI_PARTITION_MODWRITES {
  ...
  volatile LONG ClusterWritesDisabled[2];                 // offset: 0x22c (556)
...
struct _KPROCESS {
  ...
  union {
    struct {
      ...
      LONG ReservedFlags : 3;        // offset: 0x1b8 (440)
    };
...
struct _MI_SYSTEM_VA_STATE {
  ...
  volatile LONG DeleteKvaLock;                            // offset: 0x284 (644)
  struct _MI_WSLE *WsleArrays[5];                         // offset: 0x288 (648)
  struct _MI_HYPER_SPACE *PagableHyperSpace;              // offset: 0x2b0 (688)
  VOID *HyperSpaceEnd;                                    // offset: 0x2b8 (696)
  struct _KEVENT FreeSystemCacheVa;                       // offset: 0x2c0 (704)
  ULONGLONG SystemVaLock;                                 // offset: 0x2d8 (728)
  ULONGLONG SystemCacheViewLock;                          // offset: 0x2e0 (736)
  struct _MMWSL_INSTANCE SystemWorkingSetList[5];         // offset: 0x2e8 (744)
};
...
struct _KNODE {
  ...
  ULONGLONG PpmConfiguredQosSets[3];           // offset: 0x128 (296)
};

// 0x180 (384) bytes
struct _ENODE {
  struct _KNODE Ncb;                               // offset: 0x0 (0)
  struct _WORK_QUEUE_ITEM HotAddProcessorWorkItem; // offset: 0x140 (320)
};
...
struct _MI_VISIBLE_STATE {
  ...
  ULONGLONG SystemVaTypeCount[16];                     // offset: 0x690 (1680)
  UCHAR SystemVaType[256];                             // offset: 0x710 (1808)
  struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[14]; // offset: 0x810 (2064)
};
...
struct _MI_SECTION_STATE {
  ...
  struct _MMPFNLIST PurgingExtentPages;            // offset: 0x120 (288)
  struct _MMPFN *DanglingExtentPages;              // offset: 0x148 (328)
  struct _WORK_QUEUE_ITEM DanglingExtentsWorkItem; // offset: 0x150 (336)
  UCHAR DanglingExtentsWorkerActive;               // offset: 0x170 (368)
  UCHAR PurgingExtentsNeedWatchdog;                // offset: 0x171 (369)
  struct _RTL_AVL_TREE PageFileSectionHead;        // offset: 0x178 (376)
  volatile LONG PageFileSectionListSpinLock;       // offset: 0x180 (384)
  ULONG ImageBias;                                 // offset: 0x184 (388)
  struct _EX_PUSH_LOCK RelocateBitmapsLock;        // offset: 0x188 (392)
  struct _RTL_BITMAP ImageBitMap;                  // offset: 0x190 (400)
  ULONG ImageBias64Low;                            // offset: 0x1a0 (416)
  ULONG ImageBias64High;                           // offset: 0x1a4 (420)
  struct _RTL_BITMAP ImageBitMap64Low;             // offset: 0x1a8 (424)
  struct _RTL_BITMAP ImageBitMap64High;            // offset: 0x1b8 (440)
  struct _RTL_BITMAP ImageBitMapWow64Dll;          // offset: 0x1c8 (456)
  VOID *ApiSetSection;                             // offset: 0x1d8 (472)
  VOID *ApiSetSchema;                              // offset: 0x1e0 (480)
  ULONGLONG ApiSetSchemaSize;                      // offset: 0x1e8 (488)
  ULONG LostDataFiles;                             // offset: 0x1f0 (496)
  ULONG LostDataPages;                             // offset: 0x1f4 (500)
  ULONG ImageFailureReason;                        // offset: 0x1f8 (504)
  struct _SECTION *CfgBitMapSection32;             // offset: 0x200 (512)
  struct _CONTROL_AREA *CfgBitMapControlArea32;    // offset: 0x208 (520)
  struct _SECTION *CfgBitMapSection64;             // offset: 0x210 (528)
  struct _CONTROL_AREA *CfgBitMapControlArea64;    // offset: 0x218 (536)
  struct _RTL_BITMAP_EX KernelCfgBitMap;           // offset: 0x220 (544)
  struct _EX_PUSH_LOCK KernelCfgBitMapLock;        // offset: 0x230 (560)
  ULONG ImageCfgFailure;                           // offset: 0x238 (568)
  ULONG ImageChecksumBreakpoint;                   // offset: 0x23c (572)
  ULONG ImageSizeBreakpoint;                       // offset: 0x240 (576)
  volatile LONG ImageValidationFailed;             // offset: 0x244 (580)
};
...
struct _ETW_STACK_TRACE_BLOCK {
  LONG Flags;                            // offset: 0x0 (0)
  union _LARGE_INTEGER RelatedTimestamp; // offset: 0x8 (8)
  struct _ETHREAD *Thread;               // offset: 0x10 (16)
  struct _KDPC StackWalkDpc;             // offset: 0x18 (24)
  union _SLIST_HEADER ApcListHead;       // offset: 0x60 (96)
  struct _ETW_APC_ENTRY ApcEntry[12];    // offset: 0x70 (112)
  LONG ApcCount;                         // offset: 0x4f0 (1264)
  LONG MaxApcCount;                      // offset: 0x4f4 (1268)
};
...
struct _MI_SYSTEM_PTE_STATE {
  ...
  struct _MI_SYSTEM_PTE_TYPE KernelStackPteInfo;     // offset: 0x120 (288)
  ULONG StackGrowthFailures;                         // offset: 0x188 (392)
  UCHAR KernelStackPages;                            // offset: 0x18c (396)
  UCHAR TrackPtesAborted;                            // offset: 0x18d (397)
  UCHAR AdjustCounter;                               // offset: 0x18e (398)
  volatile LONG ReservedMappingLock;                 // offset: 0x190 (400)
  struct _RTL_AVL_TREE ReservedMappingTree;          // offset: 0x198 (408)
  struct _MMPFN *ReservedMappingPageTablePfns;       // offset: 0x1a0 (416)
  struct _RTL_AVL_TREE OutswappedKernelStackRoot;    // offset: 0x1a8 (424)
  volatile LONG OutswappedKernelStackLock;           // offset: 0x1b0 (432)
  struct _MI_ULTRA_VA_CONTEXT UltraSpaceContext;     // offset: 0x1b8 (440)
  ULONG NumberOfUltraMdlMaps;                        // offset: 0x1f8 (504)
  struct _MI_ULTRA_MDL_NODE *UltraMdlNodeMappings;   // offset: 0x200 (512)
};
...
struct _CC_PARTITION {
  ...
  UCHAR RundownStarted;                                // offset: 0x385 (901)
...
struct _MI_PARTITION_SEGMENTS {
  ...
  struct _MMPAGE_FILE_EXPANSION AttemptForCantExtend; // offset: 0x50 (80)
  struct _MMDEREFERENCE_SEGMENT_HEADER
      DereferenceSegmentHeader;                        // offset: 0xa8 (168)
  struct _LIST_ENTRY DeleteOnCloseList;                // offset: 0xf8 (248)
  struct _KTIMER DeleteOnCloseTimer;                   // offset: 0x108 (264)
  UCHAR DeleteOnCloseTimerActive;                      // offset: 0x148 (328)
  UCHAR SegmentDereferenceThreadExists;                // offset: 0x149 (329)
  ULONGLONG UnusedSegmentPagedPool;                    // offset: 0x150 (336)
  struct _LIST_ENTRY UnusedSegmentList;                // offset: 0x158 (344)
  struct _LIST_ENTRY UnusedSubsectionList;             // offset: 0x168 (360)
  struct _LIST_ENTRY DeleteSubsectionList;             // offset: 0x178 (376)
  struct _KEVENT ControlAreaDeleteEvent;               // offset: 0x188 (392)
  struct _SINGLE_LIST_ENTRY ControlAreaDeleteList;     // offset: 0x1a0 (416)
  struct _MI_PTE_CHAIN_HEAD FreeSystemCache;           // offset: 0x1a8 (424)
  struct _KEVENT CloneDereferenceEvent;                // offset: 0x1c0 (448)
  ...
  struct _MI_CROSS_PARTITION_CHARGES SharedCharges[5]; // offset: 0x218 (536)
  struct _KEVENT *SharedChargesDrainEvent;             // offset: 0x2b8 (696)
  struct _KEVENT *PagefileControlAreasDrainEvent;      // offset: 0x2c0 (704)
};
...
struct _MI_HARDWARE_STATE {
  ...
  ULONG MediumPageColors;                                 // offset: 0x50 (80)
  ULONG FlushTbForAttributeChange;                        // offset: 0x54 (84)
  ULONG FlushCacheForAttributeChange;                     // offset: 0x58 (88)
  ULONG FlushCacheForPageAttributeChange;                 // offset: 0x5c (92)
  ULONG CacheFlushPromoteThreshold;                       // offset: 0x60 (96)
  ULONGLONG FlushTbThreshold;                             // offset: 0x68 (104)
  enum _MI_PFN_CACHE_ATTRIBUTE OptimalZeroingAttribute[4]
                                                      [4]; // offset: 0x70 (112)
  UCHAR AttributeChangeRequiresReZero;                     // offset: 0xb0 (176)
  struct _MI_ZERO_COST_COUNTS ZeroCostCounts[2];           // offset: 0xb8 (184)
  ULONGLONG PrimaryPfns;                                   // offset: 0xd8 (216)
  ULONGLONG HighestPossiblePhysicalPage;                   // offset: 0xe0 (224)
  struct _RTL_AVL_TREE EnclaveRegions;                     // offset: 0xe8 (232)
  ULONGLONG VsmKernelPageCount;                            // offset: 0xf0 (240)
};

// 0x2040 (8256) bytes
struct _MI_NODE_INFORMATION {
  ULONGLONG LargePageFreeCount[3][2];          // offset: 0x0 (0)
  ULONGLONG LargePagesCount[3][2][2][4];       // offset: 0x30 (48)
  struct _LIST_ENTRY LargePages[2][2][2][4];   // offset: 0x1b0 (432)
  struct _LIST_ENTRY MediumPages[2][2][4][16]; // offset: 0x3b0 (944)
  ULONGLONG MediumPagesCount[2][2][4][16];     // offset: 0x13b0 (5040)
  struct _MI_REBUILD_LARGE_PAGE_TIMER
      LargePageRebuildTimer;                     // offset: 0x1bb0 (7088)
  struct _MMPFNLIST_SHORT StandbyPageList[4][8]; // offset: 0x1bd8 (7128)
  struct _RTL_BITMAP FreePageListHeadsBitmap[2]; // offset: 0x1f00 (7936)
  ULONG FreePageListHeadsBitmapBuffer[16];       // offset: 0x1f20 (7968)
  volatile ULONGLONG FreeCount[2];               // offset: 0x1f60 (8032)
  ULONGLONG TotalPages[4];                       // offset: 0x1f70 (8048)
  ULONGLONG TotalPagesEntireNode;                // offset: 0x1f90 (8080)
  ULONG MmShiftedColor;                          // offset: 0x1f98 (8088)
  ULONG Color;                                   // offset: 0x1f9c (8092)
  volatile ULONGLONG ChannelFreeCount[4][2];     // offset: 0x1fa0 (8096)
  struct {
    ULONG ChannelsHotCold : 1;     // offset: 0x0 (0)
    ULONG Spare : 31;              // offset: 0x0 (0)
  } Flags;                         // offset: 0x1fe0 (8160)
  struct _EX_PUSH_LOCK NodeLock;   // offset: 0x1fe8 (8168)
  ULONGLONG ZeroThreadHugeMapLock; // offset: 0x1ff0 (8176)
  UCHAR ChannelStatus;             // offset: 0x1ff8 (8184)
  UCHAR ChannelOrdering[4];        // offset: 0x1ff9 (8185)
  UCHAR LockedChannelOrdering[4];  // offset: 0x1ffd (8189)
  UCHAR PowerAttribute[4];         // offset: 0x2001 (8193)
  ULONGLONG LargePageLock;         // offset: 0x2008 (8200)
};
...
struct _WMI_LOGGER_CONTEXT {
  ...
  struct _RTL_BITMAP HookIdMap;                  // offset: 0x850 (2128)
  struct _ETW_STACK_CACHE *StackCache;           // offset: 0x860 (2144)
  struct _ETW_PMC_SUPPORT *PmcData;              // offset: 0x868 (2152)
  struct _ETW_LBR_SUPPORT *LbrData;              // offset: 0x870 (2160)
  struct _LIST_ENTRY BinaryTrackingList;         // offset: 0x878 (2168)
  struct _WMI_BUFFER_HEADER **ScratchArray;      // offset: 0x888 (2184)
  struct _DISALLOWED_GUIDS DisallowedGuids;      // offset: 0x890 (2192)
  LONGLONG RelativeTimerDueTime;                 // offset: 0x8a0 (2208)
  struct _PERIODIC_CAPTURE_STATE_GUIDS
      PeriodicCaptureStateGuids;               // offset: 0x8a8 (2216)
  struct _EX_TIMER *PeriodicCaptureStateTimer; // offset: 0x8b8 (2232)
  enum _ETW_PERIODIC_TIMER_STATE
      PeriodicCaptureStateTimerState;                   // offset: 0x8c0 (2240)
  struct _ETW_SOFT_RESTART_CONTEXT *SoftRestartContext; // offset: 0x8c8 (2248)
  struct _ETW_SILODRIVERSTATE *SiloState;               // offset: 0x8d0 (2256)
  struct _WORK_QUEUE_ITEM CompressionWorkItem;          // offset: 0x8d8 (2264)
  LONG CompressionWorkItemState;                        // offset: 0x8f8 (2296)
  struct _EX_PUSH_LOCK CompressionLock;                 // offset: 0x900 (2304)
  struct _WMI_BUFFER_HEADER *CompressionTarget;         // offset: 0x908 (2312)
  VOID *CompressionWorkspace;                           // offset: 0x910 (2320)
  LONG CompressionOn;                                   // offset: 0x918 (2328)
  ULONG CompressionRatioGuess;                          // offset: 0x91c (2332)
  ULONG PartialBufferCompressionLevel;                  // offset: 0x920 (2336)
  enum ETW_COMPRESSION_RESUMPTION_MODE
      CompressionResumptionMode;               // offset: 0x924 (2340)
  struct _SINGLE_LIST_ENTRY PlaceholderList;   // offset: 0x928 (2344)
  struct _KDPC CompressionDpc;                 // offset: 0x930 (2352)
  union _LARGE_INTEGER LastBufferSwitchTime;   // offset: 0x970 (2416)
  union _LARGE_INTEGER BufferWriteDuration;    // offset: 0x978 (2424)
  union _LARGE_INTEGER BufferCompressDuration; // offset: 0x980 (2432)
};
...
struct _ETW_SILODRIVERSTATE {
  ...
  struct _EX_RUNDOWN_REF_CACHE_AWARE **EtwpLoggerRundown; // offset: 0x1a0 (416)
  struct _WMI_LOGGER_CONTEXT **EtwpLoggerContext;         // offset: 0x1a8 (424)
  struct _ETW_HASH_BUCKET EtwpGuidHashTable[64];          // offset: 0x1b0 (432)
  USHORT EtwpSecurityLoggers[8];        // offset: 0xfb0 (4016)
  UCHAR EtwpSecurityProviderEnableMask; // offset: 0xfc0 (4032)
  LONG EtwpShutdownInProgress;          // offset: 0xfc4 (4036)
  ULONG EtwpSecurityProviderPID;        // offset: 0xfc8 (4040)
  struct _ETW_PRIV_HANDLE_DEMUX_TABLE
      PrivHandleDemuxTable;                        // offset: 0xfd0 (4048)
  struct _ETW_COUNTERS EtwpCounters;               // offset: 0xff0 (4080)
  union _LARGE_INTEGER LogfileBytesWritten;        // offset: 0x1000 (4096)
  struct _ETW_SILO_TRACING_BLOCK *ProcessorBlocks; // offset: 0x1008 (4104)
  struct _GUID PartitionId;                        // offset: 0x1010 (4112)
  struct _GUID ParentId;                           // offset: 0x1020 (4128)
  union _LARGE_INTEGER QpcOffsetFromRoot;          // offset: 0x1030 (4144)
  ULONG PartitionType;                             // offset: 0x1038 (4152)
  struct _ETW_SYSTEM_LOGGER_SETTINGS
      SystemLoggerSettings; // offset: 0x103c (4156)
};
...
struct _MI_PARTITION {
  ...
  struct _MI_PARTITION_PAGE_LISTS PageLists;     // offset: 0x800 (2048)
  struct _MI_PARTITION_COMMIT Commit;            // offset: 0x13c0 (5056)
  struct _MI_PARTITION_ZEROING Zeroing;          // offset: 0x1440 (5184)
  struct _MI_PAGE_COMBINING_SUPPORT PageCombine; // offset: 0x14a8 (5288)
  VOID *WorkingSetControl;                       // offset: 0x1630 (5680)
  struct _MMWORKING_SET_EXPANSION_HEAD
      WorkingSetExpansionHead;     // offset: 0x1638 (5688)
  struct _MI_VISIBLE_PARTITION Vp; // offset: 0x1680 (5760)
};
...
struct _MI_SYSTEM_INFORMATION {
  ...
  struct _MI_SESSION_STATE Sessions;          // offset: 0x438 (1080)
  struct _MI_PROCESS_STATE Processes;         // offset: 0x4c0 (1216)
  struct _MI_HARDWARE_STATE Hardware;         // offset: 0x4f8 (1272)
  struct _MI_SYSTEM_VA_STATE SystemVa;        // offset: 0x600 (1536)
  struct _MI_COMBINE_STATE PageCombines;      // offset: 0x9c0 (2496)
  struct _MI_PAGELIST_STATE PageLists;        // offset: 0x9d8 (2520)
  struct _MI_PARTITION_STATE Partitions;      // offset: 0x9e8 (2536)
  struct _MI_SHUTDOWN_STATE Shutdowns;        // offset: 0xa48 (2632)
  struct _MI_ERROR_STATE Errors;              // offset: 0xac0 (2752)
  struct _MI_ACCESS_LOG_STATE AccessLog;      // offset: 0xb80 (2944)
  struct _MI_DEBUGGER_STATE Debugger;         // offset: 0xc00 (3072)
  struct _MI_STANDBY_STATE Standby;           // offset: 0xd20 (3360)
  struct _MI_SYSTEM_PTE_STATE SystemPtes;     // offset: 0xdc0 (3520)
  struct _MI_IO_PAGE_STATE IoPages;           // offset: 0x1000 (4096)
  struct _MI_PAGING_IO_STATE PagingIo;        // offset: 0x1070 (4208)
  struct _MI_COMMON_PAGE_STATE CommonPages;   // offset: 0x10c0 (4288)
  struct _MI_SYSTEM_TRIM_STATE Trims;         // offset: 0x1180 (4480)
  ULONGLONG Cookie;                           // offset: 0x11c0 (4544)
  VOID *volatile *BootRegistryRuns;           // offset: 0x11c8 (4552)
  volatile LONG ZeroingDisabled;              // offset: 0x11d0 (4560)
  UCHAR FullyInitialized;                     // offset: 0x11d4 (4564)
  UCHAR SafeBooted;                           // offset: 0x11d5 (4565)
  struct _TlgProvider_t *TraceLogging;        // offset: 0x11d8 (4568)
  struct _MI_VISIBLE_STATE Vs;                // offset: 0x1200 (4608)
};
...
struct _KPRCB {
  ...
  union {
    volatile LONG BamFlags; // offset: 0xec (236)
    struct {
      ULONG BamQosLevel : 2;       // offset: 0xec (236)
      ULONG PendingQosUpdate : 2;  // offset: 0xec (236)
      ULONG BamFlagsReserved : 28; // offset: 0xec (236)
    };
  };
  ...
  ULONGLONG PrcbPad81[3];                         // offset: 0x5c20 (23584)
  ...
  struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;     // offset: 0x6430 (25648)
  struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;  // offset: 0x6438 (25656)
  struct _KDPC AbDpc;                               // offset: 0x6440 (25664)
  struct _IOP_IRP_STACK_PROFILER
      IoIrpStackProfilerCurrent; // offset: 0x6480 (25728)
  struct _IOP_IRP_STACK_PROFILER
      IoIrpStackProfilerPrevious;                    // offset: 0x64d4 (25812)
  struct _KSECURE_FAULT_INFORMATION SecureFault;     // offset: 0x6528 (25896)
  ULONGLONG PrcbPad120;                              // offset: 0x6538 (25912)
  struct _KSHARED_READY_QUEUE LocalSharedReadyQueue; // offset: 0x6540 (25920)
  ULONGLONG PrcbPad125[2];                           // offset: 0x67b0 (26544)
  ULONG TimerExpirationTraceCount;                   // offset: 0x67c0 (26560)
  ULONG PrcbPad127;                                  // offset: 0x67c4 (26564)
  struct _KTIMER_EXPIRATION_TRACE
      TimerExpirationTrace[16];              // offset: 0x67c8 (26568)
  ULONGLONG PrcbPad128[7];                   // offset: 0x68c8 (26824)
  struct _REQUEST_MAILBOX *Mailbox;          // offset: 0x6900 (26880)
  ULONGLONG PrcbPad130[7];                   // offset: 0x6908 (26888)
  struct _REQUEST_MAILBOX RequestMailbox[1]; // offset: 0x6940 (26944)
};
...
struct _ETHREAD {
  ...
  union {
    ...
    struct {
      ...
      ULONG ReservedCrossThreadFlags : 9; // offset: 0x6d0 (1744)
    };
  };
  union {
...
struct _PROC_PERF_DOMAIN {
  ...
  struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[3];    // offset: 0x16c (364)
  ULONG QosDisableReasons[3];                           // offset: 0x1b4 (436)
  ULONG QosEquivalencyMasks[3];                         // offset: 0x1c0 (448)
  UCHAR QosSupported;                                   // offset: 0x1cc (460)
  ULONG SelectionGeneration;                            // offset: 0x1d0 (464)
  struct _PERF_CONTROL_STATE_SELECTION QosSelection[3]; // offset: 0x1d8 (472)
  ULONGLONG PerfChangeTime;                             // offset: 0x250 (592)
  ULONG PerfChangeIntervalCount;                        // offset: 0x258 (600)
  UCHAR Force;                                          // offset: 0x25c (604)
};
