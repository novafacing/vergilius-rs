...
struct _KNODE {
  ...
  ULONG PpmConfiguredQosSets[3];               // offset: 0xe0 (224)
};
...
struct _MI_NODE_INFORMATION {
  ...
  ULONG LargePagesCount[2][2][2][1];           // offset: 0x10 (16)
  struct _LIST_ENTRY LargePages[1][2][2][1];   // offset: 0x30 (48)
  struct _LIST_ENTRY MediumPages[2][2][1][16]; // offset: 0x50 (80)
  ULONG MediumPagesCount[2][2][1][16];         // offset: 0x250 (592)
  struct _MI_REBUILD_LARGE_PAGE_TIMER
      LargePageRebuildTimer;                     // offset: 0x350 (848)
  struct _RTL_BITMAP FreePageListHeadsBitmap[2]; // offset: 0x380 (896)
  ULONG FreePageListHeadsBitmapBuffer[16];       // offset: 0x390 (912)
  volatile ULONG FreeCount[2];                   // offset: 0x3d0 (976)
  ULONG TotalPages[1];                           // offset: 0x3d8 (984)
  ULONG TotalPagesEntireNode;                    // offset: 0x3dc (988)
  ULONG MmShiftedColor;                          // offset: 0x3e0 (992)
  ULONG Color;                                   // offset: 0x3e4 (996)
  volatile ULONG ChannelFreeCount[1][2];         // offset: 0x3e8 (1000)
  struct {
    ULONG ChannelsHotCold : 1;    // offset: 0x0 (0)
    ULONG Spare : 31;             // offset: 0x0 (0)
  } Flags;                        // offset: 0x3f0 (1008)
  struct _EX_PUSH_LOCK NodeLock;  // offset: 0x3f4 (1012)
  UCHAR ChannelStatus;            // offset: 0x3f8 (1016)
  UCHAR ChannelOrdering[1];       // offset: 0x3f9 (1017)
  UCHAR LockedChannelOrdering[1]; // offset: 0x3fa (1018)
  UCHAR PowerAttribute[1];        // offset: 0x3fb (1019)
  ULONG LargePageLock;            // offset: 0x3fc (1020)
};
...
struct _MI_PARTITION_MODWRITES {
  ...
  volatile LONG ClusterWritesDisabled[2];                 // offset: 0x16c (364)
  struct _KEVENT NotifyStoreMemoryConditions;             // offset: 0x174 (372)
  volatile UCHAR DelayMappedWrite;                        // offset: 0x184 (388)
  volatile ULONG PagefileReservationsEnabled;             // offset: 0x188 (392)
  struct _EX_PUSH_LOCK PageFileCreationLock;              // offset: 0x18c (396)
  struct _WORK_QUEUE_ITEM TrimPagefileWorkItem;           // offset: 0x190 (400)
  ULONGLONG LastTrimPagefileTime;                         // offset: 0x1a0 (416)
  struct _WORK_QUEUE_ITEM WsSwapPagefileContractWorkItem; // offset: 0x1a8 (424)
  volatile LONG WsSwapPageFileContractionInProgress;      // offset: 0x1b8 (440)
  struct _EX_PUSH_LOCK WorkingSetSwapLock;                // offset: 0x1bc (444)
  volatile LONG WorkingSetInswapLock;                     // offset: 0x1c0 (448)
};
...
struct _MI_SECTION_STATE {
  ...
  struct _MMPFNLIST PurgingExtentPages;            // offset: 0xb0 (176)
  struct _MMPFN *DanglingExtentPages;              // offset: 0xc4 (196)
  struct _WORK_QUEUE_ITEM DanglingExtentsWorkItem; // offset: 0xc8 (200)
  UCHAR DanglingExtentsWorkerActive;               // offset: 0xd8 (216)
  UCHAR PurgingExtentsNeedWatchdog;                // offset: 0xd9 (217)
  struct _RTL_AVL_TREE PageFileSectionHead;        // offset: 0xdc (220)
  volatile LONG PageFileSectionListSpinLock;       // offset: 0xe0 (224)
  ULONG ImageBias;                                 // offset: 0xe4 (228)
  struct _EX_PUSH_LOCK RelocateBitmapsLock;        // offset: 0xe8 (232)
  struct _RTL_BITMAP ImageBitMap;                  // offset: 0xec (236)
  VOID *ApiSetSection;                             // offset: 0xf4 (244)
  VOID *ApiSetSchema;                              // offset: 0xf8 (248)
  ULONG ApiSetSchemaSize;                          // offset: 0xfc (252)
  ULONG LostDataFiles;                             // offset: 0x100 (256)
  ULONG LostDataPages;                             // offset: 0x104 (260)
  ULONG ImageFailureReason;                        // offset: 0x108 (264)
  struct _SECTION *CfgBitMapSection32;             // offset: 0x10c (268)
  struct _CONTROL_AREA *CfgBitMapControlArea32;    // offset: 0x110 (272)
  ULONG ImageCfgFailure;                           // offset: 0x114 (276)
  ULONG ImageChecksumBreakpoint;                   // offset: 0x118 (280)
  ULONG ImageSizeBreakpoint;                       // offset: 0x11c (284)
  volatile LONG ImageValidationFailed;             // offset: 0x120 (288)
};
...
struct _MI_VISIBLE_STATE {
  ...
  ULONG SystemVaTypeCount[17];                 // offset: 0x37c (892)
  UCHAR SystemVaType[1024];                    // offset: 0x3c0 (960)
  ULONG SystemVaTypeCountFailures[17];         // offset: 0x7c0 (1984)
  ULONG SystemVaTypeCountLimit[17];            // offset: 0x804 (2052)
  ULONG SystemVaTypeCountPeak[17];             // offset: 0x848 (2120)
  ULONG SystemAvailableVa;                     // offset: 0x88c (2188)
};
...
struct _KPROCESS {
  ...
  union {
    struct {
      ...
      LONG ReservedFlags : 22;       // offset: 0x64 (100)
    };
...
struct _MI_HARDWARE_STATE {
  ...
  ULONG MediumPageColors;                                 // offset: 0x34 (52)
  ...
  ULONG FlushTbThreshold;                                 // offset: 0x48 (72)
  enum _MI_PFN_CACHE_ATTRIBUTE OptimalZeroingAttribute[4]
                                                      [4]; // offset: 0x4c (76)
  UCHAR AttributeChangeRequiresReZero;                     // offset: 0x8c (140)
...
struct _MI_PROCESS_STATE {
  ...
  ULONG VadSecureCookie;                       // offset: 0x24 (36)
  ULONG FreePaeEntries;                        // offset: 0x28 (40)
  struct _PAE_ENTRY FirstFreePae;              // offset: 0x30 (48)
  volatile LONG AllocatedPaePages;             // offset: 0x50 (80)
  ULONG PaeLock;                               // offset: 0x54 (84)
  union _SLIST_HEADER PaeEntrySList;           // offset: 0x58 (88)
};
...
struct _ETW_STACK_TRACE_BLOCK {
  ...
  struct _ETHREAD *Thread;               // offset: 0x10 (16)
  struct _KDPC StackWalkDpc;             // offset: 0x14 (20)
  union _SLIST_HEADER ApcListHead;       // offset: 0x38 (56)
  struct _ETW_APC_ENTRY ApcEntry[12];    // offset: 0x40 (64)
  LONG ApcCount;                         // offset: 0x280 (640)
  LONG MaxApcCount;                      // offset: 0x284 (644)
};
...
struct _MI_SYSTEM_PTE_STATE {
  ...
  struct _MI_SYSTEM_PTE_TYPE KernelStackPteInfo;     // offset: 0x114 (276)
  ULONG StackGrowthFailures;                         // offset: 0x14c (332)
  UCHAR KernelStackPages;                            // offset: 0x150 (336)
  UCHAR TrackPtesAborted;                            // offset: 0x151 (337)
  UCHAR AdjustCounter;                               // offset: 0x152 (338)
  volatile LONG ReservedMappingLock;                 // offset: 0x154 (340)
  struct _RTL_AVL_TREE ReservedMappingTree;          // offset: 0x158 (344)
  struct _MMPFN *ReservedMappingPageTablePfns;       // offset: 0x15c (348)
  struct _RTL_AVL_TREE OutswappedKernelStackRoot;    // offset: 0x160 (352)
  volatile LONG OutswappedKernelStackLock;           // offset: 0x164 (356)
};
...
struct _CC_PARTITION {
  ...
  UCHAR RundownStarted;                                // offset: 0x249 (585)
...
struct _MI_PARTITION_SEGMENTS {
  ...
  struct _MMPAGE_FILE_EXPANSION AttemptForCantExtend; // offset: 0x3c (60)
  struct _MMDEREFERENCE_SEGMENT_HEADER
      DereferenceSegmentHeader;                    // offset: 0x70 (112)
  struct _LIST_ENTRY DeleteOnCloseList;            // offset: 0x9c (156)
  struct _KTIMER DeleteOnCloseTimer;               // offset: 0xa8 (168)
  UCHAR DeleteOnCloseTimerActive;                  // offset: 0xd0 (208)
  UCHAR SegmentDereferenceThreadExists;            // offset: 0xd1 (209)
  ULONG UnusedSegmentPagedPool;                    // offset: 0xd4 (212)
  struct _LIST_ENTRY UnusedSegmentList;            // offset: 0xd8 (216)
  struct _LIST_ENTRY UnusedSubsectionList;         // offset: 0xe0 (224)
  struct _LIST_ENTRY DeleteSubsectionList;         // offset: 0xe8 (232)
  struct _KEVENT ControlAreaDeleteEvent;           // offset: 0xf0 (240)
  struct _SINGLE_LIST_ENTRY ControlAreaDeleteList; // offset: 0x100 (256)
  struct _MI_PTE_CHAIN_HEAD FreeSystemCache;       // offset: 0x108 (264)
  struct _KEVENT CloneDereferenceEvent;            // offset: 0x120 (288)
  union _SLIST_HEADER CloneProtosSListHead;        // offset: 0x130 (304)
  struct _EX_PUSH_LOCK SystemCacheInitLock;        // offset: 0x138 (312)
  ULONG PagefileExtensionWaiters;                  // offset: 0x13c (316)
  ULONG PagefileExtensionRequests;                 // offset: 0x140 (320)
  struct _KEVENT PagefileExtensionWaitEvent;       // offset: 0x144 (324)
};
...
struct _EPROCESS {
  ...
  UCHAR HangCount : 4;                 // offset: 0x2ef (751)
  UCHAR GhostCount : 4;                // offset: 0x2ef (751)
  union {
    ...
    struct {
      ...
      ULONG SystemProcess : 1;          // offset: 0x2f0 (752)
      ULONG HideImageBaseAddresses : 1; // offset: 0x2f0 (752)
    };
  };
  ...
  union {
    ULONG MitigationFlags; // offset: 0x3d8 (984)
    struct {
    ...
    } MitigationFlagsValues;                              // offset: 0x3d8 (984)
  };
  union {
    ULONG MitigationFlags2; // offset: 0x3dc (988)
    struct {
    ...
    } MitigationFlags2Values;                  // offset: 0x3dc (988)
  };
  VOID *PartitionObject; // offset: 0x3e0 (992)
};
...
struct _WMI_LOGGER_CONTEXT {
  ...
  struct _RTL_BITMAP HookIdMap;                  // offset: 0x4e8 (1256)
  struct _ETW_STACK_CACHE *StackCache;           // offset: 0x4f0 (1264)
  struct _ETW_PMC_SUPPORT *PmcData;              // offset: 0x4f4 (1268)
  struct _ETW_LBR_SUPPORT *LbrData;              // offset: 0x4f8 (1272)
  struct _LIST_ENTRY BinaryTrackingList;         // offset: 0x4fc (1276)
  struct _WMI_BUFFER_HEADER **ScratchArray;      // offset: 0x504 (1284)
  struct _DISALLOWED_GUIDS DisallowedGuids;      // offset: 0x508 (1288)
  LONGLONG RelativeTimerDueTime;                 // offset: 0x510 (1296)
  struct _PERIODIC_CAPTURE_STATE_GUIDS
      PeriodicCaptureStateGuids;               // offset: 0x518 (1304)
  struct _EX_TIMER *PeriodicCaptureStateTimer; // offset: 0x520 (1312)
  enum _ETW_PERIODIC_TIMER_STATE
      PeriodicCaptureStateTimerState;                   // offset: 0x524 (1316)
  struct _ETW_SOFT_RESTART_CONTEXT *SoftRestartContext; // offset: 0x528 (1320)
  struct _ETW_SILODRIVERSTATE *SiloState;               // offset: 0x52c (1324)
  struct _WORK_QUEUE_ITEM CompressionWorkItem;          // offset: 0x530 (1328)
  LONG CompressionWorkItemState;                        // offset: 0x540 (1344)
  struct _EX_PUSH_LOCK CompressionLock;                 // offset: 0x544 (1348)
  struct _WMI_BUFFER_HEADER *CompressionTarget;         // offset: 0x548 (1352)
  VOID *CompressionWorkspace;                           // offset: 0x54c (1356)
  LONG CompressionOn;                                   // offset: 0x550 (1360)
  ULONG CompressionRatioGuess;                          // offset: 0x554 (1364)
  ULONG PartialBufferCompressionLevel;                  // offset: 0x558 (1368)
  enum ETW_COMPRESSION_RESUMPTION_MODE
      CompressionResumptionMode;               // offset: 0x55c (1372)
  struct _SINGLE_LIST_ENTRY PlaceholderList;   // offset: 0x560 (1376)
  struct _KDPC CompressionDpc;                 // offset: 0x564 (1380)
  union _LARGE_INTEGER LastBufferSwitchTime;   // offset: 0x588 (1416)
  union _LARGE_INTEGER BufferWriteDuration;    // offset: 0x590 (1424)
  union _LARGE_INTEGER BufferCompressDuration; // offset: 0x598 (1432)
};
...
struct _MI_PARTITION {
  ...
  struct _MI_PARTITION_STORES Store;             // offset: 0x2b0 (688)
  struct _MI_PARTITION_SEGMENTS Segments;        // offset: 0x340 (832)
  struct _MI_PARTITION_PAGE_LISTS PageLists;     // offset: 0x4c0 (1216)
  struct _MI_PARTITION_COMMIT Commit;            // offset: 0xc80 (3200)
  struct _MI_PARTITION_ZEROING Zeroing;          // offset: 0xd00 (3328)
  struct _MI_PAGE_COMBINING_SUPPORT PageCombine; // offset: 0xd40 (3392)
  VOID *WorkingSetControl;                       // offset: 0xe18 (3608)
  struct _MMWORKING_SET_EXPANSION_HEAD
      WorkingSetExpansionHead;     // offset: 0xe1c (3612)
  struct _MI_VISIBLE_PARTITION Vp; // offset: 0xe40 (3648)
};
...
struct _MI_SYSTEM_INFORMATION {
  ...
  struct _MI_HARDWARE_STATE Hardware;         // offset: 0x1748 (5960)
  struct _MI_SYSTEM_VA_STATE SystemVa;        // offset: 0x1840 (6208)
  struct _MI_COMBINE_STATE PageCombines;      // offset: 0x2d40 (11584)
  struct _MI_PAGELIST_STATE PageLists;        // offset: 0x2d58 (11608)
  struct _MI_PARTITION_STATE Partitions;      // offset: 0x2d60 (11616)
  struct _MI_SHUTDOWN_STATE Shutdowns;        // offset: 0x2d98 (11672)
  struct _MI_ERROR_STATE Errors;              // offset: 0x2de0 (11744)
  struct _MI_ACCESS_LOG_STATE AccessLog;      // offset: 0x2ec0 (11968)
  struct _MI_DEBUGGER_STATE Debugger;         // offset: 0x2f40 (12096)
  struct _MI_STANDBY_STATE Standby;           // offset: 0x2fd0 (12240)
  ...
  ULONG Cookie;                               // offset: 0x32c0 (12992)
  VOID *volatile *BootRegistryRuns;           // offset: 0x32c4 (12996)
  volatile LONG ZeroingDisabled;              // offset: 0x32c8 (13000)
  UCHAR FullyInitialized;                     // offset: 0x32cc (13004)
  UCHAR SafeBooted;                           // offset: 0x32cd (13005)
  struct _RTL_BITMAP PfnBitMap;               // offset: 0x32d0 (13008)
  struct _TlgProvider_t *TraceLogging;        // offset: 0x32d8 (13016)
  struct _MI_VISIBLE_STATE Vs;                // offset: 0x3300 (13056)
};
...
struct _ETW_SILODRIVERSTATE {
  ...
  ULONG MaxLoggers;                                       // offset: 0x4 (4)
  struct _ETW_GUID_ENTRY EtwpSecurityProviderGuidEntry;   // offset: 0x8 (8)
  struct _EX_RUNDOWN_REF_CACHE_AWARE **EtwpLoggerRundown; // offset: 0x170 (368)
  struct _WMI_LOGGER_CONTEXT **EtwpLoggerContext;         // offset: 0x174 (372)
  struct _ETW_HASH_BUCKET EtwpGuidHashTable[64];          // offset: 0x178 (376)
  USHORT EtwpSecurityLoggers[8];        // offset: 0x878 (2168)
  UCHAR EtwpSecurityProviderEnableMask; // offset: 0x888 (2184)
  LONG EtwpShutdownInProgress;          // offset: 0x88c (2188)
  ULONG EtwpSecurityProviderPID;        // offset: 0x890 (2192)
  struct _ETW_PRIV_HANDLE_DEMUX_TABLE
      PrivHandleDemuxTable;                        // offset: 0x894 (2196)
  struct _ETW_COUNTERS EtwpCounters;               // offset: 0x8a4 (2212)
  union _LARGE_INTEGER LogfileBytesWritten;        // offset: 0x8b8 (2232)
  struct _ETW_SILO_TRACING_BLOCK *ProcessorBlocks; // offset: 0x8c0 (2240)
  struct _GUID PartitionId;                        // offset: 0x8c4 (2244)
  struct _GUID ParentId;                           // offset: 0x8d4 (2260)
  union _LARGE_INTEGER QpcOffsetFromRoot;          // offset: 0x8e8 (2280)
  ULONG PartitionType;                             // offset: 0x8f0 (2288)
  struct _ETW_SYSTEM_LOGGER_SETTINGS
      SystemLoggerSettings; // offset: 0x8f4 (2292)
};
...
struct _KPRCB {
  ...
  UCHAR PrcbPad20;                               // offset: 0x4c3 (1219)
  ...
  ULONG PrcbPad21[2];                            // offset: 0x4d4 (1236)
  ...
  ULONG PrcbPad100[10];                              // offset: 0x4778 (18296)
  struct _KSHARED_READY_QUEUE LocalSharedReadyQueue; // offset: 0x47a0 (18336)
  struct _REQUEST_MAILBOX *Mailbox;                  // offset: 0x48e0 (18656)
  UCHAR PrcbPad[60];                                 // offset: 0x48e4 (18660)
  struct _REQUEST_MAILBOX RequestMailbox[1];         // offset: 0x4920 (18720)
};
...
struct _ETHREAD {
  ...
  union {
    ...
    struct {
      ...
      ULONG ReservedCrossThreadFlags : 9; // offset: 0x3cc (972)
    };
  };
  union {
...
struct _PROC_PERF_DOMAIN {
  ...
  struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[3];    // offset: 0x8c (140)
  ULONG QosDisableReasons[3];                           // offset: 0xd4 (212)
  ULONG QosEquivalencyMasks[3];                         // offset: 0xe0 (224)
  UCHAR QosSupported;                                   // offset: 0xec (236)
  ULONG SelectionGeneration;                            // offset: 0xf0 (240)
  struct _PERF_CONTROL_STATE_SELECTION QosSelection[3]; // offset: 0xf8 (248)
  ULONGLONG PerfChangeTime;                             // offset: 0x170 (368)
  ULONG PerfChangeIntervalCount;                        // offset: 0x178 (376)
  UCHAR Force;                                          // offset: 0x17c (380)
};
