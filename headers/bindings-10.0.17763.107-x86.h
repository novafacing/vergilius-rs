...
struct wil_details_FeatureTestState {
  ...
  struct wil_details_FeatureTestState *next;  // offset: 0x14 (20)
};
...
union wil_details_FeaturePropertyCache {
  struct wil_details_FeatureProperties cache;   // offset: 0x0 (0)
  struct wil_details_VariantProperties variant; // offset: 0x0 (0)
  volatile LONG var;                            // offset: 0x0 (0)
};

// 0x8 (8) bytes
struct wil_details_FeatureVariantPropertyCache {
  union wil_details_FeaturePropertyCache propertyCache; // offset: 0x0 (0)
...
struct _RTL_HP_LFH_CONFIG {
  ...
  USHORT MaxSubsegmentPages; // offset: 0x2 (2)
};
...
struct _IMAGE_SWITCHTABLE_BRANCH_DYNAMIC_RELOCATION {
  USHORT PageRelativeOffset : 12; // offset: 0x0 (0)
  USHORT RegisterNumber : 4;      // offset: 0x0 (0)
};

// 0x2 (2) bytes
struct _IMAGE_INDIR_CONTROL_TRANSFER_DYNAMIC_RELOCATION {
  USHORT PageRelativeOffset : 12; // offset: 0x0 (0)
  USHORT IndirectCall : 1;        // offset: 0x0 (0)
  USHORT RexWPrefix : 1;          // offset: 0x0 (0)
  USHORT CfgCheck : 1;            // offset: 0x0 (0)
  USHORT Reserved : 1;            // offset: 0x0 (0)
};
...
struct FEATURE_ERROR {
  ...
  const CHAR *process;                   // offset: 0xc (12)
  const CHAR *modulePath;                // offset: 0x10 (16)
  ULONG callerReturnAddressOffset;       // offset: 0x14 (20)
  const CHAR *callerModule;              // offset: 0x18 (24)
  const CHAR *message;                   // offset: 0x1c (28)
  USHORT originLineNumber;               // offset: 0x20 (32)
  const CHAR *originFile;                // offset: 0x24 (36)
  const CHAR *originModule;              // offset: 0x28 (40)
  ULONG originCallerReturnAddressOffset; // offset: 0x2c (44)
  const CHAR *originCallerModule;        // offset: 0x30 (48)
  const CHAR *originName;                // offset: 0x34 (52)
};
...
struct _FAULT_INFORMATION_ARM64 {
  ...
  VOID *FaultAddress;                          // offset: 0x4 (4)
  struct _DEVICE_OBJECT *PhysicalDeviceObject; // offset: 0x8 (8)
  ULONG InputMappingId;                        // offset: 0xc (12)
  struct _FAULT_INFORMATION_ARM64_FLAGS Flags; // offset: 0x10 (16)
...
struct _FAULT_INFORMATION {
  ...
  struct _FAULT_INFORMATION_ARM64 Arm64; // offset: 0x4 (4)
};
...
struct _DEVICE_FAULT_CONFIGURATION {
  ...
  VOID *FaultContext;                            // offset: 0x4 (4)
};
...
struct _RTL_HEAP_MEMORY_LIMIT_DATA {
  ULONG CommitLimitBytes;           // offset: 0x0 (0)
  ULONG CommitLimitFailureCode;     // offset: 0x4 (4)
  ULONG MaxAllocationSizeBytes;     // offset: 0x8 (8)
  ULONG AllocationLimitFailureCode; // offset: 0xc (12)
};
...
struct _IMAGE_IMPORT_CONTROL_TRANSFER_DYNAMIC_RELOCATION {
  ULONG PageRelativeOffset : 12; // offset: 0x0 (0)
  ULONG IndirectCall : 1;        // offset: 0x0 (0)
  ULONG IATIndex : 19;           // offset: 0x0 (0)
};

// 0xc (12) bytes
struct _RTL_RETPOLINE_RELOCATION_INDEX {
  USHORT ImportRelocationSize;     // offset: 0x0 (0)
  USHORT IndirectRelocationSize;   // offset: 0x2 (2)
  USHORT SwitchJumpRelocationSize; // offset: 0x4 (4)
  USHORT StraddleType;             // offset: 0x6 (6)
  union {
    struct _IMAGE_IMPORT_CONTROL_TRANSFER_DYNAMIC_RELOCATION
        Import; // offset: 0x8 (8)
    struct _IMAGE_INDIR_CONTROL_TRANSFER_DYNAMIC_RELOCATION
        Indir; // offset: 0x8 (8)
    struct _IMAGE_SWITCHTABLE_BRANCH_DYNAMIC_RELOCATION
        SwitchJump; // offset: 0x8 (8)

  } StraddleReloc; // offset: 0x8 (8)
};
...
struct _MI_PARTITION_FLAGS {
  ...
  ULONG UseSlabAllocators : 1;         // offset: 0x0 (0)
...
struct wil_details_StagingConfig {
  ...
  struct wil_details_StagingConfigHeader *header;         // offset: 0x14 (20)
  struct wil_details_StagingConfigFeature *features;      // offset: 0x18 (24)
  struct wil_details_StagingConfigUsageTrigger *triggers; // offset: 0x1c (28)
  LONG changedInSession;                                  // offset: 0x20 (32)
  VOID *buffer;                                           // offset: 0x24 (36)
  ULONG bufferSize;                                       // offset: 0x28 (40)
  ULONG bufferAlloc;                                      // offset: 0x2c (44)
  LONG bufferOwned;                                       // offset: 0x30 (48)
};

// 0xc (12) bytes
struct wil_details_SetPropertyCacheUsageContext {
  struct wil_details_RecordUsageResult *result; // offset: 0x0 (0)
  enum wil_details_ServiceReportingKind kind;   // offset: 0x4 (4)
  ULONG addend;                                 // offset: 0x8 (8)
};
...
struct wil_details_SetPropertyFlagContext {
  struct wil_details_RecordUsageResult *result; // offset: 0x0 (0)
  ULONG flags;                                  // offset: 0x4 (4)
  LONG ignoreReporting;                         // offset: 0x8 (8)
};
...
union _WHEA_EVENT_LOG_ENTRY_FLAGS {
  ULONG Reserved : 32; // offset: 0x0 (0)
  ULONG AsULONG;       // offset: 0x0 (0)
};
...
struct _PO_DIRECTED_DRIPS_STATE {
  ...
  struct _LIST_ENTRY VisitedQueueLink; // offset: 0x8 (8)
  volatile ULONG Flags;                // offset: 0x10 (16)
  ULONG CachedFlags;                   // offset: 0x14 (20)
  ULONG DeviceUsageCount;              // offset: 0x18 (24)
  VOID *Diagnostic;                    // offset: 0x1c (28)
};
...
struct _RTL_RETPOLINE_BINARY_INFO {
  LONG RetpolineStubsStartRva;     // offset: 0x0 (0)
  ULONG CfgDispatchFunctionPtrRva; // offset: 0x4 (4)
  ULONG IATRva;                    // offset: 0x8 (8)
  LONG *ImportRvas;                // offset: 0xc (12)
  ULONG *IAT;                      // offset: 0x10 (16)
  VOID *ImageBase;                 // offset: 0x14 (20)
};

// 0x20 (32) bytes
struct _MI_RETPOLINE_RELOCATION_INFORMATION {
  struct _RTL_RETPOLINE_BINARY_INFO BinaryInfo;     // offset: 0x0 (0)
  VOID *RelocationBuffer;                           // offset: 0x18 (24)
  struct _RTL_RETPOLINE_RELOCATION_INDEX *Index[1]; // offset: 0x1c (28)
};
...
struct _RTL_RVA_LIST {
  ULONG RvaCount;                    // offset: 0x0 (0)
  ULONG StateBitsPerRva;             // offset: 0x4 (4)
  UCHAR *CompressedBuffer;           // offset: 0x8 (8)
  ULONG CompressedBufferSize;        // offset: 0xc (12)
  struct _RTL_BITMAP RvaStateBitMap; // offset: 0x10 (16)
  ULONG *StateBitValueMap;           // offset: 0x18 (24)
  VOID *ExtensionBuffer;             // offset: 0x1c (28)
};

// 0x10 (16) bytes
struct _MI_IMAGE_LOAD_CONFIG {
  ULONG Flags;                   // offset: 0x0 (0)
  ULONG CfgAlignmentBias;        // offset: 0x4 (4)
  struct _RTL_RVA_LIST *RvaList; // offset: 0x8 (8)
  struct _MI_RETPOLINE_RELOCATION_INFORMATION
      *RetpolineRelocations; // offset: 0xc (12)
};
...
struct _MI_VAD_EVENT_BLOCK {
  ...
  union {
    ...
    struct _MI_SUB64K_FREE_RANGES PebTeb;      // offset: 0x4 (4)
...
struct _POP_FX_DRIVER_CALLBACKS {
  ...
  VOID (*DirectedPowerTransitionCallback)
  (VOID *arg1, UCHAR arg2, ULONG arg3); // offset: 0x20 (32)
};
...
struct _RTLP_HP_HEAP_GLOBALS {
  ...
  struct _RTL_HEAP_MEMORY_LIMIT_DATA CommitLimitData; // offset: 0xc (12)
};
...
struct _RTL_USER_PROCESS_PARAMETERS {
  ...
  struct _UNICODE_STRING RedirectionDllName;             // offset: 0x2a4 (676)
};
...
struct _WAIT_CONTEXT_BLOCK {
  union {
    ...
    struct {
      ...
      ULONG Reserved : 9;              // offset: 0xc (12)
      ULONG NumberOfRemapPages : 20;   // offset: 0xc (12)
    };
  };
...
struct PO_MEMORY_IMAGE {
  ...
  UCHAR InitializeUSBCore;                         // offset: 0x337 (823)
  UCHAR ValidUSBCoreId;                            // offset: 0x338 (824)
  UCHAR USBCoreId;                                 // offset: 0x339 (825)
  UCHAR SkipMemoryMapValidation;                   // offset: 0x33a (826)
};
...
struct _LOADER_PERFORMANCE_DATA {
  ...
  ULONGLONG LoadDriversTime;      // offset: 0x40 (64)
};
...
struct _DMA_IOMMU_INTERFACE {
  ...
  LONG (*FlushDomain)(struct _IOMMU_DMA_DOMAIN *arg1); // offset: 0x14 (20)
...
struct _LOADER_PARAMETER_EXTENSION {
  ...
  ULONG DriverVerifierEnabled : 1;                       // offset: 0x4c (76)
  ULONG Unused : 8;                                      // offset: 0x4c (76)
  ULONG FeatureSimulations : 6;                          // offset: 0x4c (76)
  ULONG MicrocodeSelfHosting : 1;                        // offset: 0x4c (76)
  ULONG XhciLegacyHandoffSkip : 1;                       // offset: 0x4c (76)
  ULONG DisableInsiderOptInHVCI : 1;                     // offset: 0x4c (76)
  ULONG MicrocodeMinVerSupported : 1;                    // offset: 0x4c (76)
  ULONG GpuIommuEnabled : 1;                             // offset: 0x4c (76)
  struct _LOADER_PERFORMANCE_DATA LoaderPerformanceData; // offset: 0x50 (80)
  struct _LIST_ENTRY BootApplicationPersistentData;      // offset: 0x98 (152)
  VOID *WmdTestResult;                                   // offset: 0xa0 (160)
  struct _GUID BootIdentifier;                           // offset: 0xa4 (164)
  ULONG ResumePages;                                     // offset: 0xb4 (180)
  VOID *DumpHeader;                                      // offset: 0xb8 (184)
  VOID *BgContext;                                       // offset: 0xbc (188)
  VOID *NumaLocalityInfo;                                // offset: 0xc0 (192)
  VOID *NumaGroupAssignment;                             // offset: 0xc4 (196)
  struct _LIST_ENTRY AttachedHives;                      // offset: 0xc8 (200)
  ULONG MemoryCachingRequirementsCount;                  // offset: 0xd0 (208)
  VOID *MemoryCachingRequirements;                       // offset: 0xd4 (212)
  struct _BOOT_ENTROPY_LDR_RESULT BootEntropyResult;     // offset: 0xd8 (216)
  ULONGLONG ProcessorCounterFrequency;                   // offset: 0x940 (2368)
  struct _LOADER_PARAMETER_HYPERVISOR_EXTENSION
      HypervisorExtension;                   // offset: 0x948 (2376)
  struct _GUID HardwareConfigurationId;      // offset: 0x988 (2440)
  struct _LIST_ENTRY HalExtensionModuleList; // offset: 0x998 (2456)
  union _LARGE_INTEGER SystemTime;           // offset: 0x9a0 (2464)
  ULONGLONG TimeStampAtSystemTimeRead;       // offset: 0x9a8 (2472)
  union {
    ULONGLONG BootFlags; // offset: 0x9b0 (2480)
    struct {
      ULONGLONG DbgMenuOsSelection : 1; // offset: 0x9b0 (2480)
      ULONGLONG DbgHiberBoot : 1;       // offset: 0x9b0 (2480)
      ULONGLONG DbgSoftRestart : 1;     // offset: 0x9b0 (2480)
      ULONGLONG DbgMeasuredLaunch : 1;  // offset: 0x9b0 (2480)
    };
  };
  union {
    ULONGLONG InternalBootFlags; // offset: 0x9b8 (2488)
    struct {
      ULONGLONG DbgUtcBootTime : 1;      // offset: 0x9b8 (2488)
      ULONGLONG DbgRtcBootTime : 1;      // offset: 0x9b8 (2488)
      ULONGLONG DbgNoLegacyServices : 1; // offset: 0x9b8 (2488)
    };
  };
  VOID *WfsFPData;                                       // offset: 0x9c0 (2496)
  ULONG WfsFPDataSize;                                   // offset: 0x9c4 (2500)
  struct _LOADER_BUGCHECK_PARAMETERS BugcheckParameters; // offset: 0x9c8 (2504)
  VOID *ApiSetSchema;                                    // offset: 0x9dc (2524)
  ULONG ApiSetSchemaSize;                                // offset: 0x9e0 (2528)
  struct _LIST_ENTRY ApiSetSchemaExtensions;             // offset: 0x9e4 (2532)
  struct _UNICODE_STRING AcpiBiosVersion;                // offset: 0x9ec (2540)
  struct _UNICODE_STRING SmbiosVersion;                  // offset: 0x9f4 (2548)
  struct _UNICODE_STRING EfiVersion;                     // offset: 0x9fc (2556)
  struct _DEBUG_DEVICE_DESCRIPTOR *KdDebugDevice;        // offset: 0xa04 (2564)
  struct _OFFLINE_CRASHDUMP_CONFIGURATION_TABLE_V2
      OfflineCrashdumpConfigurationTable;      // offset: 0xa08 (2568)
  struct _UNICODE_STRING ManufacturingProfile; // offset: 0xa28 (2600)
  VOID *BbtBuffer;                             // offset: 0xa30 (2608)
  ULONGLONG XsaveAllowedFeatures;              // offset: 0xa38 (2616)
  ULONG XsaveFlags;                            // offset: 0xa40 (2624)
  VOID *BootOptions;                           // offset: 0xa44 (2628)
  ULONG IumEnablement;                         // offset: 0xa48 (2632)
  ULONG IumPolicy;                             // offset: 0xa4c (2636)
  LONG IumStatus;                              // offset: 0xa50 (2640)
  ULONG BootId;                                // offset: 0xa54 (2644)
  struct _LOADER_PARAMETER_CI_EXTENSION
      *CodeIntegrityData;      // offset: 0xa58 (2648)
  ULONG CodeIntegrityDataSize; // offset: 0xa5c (2652)
  struct _LOADER_HIVE_RECOVERY_INFO
      SystemHiveRecoveryInfo;               // offset: 0xa60 (2656)
  ULONG SoftRestartCount;                   // offset: 0xa74 (2676)
  LONGLONG SoftRestartTime;                 // offset: 0xa78 (2680)
  struct _LEAP_SECOND_DATA *LeapSecondData; // offset: 0xa80 (2688)
  ULONG MajorRelease;                       // offset: 0xa84 (2692)
  ULONG Reserved1;                          // offset: 0xa88 (2696)
  CHAR NtBuildLab[224];                     // offset: 0xa8c (2700)
  CHAR NtBuildLabEx[224];                   // offset: 0xb6c (2924)
  struct _LOADER_RESET_REASON ResetReason;  // offset: 0xc50 (3152)
  ULONG MaxPciBusNumber;                    // offset: 0xc80 (3200)
  ULONG FeatureSettings;                    // offset: 0xc84 (3204)
};
...
struct _HEAP {
  ...
  struct _RTL_HEAP_MEMORY_LIMIT_DATA CommitLimitData; // offset: 0xd4 (212)
  VOID *FrontEndHeap;                                 // offset: 0xe4 (228)
  USHORT FrontHeapLockCount;                          // offset: 0xe8 (232)
  UCHAR FrontEndHeapType;                             // offset: 0xea (234)
  UCHAR RequestedFrontEndHeapType;                    // offset: 0xeb (235)
  WCHAR *FrontEndHeapUsageData;                       // offset: 0xec (236)
  USHORT FrontEndHeapMaximumIndex;                    // offset: 0xf0 (240)
  volatile UCHAR FrontEndHeapStatusBitmap[257];       // offset: 0xf2 (242)
  struct _HEAP_COUNTERS Counters;                     // offset: 0x1f4 (500)
  struct _HEAP_TUNING_PARAMETERS TuningParameters;    // offset: 0x250 (592)
};
...
struct _LOG_HANDLE_CONTEXT {
  ...
  VOID (*FlushToLsnRoutine)
  (VOID *arg1, union _LARGE_INTEGER arg2);                    // offset: 0x4 (4)
  VOID (*QueryLogHandleInfoRoutine)(VOID *arg1, WCHAR *arg2); // offset: 0x8 (8)
...
struct _PPM_ENGINE_SETTINGS {
  ...
  UCHAR AllowScaling;                                 // offset: 0x90 (144)
  UCHAR IdleDisabled;                                 // offset: 0x91 (145)
  ULONG IdleTimeCheck;                                // offset: 0x94 (148)
  UCHAR IdleDemotePercent;                            // offset: 0x98 (152)
  UCHAR IdlePromotePercent;                           // offset: 0x99 (153)
  UCHAR IdleStateMax;                                 // offset: 0x9a (154)
  UCHAR HeteroDecreaseTime;                           // offset: 0x9b (155)
  UCHAR HeteroIncreaseTime;                           // offset: 0x9c (156)
  UCHAR HeteroDecreaseThreshold[32];                  // offset: 0x9d (157)
  UCHAR HeteroIncreaseThreshold[32];                  // offset: 0xbd (189)
  UCHAR Class0FloorPerformance;                       // offset: 0xdd (221)
  UCHAR Class1InitialPerformance;                     // offset: 0xde (222)
  enum _KHETERO_CPU_POLICY ThreadPolicies[2];         // offset: 0xe0 (224)
};
...
struct _POP_PPM_PROFILE {
  ...
  ULONGLONG StartTime;                     // offset: 0x1f0 (496)
  ULONGLONG Count;                         // offset: 0x1f8 (504)
  ULONGLONG MaxDuration;                   // offset: 0x200 (512)
  ULONGLONG MinDuration;                   // offset: 0x208 (520)
  ULONGLONG TotalDuration;                 // offset: 0x210 (528)
};
...
struct _HV_X64_HYPERVISOR_FEATURES {
  ...
  ULONG Reserved1 : 5;                           // offset: 0xc (12)
};
...
struct _MI_SLAB_ALLOCATOR_CONTEXT {
  ...
  struct _MI_SLAB_ALLOCATOR_ENTRY *SlabEntryHint; // offset: 0xc (12)
  ULONG FreePageCount;                            // offset: 0x10 (16)
  ULONG SlabEntryCount;                           // offset: 0x14 (20)
  enum _MI_SLAB_ALLOCATOR_PROTECTION Protection;  // offset: 0x18 (24)
  union {
    ULONG EntryBecameEmpty : 1; // offset: 0x1c (28)
    ULONG Spare : 31;           // offset: 0x1c (28)
    ULONG AllFlags;             // offset: 0x1c (28)

  } Flags;                     // offset: 0x1c (28)
  ULONGLONG LastReplenishTime; // offset: 0x20 (32)
  ULONGLONG LastFailureTime;   // offset: 0x28 (40)
};
...
struct _MMPTE_LIST {
  ...
  ULONGLONG filler1 : 5;    // offset: 0x0 (0)
  ULONGLONG Prototype : 1;  // offset: 0x0 (0)
  ULONGLONG Transition : 1; // offset: 0x0 (0)
  ULONGLONG filler2 : 20;   // offset: 0x0 (0)
...
struct _MMPTE_TIMESTAMP {
  ...
  ULONGLONG Unused1 : 16;         // offset: 0x0 (0)
...
struct _MMPTE_SOFTWARE {
  ...
  ULONGLONG Unused0 : 1;           // offset: 0x0 (0)
  ULONGLONG SwizzleBit : 1;        // offset: 0x0 (0)
  ULONGLONG Protection : 5;        // offset: 0x0 (0)
  ULONGLONG Prototype : 1;         // offset: 0x0 (0)
  ULONGLONG Transition : 1;        // offset: 0x0 (0)
    ...
    struct {
      ...
      union {
        ...
        struct {
          ...
          ULONG AweSection : 1;                // offset: 0x4 (4)
...
struct _MI_SECTION_STATE {
  ...
  struct _KEVENT DanglingExtentsDeletionComplete;  // offset: 0xe8 (232)
  UCHAR DanglingExtentsWorkerActive;               // offset: 0xf8 (248)
  UCHAR PurgingExtentsNeedWatchdog;                // offset: 0xf9 (249)
  struct _RTL_AVL_TREE PrototypePtesTree;          // offset: 0xfc (252)
  volatile LONG PrototypePtesTreeSpinLock;         // offset: 0x100 (256)
  ULONG ImageBias;                                 // offset: 0x104 (260)
  struct _EX_PUSH_LOCK RelocateBitmapsLock;        // offset: 0x108 (264)
  struct _RTL_BITMAP ImageBitMap;                  // offset: 0x10c (268)
  VOID *ApiSetSection;                             // offset: 0x114 (276)
  VOID *ApiSetSchema;                              // offset: 0x118 (280)
  ULONG ApiSetSchemaSize;                          // offset: 0x11c (284)
  ULONG LostDataFiles;                             // offset: 0x120 (288)
  ULONG LostDataPages;                             // offset: 0x124 (292)
  ULONG ImageFailureReason;                        // offset: 0x128 (296)
  struct _SECTION *CfgBitMapSection32;             // offset: 0x12c (300)
  struct _CONTROL_AREA *CfgBitMapControlArea32;    // offset: 0x130 (304)
  ULONG ImageCfgFailure;                           // offset: 0x134 (308)
  ULONG ImageChecksumBreakpoint;                   // offset: 0x138 (312)
  ULONG ImageSizeBreakpoint;                       // offset: 0x13c (316)
  volatile LONG ImageValidationFailed;             // offset: 0x140 (320)
};
...
struct _POP_FX_ACCOUNTING {
  ...
  struct _POP_FX_ACTIVE_TIME_ACCOUNTING
      CsActiveTimeAccounting; // offset: 0x18 (24)
  struct _POP_FX_ACTIVE_TIME_ACCOUNTING
      CsCriticalActiveTimeAccounting; // offset: 0x78 (120)
};
...
struct _KAPC_STATE {
  ...
  union {
    UCHAR UserApcPendingAll; // offset: 0x16 (22)
    struct {
      UCHAR SpecialUserApcPending : 1; // offset: 0x16 (22)
      UCHAR UserApcPending : 1;        // offset: 0x16 (22)
    };
  };
};
...
struct _ARBITER_INSTANCE {
  ...
  (struct _ARBITER_INSTANCE *arg1, VOID *arg2); // offset: 0x90 (144)
  UCHAR TransactionInProgress;                  // offset: 0x94 (148)
  struct _KEVENT *TransactionEvent;             // offset: 0x98 (152)
  VOID *Extension;                              // offset: 0x9c (156)
  struct _DEVICE_OBJECT *BusDeviceObject;       // offset: 0xa0 (160)
  VOID *ConflictCallbackContext;                // offset: 0xa4 (164)
  UCHAR (*ConflictCallback)
  (VOID *arg1, struct _RTL_RANGE *arg2); // offset: 0xa8 (168)
};
...
struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION {
  ...
  (struct _HAL_HV_DMA_DOMAIN_INFO *arg1, ULONG arg2, ULONGLONG arg3,
   ULONG *arg4, ULONGLONG *arg5, UCHAR arg6); // offset: 0xe0 (224)
...
struct _ETW_SILO_TRACING_BLOCK {
  ...
  LONGLONG *volatile QpcDelta;           // offset: 0x8 (8)
};
...
struct _MI_HARDWARE_STATE {
  ...
  UCHAR ProcessorCachesFlushedOnPowerLoss;                // offset: 0x28 (40)
  ULONG TotalPagesAllowed;                                // offset: 0x2c (44)
  ULONG SecondaryColorMask;                               // offset: 0x30 (48)
  ULONG SecondaryColors;                                  // offset: 0x34 (52)
  ULONG FlushTbForAttributeChange;                        // offset: 0x38 (56)
  ULONG FlushCacheForAttributeChange;                     // offset: 0x3c (60)
  ULONG FlushCacheForPageAttributeChange;                 // offset: 0x40 (64)
  ULONG CacheFlushPromoteThreshold;                       // offset: 0x44 (68)
  ULONGLONG InvalidPteMask;                               // offset: 0x80 (128)
  ULONG LargePageColors[2];                               // offset: 0xc0 (192)
  ULONG FlushTbThreshold;                                 // offset: 0xc8 (200)
  enum _MI_PFN_CACHE_ATTRIBUTE OptimalZeroingAttribute[4]
                                                      [4]; // offset: 0xcc (204)
  UCHAR AttributeChangeRequiresReZero;           // offset: 0x10c (268)
  struct _MI_ZERO_COST_COUNTS ZeroCostCounts[2]; // offset: 0x110 (272)
  ULONG HighestPossiblePhysicalPage;             // offset: 0x130 (304)
  ULONG VsmKernelPageCount;                      // offset: 0x134 (308)
  struct _RTL_AVL_TREE EnclaveRegions;           // offset: 0x138 (312)
  VOID *EnclaveMetadataPage;                     // offset: 0x13c (316)
  struct _RTL_BITMAP *EnclaveMetadataBitMap;     // offset: 0x140 (320)
  struct _EX_PUSH_LOCK EnclaveMetadataEntryLock; // offset: 0x144 (324)
  volatile LONG EnclaveMetadataPageLock;         // offset: 0x148 (328)
};
...
struct _MI_PARTITION_PAGE_LISTS {
  ...
  UCHAR PfnBitMapsReady;                                 // offset: 0x672 (1650)
  ...
  struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[3]; // offset: 0x878 (2168)
  struct _RTL_BITMAP SlabPfnBitMap;                  // offset: 0x908 (2312)
};
...
struct _SHARED_CACHE_MAP {
  ...
  ULONG InternalRefCount;                              // offset: 0x178 (376)
};
...
struct _MI_PARTITION_SEGMENTS {
  ...
  VOID *SegmentDereferenceActiveControlArea;           // offset: 0xdc (220)
  ULONG UnusedSegmentPagedPool;                        // offset: 0xe0 (224)
  struct _LIST_ENTRY UnusedSegmentList;                // offset: 0xe4 (228)
  struct _LIST_ENTRY UnusedSubsectionList;             // offset: 0xec (236)
  struct _LIST_ENTRY DeleteSubsectionList;             // offset: 0xf4 (244)
  struct _KEVENT ControlAreaDeleteEvent;               // offset: 0xfc (252)
  struct _SINGLE_LIST_ENTRY ControlAreaDeleteList;     // offset: 0x10c (268)
...
struct _PEB {
  ...
  struct _LEAP_SECOND_DATA *LeapSecondData;     // offset: 0x470 (1136)
  union {
...
struct _EPROCESS {
  ...
  UCHAR HangCount : 3;                 // offset: 0x2f7 (759)
  UCHAR GhostCount : 3;                // offset: 0x2f7 (759)
  UCHAR PrefilterException : 1;        // offset: 0x2f7 (759)
  union {
    ...
    struct {
      ...
      ULONG EnableProcessSuspendResumeLogging : 1; // offset: 0x2f8 (760)
      ULONG EnableThreadSuspendResumeLogging : 1;  // offset: 0x2f8 (760)
      ULONG SecurityDomainChanged : 1;             // offset: 0x2f8 (760)
      ULONG SecurityFreezeComplete : 1;            // offset: 0x2f8 (760)
      ULONG VmProcessorHost : 1;                   // offset: 0x2f8 (760)
    };
  };
  ...
  union {
    ...
    struct {
      ...
      ULONG CetShadowStacks : 1;               // offset: 0x0 (0)
    } MitigationFlags2Values;                  // offset: 0x3e4 (996)
  };
  VOID *PartitionObject;          // offset: 0x3e8 (1000)
  ULONGLONG SecurityDomain;       // offset: 0x3f0 (1008)
  ULONGLONG ParentSecurityDomain; // offset: 0x3f8 (1016)
  VOID *CoverageSamplerContext;   // offset: 0x400 (1024)
  VOID *MmHotPatchContext;        // offset: 0x404 (1028)
};
...
struct _WMI_LOGGER_CONTEXT {
  ...
  union {
    ...
    struct {
      ...
      ULONG QpcDeltaTracking : 1;            // offset: 0x258 (600)
      ULONG SpareFlags2 : 4;                 // offset: 0x258 (600)
    };
  };
  union {
  ...
  LONGLONG ReferenceQpcDelta;                          // offset: 0x370 (880)
  struct _ETW_EVENT_CALLBACK_CONTEXT *CallbackContext; // offset: 0x378 (888)
};
...
struct HAL_PRIVATE_DISPATCH {
  ...
  (ULONG arg1, ULONG *arg2, ULONG *arg3); // offset: 0x11c (284)
  ...
  (ULONG arg1, volatile LONG *arg2) (*HalPowerSetRebootHandler)(
      VOID (*arg1)(ULONG arg1, volatile LONG *arg2)); // offset: 0x18c (396)
  ...
  (ULONG arg1, ULONG arg2, UCHAR *arg3, UCHAR *arg4, UCHAR *arg5, ULONG *arg6,
   ULONG *arg7);                                   // offset: 0x22c (556)
  VOID (*HalInitPlatformDebugTriggers)();          // offset: 0x230 (560)
  VOID (*HalRunPlatformDebugTriggers)(UCHAR arg1); // offset: 0x234 (564)
  VOID *(*HalTimerGetReferencePage)();             // offset: 0x238 (568)
};
...
struct _POP_FX_DEVICE {
  ...
  VOID *DriverContext;                           // offset: 0x60 (96)
  struct _LIST_ENTRY AcpiLink;                   // offset: 0x64 (100)
  struct _UNICODE_STRING DeviceId;               // offset: 0x6c (108)
  struct _IO_REMOVE_LOCK RemoveLock;             // offset: 0x74 (116)
  struct _IO_REMOVE_LOCK AcpiRemoveLock;         // offset: 0x8c (140)
  struct _POP_FX_WORK_ORDER WorkOrder;           // offset: 0xa4 (164)
  ULONG IdleLock;                                // offset: 0xc0 (192)
  struct _KTIMER IdleTimer;                      // offset: 0xc8 (200)
  struct _KDPC IdleDpc;                          // offset: 0xf0 (240)
  ULONGLONG IdleTimeout;                         // offset: 0x110 (272)
  ULONGLONG IdleStamp;                           // offset: 0x118 (280)
  struct _DEVICE_OBJECT *NextIrpDeviceObject[2]; // offset: 0x120 (288)
  union _POWER_STATE NextIrpPowerState[2];       // offset: 0x128 (296)
  VOID (*NextIrpCallerCompletion[2])
  (struct _DEVICE_OBJECT *arg1, UCHAR arg2, union _POWER_STATE arg3, VOID *arg4,
   struct _IO_STATUS_BLOCK *arg5); // offset: 0x130 (304)
  VOID *NextIrpCallerContext[2];   // offset: 0x138 (312)
  struct _KEVENT IrpCompleteEvent; // offset: 0x140 (320)
  UCHAR (*PowerOnDumpDeviceCallback)
  (struct _PEP_CRASHDUMP_INFORMATION *arg1);        // offset: 0x150 (336)
  struct _POP_FX_ACCOUNTING Accounting;             // offset: 0x158 (344)
  volatile ULONG Flags;                             // offset: 0x230 (560)
  ULONG ComponentCount;                             // offset: 0x234 (564)
  struct _POP_FX_COMPONENT **Components;            // offset: 0x238 (568)
  ULONG LogEntries;                                 // offset: 0x23c (572)
  struct _POP_FX_LOG_ENTRY *Log;                    // offset: 0x240 (576)
  volatile LONG LogIndex;                           // offset: 0x244 (580)
  struct _DRIVER_OBJECT *DripsWatchdogDriverObject; // offset: 0x248 (584)
  struct _POP_FX_DRIPS_WATCHDOG_CONTEXT
      DripsWatchdogContext;                    // offset: 0x24c (588)
  ULONG DirectedTimeout;                       // offset: 0x260 (608)
  struct _POP_FX_WORK_ORDER DirectedWorkOrder; // offset: 0x264 (612)
  volatile LONG DirectedTransitionCallCount;   // offset: 0x280 (640)
  VOID *DirectedTransitionCompletionContext;   // offset: 0x284 (644)
  struct _UNICODE_STRING FriendlyName;         // offset: 0x288 (648)
};
...
struct _POP_FX_COMPONENT {
  ...
  struct _POP_FX_PERF_INFO *Performance;        // offset: 0x168 (360)
};
...
struct _DEVICE_NODE {
  ...
  struct _PO_DIRECTED_DRIPS_STATE DirectedDripsState;    // offset: 0x1d4 (468)
};
...
struct _MI_VISIBLE_PARTITION {
  ...
  ULONG SlabAllocatorPages;                           // offset: 0x1e8 (488)
  ULONG ChargeCommitmentFailures[4];                  // offset: 0x1ec (492)
  volatile LONG PageFileTraceIndex;                   // offset: 0x1fc (508)
...
struct _MI_PARTITION {
  ...
  struct _MI_PARTITION_COMMIT Commit;            // offset: 0xe80 (3712)
  struct _MI_PARTITION_ZEROING Zeroing;          // offset: 0xf00 (3840)
  struct _MI_PAGE_COMBINING_SUPPORT PageCombine; // offset: 0xf40 (3904)
  VOID *WorkingSetControl;                       // offset: 0x1018 (4120)
  struct _MMWORKING_SET_EXPANSION_HEAD
      WorkingSetExpansionHead;     // offset: 0x101c (4124)
  struct _MI_VISIBLE_PARTITION Vp; // offset: 0x1040 (4160)
};
...
struct _MI_SYSTEM_INFORMATION {
  ...
  struct _MI_SYSTEM_IMAGE_STATE SystemImages; // offset: 0x680 (1664)
  struct _MI_SESSION_STATE Sessions;          // offset: 0x6f0 (1776)
  struct _MI_PROCESS_STATE Processes;         // offset: 0x1730 (5936)
  struct _MI_HARDWARE_STATE Hardware;         // offset: 0x17c0 (6080)
  struct _MI_SYSTEM_VA_STATE SystemVa;        // offset: 0x1940 (6464)
  struct _MI_COMBINE_STATE PageCombines;      // offset: 0x4080 (16512)
  struct _MI_PAGELIST_STATE PageLists;        // offset: 0x4098 (16536)
  struct _MI_PARTITION_STATE Partitions;      // offset: 0x40b0 (16560)
  struct _MI_SHUTDOWN_STATE Shutdowns;        // offset: 0x40e8 (16616)
  struct _MI_ERROR_STATE Errors;              // offset: 0x4130 (16688)
  struct _MI_ACCESS_LOG_STATE AccessLog;      // offset: 0x4200 (16896)
  struct _MI_DEBUGGER_STATE Debugger;         // offset: 0x4280 (17024)
  struct _MI_STANDBY_STATE Standby;           // offset: 0x4310 (17168)
  struct _MI_SYSTEM_PTE_STATE SystemPtes;     // offset: 0x4380 (17280)
  struct _MI_IO_PAGE_STATE IoPages;           // offset: 0x4500 (17664)
  struct _MI_PAGING_IO_STATE PagingIo;        // offset: 0x4540 (17728)
  struct _MI_COMMON_PAGE_STATE CommonPages;   // offset: 0x4578 (17784)
  struct _MI_SYSTEM_TRIM_STATE Trims;         // offset: 0x45c0 (17856)
  ULONG Cookie;                               // offset: 0x4600 (17920)
  VOID *volatile *BootRegistryRuns;           // offset: 0x4604 (17924)
  volatile LONG ZeroingDisabled;              // offset: 0x4608 (17928)
  UCHAR FullyInitialized;                     // offset: 0x460c (17932)
  UCHAR SafeBooted;                           // offset: 0x460d (17933)
  struct _RTL_BITMAP PfnBitMap;               // offset: 0x4610 (17936)
  struct _TlgProvider_t *TraceLogging;        // offset: 0x4618 (17944)
  struct _MI_VISIBLE_STATE Vs;                // offset: 0x4640 (17984)
};
...
struct _MMINPAGE_SUPPORT {
  ...
  volatile LONG InjectRetry;     // offset: 0x6c (108)
  ULONG ByteCount;               // offset: 0x70 (112)
  union {
    ULONG ImagePteOffset; // offset: 0x74 (116)
    ULONG TossPage;       // offset: 0x74 (116)

  } u3; // offset: 0x74 (116)
  union {
    struct _MMINPAGE_FLAGS e1; // offset: 0x78 (120)
    ULONG LongFlags;           // offset: 0x78 (120)

  } u1;                             // offset: 0x78 (120)
  struct _FILE_OBJECT *FilePointer; // offset: 0x7c (124)
  union {
    struct _CONTROL_AREA *ControlArea; // offset: 0x80 (128)
    struct _SUBSECTION *Subsection;    // offset: 0x80 (128)
  };
  VOID *Autoboost;              // offset: 0x84 (132)
  VOID *FaultingAddress;        // offset: 0x88 (136)
  struct _MMPTE *PointerPte;    // offset: 0x8c (140)
  struct _MMPTE *BasePte;       // offset: 0x90 (144)
  struct _MMPFN *Pfn;           // offset: 0x94 (148)
  struct _MDL *PrefetchMdl;     // offset: 0x98 (152)
  volatile LONGLONG ProbeCount; // offset: 0xa0 (160)
  struct _MDL Mdl;              // offset: 0xa8 (168)
  union {
    ULONG Page[16];                                    // offset: 0xc4 (196)
    struct _MMINPAGE_SUPPORT_FLOW_THROUGH FlowThrough; // offset: 0xc4 (196)
  };
};
...
struct _POP_HIBER_CONTEXT {
  ...
  WCHAR *IoChecksums;                                  // offset: 0x128 (296)
...
struct _MCUPDATE_INFO {
  struct _LIST_ENTRY List;    // offset: 0x0 (0)
  ULONG Status;               // offset: 0x8 (8)
  ULONGLONG Id;               // offset: 0x10 (16)
  ULONGLONG VendorScratch[2]; // offset: 0x18 (24)
};
...
struct _PROC_PERF_CHECK_SNAP {
  ...
  ULONG ResponsivenessEvents;              // offset: 0x50 (80)
};
...
struct _PROC_PERF_CHECK {
  ...
  struct _PROC_PERF_CHECK_SNAP CurrentSnap;       // offset: 0x78 (120)
  struct _PROC_PERF_CHECK_SNAP LastDeliveredSnap; // offset: 0xd0 (208)
  ULONG LastDeliveredPerformance;                 // offset: 0x128 (296)
  ULONG LastDeliveredFrequency;                   // offset: 0x12c (300)
  UCHAR TaggedThreadPercent[2];                   // offset: 0x130 (304)
  UCHAR Class0FloorPerfSelection;                 // offset: 0x132 (306)
  UCHAR Class1MinimumPerfSelection;               // offset: 0x133 (307)
  ULONG CurrentResponsivenessEvents;              // offset: 0x134 (308)
};
...
struct _PROCESSOR_POWER_STATE {
  ...
  UCHAR HvTargetState;                          // offset: 0x2a (42)
  UCHAR Reserved;                               // offset: 0x2b (43)
  ...
  UCHAR ArchitecturalEfficiencyClass;                   // offset: 0x14c (332)
  UCHAR PerformanceSchedulingClass;                     // offset: 0x14d (333)
  UCHAR EfficiencySchedulingClass;                      // offset: 0x14e (334)
  UCHAR GuaranteedPerformancePercent;                   // offset: 0x14f (335)
  UCHAR Parked;                                         // offset: 0x150 (336)
  UCHAR LongPriorQosPeriod;                             // offset: 0x151 (337)
  USHORT LatestAffinitizedPercent;                      // offset: 0x152 (338)
  ULONG LatestPerformancePercent;                       // offset: 0x154 (340)
  ULONG AveragePerformancePercent;                      // offset: 0x158 (344)
  ...
  USHORT QosEquivalencyMask;               // offset: 0x1a0 (416)
  USHORT HwFeedbackTableIndex;             // offset: 0x1a2 (418)
  UCHAR HwFeedbackParkHint;                // offset: 0x1a4 (420)
  UCHAR HwFeedbackPerformanceClass;        // offset: 0x1a5 (421)
  UCHAR HwFeedbackEfficiencyClass;         // offset: 0x1a6 (422)
  UCHAR HeteroCoreType;                    // offset: 0x1a7 (423)
};
...
struct _KPRCB {
  ...
  VOID *MmInternal;                              // offset: 0x4d4 (1236)
  ...
  union {
    UCHAR BpbState; // offset: 0x21b8 (8632)
    struct {
      UCHAR BpbCpuIdle : 1;        // offset: 0x21b8 (8632)
      UCHAR BpbFlushRsbOnTrap : 1; // offset: 0x21b8 (8632)
      UCHAR BpbIbpbOnReturn : 1;   // offset: 0x21b8 (8632)
      UCHAR BpbIbpbOnTrap : 1;     // offset: 0x21b8 (8632)
      UCHAR BpbReserved : 4;       // offset: 0x21b8 (8632)
    };
  };
  union {
    UCHAR BpbFeatures; // offset: 0x21b9 (8633)
    struct {
      UCHAR BpbClearOnIdle : 1;      // offset: 0x21b9 (8633)
      UCHAR BpbEnabled : 1;          // offset: 0x21b9 (8633)
      UCHAR BpbSmep : 1;             // offset: 0x21b9 (8633)
      UCHAR BpbFeaturesReserved : 5; // offset: 0x21b9 (8633)
    };
  };
  UCHAR BpbCurrentSpecCtrl;        // offset: 0x21ba (8634)
  UCHAR BpbKernelSpecCtrl;         // offset: 0x21bb (8635)
  UCHAR BpbNmiSpecCtrl;            // offset: 0x21bc (8636)
  UCHAR BpbUserSpecCtrl;           // offset: 0x21bd (8637)
  UCHAR PrcbPad49[2];              // offset: 0x21be (8638)
  ULONG ProcessorSignature;        // offset: 0x21c0 (8640)
  ULONG ProcessorFlags;            // offset: 0x21c4 (8644)
  UCHAR PrcbPad50[8];              // offset: 0x21c8 (8648)
...
struct _KTHREAD {
  ...
  union {
    struct {
      ...
      ULONG CetShadowStack : 1;          // offset: 0x58 (88)
...
struct _ETHREAD {
  ...
  union {
    ...
    struct {
      ...
      ULONG WorkloadClass : 1;                   // offset: 0x3d0 (976)
      ULONG ReservedSameThreadPassiveFlags : 20; // offset: 0x3d0 (976)
    };
  };
  union {
    ...
    struct {
      ...
      UCHAR OwnsVadShared : 1;                    // offset: 0x3d5 (981)
    };
  };
  ...
  ULONG KernelStackReference;                       // offset: 0x400 (1024)
  struct _LIST_ENTRY BoostList;                     // offset: 0x404 (1028)
  struct _LIST_ENTRY DeboostList;                   // offset: 0x40c (1036)
  ULONG BoostListLock;                              // offset: 0x414 (1044)
  ULONG IrpListLock;                                // offset: 0x418 (1048)
  VOID *ReservedForSynchTracking;                   // offset: 0x41c (1052)
  struct _SINGLE_LIST_ENTRY CmCallbackListHead;     // offset: 0x420 (1056)
  struct _GUID *ActivityId;                         // offset: 0x424 (1060)
  struct _SINGLE_LIST_ENTRY SeLearningModeListHead; // offset: 0x428 (1064)
  VOID *VerifierContext;                            // offset: 0x42c (1068)
  ...
  ULONG HeapData;                                // offset: 0x468 (1128)
  struct _LIST_ENTRY OwnerEntryListHead;         // offset: 0x46c (1132)
  ULONG DisownedOwnerEntryListLock;              // offset: 0x474 (1140)
  struct _LIST_ENTRY DisownedOwnerEntryListHead; // offset: 0x478 (1144)
};
...
struct _PROC_PERF_CONSTRAINT {
  ...
  UCHAR EngageResponsivenessOverrides;            // offset: 0x2c (44)
  UCHAR ResponsivenessChangeCount;                // offset: 0x2d (45)
...
struct _PROC_PERF_DOMAIN {
  ...
  (ULONG arg1, ULONG arg2, ULONG arg3, ULONG arg4, ULONG arg5, ULONG arg6,
   ULONG arg7, ULONG *arg8, ULONGLONG *arg9); // offset: 0x44 (68)
  VOID (*PerfControlHandler)
  (ULONG arg1, struct _PERF_CONTROL_STATE_SELECTION *arg2, UCHAR arg3,
   UCHAR arg4); // offset: 0x48 (72)
  VOID (*DomainPerfControlHandler)
  (ULONG arg1, struct _PERF_CONTROL_STATE_SELECTION *arg2, UCHAR arg3,
   UCHAR arg4);                                         // offset: 0x4c (76)
  ULONG MaxFrequency;                                   // offset: 0x50 (80)
  ULONG NominalFrequency;                               // offset: 0x54 (84)
  ULONG MaxPercent;                                     // offset: 0x58 (88)
  ULONG MinPerfPercent;                                 // offset: 0x5c (92)
  ULONG MinThrottlePercent;                             // offset: 0x60 (96)
  ULONG AdvertizedMaximumFrequency;                     // offset: 0x64 (100)
  ...
  UCHAR EngageResponsivenessOverrides;                  // offset: 0x8c (140)
  struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[4];    // offset: 0x90 (144)
  ULONG QosDisableReasons[4];                           // offset: 0x100 (256)
  USHORT QosEquivalencyMasks[4];                        // offset: 0x110 (272)
  UCHAR QosSupported;                                   // offset: 0x118 (280)
  volatile ULONG SelectionGeneration;                   // offset: 0x11c (284)
  struct _PERF_CONTROL_STATE_SELECTION QosSelection[4]; // offset: 0x120 (288)
  ULONGLONG PerfChangeTime;                             // offset: 0x1c0 (448)
  ULONG PerfChangeIntervalCount;                        // offset: 0x1c8 (456)
  UCHAR Force;                                          // offset: 0x1cc (460)
};
