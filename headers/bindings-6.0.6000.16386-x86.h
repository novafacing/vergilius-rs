...
union _PTE_QUEUE_POINTER {
  struct {
    LONG PointerPte; // offset: 0x0 (0)
    LONG TimeStamp;  // offset: 0x4 (4)
  };
...
struct _VI_DEADLOCK_GLOBALS {
  ...
  ULONG CacheReductionInProgress;            // offset: 0x40d8 (16600)
};
...
struct _SECTION_IMAGE_INFORMATION {
  ...
  union {
    ...
    struct {
      ...
      UCHAR Reserved : 5;                  // offset: 0x23 (35)
    };
  };
...
struct _MMWSL {
  ...
  struct _MMWSLE_HASH *HashTableStart;              // offset: 0x3c (60)
  struct _MMWSLE_HASH *HighestPermittedHashAddress; // offset: 0x40 (64)
  VOID *HighestUserAddress;                         // offset: 0x44 (68)
...
struct _MI_SYSTEM_PTE_TYPE {
  ...
  struct _KGUARDED_MUTEX *GlobalMutex; // offset: 0x8 (8)
  volatile ULONG TbFlushTimeStamp;     // offset: 0xc (12)
};
...
struct _DEVICE_OBJECT_POWER_EXTENSION {
  ...
  ULONG PreviousIdleCount;                           // offset: 0x4c (76)
};
...
struct _CM_KEY_BODY {
  ...
  struct _EX_PUSH_LOCK KeyBodyLock;              // offset: 0x24 (36)
  struct _LIST_ENTRY ContextListHead;            // offset: 0x28 (40)
};
...
struct PO_MEMORY_IMAGE {
  ...
  ULONG NoBootLoaderLogPages;      // offset: 0xb8 (184)
  ULONG BootLoaderLogPages[8];     // offset: 0xbc (188)
  ULONG TotalPhysicalMemoryCount;  // offset: 0xdc (220)
};
...
struct _POP_HIBER_CONTEXT {
  ...
  VOID *CurrentMcb;                         // offset: 0x4c (76)
  struct _DUMP_STACK_CONTEXT *DumpStack;    // offset: 0x50 (80)
  struct _KPROCESSOR_STATE *WakeState;      // offset: 0x54 (84)
  ULONG HiberVa;                            // offset: 0x58 (88)
...
struct _POP_POWER_ACTION {
  ...
  struct _SYSTEM_POWER_STATE_CONTEXT SystemContext;         // offset: 0x50 (80)
  struct SYSTEM_POWER_CAPABILITIES FilteredCapabilities;    // offset: 0x54 (84)
};
...
struct _ARBITER_INSTANCE {
  ...
  VOID *Extension;                        // offset: 0x94 (148)
  struct _DEVICE_OBJECT *BusDeviceObject; // offset: 0x98 (152)
  VOID *ConflictCallbackContext;          // offset: 0x9c (156)
  UCHAR (*ConflictCallback)
  (VOID *arg1, struct _RTL_RANGE *arg2); // offset: 0xa0 (160)
  WCHAR PdoDescriptionString[336];       // offset: 0xa4 (164)
  CHAR PdoSymbolicNameString[672];       // offset: 0x344 (836)
  WCHAR PdoAddressString[1];             // offset: 0x5e4 (1508)
};
...
struct _ETW_GUID_ENTRY {
  ...
  struct _TRACE_ENABLE_CONTEXT LegacyEnableContext; // offset: 0x28 (40)
  ULONG LegacyProviderEnabled;                      // offset: 0x30 (48)
...
struct _CMHIVE {
  ...
  struct _FAST_MUTEX *ViewLock;                       // offset: 0x314 (788)
  struct _FAST_MUTEX *WriterLock;                     // offset: 0x318 (792)
  struct _EX_PUSH_LOCK FlusherLock;                   // offset: 0x31c (796)
  struct _EX_PUSH_LOCK SecurityLock;                  // offset: 0x320 (800)
  struct _LIST_ENTRY MappedViewList;                  // offset: 0x324 (804)
  struct _LIST_ENTRY PinnedViewList;                  // offset: 0x32c (812)
  struct _LIST_ENTRY FlushedViewList;                 // offset: 0x334 (820)
  USHORT MappedViewCount;                             // offset: 0x33c (828)
  USHORT PinnedViewCount;                             // offset: 0x33e (830)
  ULONG UseCount;                                     // offset: 0x340 (832)
  ULONG ViewsPerHive;                                 // offset: 0x344 (836)
  struct _FILE_OBJECT *FileObject;                    // offset: 0x348 (840)
  ULONG LastShrinkHiveSize;                           // offset: 0x34c (844)
  union _LARGE_INTEGER ActualFileSize;                // offset: 0x350 (848)
  struct _UNICODE_STRING FileFullPath;                // offset: 0x358 (856)
  struct _UNICODE_STRING FileUserName;                // offset: 0x360 (864)
  struct _UNICODE_STRING HiveRootPath;                // offset: 0x368 (872)
  ULONG SecurityCount;                                // offset: 0x370 (880)
  ULONG SecurityCacheSize;                            // offset: 0x374 (884)
  LONG SecurityHitHint;                               // offset: 0x378 (888)
  struct _CM_KEY_SECURITY_CACHE_ENTRY *SecurityCache; // offset: 0x37c (892)
  struct _LIST_ENTRY SecurityHash[64];                // offset: 0x380 (896)
  ULONG UnloadEventCount;                             // offset: 0x580 (1408)
  struct _KEVENT **UnloadEventArray;                  // offset: 0x584 (1412)
  struct _CM_KEY_CONTROL_BLOCK *RootKcb;              // offset: 0x588 (1416)
  UCHAR Frozen;                                       // offset: 0x58c (1420)
  struct _CM_WORKITEM *UnloadWorkItem;                // offset: 0x590 (1424)
  UCHAR GrowOnlyMode;                                 // offset: 0x594 (1428)
  ULONG GrowOffset;                                   // offset: 0x598 (1432)
  struct _LIST_ENTRY KcbConvertListHead;              // offset: 0x59c (1436)
  struct _LIST_ENTRY KnodeConvertListHead;            // offset: 0x5a4 (1444)
  struct _CM_CELL_REMAP_BLOCK *CellRemapArray;        // offset: 0x5ac (1452)
  ULONG Flags;                                        // offset: 0x5b0 (1456)
  struct _LIST_ENTRY TrustClassEntry;                 // offset: 0x5b4 (1460)
  ULONG FlushCount;                                   // offset: 0x5bc (1468)
  struct _CM_RM *CmRm;                                // offset: 0x5c0 (1472)
  ULONG CmRmInitFailPoint;                            // offset: 0x5c4 (1476)
  LONG CmRmInitFailStatus;                            // offset: 0x5c8 (1480)
  struct _KTHREAD *CreatorOwner;                      // offset: 0x5cc (1484)
};
...
struct _MAPPED_FILE_SEGMENT {
  ...
  struct _SEGMENT_FLAGS SegmentFlags;      // offset: 0x20 (32)
  struct _MSUBSECTION *LastSubsectionHint; // offset: 0x24 (36)
};
...
struct PPM_PERF_STATES {
  ...
  ULONG TargetProcessors; // offset: 0x28 (40)
  LONG (*PStateHandler)
  (ULONG arg1, ULONGLONG arg2, ULONGLONG arg3); // offset: 0x2c (44)
  ULONG PStateContext;                          // offset: 0x30 (48)
  LONG (*TStateHandler)
  (ULONG arg1, ULONGLONG arg2, ULONGLONG arg3); // offset: 0x34 (52)
  ULONG TStateContext;                          // offset: 0x38 (56)
  ULONG (*FeedbackHandler)(UCHAR arg1);         // offset: 0x3c (60)
  struct PPM_PERF_STATE State[1];               // offset: 0x40 (64)
};
...
struct PPM_IDLE_STATE {
  LONG (*IdleHandler)
  (ULONG arg1, struct PROCESSOR_IDLE_TIMES *arg2); // offset: 0x0 (0)
  ULONG Context;                                   // offset: 0x4 (4)
...
struct PPM_IDLE_STATES {
  ...
  struct PPM_IDLE_STATE State[1]; // offset: 0x1c (28)
};
...
struct _WMI_LOGGER_CONTEXT {
  ...
  struct _UNICODE_STRING LoggerName;      // offset: 0x30 (48)
  struct _UNICODE_STRING LogFileName;     // offset: 0x38 (56)
  struct _UNICODE_STRING LogFilePattern;  // offset: 0x40 (64)
  struct _UNICODE_STRING NewLogFileName;  // offset: 0x48 (72)
  ULONG ClockType;                        // offset: 0x50 (80)
  LONG CollectionOn;                      // offset: 0x54 (84)
  ULONG MaximumFileSize;                  // offset: 0x58 (88)
  ULONG LoggerMode;                       // offset: 0x5c (92)
  ULONG LastFlushedBuffer;                // offset: 0x60 (96)
  ULONG FlushTimer;                       // offset: 0x64 (100)
  union _LARGE_INTEGER ByteOffset;        // offset: 0x68 (104)
  union _LARGE_INTEGER FlushTimeStamp;    // offset: 0x70 (112)
  ULONG MinimumBuffers;                   // offset: 0x78 (120)
  volatile LONG BuffersAvailable;         // offset: 0x7c (124)
  volatile LONG NumberOfBuffers;          // offset: 0x80 (128)
  ULONG MaximumBuffers;                   // offset: 0x84 (132)
  volatile ULONG EventsLost;              // offset: 0x88 (136)
  ULONG BuffersWritten;                   // offset: 0x8c (140)
  ULONG LogBuffersLost;                   // offset: 0x90 (144)
  ULONG RealTimeBuffersDelivered;         // offset: 0x94 (148)
  ULONG RealTimeBuffersLost;              // offset: 0x98 (152)
  ULONG BufferSize;                       // offset: 0x9c (156)
  ULONG MaximumEventSize;                 // offset: 0xa0 (160)
  LONG *SequencePtr;                      // offset: 0xa4 (164)
  ULONG LocalSequence;                    // offset: 0xa8 (168)
  struct _GUID InstanceGuid;              // offset: 0xac (172)
  LONGLONG (*GetCpuClock)();              // offset: 0xbc (188)
  LONG FileCounter;                       // offset: 0xc0 (192)
  VOID (*volatileBufferCallback)
  (struct _WMI_BUFFER_HEADER *arg1, VOID *arg2);         // offset: 0xc4 (196)
  enum _POOL_TYPE PoolType;                              // offset: 0xc8 (200)
  struct _ETW_REF_CLOCK ReferenceTime;                   // offset: 0xd0 (208)
  UCHAR RealtimeLoggerContextFreed;                      // offset: 0xe0 (224)
  struct _LIST_ENTRY Consumers;                          // offset: 0xe4 (228)
  ULONG NumConsumers;                                    // offset: 0xec (236)
  struct _LIST_ENTRY Connecting;                         // offset: 0xf0 (240)
  UCHAR NewConsumer;                                     // offset: 0xf8 (248)
  VOID *RealtimeLogfileHandle;                           // offset: 0xfc (252)
  struct _UNICODE_STRING RealtimeLogfileName;            // offset: 0x100 (256)
  ...
  ULONG RealtimeBuffersSaved;                            // offset: 0x128 (296)
  struct _ETW_REF_CLOCK RealtimeReferenceTime;           // offset: 0x130 (304)
  ULONG RealtimeDisconnectProcessId;                     // offset: 0x140 (320)
  ULONG RealtimeDisconnectConsumerId;                    // offset: 0x144 (324)
  ...
  struct _KDPC FlushDpc;                                 // offset: 0x16c (364)
  struct _KMUTANT LoggerMutex;                           // offset: 0x18c (396)
  struct _SECURITY_CLIENT_CONTEXT ClientSecurityContext; // offset: 0x1ac (428)
  struct _EX_FAST_REF SecurityDescriptor;                // offset: 0x1e8 (488)
  struct _WMI_BUFFER_HEADER DummyBufferForMarker;        // offset: 0x1f0 (496)
  LONGLONG BufferSequenceNumber;                         // offset: 0x238 (568)
  LONG AcceptNewEvents;                                  // offset: 0x240 (576)
  union {
    ULONG Flags; // offset: 0x244 (580)
    struct {
      ULONG Persistent : 1;   // offset: 0x244 (580)
      ULONG AutoLogger : 1;   // offset: 0x244 (580)
      ULONG FsReady : 1;      // offset: 0x244 (580)
      ULONG RealTime : 1;     // offset: 0x244 (580)
      ULONG Wow : 1;          // offset: 0x244 (580)
      ULONG KernelTrace : 1;  // offset: 0x244 (580)
      ULONG NoMoreEnable : 1; // offset: 0x244 (580)
    };
  };
  union {
    ULONG RequestFlag; // offset: 0x248 (584)
    struct {
      ULONG RequestNewFie : 1;             // offset: 0x248 (584)
      ULONG RequestUpdateFile : 1;         // offset: 0x248 (584)
      ULONG RequestFlush : 1;              // offset: 0x248 (584)
      ULONG RequestDisableRealtime : 1;    // offset: 0x248 (584)
      ULONG RequestDisconnectConsumer : 1; // offset: 0x248 (584)
    };
  };
  USHORT StackTraceFilterHookCount; // offset: 0x24c (588)
  USHORT StackTraceFilter[16];      // offset: 0x24e (590)
};
...
struct _EPROCESS {
  ...
  VOID *VadFreeHint;                          // offset: 0x12c (300)
  ...
  union {
    ...
    struct {
      ...
      ULONG SparePsFlags1 : 2;           // offset: 0x228 (552)
    };
  };
...
struct _KTM {
  ...
  VOID *TmRmHandle;                                 // offset: 0x188 (392)
  struct _KRESOURCEMANAGER *TmRm;                   // offset: 0x18c (396)
  struct _KEVENT LogFullNotifyEvent;                // offset: 0x190 (400)
  struct _WORK_QUEUE_ITEM CheckpointWorkItem;       // offset: 0x1a0 (416)
  union _CLS_LSN CheckpointTargetLsn;               // offset: 0x1b0 (432)
  struct _WORK_QUEUE_ITEM LogFullCompletedWorkItem; // offset: 0x1b8 (440)
  struct _ERESOURCE LogWriteResource;               // offset: 0x1c8 (456)
  ULONG LogFlags;                                   // offset: 0x200 (512)
  LONG LogFullStatus;                               // offset: 0x204 (516)
  LONG RecoveryStatus;                              // offset: 0x208 (520)
};
...
struct _SEGMENT {
  ...
  struct _SEGMENT_FLAGS SegmentFlags; // offset: 0x20 (32)
  union {
    ULONG ImageCommitment;             // offset: 0x24 (36)
    struct _EPROCESS *CreatingProcess; // offset: 0x24 (36)

  } u1; // offset: 0x24 (36)
  union {
    struct _MI_SECTION_IMAGE_INFORMATION *ImageInformation; // offset: 0x28 (40)
    VOID *FirstMappedVa;                                    // offset: 0x28 (40)

  } u2;                        // offset: 0x28 (40)
  struct _MMPTE *PrototypePte; // offset: 0x2c (44)
  struct _MMPTE ThePtes[1];    // offset: 0x30 (48)
};
...
struct _CONTROL_AREA {
  ...
  struct _MI_SECTION_CREATION_EVENT *WaitingForDeletion; // offset: 0x30 (48)
  union {
    struct {
      union {
...
struct _OBJECT_TYPE_INITIALIZER {
  ...
  (enum _OB_OPEN_REASON arg1, CHAR arg2, struct _EPROCESS *arg3, VOID *arg4,
   ULONG *arg5, ULONG arg6); // offset: 0x30 (48)
  VOID (*CloseProcedure)
...
struct _OBJECT_TYPE {
  ...
  struct _EX_PUSH_LOCK ObjectLocks[32];     // offset: 0xb0 (176)
};
...
struct _MM_SESSION_SPACE {
  ...
  struct _KEVENT AttachEvent;                     // offset: 0x64 (100)
  ...
  struct _MMPTE SessionPteFreeHead;         // offset: 0x1e40 (7744)
  struct _MI_SYSTEM_PTE_TYPE SystemPteInfo; // offset: 0x1e44 (7748)
  VOID *PoolTrackTableExpansion;            // offset: 0x1e54 (7764)
  ULONG PoolTrackTableExpansionSize;        // offset: 0x1e58 (7768)
  VOID *PoolTrackBigPages;                  // offset: 0x1e5c (7772)
  ULONG PoolTrackBigPagesSize;              // offset: 0x1e60 (7776)
  struct _RTL_BITMAP SessionPoolPdes;       // offset: 0x1e64 (7780)
};
...
struct _MMMOD_WRITER_MDL_ENTRY {
  ...
  union {
    ULONG LastPageToWrite; // offset: 0x14 (20)
...
struct _KTRANSACTION {
  ...
  ULONG NextSavepoint;                                  // offset: 0x13c (316)
  struct _KTM *Tm;                                      // offset: 0x140 (320)
  LONGLONG CommitReservation;                           // offset: 0x148 (328)
  struct _KTRANSACTION_HISTORY TransactionHistory[10];  // offset: 0x150 (336)
  ULONG TransactionHistoryCount;                        // offset: 0x1a0 (416)
};
...
struct _KTHREAD {
  ...
  union {
    struct {
      ...
      ULONG Reserved : 25;            // offset: 0x68 (104)
    };
  ...
  ULONG Spare02;                          // offset: 0x13c (316)
...
struct _ETHREAD {
  ...
  union {
    ...
    struct {
      ...
      USHORT PriorityRegionActive : 4;            // offset: 0x26a (618)
    };
  };
...
struct _PROCESSOR_POWER_STATE {
  ...
  struct PPM_IDLE_STATES *IdleStates;                        // offset: 0x4 (4)
  ULONGLONG LastTimeCheck;                                   // offset: 0x8 (8)
  ULONGLONG LastIdleTime;                     // offset: 0x10 (16)
  struct PROCESSOR_IDLE_TIMES IdleTimes;      // offset: 0x18 (24)
  struct PPM_IDLE_ACCOUNTING *IdleAccounting; // offset: 0x38 (56)
  struct PPM_PERF_STATES *PerfStates;         // offset: 0x3c (60)
  ULONG LastKernelUserTime;                   // offset: 0x40 (64)
  ULONG LastIdleThreadKTime;                  // offset: 0x44 (68)
  ULONGLONG LastGlobalTimeHv;                 // offset: 0x48 (72)
  ULONGLONG LastProcessorTimeHv;              // offset: 0x50 (80)
  UCHAR ThermalConstraint;                    // offset: 0x58 (88)
  UCHAR LastBusyPercentage;                   // offset: 0x59 (89)
  union {
    USHORT AsUSHORT;                       // offset: 0x5a (90)
    USHORT PStateDomain : 1;               // offset: 0x5a (90)
    USHORT PStateDomainIdleAccounting : 1; // offset: 0x5a (90)
    USHORT Reserved : 14;                  // offset: 0x5a (90)

  } Flags;                            // offset: 0x5a (90)
  struct _KTIMER PerfTimer;           // offset: 0x60 (96)
  struct _KDPC PerfDpc;               // offset: 0x88 (136)
  ULONG LastSysTime;                  // offset: 0xa8 (168)
  struct _KPRCB *PStateMaster;        // offset: 0xac (172)
  ULONG PStateSet;                    // offset: 0xb0 (176)
  ULONG CurrentPState;                // offset: 0xb4 (180)
  ULONG Reserved0;                    // offset: 0xb8 (184)
  ULONG DesiredPState;                // offset: 0xbc (188)
  ULONG Reserved1;                    // offset: 0xc0 (192)
  volatile ULONG PStateIdleStartTime; // offset: 0xc4 (196)
  ULONG PStateIdleTime;               // offset: 0xc8 (200)
  ULONG LastPStateIdleTime;           // offset: 0xcc (204)
  ULONG PStateStartTime;              // offset: 0xd0 (208)
  ULONG WmiDispatchPtr;               // offset: 0xd4 (212)
  LONG WmiInterfaceEnabled;           // offset: 0xd8 (216)
};
...
struct _KPRCB {
  ...
  UCHAR PrcbPad0[88];                            // offset: 0x3c0 (960)
  ...
  ULONG DpcTimeCount;                            // offset: 0x534 (1332)
  ...
  UCHAR PollSlot;                                // offset: 0x547 (1351)
  ...
  ULONG DpcTimeLimit;                            // offset: 0x55c (1372)
  ...
  volatile LONG MmSpinLockOrdering;              // offset: 0x578 (1400)
  volatile LONG IoReadOperationCount;            // offset: 0x57c (1404)
  volatile LONG IoWriteOperationCount;           // offset: 0x580 (1408)
  volatile LONG IoOtherOperationCount;           // offset: 0x584 (1412)
  union _LARGE_INTEGER IoReadTransferCount;      // offset: 0x588 (1416)
  union _LARGE_INTEGER IoWriteTransferCount;     // offset: 0x590 (1424)
  union _LARGE_INTEGER IoOtherTransferCount;     // offset: 0x598 (1432)
  ULONG CcFastMdlReadNoWait;                     // offset: 0x5a0 (1440)
  ULONG CcFastMdlReadWait;                       // offset: 0x5a4 (1444)
  ULONG CcFastMdlReadNotPossible;                // offset: 0x5a8 (1448)
  ULONG CcMapDataNoWait;                         // offset: 0x5ac (1452)
  ULONG CcMapDataWait;                           // offset: 0x5b0 (1456)
  ULONG CcPinMappedDataCount;                    // offset: 0x5b4 (1460)
  ULONG CcPinReadNoWait;                         // offset: 0x5b8 (1464)
  ULONG CcPinReadWait;                           // offset: 0x5bc (1468)
  ULONG CcMdlReadNoWait;                         // offset: 0x5c0 (1472)
  ULONG CcMdlReadWait;                           // offset: 0x5c4 (1476)
  ULONG CcLazyWriteHotSpots;                     // offset: 0x5c8 (1480)
  ULONG CcLazyWriteIos;                          // offset: 0x5cc (1484)
  ULONG CcLazyWritePages;                        // offset: 0x5d0 (1488)
  ULONG CcDataFlushes;                           // offset: 0x5d4 (1492)
  ULONG CcDataPages;                             // offset: 0x5d8 (1496)
  ULONG CcLostDelayedWrites;                     // offset: 0x5dc (1500)
  ULONG CcFastReadResourceMiss;                  // offset: 0x5e0 (1504)
  ULONG CcCopyReadWaitMiss;                      // offset: 0x5e4 (1508)
  ULONG CcFastMdlReadResourceMiss;               // offset: 0x5e8 (1512)
  ULONG CcMapDataNoWaitMiss;                     // offset: 0x5ec (1516)
  ULONG CcMapDataWaitMiss;                       // offset: 0x5f0 (1520)
  ULONG CcPinReadNoWaitMiss;                     // offset: 0x5f4 (1524)
  ULONG CcPinReadWaitMiss;                       // offset: 0x5f8 (1528)
  ULONG CcMdlReadNoWaitMiss;                     // offset: 0x5fc (1532)
  ULONG CcMdlReadWaitMiss;                       // offset: 0x600 (1536)
  ULONG CcReadAheadIos;                          // offset: 0x604 (1540)
  ULONG KeAlignmentFixupCount;                   // offset: 0x608 (1544)
  ULONG KeExceptionDispatchCount;                // offset: 0x60c (1548)
  ULONG KeSystemCalls;                           // offset: 0x610 (1552)
  ULONG PrcbPad1[3];                             // offset: 0x614 (1556)
  struct _PP_LOOKASIDE_LIST PPLookasideList[16]; // offset: 0x620 (1568)
  struct _GENERAL_LOOKASIDE_POOL
      PPNPagedLookasideList[32]; // offset: 0x6a0 (1696)
  struct _GENERAL_LOOKASIDE_POOL
      PPPagedLookasideList[32];    // offset: 0xfa0 (4000)
  volatile ULONG PacketBarrier;    // offset: 0x18a0 (6304)
  volatile LONG ReverseStall;      // offset: 0x18a4 (6308)
  VOID *IpiFrame;                  // offset: 0x18a8 (6312)
  UCHAR PrcbPad2[52];              // offset: 0x18ac (6316)
  VOID *volatile CurrentPacket[3]; // offset: 0x18e0 (6368)
  volatile ULONG TargetSet;        // offset: 0x18ec (6380)
  VOID (*volatileWorkerRoutine)
  (VOID *arg1, VOID *arg2, VOID *arg3, VOID *arg4); // offset: 0x18f0 (6384)
  volatile ULONG IpiFrozen;                         // offset: 0x18f4 (6388)
  UCHAR PrcbPad3[40];                               // offset: 0x18f8 (6392)
  volatile ULONG RequestSummary;                    // offset: 0x1920 (6432)
  struct _KPRCB *volatile SignalDone;               // offset: 0x1924 (6436)
  UCHAR PrcbPad4[56];                               // offset: 0x1928 (6440)
  struct _KDPC_DATA DpcData[2];                     // offset: 0x1960 (6496)
  VOID *DpcStack;                                   // offset: 0x1988 (6536)
  LONG MaximumDpcQueueDepth;                        // offset: 0x198c (6540)
  ULONG DpcRequestRate;                             // offset: 0x1990 (6544)
  ULONG MinimumDpcRate;                             // offset: 0x1994 (6548)
  volatile UCHAR DpcInterruptRequested;             // offset: 0x1998 (6552)
  volatile UCHAR DpcThreadRequested;                // offset: 0x1999 (6553)
  volatile UCHAR DpcRoutineActive;                  // offset: 0x199a (6554)
  volatile UCHAR DpcThreadActive;                   // offset: 0x199b (6555)
  ULONG PrcbLock;                                   // offset: 0x199c (6556)
  ULONG DpcLastCount;                               // offset: 0x19a0 (6560)
  volatile ULONG TimerHand;                         // offset: 0x19a4 (6564)
  volatile ULONG TimerRequest;                      // offset: 0x19a8 (6568)
  VOID *PrcbPad41;                                  // offset: 0x19ac (6572)
  struct _KEVENT DpcEvent;                          // offset: 0x19b0 (6576)
  UCHAR ThreadDpcEnable;                            // offset: 0x19c0 (6592)
  volatile UCHAR QuantumEnd;                        // offset: 0x19c1 (6593)
  UCHAR PrcbPad50;                                  // offset: 0x19c2 (6594)
  volatile UCHAR IdleSchedule;                      // offset: 0x19c3 (6595)
  LONG DpcSetEventRequest;                          // offset: 0x19c4 (6596)
  LONG Sleeping;                                    // offset: 0x19c8 (6600)
  ULONG PeriodicCount;                              // offset: 0x19cc (6604)
  ULONG PeriodicBias;                               // offset: 0x19d0 (6608)
  UCHAR PrcbPad5[6];                                // offset: 0x19d4 (6612)
  LONG TickOffset;                                  // offset: 0x19dc (6620)
  struct _KDPC CallDpc;                             // offset: 0x19e0 (6624)
  LONG ClockKeepAlive;                              // offset: 0x1a00 (6656)
  UCHAR ClockCheckSlot;                             // offset: 0x1a04 (6660)
  UCHAR ClockPollCycle;                             // offset: 0x1a05 (6661)
  UCHAR PrcbPad6[2];                                // offset: 0x1a06 (6662)
  LONG DpcWatchdogPeriod;                           // offset: 0x1a08 (6664)
  LONG DpcWatchdogCount;                            // offset: 0x1a0c (6668)
  LONG ThreadWatchdogPeriod;                        // offset: 0x1a10 (6672)
  LONG ThreadWatchdogCount;                         // offset: 0x1a14 (6676)
  ULONG PrcbPad70[2];                               // offset: 0x1a18 (6680)
  struct _LIST_ENTRY WaitListHead;                  // offset: 0x1a20 (6688)
  ULONG WaitLock;                                   // offset: 0x1a28 (6696)
  ULONG ReadySummary;                               // offset: 0x1a2c (6700)
  ULONG QueueIndex;                                 // offset: 0x1a30 (6704)
  struct _SINGLE_LIST_ENTRY DeferredReadyListHead;  // offset: 0x1a34 (6708)
  ULONGLONG StartCycles;                            // offset: 0x1a38 (6712)
  ULONGLONG CycleTime;                              // offset: 0x1a40 (6720)
  ULONGLONG PrcbPad71[3];                           // offset: 0x1a48 (6728)
  struct _LIST_ENTRY DispatcherReadyListHead[32];   // offset: 0x1a60 (6752)
  VOID *ChainedInterruptList;                       // offset: 0x1b60 (7008)
  LONG LookasideIrpFloat;                           // offset: 0x1b64 (7012)
  volatile LONG MmPageFaultCount;                   // offset: 0x1b68 (7016)
  volatile LONG MmCopyOnWriteCount;                 // offset: 0x1b6c (7020)
  volatile LONG MmTransitionCount;                  // offset: 0x1b70 (7024)
  volatile LONG MmCacheTransitionCount;             // offset: 0x1b74 (7028)
  volatile LONG MmDemandZeroCount;                  // offset: 0x1b78 (7032)
  volatile LONG MmPageReadCount;                    // offset: 0x1b7c (7036)
  volatile LONG MmPageReadIoCount;                  // offset: 0x1b80 (7040)
  volatile LONG MmCacheReadCount;                   // offset: 0x1b84 (7044)
  volatile LONG MmCacheIoCount;                     // offset: 0x1b88 (7048)
  volatile LONG MmDirtyPagesWriteCount;             // offset: 0x1b8c (7052)
  volatile LONG MmDirtyWriteIoCount;                // offset: 0x1b90 (7056)
  volatile LONG MmMappedPagesWriteCount;            // offset: 0x1b94 (7060)
  volatile LONG MmMappedWriteIoCount;               // offset: 0x1b98 (7064)
  volatile ULONG CachedCommit;                      // offset: 0x1b9c (7068)
  volatile ULONG CachedResidentAvailable;           // offset: 0x1ba0 (7072)
  VOID *HyperPte;                                   // offset: 0x1ba4 (7076)
  UCHAR CpuVendor;                                  // offset: 0x1ba8 (7080)
  UCHAR PrcbPad9[3];                                // offset: 0x1ba9 (7081)
  UCHAR VendorString[13];                           // offset: 0x1bac (7084)
  UCHAR InitialApicId;                              // offset: 0x1bb9 (7097)
  UCHAR CoresPerPhysicalProcessor;                  // offset: 0x1bba (7098)
  UCHAR LogicalProcessorsPerPhysicalProcessor;      // offset: 0x1bbb (7099)
  ULONG MHz;                                        // offset: 0x1bbc (7100)
  ULONG FeatureBits;                                // offset: 0x1bc0 (7104)
  union _LARGE_INTEGER UpdateSignature;             // offset: 0x1bc8 (7112)
  volatile ULONGLONG IsrTime;                       // offset: 0x1bd0 (7120)
  ULONGLONG SpareField1;                            // offset: 0x1bd8 (7128)
  struct _FX_SAVE_AREA NpxSaveArea;                 // offset: 0x1be0 (7136)
  struct _PROCESSOR_POWER_STATE PowerState;         // offset: 0x1df0 (7664)
  struct _KDPC DpcWatchdogDpc;                      // offset: 0x1ed0 (7888)
  struct _KTIMER DpcWatchdogTimer;                  // offset: 0x1ef0 (7920)
  VOID *WheaInfo;                                   // offset: 0x1f18 (7960)
  VOID *EtwSupport;                                 // offset: 0x1f1c (7964)
  union _SLIST_HEADER InterruptObjectPool;          // offset: 0x1f20 (7968)
  union _LARGE_INTEGER HypercallPagePhysical;       // offset: 0x1f28 (7976)
  VOID *HypercallPageVirtual;                       // offset: 0x1f30 (7984)
  VOID *RateControl;                                // offset: 0x1f34 (7988)
  struct _CACHE_DESCRIPTOR Cache[5];                // offset: 0x1f38 (7992)
  ULONG CacheCount;                                 // offset: 0x1f74 (8052)
  ULONG CacheProcessorMask[5];                      // offset: 0x1f78 (8056)
  UCHAR LogicalProcessorsPerCore;                   // offset: 0x1f8c (8076)
  UCHAR PrcbPad8[3];                                // offset: 0x1f8d (8077)
  ULONG PackageProcessorSet;                        // offset: 0x1f90 (8080)
  ULONG CoreProcessorSet;                           // offset: 0x1f94 (8084)
};
