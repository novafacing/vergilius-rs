...
struct PO_MEMORY_IMAGE {
  ...
  ULONG FirmwareRuntimeInformationPages;   // offset: 0xd8 (216)
  ULONGLONG FirmwareRuntimeInformation[1]; // offset: 0xe0 (224)
  ULONG NoBootLoaderLogPages;              // offset: 0xe8 (232)
  ULONGLONG BootLoaderLogPages[8];         // offset: 0xf0 (240)
  ULONG NotUsed;                           // offset: 0x130 (304)
  ULONG ResumeContextCheck;                // offset: 0x134 (308)
  ULONG ResumeContextPages;                // offset: 0x138 (312)
};
...
struct _POP_HIBER_CONTEXT {
  ...
  struct _PO_MEMORY_RANGE_ARRAY *TableHead;   // offset: 0xc0 (192)
