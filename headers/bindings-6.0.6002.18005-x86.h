...
struct _PO_MEMORY_RANGE {
  ULONG StartPage; // offset: 0x0 (0)
  ULONG EndPage;   // offset: 0x4 (4)
};
...
struct _PO_MEMORY_RANGE_TABLE {
  ...
  struct _PO_MEMORY_RANGE Range[1];    // offset: 0xc (12)
};
...
struct _POP_HIBER_CONTEXT {
  ...
  struct _PO_MEMORY_RANGE_TABLE *TableHead;   // offset: 0x70 (112)
