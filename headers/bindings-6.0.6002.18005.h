...
// 0x2 bytes (sizeof)
typedef struct __anon_1588 {
  WCHAR ParentId[1]; // offset: 0x0 ordinal: 0x0
} __anon_1588;

// 0x2 bytes (sizeof)
typedef struct __anon_1582 {
  WCHAR DeviceId[1]; // offset: 0x0 ordinal: 0x0
} __anon_1582;

// 0x2 bytes (sizeof)
typedef struct __anon_1581 {
...
typedef enum _PCI_HOTPLUG_SLOT_INTERRUPT {
  ...
  SlotInterruptLinkStateChange = 3, // ordinal: 0x3
  SlotInterruptPowerFault = 4,      // ordinal: 0x4
  SlotInterruptMaximum = 7,         // ordinal: 0x5
...
typedef enum _MI_SYSTEM_VA_TYPE {
  ...
  MiVaMaximumType = 13,        // ordinal: 0xd
} _MI_SYSTEM_VA_TYPE;
...
typedef enum _DPFLTR_TYPE {
  ...
  DPFLTR_EXFAT_ID = 138,         // ordinal: 0x8a
  DPFLTR_ENDOFTABLE_ID = 139,    // ordinal: 0x8b
} _DPFLTR_TYPE;
...
typedef enum _WHEA_RAW_DATA_FORMAT {
  WheaRawDataFormatIPFSalRecord = 0, // ordinal: 0x0
  WheaRawDataFormatIA32MCA = 1,      // ordinal: 0x1
  WheaRawDataFormatIntel64MCA = 2,   // ordinal: 0x2
  WheaRawDataFormatAMD64MCA = 3,     // ordinal: 0x3
  WheaRawDataFormatMemory = 4,       // ordinal: 0x4
  WheaRawDataFormatPCIExpress = 5,   // ordinal: 0x5
  WheaRawDataFormatNMIPort = 6,      // ordinal: 0x6
  WheaRawDataFormatPCIXBus = 7,      // ordinal: 0x7
  WheaRawDataFormatPCIXDevice = 8,   // ordinal: 0x8
  WheaRawDataFormatGeneric = 9,      // ordinal: 0x9
  WheaRawDataFormatMax = 10,         // ordinal: 0xa
...
typedef enum WHEA_PCIEXPRESS_DEVICE_TYPE {
  WheaPciExpressEndpoint = 0,                      // ordinal: 0x0
  WheaPciExpressLegacyEndpoint = 1,                // ordinal: 0x1
  WheaPciExpressRootPort = 4,                      // ordinal: 0x2
  WheaPciExpressUpstreamSwitchPort = 5,            // ordinal: 0x3
  WheaPciExpressDownstreamSwitchPort = 6,          // ordinal: 0x4
  WheaPciExpressToPciXBridge = 7,                  // ordinal: 0x5
  WheaPciXToExpressBridge = 8,                     // ordinal: 0x6
  WheaPciExpressRootComplexIntegratedEndpoint = 9, // ordinal: 0x7
  WheaPciExpressRootComplexEventCollector = 10,    // ordinal: 0x8
...
typedef enum _FILE_INFORMATION_CLASS {
  ...
  FileMaximumInformation = 51,                  // ordinal: 0x32
...
// 0x8 bytes (sizeof)
typedef union __anon_1197 {
  struct __anon_1202 s1; // offset: 0x0 ordinal: 0x0
  ULONGLONG Value;       // offset: 0x0 ordinal: 0x1
} __anon_1197;

// 0x8 bytes (sizeof)
typedef struct _ALPC_COMPLETION_LIST_STATE {
  union __anon_1197 u1; // offset: 0x0 ordinal: 0x0
} _ALPC_COMPLETION_LIST_STATE;

// 0x4 bytes (sizeof)
typedef struct __anon_1572 {
...
typedef union __anon_1156 {
  struct __anon_1155 s1; // offset: 0x0 ordinal: 0x0
...
typedef struct _MMSUPPORT_FLAGS {
  ...
  UCHAR Reserved : 3;              // offset: 0x1 ordinal: 0x9
  UCHAR PageStealers : 4;          // offset: 0x1 ordinal: 0xa
  UCHAR MemoryPriority : 8;        // offset: 0x2 ordinal: 0xb
  UCHAR WsleDeleted : 1;           // offset: 0x3 ordinal: 0xc
  UCHAR VmExiting : 1;             // offset: 0x3 ordinal: 0xd
  UCHAR ExpansionFailed : 1;       // offset: 0x3 ordinal: 0xe
  UCHAR Available : 5;             // offset: 0x3 ordinal: 0xf
} _MMSUPPORT_FLAGS;

typedef UCHAR (*__anon_347)(struct _FILE_OBJECT *, struct _MDL *,
...
typedef union __anon_756 {
  struct __anon_755 e2; // offset: 0x0 ordinal: 0x0
} __anon_756;

// 0x4 bytes (sizeof)
typedef struct __anon_744 {
...
typedef union __anon_745 {
  ...
  struct __anon_742 e2;  // offset: 0x0 ordinal: 0x2
  struct __anon_744 e3;  // offset: 0x0 ordinal: 0x3
} __anon_745;

// 0x2 bytes (sizeof)
typedef union _WHEA_PCIXBUS_ID {
  UCHAR BusNumber;  // offset: 0x0 ordinal: 0x0
  UCHAR BusSegment; // offset: 0x1 ordinal: 0x1
...
typedef VOID (*__anon_488)();

typedef VOID (*__anon_343)(struct _DEVICE_OBJECT *, struct _DEVICE_OBJECT *);

typedef VOID (*__anon_342)(struct _FILE_OBJECT *);

// 0x8 bytes (sizeof)
typedef struct __anon_1584 {
...
typedef VOID (*__anon_1129)(struct _WMI_BUFFER_HEADER *, VOID *);

typedef UCHAR (*__anon_1078)(VOID *, UCHAR);
...
typedef VOID (*__anon_165)(struct _KDPC *, VOID *, VOID *, VOID *);
...
typedef LONGLONG (*__anon_1128)();

// 0x8 bytes (sizeof)
typedef union __anon_809 {
...
// 0x8 bytes (sizeof)
typedef union __anon_795 {
  LONGLONG Balance : 2;  // offset: 0x0 ordinal: 0x0
  struct _MMVAD *Parent; // offset: 0x0 ordinal: 0x1
} __anon_795;

// 0x8 bytes (sizeof)
typedef union __anon_765 {
  LONGLONG Balance : 2;              // offset: 0x0 ordinal: 0x0
...
typedef LONG (*__anon_352)(struct _FILE_OBJECT *, struct _DEVICE_OBJECT *);
...
typedef struct PROCESSOR_IDLESTATE_POLICY {
  ...
  union __anon_1530 Flags;                   // offset: 0x2 ordinal: 0x1
...
typedef struct _VI_DEADLOCK_NODE {
  ...
  union __anon_1523 u1;                    // offset: 0x48 ordinal: 0x7
...
typedef VOID (*__anon_1477)(ULONG);
...
typedef struct _IMAGE_SECTION_HEADER {
  ...
  union __anon_1415 Misc;     // offset: 0x8 ordinal: 0x1
...
typedef struct PROCESSOR_PERFSTATE_POLICY {
  ...
  union {
    ...
    union __anon_1406 Flags; // offset: 0x7 ordinal: 0x5
  };
...
typedef struct _POP_ACTION_TRIGGER {
  ...
  union {
    struct __anon_1401 Battery; // offset: 0x10 ordinal: 0x3
    struct __anon_1402 Button;  // offset: 0x10 ordinal: 0x4
  };
} _POP_ACTION_TRIGGER;
...
typedef VOID (*__anon_1263)(ULONG, ULONG, VOID *);
...
typedef struct _MMADDRESS_LIST {
  union __anon_1257 u1; // offset: 0x0 ordinal: 0x0
  VOID *EndVa;          // offset: 0x8 ordinal: 0x1
} _MMADDRESS_LIST;

// 0x10 bytes (sizeof)
typedef union __anon_1255 {
  struct _LIST_ENTRY List;        // offset: 0x0 ordinal: 0x0
...
// 0x4 bytes (sizeof)
typedef union __anon_1199 {
  struct __anon_1204 s1; // offset: 0x0 ordinal: 0x0
} __anon_1199;
...
typedef union __anon_1198 {
  struct __anon_1203 s1; // offset: 0x0 ordinal: 0x0
} __anon_1198;
...
// 0x4 bytes (sizeof)
typedef union __anon_1181 {
  struct __anon_1187 s1; // offset: 0x0 ordinal: 0x0
  ULONG State;           // offset: 0x0 ordinal: 0x1
} __anon_1181;

// 0x4 bytes (sizeof)
typedef struct __anon_1177 {
  ULONG Initialized : 1;         // offset: 0x0 ordinal: 0x0
...
// 0x4 bytes (sizeof)
typedef union __anon_1171 {
  struct __anon_1177 s1; // offset: 0x0 ordinal: 0x0
  ULONG State;           // offset: 0x0 ordinal: 0x1
} __anon_1171;

// 0x4 bytes (sizeof)
typedef struct __anon_1158 {
  ULONG Internal : 1; // offset: 0x0 ordinal: 0x0
  ULONG Secure : 1;   // offset: 0x0 ordinal: 0x1
} __anon_1158;

// 0x4 bytes (sizeof)
typedef union __anon_1159 {
  struct __anon_1158 s1; // offset: 0x0 ordinal: 0x0
} __anon_1159;

// 0x4 bytes (sizeof)
typedef union __anon_1148 {
  struct __anon_1147 s2; // offset: 0x0 ordinal: 0x0
  ULONG ZeroInit;        // offset: 0x0 ordinal: 0x1
} __anon_1148;

// 0x4 bytes (sizeof)
typedef union __anon_1146 {
  struct __anon_1145 s1; // offset: 0x0 ordinal: 0x0
  ULONG Length;          // offset: 0x0 ordinal: 0x1
} __anon_1146;

// 0x18 bytes (sizeof)
typedef struct _PORT_MESSAGE32 {
  union __anon_1146 u1; // offset: 0x0 ordinal: 0x0
  union __anon_1148 u2; // offset: 0x4 ordinal: 0x1
  union {
...
typedef struct _KTRANSACTION_HISTORY {
  enum __anon_941 RecordType; // offset: 0x0 ordinal: 0x0
  ULONG Payload;              // offset: 0x4 ordinal: 0x1
} _KTRANSACTION_HISTORY;

// 0x8 bytes (sizeof)
typedef struct __anon_935 {
...
typedef VOID (*__anon_944)(struct _RTL_AVL_TABLE *, VOID *);

typedef VOID *(*__anon_943)(struct _RTL_AVL_TABLE *, ULONG);

typedef enum _RTL_GENERIC_COMPARE_RESULTS (*__anon_942)(struct _RTL_AVL_TABLE *,
                                                        VOID *, VOID *);
...
typedef VOID (*__anon_829)(VOID *, ULONG);

typedef VOID *(*__anon_828)(ULONG, UCHAR, ULONG);
...
typedef struct _MI_EXTRA_IMAGE_INFORMATION {
  ...
  VOID *ImageMerge;    // offset: 0x8 ordinal: 0x1
...
typedef struct _SEGMENT_FLAGS {
  ...
  ULONG ContainsPxeSubsection : 1;     // offset: 0x0 ordinal: 0x9
  ULONG Binary32 : 1;                  // offset: 0x0 ordinal: 0xa
  ULONG Spare : 8;                     // offset: 0x0 ordinal: 0xb
} _SEGMENT_FLAGS;

// 0x4 bytes (sizeof)
typedef union __anon_764 {
  ULONG LongFlags;                            // offset: 0x0 ordinal: 0x0
...
typedef struct _MMPTE_FLUSH_LIST {
  ULONG Count;        // offset: 0x0 ordinal: 0x0
  ULONG MaximumCount; // offset: 0x4 ordinal: 0x1
  VOID *FlushVa[20];  // offset: 0x8 ordinal: 0x2
} _MMPTE_FLUSH_LIST;
...
typedef union _WHEA_ERROR_PACKET_FLAGS {
  ...
  ULONG CpuValid : 1;        // offset: 0x0 ordinal: 0x1
...
typedef struct _WHEA_PCIXDEVICE_ID {
  ...
  ULONG BusNumber : 8;      // offset: 0x8 ordinal: 0x5
  ULONG SegmentNumber : 8;  // offset: 0x8 ordinal: 0x6
  ULONG Reserved1 : 8;      // offset: 0x8 ordinal: 0x7
  ULONG Reserved2;          // offset: 0xc ordinal: 0x8
} _WHEA_PCIXDEVICE_ID;

// 0x4 bytes (sizeof)
typedef union _WHEA_PCIEXPRESS_BRIDGE_CONTROL_STATUS {
  USHORT BridgeSecondaryStatus; // offset: 0x0 ordinal: 0x0
  USHORT BridgeControl;         // offset: 0x2 ordinal: 0x1
...
typedef union _WHEA_PCIEXPRESS_COMMAND_STATUS {
  USHORT Command; // offset: 0x0 ordinal: 0x0
  USHORT Status;  // offset: 0x2 ordinal: 0x1
  ULONG AsULONG;  // offset: 0x0 ordinal: 0x2
} _WHEA_PCIEXPRESS_COMMAND_STATUS;

// 0x4 bytes (sizeof)
typedef union _WHEA_PCIEXPRESS_VERSION {
  UCHAR MinorVersion; // offset: 0x0 ordinal: 0x0
  UCHAR MajorVersion; // offset: 0x1 ordinal: 0x1
...
typedef union _WHEA_NMI_ERROR_FLAGS {
  ULONG HypervisorError : 1; // offset: 0x0 ordinal: 0x0
...
typedef struct _WHEA_NMI_ERROR {
  ...
  union _WHEA_NMI_ERROR_FLAGS Flags; // offset: 0x8 ordinal: 0x1
} _WHEA_NMI_ERROR;
...
typedef union __anon_1579 {
  struct __anon_1580 DeviceClass;               // offset: 0x0 ordinal: 0x0
  struct __anon_1581 TargetDevice;              // offset: 0x0 ordinal: 0x1
  struct __anon_1582 InstallDevice;             // offset: 0x0 ordinal: 0x2
  struct __anon_1583 CustomNotification;        // offset: 0x0 ordinal: 0x3
  struct __anon_1584 ProfileNotification;       // offset: 0x0 ordinal: 0x4
  struct __anon_1585 PowerNotification;         // offset: 0x0 ordinal: 0x5
  struct __anon_1586 VetoNotification;          // offset: 0x0 ordinal: 0x6
  struct __anon_1587 BlockedDriverNotification; // offset: 0x0 ordinal: 0x7
  struct __anon_1588 InvalidIDNotification;     // offset: 0x0 ordinal: 0x8
  struct __anon_1589 PowerSettingNotification;  // offset: 0x0 ordinal: 0x9
} __anon_1579;
...
typedef union __anon_1475 {
  struct __anon_1482 Mbr; // offset: 0x0 ordinal: 0x0
  struct __anon_1483 Gpt; // offset: 0x0 ordinal: 0x1
} __anon_1475;
...
typedef struct _CM_KEY_BODY {
  ...
  struct _LIST_ENTRY ContextListHead;            // offset: 0x48 ordinal: 0x8
} _CM_KEY_BODY;
...
typedef union _WHEA_ERROR_RECORD_HEADER_VALIDBITS {
  ULONG Timestamp : 1;   // offset: 0x0 ordinal: 0x0
  ULONG PlatformId : 1;  // offset: 0x0 ordinal: 0x1
...
typedef union _MM_PAGE_ACCESS_INFO_FLAGS {
  struct __anon_643 File;    // offset: 0x0 ordinal: 0x0
  struct __anon_644 Private; // offset: 0x0 ordinal: 0x1
...
typedef VOID (*__anon_605)(VOID *, struct _OBJECT_DUMP_CONTROL *);
...
// 0x8 bytes (sizeof)
typedef struct __anon_357 {
  ULONG IdleTime;    // offset: 0x0 ordinal: 0x0
  ULONG NonIdleTime; // offset: 0x4 ordinal: 0x1
} __anon_357;

// 0x8 bytes (sizeof)
typedef union __anon_329 {
  struct __anon_357 Disk; // offset: 0x0 ordinal: 0x0
} __anon_329;
...
typedef struct _DEVICE_OBJECT_POWER_EXTENSION {
  ...
  ULONG TotalBusyCount;                  // offset: 0x8 ordinal: 0x2
  ULONG ConservationIdleTime;            // offset: 0xc ordinal: 0x3
  ULONG PerformanceIdleTime;             // offset: 0x10 ordinal: 0x4
  struct _DEVICE_OBJECT *DeviceObject;   // offset: 0x18 ordinal: 0x5
  struct _LIST_ENTRY IdleList;           // offset: 0x20 ordinal: 0x6
  UCHAR DeviceType;                      // offset: 0x30 ordinal: 0x7
  enum _DEVICE_POWER_STATE IdleState;    // offset: 0x34 ordinal: 0x8
  enum _DEVICE_POWER_STATE CurrentState; // offset: 0x38 ordinal: 0x9
  struct _LIST_ENTRY NotifySourceList;   // offset: 0x40 ordinal: 0xa
  struct _LIST_ENTRY NotifyTargetList;   // offset: 0x50 ordinal: 0xb
  struct _POWER_CHANNEL_SUMMARY
      PowerChannelSummary;   // offset: 0x60 ordinal: 0xc
  struct _LIST_ENTRY Volume; // offset: 0x80 ordinal: 0xd
  union __anon_329 Specific; // offset: 0x90 ordinal: 0xe
...
typedef LONG (*__anon_224)(VOID *, ULONG);

// 0xc bytes (sizeof)
typedef struct _PPM_DIA_STATS {
  ULONG PerfLevel;    // offset: 0x0 ordinal: 0x0
  ULONG IdleTime;     // offset: 0x4 ordinal: 0x1
  ULONG TimeInterval; // offset: 0x8 ordinal: 0x2
} _PPM_DIA_STATS;
...
typedef struct _PPM_IDLE_STATE {
  LONG (*IdleHandler)(VOID *, ULONG); // offset: 0x0 ordinal: 0x0
...
// 0x4 bytes (sizeof)
typedef union __anon_196 {
  ULONG AsULONG;          // offset: 0x0 ordinal: 0x0
  ULONG AllowScaling : 1; // offset: 0x0 ordinal: 0x1
  ULONG Disabled : 1;     // offset: 0x0 ordinal: 0x2
  ULONG Hypervisor : 2;   // offset: 0x0 ordinal: 0x3
  ULONG HvMaxCState : 4;  // offset: 0x0 ordinal: 0x4
  ULONG Reserved : 24;    // offset: 0x0 ordinal: 0x5
} __anon_196;
...
typedef struct _ACCESS_STATE {
  ...
  union __anon_547 Privileges;           // offset: 0x50 ordinal: 0xc
...
typedef LONG (*__anon_608)(VOID *, VOID *, struct _ACCESS_STATE *, CHAR, ULONG,
...
typedef struct _PLUGPLAY_EVENT_BLOCK {
  ...
  union __anon_1579 u;                         // offset: 0x30 ordinal: 0x6
...
typedef LONG (*__anon_610)(VOID *, UCHAR, struct _OBJECT_NAME_INFORMATION *,
                           ULONG, ULONG *, CHAR);

typedef LONG (*__anon_609)(VOID *, enum _SECURITY_OPERATION_CODE, ULONG *,
...
typedef UCHAR (*__anon_1478)(union _LARGE_INTEGER);
...
typedef UCHAR (*__anon_832)(struct _HHIVE *, ULONG, ULONG *, VOID *, ULONG);

typedef UCHAR (*__anon_831)(struct _HHIVE *, ULONG, struct CMP_OFFSET_ARRAY *,
                            ULONG, ULONG *);

typedef UCHAR (*__anon_830)(struct _HHIVE *, ULONG, ULONG, ULONG);

typedef VOID (*__anon_827)(struct _HHIVE *, ULONG);

typedef struct _CELL_DATA *(*__anon_826)(struct _HHIVE *, ULONG);
...
typedef LONG (*__anon_1481)(LONG, union _LARGE_INTEGER *, struct _MDL *,
                            VOID *);

typedef LONG (*__anon_1479)(union _LARGE_INTEGER *, struct _MDL *);
...
typedef struct _DUMP_INITIALIZATION_CONTEXT {
  ...
  union __anon_1475 DiskInfo; // offset: 0x8c ordinal: 0x12
...
typedef LONG (*__anon_932)(struct _KENLISTMENT *, VOID *, VOID *, ULONG,
                           union _LARGE_INTEGER *, ULONG, VOID *);

typedef UCHAR (*__anon_833)(struct _HHIVE *, ULONG, union _LARGE_INTEGER *,
                            ULONG);
...
typedef union _KGDTENTRY64 {
  ...
  struct __anon_1572 Bytes; // offset: 0x4 ordinal: 0x2
  struct __anon_1573 Bits;  // offset: 0x4 ordinal: 0x3
...
typedef struct _TEB32 {
  ...
  USHORT RtlDisableUserStackWalk : 1;    // offset: 0xfca ordinal: 0x57
  USHORT RtlExceptionAttached : 1;       // offset: 0xfca ordinal: 0x58
  USHORT SpareSameTebBits : 6;           // offset: 0xfca ordinal: 0x59
  ULONG TxnScopeEnterCallback;           // offset: 0xfcc ordinal: 0x5a
  ULONG TxnScopeExitCallback;            // offset: 0xfd0 ordinal: 0x5b
  ULONG TxnScopeContext;                 // offset: 0xfd4 ordinal: 0x5c
  ULONG LockCount;                       // offset: 0xfd8 ordinal: 0x5d
  ULONG ProcessRundown;                  // offset: 0xfdc ordinal: 0x5e
  ULONGLONG LastSwitchTime;              // offset: 0xfe0 ordinal: 0x5f
  ULONGLONG TotalSwitchOutTime;          // offset: 0xfe8 ordinal: 0x60
  union _LARGE_INTEGER WaitReasonBitMap; // offset: 0xff0 ordinal: 0x61
} _TEB32;
...
typedef struct _RTLP_RANGE_LIST_ENTRY {
  ...
  union {
    struct __anon_1527 Allocated; // offset: 0x10 ordinal: 0x2
    struct __anon_1528 Merged;    // offset: 0x10 ordinal: 0x3
  };
...
typedef struct _PO_MEMORY_RANGE {
  ...
  ULONGLONG EndPage;   // offset: 0x8 ordinal: 0x1
} _PO_MEMORY_RANGE;

// 0x28 bytes (sizeof)
typedef struct _PO_MEMORY_RANGE_TABLE {
  struct _PO_MEMORY_RANGE_TABLE *Next; // offset: 0x0 ordinal: 0x0
  ULONGLONG NextTable;                 // offset: 0x8 ordinal: 0x1
  ULONG EntryCount;                    // offset: 0x10 ordinal: 0x2
  struct _PO_MEMORY_RANGE Range[1];    // offset: 0x18 ordinal: 0x3
...
typedef LONG (*__anon_1431)(LONG, VOID *, VOID *, ULONGLONG, ULONG, VOID *);
...
typedef UCHAR (*__anon_1360)(VOID *, struct _RTL_RANGE *);
...
typedef struct _ALPC_COMPLETION_PACKET_LOOKASIDE_ENTRY {
  struct _SINGLE_LIST_ENTRY ListEntry; // offset: 0x0 ordinal: 0x0
  VOID *Packet;                        // offset: 0x8 ordinal: 0x1
...
typedef struct _ALPC_COMPLETION_PACKET_LOOKASIDE {
  ...
  struct _ALPC_COMPLETION_PACKET_LOOKASIDE_ENTRY
      Entry[0]; // offset: 0x38 ordinal: 0x9
...
typedef struct _ETW_GUID_ENTRY {
  ...
  struct _TRACE_ENABLE_INFO ProviderEnableInfo; // offset: 0x50 ordinal: 0x6
  struct _TRACE_ENABLE_INFO EnableInfo[8];      // offset: 0x70 ordinal: 0x7
} _ETW_GUID_ENTRY;
...
typedef struct _WMI_BUFFER_HEADER {
  ...
  union {
    ULONG Padding0[2];                     // offset: 0x20 ordinal: 0x8
    struct _SINGLE_LIST_ENTRY SlistEntry;  // offset: 0x20 ordinal: 0x9
    struct _WMI_BUFFER_HEADER *NextBuffer; // offset: 0x20 ordinal: 0xa
  };
  struct _ETW_BUFFER_CONTEXT ClientContext; // offset: 0x28 ordinal: 0xb
  union {
    enum _ETW_BUFFER_STATE State; // offset: 0x2c ordinal: 0xc
    ULONG Flags;                  // offset: 0x2c ordinal: 0xd
  };
  ULONG Offset;      // offset: 0x30 ordinal: 0xe
  USHORT BufferFlag; // offset: 0x34 ordinal: 0xf
  USHORT BufferType; // offset: 0x36 ordinal: 0x10
  union {
    ULONG Padding1[4];              // offset: 0x38 ordinal: 0x11
    union _LARGE_INTEGER StartTime; // offset: 0x38 ordinal: 0x12
    struct _LIST_ENTRY Entry;       // offset: 0x38 ordinal: 0x13
    VOID *Padding2;                 // offset: 0x38 ordinal: 0x14
  };
  struct _SINGLE_LIST_ENTRY GlobalEntry; // offset: 0x40 ordinal: 0x15
  VOID *Pointer0;                        // offset: 0x38 ordinal: 0x16
  VOID *Pointer1;                        // offset: 0x40 ordinal: 0x17
} _WMI_BUFFER_HEADER;
...
typedef struct _PRIVATE_CACHE_MAP {
  ...
  VOID *ReadAheadWorkItem;                 // offset: 0x60 ordinal: 0xd
} _PRIVATE_CACHE_MAP;
...
typedef struct _DBGKD_MANIPULATE_STATE32 {
  ...
  union __anon_1050 u;   // offset: 0xc ordinal: 0x4
} _DBGKD_MANIPULATE_STATE32;

// 0x28 bytes (sizeof)
typedef union __anon_1028 {
...
typedef struct _DBGKD_MANIPULATE_STATE64 {
  ...
  USHORT Processor;      // offset: 0x6 ordinal: 0x2
  LONG ReturnStatus;     // offset: 0x8 ordinal: 0x3
  union __anon_1028 u;   // offset: 0x10 ordinal: 0x4
...
typedef union _CLS_LSN {
  struct __anon_935 offset; // offset: 0x0 ordinal: 0x0
...
typedef union __anon_768 {
  struct __anon_757 e2; // offset: 0x0 ordinal: 0x0
} __anon_768;

// 0x8 bytes (sizeof)
typedef union __anon_747 {
...
typedef struct _MMPTE_HARDWARE_LARGEPAGE {
  ...
  ULONGLONG PageFrameNumber : 27; // offset: 0x0 ordinal: 0xe
  ULONGLONG reserved2 : 16;       // offset: 0x0 ordinal: 0xf
...
typedef struct _FIRMWARE_INFORMATION_LOADER_BLOCK {
  ...
  ULONG Reserved : 31;       // offset: 0x0 ordinal: 0x1
  union __anon_710 u;        // offset: 0x8 ordinal: 0x2
...
typedef struct _LOADER_PARAMETER_EXTENSION {
  ...
  ULONGLONG LoaderPagesSpanned;            // offset: 0x38 ordinal: 0x7
  ...
  ULONG ResumePages;                 // offset: 0xb8 ordinal: 0x16
  VOID *DumpHeader;                  // offset: 0xc0 ordinal: 0x17
...
typedef struct _LOADER_PARAMETER_BLOCK {
  ...
  union __anon_695 u;                            // offset: 0xb8 ordinal: 0x14
...
typedef struct WHEA_PCIXDEVICE_REGISTER_PAIR {
  ULONGLONG Register; // offset: 0x0 ordinal: 0x0
  ULONGLONG Data;     // offset: 0x8 ordinal: 0x1
...
typedef union _WHEA_PCIXDEVICE_ERROR_VALIDBITS {
  ...
  ULONGLONG IdInfo : 1;            // offset: 0x0 ordinal: 0x1
  ULONGLONG MemoryNumber : 1;      // offset: 0x0 ordinal: 0x2
  ULONGLONG IoNumber : 1;          // offset: 0x0 ordinal: 0x3
  ULONGLONG RegisterDataPairs : 1; // offset: 0x0 ordinal: 0x4
  ULONGLONG Reserved : 59;         // offset: 0x0 ordinal: 0x5
  ULONGLONG ValidBits;             // offset: 0x0 ordinal: 0x6
} _WHEA_PCIXDEVICE_ERROR_VALIDBITS;

// 0x8 bytes (sizeof)
typedef union _WHEA_PCIXBUS_COMMAND {
  ULONGLONG Command : 56;    // offset: 0x0 ordinal: 0x0
  ULONGLONG PCIXCommand : 1; // offset: 0x0 ordinal: 0x1
  ULONGLONG Reserved : 7;    // offset: 0x0 ordinal: 0x2
  ULONGLONG AsULONGLONG;     // offset: 0x0 ordinal: 0x3
} _WHEA_PCIXBUS_COMMAND;

// 0x8 bytes (sizeof)
typedef union _WHEA_PCIXBUS_ERROR_VALIDBITS {
  ULONGLONG ErrorStatus : 1; // offset: 0x0 ordinal: 0x0
  ULONGLONG ErrorType : 1;   // offset: 0x0 ordinal: 0x1
  ULONGLONG BusId : 1;       // offset: 0x0 ordinal: 0x2
  ULONGLONG BusAddress : 1;  // offset: 0x0 ordinal: 0x3
  ULONGLONG BusData : 1;     // offset: 0x0 ordinal: 0x4
  ULONGLONG BusCommand : 1;  // offset: 0x0 ordinal: 0x5
  ULONGLONG RequesterId : 1; // offset: 0x0 ordinal: 0x6
  ULONGLONG CompleterId : 1; // offset: 0x0 ordinal: 0x7
  ULONGLONG TargetId : 1;    // offset: 0x0 ordinal: 0x8
  ULONGLONG Reserved : 55;   // offset: 0x0 ordinal: 0x9
  ULONGLONG ValidBits;       // offset: 0x0 ordinal: 0xa
} _WHEA_PCIXBUS_ERROR_VALIDBITS;

// 0x8 bytes (sizeof)
typedef union _WHEA_PCIEXPRESS_ERROR_VALIDBITS {
  ULONGLONG PortType : 1;            // offset: 0x0 ordinal: 0x0
  ULONGLONG Version : 1;             // offset: 0x0 ordinal: 0x1
  ULONGLONG CommandStatus : 1;       // offset: 0x0 ordinal: 0x2
  ULONGLONG DeviceId : 1;            // offset: 0x0 ordinal: 0x3
  ULONGLONG DeviceSerialNumber : 1;  // offset: 0x0 ordinal: 0x4
  ULONGLONG BridgeControlStatus : 1; // offset: 0x0 ordinal: 0x5
  ULONGLONG ExpressCapability : 1;   // offset: 0x0 ordinal: 0x6
  ULONGLONG AerInfo : 1;             // offset: 0x0 ordinal: 0x7
  ULONGLONG Reserved : 56;           // offset: 0x0 ordinal: 0x8
  ULONGLONG ValidBits;               // offset: 0x0 ordinal: 0x9
...
typedef struct _WHEA_PCIXBUS_ERROR {
  union _WHEA_PCIXBUS_ERROR_VALIDBITS ValidBits; // offset: 0x0 ordinal: 0x0
  union _WHEA_ERROR_STATUS ErrorStatus;          // offset: 0x8 ordinal: 0x1
  USHORT ErrorType;                              // offset: 0x10 ordinal: 0x2
  union _WHEA_PCIXBUS_ID BusId;                  // offset: 0x12 ordinal: 0x3
  ...
  union _WHEA_PCIXBUS_COMMAND BusCommand;        // offset: 0x28 ordinal: 0x7
  ULONGLONG RequesterId;                         // offset: 0x30 ordinal: 0x8
  ULONGLONG CompleterId;                         // offset: 0x38 ordinal: 0x9
  ULONGLONG TargetId;                            // offset: 0x40 ordinal: 0xa
} _WHEA_PCIXBUS_ERROR;

// 0xd0 bytes (sizeof)
typedef struct _WHEA_PCIEXPRESS_ERROR {
  union _WHEA_PCIEXPRESS_ERROR_VALIDBITS ValidBits; // offset: 0x0 ordinal: 0x0
  enum WHEA_PCIEXPRESS_DEVICE_TYPE PortType;        // offset: 0x8 ordinal: 0x1
  union _WHEA_PCIEXPRESS_VERSION Version;           // offset: 0xc ordinal: 0x2
  union _WHEA_PCIEXPRESS_COMMAND_STATUS
      CommandStatus;                          // offset: 0x10 ordinal: 0x3
  ULONG Reserved;                             // offset: 0x14 ordinal: 0x4
  struct _WHEA_PCIEXPRESS_DEVICE_ID DeviceId; // offset: 0x18 ordinal: 0x5
  ULONGLONG DeviceSerialNumber;               // offset: 0x28 ordinal: 0x6
  union _WHEA_PCIEXPRESS_BRIDGE_CONTROL_STATUS
      BridgeControlStatus;     // offset: 0x30 ordinal: 0x7
...
typedef struct _WHEA_MEMORY_ERROR {
  union _WHEA_MEMORY_ERROR_VALIDBITS ValidBits; // offset: 0x0 ordinal: 0x0
  union _WHEA_ERROR_STATUS ErrorStatus;         // offset: 0x8 ordinal: 0x1
...
typedef union __anon_664 {
  ...
  struct _WHEA_PCIXBUS_ERROR PciXBusError;       // offset: 0x0 ordinal: 0x4
  struct _WHEA_PCIXDEVICE_ERROR PciXDeviceError; // offset: 0x0 ordinal: 0x5
} __anon_664;

// 0x119 bytes (sizeof)
typedef struct _WHEA_ERROR_PACKET {
  ULONG Signature;                              // offset: 0x0 ordinal: 0x0
  union _WHEA_ERROR_PACKET_FLAGS Flags;         // offset: 0x4 ordinal: 0x1
  ULONG Size;                                   // offset: 0x8 ordinal: 0x2
  ULONG RawDataLength;                          // offset: 0xc ordinal: 0x3
  ULONGLONG Reserved1;                          // offset: 0x10 ordinal: 0x4
  ULONGLONG Context;                            // offset: 0x18 ordinal: 0x5
  enum _WHEA_ERROR_TYPE ErrorType;              // offset: 0x20 ordinal: 0x6
  enum _WHEA_ERROR_SEVERITY ErrorSeverity;      // offset: 0x24 ordinal: 0x7
  ULONG ErrorSourceId;                          // offset: 0x28 ordinal: 0x8
  enum _WHEA_ERROR_SOURCE_TYPE ErrorSourceType; // offset: 0x2c ordinal: 0x9
  ULONG Reserved2;                              // offset: 0x30 ordinal: 0xa
  ULONG Version;                                // offset: 0x34 ordinal: 0xb
  ULONGLONG Cpu;                                // offset: 0x38 ordinal: 0xc
  union __anon_664 u;                           // offset: 0x40 ordinal: 0xd
  enum _WHEA_RAW_DATA_FORMAT RawDataFormat;     // offset: 0x110 ordinal: 0xe
  ULONG RawDataOffset;                          // offset: 0x114 ordinal: 0xf
  UCHAR RawData[1];                             // offset: 0x118 ordinal: 0x10
} _WHEA_ERROR_PACKET;
...
typedef union _WHEA_TIMESTAMP {
  ...
  ULONGLONG Reserved : 8;               // offset: 0x0 ordinal: 0x3
  ULONGLONG Day : 8;                    // offset: 0x0 ordinal: 0x4
  ULONGLONG Month : 8;                  // offset: 0x0 ordinal: 0x5
  ULONGLONG Year : 8;                   // offset: 0x0 ordinal: 0x6
  ULONGLONG Century : 8;                // offset: 0x0 ordinal: 0x7
  union _LARGE_INTEGER AsLARGE_INTEGER; // offset: 0x0 ordinal: 0x8
} _WHEA_TIMESTAMP;
...
typedef struct __anon_573 {
  union {
    struct __anon_580 Raw;        // offset: 0x0 ordinal: 0x0
    struct __anon_572 Translated; // offset: 0x0 ordinal: 0x1
  };
} __anon_573;

// 0x10 bytes (sizeof)
typedef union __anon_568 {
  struct __anon_571 Generic;            // offset: 0x0 ordinal: 0x0
  struct __anon_571 Port;               // offset: 0x0 ordinal: 0x1
  struct __anon_572 Interrupt;          // offset: 0x0 ordinal: 0x2
  struct __anon_573 MessageInterrupt;   // offset: 0x0 ordinal: 0x3
  struct __anon_571 Memory;             // offset: 0x0 ordinal: 0x4
  struct __anon_574 Dma;                // offset: 0x0 ordinal: 0x5
  struct __anon_562 DevicePrivate;      // offset: 0x0 ordinal: 0x6
  struct __anon_575 BusNumber;          // offset: 0x0 ordinal: 0x7
  struct __anon_576 DeviceSpecificData; // offset: 0x0 ordinal: 0x8
  struct __anon_577 Memory40;           // offset: 0x0 ordinal: 0x9
  struct __anon_578 Memory48;           // offset: 0x0 ordinal: 0xa
  struct __anon_579 Memory64;           // offset: 0x0 ordinal: 0xb
} __anon_568;
...
typedef struct _CM_PARTIAL_RESOURCE_DESCRIPTOR {
  ...
  union __anon_568 u;     // offset: 0x4 ordinal: 0x3
...
// 0x18 bytes (sizeof)
typedef union __anon_556 {
  struct __anon_559 Port;          // offset: 0x0 ordinal: 0x0
  struct __anon_559 Memory;        // offset: 0x0 ordinal: 0x1
  struct __anon_560 Interrupt;     // offset: 0x0 ordinal: 0x2
  struct __anon_561 Dma;           // offset: 0x0 ordinal: 0x3
  struct __anon_559 Generic;       // offset: 0x0 ordinal: 0x4
  struct __anon_562 DevicePrivate; // offset: 0x0 ordinal: 0x5
  struct __anon_563 BusNumber;     // offset: 0x0 ordinal: 0x6
  struct __anon_564 ConfigData;    // offset: 0x0 ordinal: 0x7
  struct __anon_565 Memory40;      // offset: 0x0 ordinal: 0x8
  struct __anon_566 Memory48;      // offset: 0x0 ordinal: 0x9
  struct __anon_567 Memory64;      // offset: 0x0 ordinal: 0xa
} __anon_556;
...
typedef struct _IO_RESOURCE_DESCRIPTOR {
  ...
  union __anon_556 u;     // offset: 0x8 ordinal: 0x6
...
typedef struct _ARBITER_PARAMETERS {
  union __anon_1391 Parameters; // offset: 0x0 ordinal: 0x0
} _ARBITER_PARAMETERS;

typedef LONG (*__anon_1375)(VOID *, enum _ARBITER_ACTION,
...
typedef LONG (*__anon_1347)(struct _IO_RESOURCE_DESCRIPTOR *);

typedef LONG (*__anon_1345)(struct _IO_RESOURCE_DESCRIPTOR *, ULONGLONG,
                            struct _CM_PARTIAL_RESOURCE_DESCRIPTOR *);
...
typedef struct _MMWSLE {
  union __anon_534 u1; // offset: 0x0 ordinal: 0x0
} _MMWSLE;
...
typedef struct _CM_CACHED_VALUE_INDEX {
  ...
  union __anon_1425 Data; // offset: 0x8 ordinal: 0x1
...
typedef struct _MMWSL {
  ...
  ULONG LastVadBit;                             // offset: 0x40 ordinal: 0xe
  ULONG MaximumLastVadBit;                      // offset: 0x44 ordinal: 0xf
  ULONG LastAllocationSizeHint;                 // offset: 0x48 ordinal: 0x10
  ULONG LastAllocationSize;                     // offset: 0x4c ordinal: 0x11
  struct _MMWSLE_NONDIRECT_HASH *NonDirectHash; // offset: 0x50 ordinal: 0x12
  struct _MMWSLE_HASH *HashTableStart;          // offset: 0x58 ordinal: 0x13
  struct _MMWSLE_HASH
      *HighestPermittedHashAddress;            // offset: 0x60 ordinal: 0x14
  VOID *HighestUserAddress;                    // offset: 0x68 ordinal: 0x15
  ULONG MaximumUserPageTablePages;             // offset: 0x70 ordinal: 0x16
  ULONG MaximumUserPageDirectoryPages;         // offset: 0x74 ordinal: 0x17
  ULONG *CommittedPageTables;                  // offset: 0x78 ordinal: 0x18
  ULONG NumberOfCommittedPageDirectories;      // offset: 0x80 ordinal: 0x19
  ULONGLONG CommittedPageDirectories[128];     // offset: 0x88 ordinal: 0x1a
  ULONG NumberOfCommittedPageDirectoryParents; // offset: 0x488 ordinal: 0x1b
  ULONGLONG CommittedPageDirectoryParents[1];  // offset: 0x490 ordinal: 0x1c
} _MMWSL;
...
// 0x20 bytes (sizeof)
typedef union __anon_380 {
  struct __anon_400 Create;                     // offset: 0x0 ordinal: 0x0
  struct __anon_401 CreatePipe;                 // offset: 0x0 ordinal: 0x1
  struct __anon_402 CreateMailslot;             // offset: 0x0 ordinal: 0x2
  struct __anon_403 Read;                       // offset: 0x0 ordinal: 0x3
  struct __anon_403 Write;                      // offset: 0x0 ordinal: 0x4
  struct __anon_404 QueryDirectory;             // offset: 0x0 ordinal: 0x5
  struct __anon_405 NotifyDirectory;            // offset: 0x0 ordinal: 0x6
  struct __anon_406 QueryFile;                  // offset: 0x0 ordinal: 0x7
  struct __anon_407 SetFile;                    // offset: 0x0 ordinal: 0x8
  struct __anon_408 QueryEa;                    // offset: 0x0 ordinal: 0x9
  struct __anon_409 SetEa;                      // offset: 0x0 ordinal: 0xa
  struct __anon_410 QueryVolume;                // offset: 0x0 ordinal: 0xb
  struct __anon_410 SetVolume;                  // offset: 0x0 ordinal: 0xc
  struct __anon_411 FileSystemControl;          // offset: 0x0 ordinal: 0xd
  struct __anon_412 LockControl;                // offset: 0x0 ordinal: 0xe
  struct __anon_413 DeviceIoControl;            // offset: 0x0 ordinal: 0xf
  struct __anon_414 QuerySecurity;              // offset: 0x0 ordinal: 0x10
  struct __anon_415 SetSecurity;                // offset: 0x0 ordinal: 0x11
  struct __anon_416 MountVolume;                // offset: 0x0 ordinal: 0x12
  struct __anon_416 VerifyVolume;               // offset: 0x0 ordinal: 0x13
  struct __anon_417 Scsi;                       // offset: 0x0 ordinal: 0x14
  struct __anon_418 QueryQuota;                 // offset: 0x0 ordinal: 0x15
  struct __anon_409 SetQuota;                   // offset: 0x0 ordinal: 0x16
  struct __anon_419 QueryDeviceRelations;       // offset: 0x0 ordinal: 0x17
  struct __anon_420 QueryInterface;             // offset: 0x0 ordinal: 0x18
  struct __anon_421 DeviceCapabilities;         // offset: 0x0 ordinal: 0x19
  struct __anon_422 FilterResourceRequirements; // offset: 0x0 ordinal: 0x1a
  struct __anon_423 ReadWriteConfig;            // offset: 0x0 ordinal: 0x1b
  struct __anon_424 SetLock;                    // offset: 0x0 ordinal: 0x1c
  struct __anon_425 QueryId;                    // offset: 0x0 ordinal: 0x1d
  struct __anon_426 QueryDeviceText;            // offset: 0x0 ordinal: 0x1e
  struct __anon_427 UsageNotification;          // offset: 0x0 ordinal: 0x1f
  struct __anon_428 WaitWake;                   // offset: 0x0 ordinal: 0x20
  struct __anon_429 PowerSequence;              // offset: 0x0 ordinal: 0x21
  struct __anon_430 Power;                      // offset: 0x0 ordinal: 0x22
  struct __anon_431 StartDevice;                // offset: 0x0 ordinal: 0x23
  struct __anon_432 WMI;                        // offset: 0x0 ordinal: 0x24
  struct __anon_433 Others;                     // offset: 0x0 ordinal: 0x25
} __anon_380;
...
typedef union _FS_FILTER_PARAMETERS {
  struct __anon_525 AcquireForModifiedPageWriter; // offset: 0x0 ordinal: 0x0
  struct __anon_526 ReleaseForModifiedPageWriter; // offset: 0x0 ordinal: 0x1
  struct __anon_527
      AcquireForSectionSynchronization;     // offset: 0x0 ordinal: 0x2
  struct __anon_528 NotifyStreamFileObject; // offset: 0x0 ordinal: 0x3
  struct __anon_529 Others;                 // offset: 0x0 ordinal: 0x4
...
typedef VOID (*__anon_385)(struct _FS_FILTER_CALLBACK_DATA *, LONG, VOID *);

typedef LONG (*__anon_384)(struct _FS_FILTER_CALLBACK_DATA *, VOID **);
...
typedef LONG (*__anon_345)(struct _FILE_OBJECT *, union _LARGE_INTEGER *,
                           struct _ERESOURCE **, struct _DEVICE_OBJECT *);

typedef LONG (*__anon_351)(struct _FILE_OBJECT *, struct _ERESOURCE *,
                           struct _DEVICE_OBJECT *);
...
typedef union __anon_729 {
  ...
  struct _MMPTE_TIMESTAMP TimeStamp;          // offset: 0x0 ordinal: 0x7
  struct _MMPTE_TRANSITION Trans;             // offset: 0x0 ordinal: 0x8
  struct _MMPTE_SUBSECTION Subsect;           // offset: 0x0 ordinal: 0x9
  struct _MMPTE_LIST List;                    // offset: 0x0 ordinal: 0xa
} __anon_729;

// 0x8 bytes (sizeof)
typedef struct _MMPTE {
  union __anon_729 u; // offset: 0x0 ordinal: 0x0
} _MMPTE;
...
typedef struct _MI_PER_SESSION_PROTOS {
  union __anon_809 u1;                // offset: 0x0 ordinal: 0x0
  struct _MMADDRESS_NODE *LeftChild;  // offset: 0x8 ordinal: 0x1
  struct _MMADDRESS_NODE *RightChild; // offset: 0x10 ordinal: 0x2
  union {
  ...
  union __anon_812 u2;           // offset: 0x30 ordinal: 0x8
...
typedef struct _MMPFN {
  union __anon_739 u1; // offset: 0x0 ordinal: 0x0
  union __anon_740 u2; // offset: 0x8 ordinal: 0x1
  union {
    struct _MMPTE *PteAddress; // offset: 0x10 ordinal: 0x2
    VOID *VolatilePteAddress;  // offset: 0x10 ordinal: 0x3
  };
  union __anon_745 u3;         // offset: 0x18 ordinal: 0x4
  ...
  union __anon_747 u4; // offset: 0x28 ordinal: 0xa
} _MMPFN;
...
typedef struct _SHARED_CACHE_MAP {
  ...
  VOID *WriteBehindWorkQueueEntry;             // offset: 0x1b8 ordinal: 0x29
  struct _VOLUME_CACHE_MAP *VolumeCacheMap;    // offset: 0x1c0 ordinal: 0x2a
  ULONG ProcImagePathHash;                     // offset: 0x1c8 ordinal: 0x2b
  ULONG MappedWritesInProgress;                // offset: 0x1cc ordinal: 0x2c
} _SHARED_CACHE_MAP;

// 0x8 bytes (sizeof)
typedef struct __anon_1080 {
  struct _SHARED_CACHE_MAP *SharedCacheMap; // offset: 0x0 ordinal: 0x0
} __anon_1080;

// 0x8 bytes (sizeof)
typedef union __anon_1083 {
  struct __anon_1079 Read;         // offset: 0x0 ordinal: 0x0
  struct __anon_1080 Write;        // offset: 0x0 ordinal: 0x1
  struct __anon_1081 Event;        // offset: 0x0 ordinal: 0x2
  struct __anon_1082 Notification; // offset: 0x0 ordinal: 0x3
} __anon_1083;
...
typedef struct _WORK_QUEUE_ENTRY {
  ...
  union __anon_1083 Parameters;               // offset: 0x20 ordinal: 0x2
...
typedef struct _VACB {
  ...
  union __anon_1073 Overlay;                // offset: 0x10 ordinal: 0x2
...
typedef struct _MAPPED_FILE_SEGMENT {
  ...
  struct _MSUBSECTION *LastSubsectionHint; // offset: 0x30 ordinal: 0x8
} _MAPPED_FILE_SEGMENT;

// 0x78 bytes (sizeof)
typedef struct _MMVAD_LONG {
  union __anon_795 u1;              // offset: 0x0 ordinal: 0x0
  struct _MMVAD *LeftChild;         // offset: 0x8 ordinal: 0x1
  struct _MMVAD *RightChild;        // offset: 0x10 ordinal: 0x2
  ULONGLONG StartingVpn;            // offset: 0x18 ordinal: 0x3
  ULONGLONG EndingVpn;              // offset: 0x20 ordinal: 0x4
  union __anon_798 u;               // offset: 0x28 ordinal: 0x5
  struct _EX_PUSH_LOCK PushLock;    // offset: 0x30 ordinal: 0x6
  union __anon_799 u5;              // offset: 0x38 ordinal: 0x7
  union __anon_800 u2;              // offset: 0x40 ordinal: 0x8
  ...
  union __anon_1255 u3;             // offset: 0x60 ordinal: 0xc
  union __anon_1259 u4;             // offset: 0x70 ordinal: 0xd
} _MMVAD_LONG;

// 0x20 bytes (sizeof)
typedef struct _ALPC_HANDLE_TABLE {
  ULONG Flags;                        // offset: 0x0 ordinal: 0x0
  struct _ALPC_HANDLE_ENTRY *Handles; // offset: 0x8 ordinal: 0x1
  ULONG TotalHandles;                 // offset: 0x10 ordinal: 0x2
  struct _EX_PUSH_LOCK Lock;          // offset: 0x18 ordinal: 0x3
} _ALPC_HANDLE_TABLE;
...
typedef struct _BLOB {
  ...
  union __anon_1156 u1;      // offset: 0x10 ordinal: 0x2
...
typedef struct _CMHIVE {
  ...
  struct _EX_PUSH_LOCK ViewLock;       // offset: 0x5e8 ordinal: 0x5
  struct _KTHREAD *ViewLockOwner;      // offset: 0x5f0 ordinal: 0x6
  ULONG ViewLockLast;                  // offset: 0x5f8 ordinal: 0x7
  ULONG ViewUnLockLast;                // offset: 0x5fc ordinal: 0x8
  struct _FAST_MUTEX *WriterLock;      // offset: 0x600 ordinal: 0x9
  struct _EX_PUSH_LOCK FlusherLock;    // offset: 0x608 ordinal: 0xa
  struct _EX_PUSH_LOCK SecurityLock;   // offset: 0x610 ordinal: 0xb
  struct _LIST_ENTRY MappedViewList;   // offset: 0x618 ordinal: 0xc
  struct _LIST_ENTRY PinnedViewList;   // offset: 0x628 ordinal: 0xd
  struct _LIST_ENTRY FlushedViewList;  // offset: 0x638 ordinal: 0xe
  USHORT MappedViewCount;              // offset: 0x648 ordinal: 0xf
  USHORT PinnedViewCount;              // offset: 0x64a ordinal: 0x10
  ULONG UseCount;                      // offset: 0x64c ordinal: 0x11
  ULONG ViewsPerHive;                  // offset: 0x650 ordinal: 0x12
  struct _FILE_OBJECT *FileObject;     // offset: 0x658 ordinal: 0x13
  ULONG LastShrinkHiveSize;            // offset: 0x660 ordinal: 0x14
  union _LARGE_INTEGER ActualFileSize; // offset: 0x668 ordinal: 0x15
  struct _UNICODE_STRING FileFullPath; // offset: 0x670 ordinal: 0x16
  struct _UNICODE_STRING FileUserName; // offset: 0x680 ordinal: 0x17
  struct _UNICODE_STRING HiveRootPath; // offset: 0x690 ordinal: 0x18
  ULONG SecurityCount;                 // offset: 0x6a0 ordinal: 0x19
  ULONG SecurityCacheSize;             // offset: 0x6a4 ordinal: 0x1a
  LONG SecurityHitHint;                // offset: 0x6a8 ordinal: 0x1b
  struct _CM_KEY_SECURITY_CACHE_ENTRY
      *SecurityCache;                          // offset: 0x6b0 ordinal: 0x1c
  struct _LIST_ENTRY SecurityHash[64];         // offset: 0x6b8 ordinal: 0x1d
  ULONG UnloadEventCount;                      // offset: 0xab8 ordinal: 0x1e
  struct _KEVENT **UnloadEventArray;           // offset: 0xac0 ordinal: 0x1f
  struct _CM_KEY_CONTROL_BLOCK *RootKcb;       // offset: 0xac8 ordinal: 0x20
  UCHAR Frozen;                                // offset: 0xad0 ordinal: 0x21
  struct _CM_WORKITEM *UnloadWorkItem;         // offset: 0xad8 ordinal: 0x22
  UCHAR GrowOnlyMode;                          // offset: 0xae0 ordinal: 0x23
  ULONG GrowOffset;                            // offset: 0xae4 ordinal: 0x24
  struct _LIST_ENTRY KcbConvertListHead;       // offset: 0xae8 ordinal: 0x25
  struct _LIST_ENTRY KnodeConvertListHead;     // offset: 0xaf8 ordinal: 0x26
  struct _CM_CELL_REMAP_BLOCK *CellRemapArray; // offset: 0xb08 ordinal: 0x27
  ULONG Flags;                                 // offset: 0xb10 ordinal: 0x28
  struct _LIST_ENTRY TrustClassEntry;          // offset: 0xb18 ordinal: 0x29
  ULONG FlushCount;                            // offset: 0xb28 ordinal: 0x2a
  struct _CM_RM *CmRm;                         // offset: 0xb30 ordinal: 0x2b
  ULONG CmRmInitFailPoint;                     // offset: 0xb38 ordinal: 0x2c
  LONG CmRmInitFailStatus;                     // offset: 0xb3c ordinal: 0x2d
  struct _KTHREAD *CreatorOwner;               // offset: 0xb40 ordinal: 0x2e
} _CMHIVE;
...
typedef struct _CM_KEY_CONTROL_BLOCK {
  ...
  ULONG ExtFlags : 9;           // offset: 0x4 ordinal: 0x1
  ULONG PrivateAlloc : 1;       // offset: 0x4 ordinal: 0x2
  ULONG Delete : 1;             // offset: 0x4 ordinal: 0x3
  ULONG DelayedCloseIndex : 11; // offset: 0x4 ordinal: 0x4
...
typedef struct _OBP_LOOKUP_CONTEXT {
  ...
  ULONG LockStateSignature;            // offset: 0x18 ordinal: 0x5
} _OBP_LOOKUP_CONTEXT;
...
typedef struct _MMSUPPORT {
  ...
  ULONG ChargedWslePages;                      // offset: 0x20 ordinal: 0x6
  ...
  ULONG ActualWslePages;                       // offset: 0x3c ordinal: 0xb
  ...
  struct _KGATE *ExitGate;                     // offset: 0x50 ordinal: 0xf
...
typedef struct _MI_SYSTEM_PTE_TYPE {
  ...
  ULONG Hint;                          // offset: 0x10 ordinal: 0x1
  struct _MMPTE *BasePte;              // offset: 0x18 ordinal: 0x2
  ULONG *FailureCount;                 // offset: 0x20 ordinal: 0x3
  struct _MMSUPPORT *Vm;               // offset: 0x28 ordinal: 0x4
  LONG TotalSystemPtes;                // offset: 0x30 ordinal: 0x5
  LONG TotalFreeSystemPtes;            // offset: 0x34 ordinal: 0x6
  LONG CachedPteCount;                 // offset: 0x38 ordinal: 0x7
  ULONG PteFailures;                   // offset: 0x3c ordinal: 0x8
  struct _KGUARDED_MUTEX *GlobalMutex; // offset: 0x40 ordinal: 0x9
} _MI_SYSTEM_PTE_TYPE;
...
typedef struct _PPM_PERF_STATES {
  ...
  union __anon_199 Flags;     // offset: 0x2c ordinal: 0xe
  ULONGLONG TargetProcessors; // offset: 0x30 ordinal: 0xf
  LONG(*PStateHandler)
  (ULONGLONG, ULONGLONG, ULONGLONG); // offset: 0x38 ordinal: 0x10
  ULONGLONG PStateContext;           // offset: 0x40 ordinal: 0x11
  LONG(*TStateHandler)
  (ULONGLONG, ULONGLONG, ULONGLONG); // offset: 0x48 ordinal: 0x12
  ULONGLONG TStateContext;           // offset: 0x50 ordinal: 0x13
  ULONG (*FeedbackHandler)(UCHAR);   // offset: 0x58 ordinal: 0x14
  struct _PPM_DIA_STATS *DiaStats;   // offset: 0x60 ordinal: 0x15
  ULONG DiaStatsCount;               // offset: 0x68 ordinal: 0x16
  struct _PPM_PERF_STATE State[1];   // offset: 0x70 ordinal: 0x17
} _PPM_PERF_STATES;
...
typedef struct _PPM_IDLE_STATES {
  ...
  union __anon_196 Flags;          // offset: 0x8 ordinal: 0x2
  ...
  struct _PPM_IDLE_STATE State[1]; // offset: 0x20 ordinal: 0x7
} _PPM_IDLE_STATES;
...
typedef union _SLIST_HEADER {
  ...
  struct __anon_118 Header8;   // offset: 0x0 ordinal: 0x2
  struct __anon_119 Header16;  // offset: 0x0 ordinal: 0x3
  struct __anon_120 HeaderX64; // offset: 0x0 ordinal: 0x4
} _SLIST_HEADER;

// 0x8 bytes (sizeof)
typedef struct __anon_112 {
  ULONGLONG LastIdleCheck; // offset: 0x0 ordinal: 0x0
} __anon_112;

// 0x8 bytes (sizeof)
typedef struct __anon_111 {
  ULONGLONG IdleTransitionTime; // offset: 0x0 ordinal: 0x0
} __anon_111;
...
typedef enum _EXCEPTION_DISPOSITION (*__anon_979)(struct _EXCEPTION_RECORD *,
...
typedef LONG (*__anon_1346)(struct _CM_PARTIAL_RESOURCE_DESCRIPTOR *,
                            ULONGLONG *, ULONGLONG *);

typedef LONG (*__anon_1344)(struct _IO_RESOURCE_DESCRIPTOR *, ULONGLONG *,
...
typedef LONG (*__anon_1359)(struct _ARBITER_INSTANCE *, ULONG,
                            struct _CM_PARTIAL_RESOURCE_DESCRIPTOR *,
                            struct _RTL_RANGE_LIST *);

typedef VOID (*__anon_1358)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_ALLOCATION_STATE *);

typedef UCHAR (*__anon_1357)(struct _ARBITER_INSTANCE *,
                             struct _ARBITER_ALLOCATION_STATE *);

typedef LONG (*__anon_1356)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_ALLOCATION_STATE *);

typedef LONG (*__anon_1355)(struct _ARBITER_INSTANCE *,
                            struct _CM_RESOURCE_LIST *);

typedef LONG (*__anon_1354)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_ADD_RESERVED_PARAMETERS *);

typedef LONG (*__anon_1353)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_QUERY_CONFLICT_PARAMETERS *);

typedef LONG (*__anon_1352)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_QUERY_ARBITRATE_PARAMETERS *);

typedef LONG (*__anon_1351)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_BOOT_ALLOCATION_PARAMETERS *);

typedef LONG (*__anon_1350)(struct _ARBITER_INSTANCE *);

typedef LONG (*__anon_1349)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_RETEST_ALLOCATION_PARAMETERS *);

typedef LONG (*__anon_1348)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_TEST_ALLOCATION_PARAMETERS *);
...
typedef UCHAR (*__anon_1276)(struct _KINTERRUPT *, VOID *, ULONG);

typedef UCHAR (*__anon_1275)(struct _KINTERRUPT *, VOID *);

typedef LONG (*__anon_1102)(VOID *, VOID **, ULONGLONG *);
...
typedef struct _WMI_LOGGER_CONTEXT {
  ...
  struct _WMI_BUFFER_HEADER *BatchedBufferList; // offset: 0x50 ordinal: 0x9
  struct _UNICODE_STRING LoggerName;            // offset: 0x58 ordinal: 0xa
  struct _UNICODE_STRING LogFileName;           // offset: 0x68 ordinal: 0xb
  struct _UNICODE_STRING LogFilePattern;        // offset: 0x78 ordinal: 0xc
  struct _UNICODE_STRING NewLogFileName;        // offset: 0x88 ordinal: 0xd
  ULONG ClockType;                              // offset: 0x98 ordinal: 0xe
  LONG CollectionOn;                            // offset: 0x9c ordinal: 0xf
  ULONG MaximumFileSize;                        // offset: 0xa0 ordinal: 0x10
  ULONG LoggerMode;                             // offset: 0xa4 ordinal: 0x11
  ULONG LastFlushedBuffer;                      // offset: 0xa8 ordinal: 0x12
  ULONG FlushTimer;                             // offset: 0xac ordinal: 0x13
  ULONG FlushThreshold;                         // offset: 0xb0 ordinal: 0x14
  union _LARGE_INTEGER ByteOffset;              // offset: 0xb8 ordinal: 0x15
  union _LARGE_INTEGER FlushTimeStamp;          // offset: 0xc0 ordinal: 0x16
  ULONG MinimumBuffers;                         // offset: 0xc8 ordinal: 0x17
  LONG BuffersAvailable;                        // offset: 0xcc ordinal: 0x18
  LONG NumberOfBuffers;                         // offset: 0xd0 ordinal: 0x19
  ULONG MaximumBuffers;                         // offset: 0xd4 ordinal: 0x1a
  ULONG EventsLost;                             // offset: 0xd8 ordinal: 0x1b
  ULONG BuffersWritten;                         // offset: 0xdc ordinal: 0x1c
  ULONG LogBuffersLost;                         // offset: 0xe0 ordinal: 0x1d
  ULONG RealTimeBuffersDelivered;               // offset: 0xe4 ordinal: 0x1e
  ULONG RealTimeBuffersLost;                    // offset: 0xe8 ordinal: 0x1f
  ULONG BufferSize;                             // offset: 0xec ordinal: 0x20
  ULONG MaximumEventSize;                       // offset: 0xf0 ordinal: 0x21
  LONG *SequencePtr;                            // offset: 0xf8 ordinal: 0x22
  ULONG LocalSequence;                          // offset: 0x100 ordinal: 0x23
  struct _GUID InstanceGuid;                    // offset: 0x104 ordinal: 0x24
  LONGLONG (*GetCpuClock)();                    // offset: 0x118 ordinal: 0x25
  LONG FileCounter;                             // offset: 0x120 ordinal: 0x26
  VOID(*BufferCallback)
  (struct _WMI_BUFFER_HEADER *, VOID *);       // offset: 0x128 ordinal: 0x27
  enum _POOL_TYPE PoolType;                    // offset: 0x130 ordinal: 0x28
  struct _ETW_REF_CLOCK ReferenceTime;         // offset: 0x138 ordinal: 0x29
  UCHAR RealtimeLoggerContextFreed;            // offset: 0x148 ordinal: 0x2a
  struct _LIST_ENTRY Consumers;                // offset: 0x150 ordinal: 0x2b
  ULONG NumConsumers;                          // offset: 0x160 ordinal: 0x2c
  struct _LIST_ENTRY Connecting;               // offset: 0x168 ordinal: 0x2d
  UCHAR NewConsumer;                           // offset: 0x178 ordinal: 0x2e
  VOID *RealtimeLogfileHandle;                 // offset: 0x180 ordinal: 0x2f
  struct _UNICODE_STRING RealtimeLogfileName;  // offset: 0x188 ordinal: 0x30
  union _LARGE_INTEGER RealtimeWriteOffset;    // offset: 0x198 ordinal: 0x31
  union _LARGE_INTEGER RealtimeReadOffset;     // offset: 0x1a0 ordinal: 0x32
  union _LARGE_INTEGER RealtimeLogfileSize;    // offset: 0x1a8 ordinal: 0x33
  ULONGLONG RealtimeLogfileUsage;              // offset: 0x1b0 ordinal: 0x34
  ULONGLONG RealtimeMaximumFileSize;           // offset: 0x1b8 ordinal: 0x35
  ULONG RealtimeBuffersSaved;                  // offset: 0x1c0 ordinal: 0x36
  struct _ETW_REF_CLOCK RealtimeReferenceTime; // offset: 0x1c8 ordinal: 0x37
  ULONG RealtimeDisconnectProcessId;           // offset: 0x1d8 ordinal: 0x38
  ULONG RealtimeDisconnectConsumerId;          // offset: 0x1dc ordinal: 0x39
  enum _ETW_RT_EVENT_LOSS NewRTEventsLost;     // offset: 0x1e0 ordinal: 0x3a
  struct _KEVENT LoggerEvent;                  // offset: 0x1e8 ordinal: 0x3b
  struct _KEVENT FlushEvent;                   // offset: 0x200 ordinal: 0x3c
  struct _KDPC FlushDpc;                       // offset: 0x218 ordinal: 0x3d
  struct _KMUTANT LoggerMutex;                 // offset: 0x258 ordinal: 0x3e
  struct _EX_PUSH_LOCK LoggerLock;             // offset: 0x290 ordinal: 0x3f
  struct _SECURITY_CLIENT_CONTEXT
      ClientSecurityContext;                      // offset: 0x298 ordinal: 0x40
  struct _EX_FAST_REF SecurityDescriptor;         // offset: 0x2e0 ordinal: 0x41
  struct _WMI_BUFFER_HEADER DummyBufferForMarker; // offset: 0x2e8 ordinal: 0x42
  LONGLONG BufferSequenceNumber;                  // offset: 0x330 ordinal: 0x43
  LONG AcceptNewEvents;                           // offset: 0x338 ordinal: 0x44
  union {
    ULONG Flags;          // offset: 0x33c ordinal: 0x45
    ULONG Persistent : 1; // offset: 0x33c ordinal: 0x46
  };
  ULONG AutoLogger : 1;   // offset: 0x33c ordinal: 0x47
  ULONG FsReady : 1;      // offset: 0x33c ordinal: 0x48
  ULONG RealTime : 1;     // offset: 0x33c ordinal: 0x49
  ULONG Wow : 1;          // offset: 0x33c ordinal: 0x4a
  ULONG KernelTrace : 1;  // offset: 0x33c ordinal: 0x4b
  ULONG NoMoreEnable : 1; // offset: 0x33c ordinal: 0x4c
  union {
    ULONG RequestFlag;       // offset: 0x340 ordinal: 0x4d
    ULONG RequestNewFie : 1; // offset: 0x340 ordinal: 0x4e
  };
  ULONG RequestUpdateFile : 1;         // offset: 0x340 ordinal: 0x4f
  ULONG RequestFlush : 1;              // offset: 0x340 ordinal: 0x50
  ULONG RequestDisableRealtime : 1;    // offset: 0x340 ordinal: 0x51
  ULONG RequestDisconnectConsumer : 1; // offset: 0x340 ordinal: 0x52
  USHORT StackTraceFilterHookCount;    // offset: 0x344 ordinal: 0x53
  USHORT StackTraceFilter[16];         // offset: 0x346 ordinal: 0x54
} _WMI_LOGGER_CONTEXT;
...
typedef struct _KUSER_SHARED_DATA {
  ...
  ULONG DbgSystemDllRelocated : 1;     // offset: 0x2f0 ordinal: 0x25
  ULONG DbgDynProcessorEnabled : 1;    // offset: 0x2f0 ordinal: 0x26
  ULONG DbgSEHValidationEnabled : 1;   // offset: 0x2f0 ordinal: 0x27
  ULONG SpareBits : 25;                // offset: 0x2f0 ordinal: 0x28
  ULONGLONG TestRetInstruction;        // offset: 0x2f8 ordinal: 0x29
  ULONG SystemCall;                    // offset: 0x300 ordinal: 0x2a
  ULONG SystemCallReturn;              // offset: 0x304 ordinal: 0x2b
  ULONGLONG SystemCallPad[3];          // offset: 0x308 ordinal: 0x2c
  union {
    struct _KSYSTEM_TIME TickCount; // offset: 0x320 ordinal: 0x2d
    ULONGLONG TickCountQuad;        // offset: 0x320 ordinal: 0x2e
  };
  ULONG Cookie;                               // offset: 0x330 ordinal: 0x2f
  LONGLONG ConsoleSessionForegroundProcessId; // offset: 0x338 ordinal: 0x30
  ULONG Wow64SharedInformation[16];           // offset: 0x340 ordinal: 0x31
  USHORT UserModeGlobalLogger[8];             // offset: 0x380 ordinal: 0x32
  ULONG HeapTracingPid[2];                    // offset: 0x390 ordinal: 0x33
  ULONG CritSecTracingPid[2];                 // offset: 0x398 ordinal: 0x34
  ULONG ImageFileExecutionOptions;            // offset: 0x3a0 ordinal: 0x35
  ULONG LangGenerationCount;                  // offset: 0x3a4 ordinal: 0x36
  union {
    ULONGLONG AffinityPad;             // offset: 0x3a8 ordinal: 0x37
    ULONGLONG ActiveProcessorAffinity; // offset: 0x3a8 ordinal: 0x38
  };
  ULONGLONG InterruptTimeBias; // offset: 0x3b0 ordinal: 0x39
} _KUSER_SHARED_DATA;
...
typedef struct PO_MEMORY_IMAGE {
  ...
  ULONG FirmwareRuntimeInformationPages;   // offset: 0xd0 ordinal: 0x14
  ULONGLONG FirmwareRuntimeInformation[1]; // offset: 0xd8 ordinal: 0x15
  ULONG NoBootLoaderLogPages;              // offset: 0xe0 ordinal: 0x16
  ULONGLONG BootLoaderLogPages[8];         // offset: 0xe8 ordinal: 0x17
  ULONG NotUsed;                           // offset: 0x128 ordinal: 0x18
  ULONG ResumeContextCheck;                // offset: 0x12c ordinal: 0x19
  ULONG ResumeContextPages;                // offset: 0x130 ordinal: 0x1a
} PO_MEMORY_IMAGE;
...
typedef struct _POP_HIBER_CONTEXT {
  ...
  ULONG IoPagesCount;                         // offset: 0x80 ordinal: 0x13
  VOID *CurrentMcb;                           // offset: 0x88 ordinal: 0x14
  struct _DUMP_STACK_CONTEXT *DumpStack;      // offset: 0x90 ordinal: 0x15
  struct _KPROCESSOR_STATE *WakeState;        // offset: 0x98 ordinal: 0x16
  ULONGLONG HiberVa;                          // offset: 0xa0 ordinal: 0x17
  union _LARGE_INTEGER HiberPte;              // offset: 0xa8 ordinal: 0x18
  LONG Status;                                // offset: 0xb0 ordinal: 0x19
  struct PO_MEMORY_IMAGE *MemoryImage;        // offset: 0xb8 ordinal: 0x1a
  struct _PO_MEMORY_RANGE_TABLE *TableHead;   // offset: 0xc0 ordinal: 0x1b
  UCHAR *CompressionWorkspace;                // offset: 0xc8 ordinal: 0x1c
  UCHAR *CompressedWriteBuffer;               // offset: 0xd0 ordinal: 0x1d
  ULONG *PerformanceStats;                    // offset: 0xd8 ordinal: 0x1e
  VOID *CompressionBlock;                     // offset: 0xe0 ordinal: 0x1f
  VOID *DmaIO;                                // offset: 0xe8 ordinal: 0x20
  VOID *TemporaryHeap;                        // offset: 0xf0 ordinal: 0x21
  struct _PO_HIBER_PERF PerfInfo;             // offset: 0xf8 ordinal: 0x22
  struct _MDL *BootLoaderLogMdl;              // offset: 0x158 ordinal: 0x23
  struct _MDL *FirmwareRuntimeInformationMdl; // offset: 0x160 ordinal: 0x24
  VOID *ResumeContext;                        // offset: 0x168 ordinal: 0x25
  ULONG ResumeContextPages;                   // offset: 0x170 ordinal: 0x26
} _POP_HIBER_CONTEXT;
...
typedef struct _POP_POWER_ACTION {
  ...
  struct SYSTEM_POWER_CAPABILITIES
      FilteredCapabilities; // offset: 0x60 ordinal: 0x15
} _POP_POWER_ACTION;
...
typedef UCHAR (*__anon_346)(struct _FILE_OBJECT *, union _LARGE_INTEGER *,
                            ULONG, ULONG, struct _MDL **,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_344)(struct _FILE_OBJECT *, UCHAR,
                            struct _FILE_NETWORK_OPEN_INFORMATION *,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_341)(struct _FILE_OBJECT *, UCHAR, VOID *, ULONG, VOID *,
                            ULONG, ULONG, struct _IO_STATUS_BLOCK *,
                            struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_340)(struct _FILE_OBJECT *, VOID *, ULONG,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);
...
typedef struct _DEVICE_NODE {
  ...
  union __anon_989 OverUsed1;              // offset: 0x198 ordinal: 0x25
  union __anon_998 OverUsed2;              // offset: 0x1a0 ordinal: 0x26
  ...
  struct __anon_999 DockInfo;                 // offset: 0x1c0 ordinal: 0x2a
...
typedef LONG (*__anon_434)(struct _DEVICE_OBJECT *, struct _IRP *, VOID *);
...
typedef struct _IO_STACK_LOCATION {
  ...
  union __anon_380 Parameters;         // offset: 0x8 ordinal: 0x4
  struct _DEVICE_OBJECT *DeviceObject; // offset: 0x28 ordinal: 0x5
...
typedef UCHAR (*__anon_350)(struct _IRP *,
                            struct _FILE_NETWORK_OPEN_INFORMATION *,
                            struct _DEVICE_OBJECT *);
...
typedef struct _PEB32 {
  ...
  ULONG ReservedBits0 : 28;      // offset: 0x28 ordinal: 0x18
  union {
    ULONG KernelCallbackTable; // offset: 0x2c ordinal: 0x19
    ULONG UserSharedInfoPtr;   // offset: 0x2c ordinal: 0x1a
  };
  ULONG SystemReserved[1];                     // offset: 0x30 ordinal: 0x1b
  ULONG SpareUlong;                            // offset: 0x34 ordinal: 0x1c
  ULONG SparePebPtr0;                          // offset: 0x38 ordinal: 0x1d
  ULONG TlsExpansionCounter;                   // offset: 0x3c ordinal: 0x1e
  ULONG TlsBitmap;                             // offset: 0x40 ordinal: 0x1f
  ULONG TlsBitmapBits[2];                      // offset: 0x44 ordinal: 0x20
  ULONG ReadOnlySharedMemoryBase;              // offset: 0x4c ordinal: 0x21
  ULONG HotpatchInformation;                   // offset: 0x50 ordinal: 0x22
  ULONG ReadOnlyStaticServerData;              // offset: 0x54 ordinal: 0x23
  ULONG AnsiCodePageData;                      // offset: 0x58 ordinal: 0x24
  ULONG OemCodePageData;                       // offset: 0x5c ordinal: 0x25
  ULONG UnicodeCaseTableData;                  // offset: 0x60 ordinal: 0x26
  ULONG NumberOfProcessors;                    // offset: 0x64 ordinal: 0x27
  ULONG NtGlobalFlag;                          // offset: 0x68 ordinal: 0x28
  union _LARGE_INTEGER CriticalSectionTimeout; // offset: 0x70 ordinal: 0x29
  ULONG HeapSegmentReserve;                    // offset: 0x78 ordinal: 0x2a
  ULONG HeapSegmentCommit;                     // offset: 0x7c ordinal: 0x2b
  ULONG HeapDeCommitTotalFreeThreshold;        // offset: 0x80 ordinal: 0x2c
  ULONG HeapDeCommitFreeBlockThreshold;        // offset: 0x84 ordinal: 0x2d
  ULONG NumberOfHeaps;                         // offset: 0x88 ordinal: 0x2e
  ULONG MaximumNumberOfHeaps;                  // offset: 0x8c ordinal: 0x2f
  ULONG ProcessHeaps;                          // offset: 0x90 ordinal: 0x30
  ULONG GdiSharedHandleTable;                  // offset: 0x94 ordinal: 0x31
  ULONG ProcessStarterHelper;                  // offset: 0x98 ordinal: 0x32
  ULONG GdiDCAttributeList;                    // offset: 0x9c ordinal: 0x33
  ULONG LoaderLock;                            // offset: 0xa0 ordinal: 0x34
  ULONG OSMajorVersion;                        // offset: 0xa4 ordinal: 0x35
  ULONG OSMinorVersion;                        // offset: 0xa8 ordinal: 0x36
  USHORT OSBuildNumber;                        // offset: 0xac ordinal: 0x37
  USHORT OSCSDVersion;                         // offset: 0xae ordinal: 0x38
  ULONG OSPlatformId;                          // offset: 0xb0 ordinal: 0x39
  ULONG ImageSubsystem;                        // offset: 0xb4 ordinal: 0x3a
  ULONG ImageSubsystemMajorVersion;            // offset: 0xb8 ordinal: 0x3b
  ULONG ImageSubsystemMinorVersion;            // offset: 0xbc ordinal: 0x3c
  ULONG ActiveProcessAffinityMask;             // offset: 0xc0 ordinal: 0x3d
  ULONG GdiHandleBuffer[34];                   // offset: 0xc4 ordinal: 0x3e
  ULONG PostProcessInitRoutine;                // offset: 0x14c ordinal: 0x3f
  ULONG TlsExpansionBitmap;                    // offset: 0x150 ordinal: 0x40
  ULONG TlsExpansionBitmapBits[32];            // offset: 0x154 ordinal: 0x41
  ULONG SessionId;                             // offset: 0x1d4 ordinal: 0x42
  union _ULARGE_INTEGER AppCompatFlags;        // offset: 0x1d8 ordinal: 0x43
  union _ULARGE_INTEGER AppCompatFlagsUser;    // offset: 0x1e0 ordinal: 0x44
  ULONG pShimData;                             // offset: 0x1e8 ordinal: 0x45
  ULONG AppCompatInfo;                         // offset: 0x1ec ordinal: 0x46
  struct _STRING32 CSDVersion;                 // offset: 0x1f0 ordinal: 0x47
  ULONG ActivationContextData;                 // offset: 0x1f8 ordinal: 0x48
  ULONG ProcessAssemblyStorageMap;             // offset: 0x1fc ordinal: 0x49
  ULONG SystemDefaultActivationContextData;    // offset: 0x200 ordinal: 0x4a
  ULONG SystemAssemblyStorageMap;              // offset: 0x204 ordinal: 0x4b
  ULONG MinimumStackCommit;                    // offset: 0x208 ordinal: 0x4c
  ULONG FlsCallback;                           // offset: 0x20c ordinal: 0x4d
  struct LIST_ENTRY32 FlsListHead;             // offset: 0x210 ordinal: 0x4e
  ULONG FlsBitmap;                             // offset: 0x218 ordinal: 0x4f
  ULONG FlsBitmapBits[4];                      // offset: 0x21c ordinal: 0x50
  ULONG FlsHighIndex;                          // offset: 0x22c ordinal: 0x51
  ULONG WerRegistrationData;                   // offset: 0x230 ordinal: 0x52
  ULONG WerShipAssertPtr;                      // offset: 0x234 ordinal: 0x53
} _PEB32;
...
typedef struct _PEB {
  ...
  ULONG ReservedBits0 : 28;      // offset: 0x50 ordinal: 0x18
  union {
    VOID *KernelCallbackTable; // offset: 0x58 ordinal: 0x19
    VOID *UserSharedInfoPtr;   // offset: 0x58 ordinal: 0x1a
  };
  ULONG SystemReserved[1];                     // offset: 0x60 ordinal: 0x1b
  ULONG SpareUlong;                            // offset: 0x64 ordinal: 0x1c
  ULONGLONG SparePebPtr0;                      // offset: 0x68 ordinal: 0x1d
  ULONG TlsExpansionCounter;                   // offset: 0x70 ordinal: 0x1e
  VOID *TlsBitmap;                             // offset: 0x78 ordinal: 0x1f
  ULONG TlsBitmapBits[2];                      // offset: 0x80 ordinal: 0x20
  VOID *ReadOnlySharedMemoryBase;              // offset: 0x88 ordinal: 0x21
  VOID *HotpatchInformation;                   // offset: 0x90 ordinal: 0x22
  VOID **ReadOnlyStaticServerData;             // offset: 0x98 ordinal: 0x23
  VOID *AnsiCodePageData;                      // offset: 0xa0 ordinal: 0x24
  VOID *OemCodePageData;                       // offset: 0xa8 ordinal: 0x25
  VOID *UnicodeCaseTableData;                  // offset: 0xb0 ordinal: 0x26
  ULONG NumberOfProcessors;                    // offset: 0xb8 ordinal: 0x27
  ULONG NtGlobalFlag;                          // offset: 0xbc ordinal: 0x28
  union _LARGE_INTEGER CriticalSectionTimeout; // offset: 0xc0 ordinal: 0x29
  ULONGLONG HeapSegmentReserve;                // offset: 0xc8 ordinal: 0x2a
  ULONGLONG HeapSegmentCommit;                 // offset: 0xd0 ordinal: 0x2b
  ULONGLONG HeapDeCommitTotalFreeThreshold;    // offset: 0xd8 ordinal: 0x2c
  ULONGLONG HeapDeCommitFreeBlockThreshold;    // offset: 0xe0 ordinal: 0x2d
  ULONG NumberOfHeaps;                         // offset: 0xe8 ordinal: 0x2e
  ULONG MaximumNumberOfHeaps;                  // offset: 0xec ordinal: 0x2f
  VOID **ProcessHeaps;                         // offset: 0xf0 ordinal: 0x30
  VOID *GdiSharedHandleTable;                  // offset: 0xf8 ordinal: 0x31
  VOID *ProcessStarterHelper;                  // offset: 0x100 ordinal: 0x32
  ULONG GdiDCAttributeList;                    // offset: 0x108 ordinal: 0x33
  struct _RTL_CRITICAL_SECTION *LoaderLock;    // offset: 0x110 ordinal: 0x34
  ULONG OSMajorVersion;                        // offset: 0x118 ordinal: 0x35
  ULONG OSMinorVersion;                        // offset: 0x11c ordinal: 0x36
  USHORT OSBuildNumber;                        // offset: 0x120 ordinal: 0x37
  USHORT OSCSDVersion;                         // offset: 0x122 ordinal: 0x38
  ULONG OSPlatformId;                          // offset: 0x124 ordinal: 0x39
  ULONG ImageSubsystem;                        // offset: 0x128 ordinal: 0x3a
  ULONG ImageSubsystemMajorVersion;            // offset: 0x12c ordinal: 0x3b
  ULONG ImageSubsystemMinorVersion;            // offset: 0x130 ordinal: 0x3c
  ULONGLONG ActiveProcessAffinityMask;         // offset: 0x138 ordinal: 0x3d
  ULONG GdiHandleBuffer[60];                   // offset: 0x140 ordinal: 0x3e
  VOID (*PostProcessInitRoutine)();            // offset: 0x230 ordinal: 0x3f
  VOID *TlsExpansionBitmap;                    // offset: 0x238 ordinal: 0x40
  ULONG TlsExpansionBitmapBits[32];            // offset: 0x240 ordinal: 0x41
  ULONG SessionId;                             // offset: 0x2c0 ordinal: 0x42
  union _ULARGE_INTEGER AppCompatFlags;        // offset: 0x2c8 ordinal: 0x43
  union _ULARGE_INTEGER AppCompatFlagsUser;    // offset: 0x2d0 ordinal: 0x44
  VOID *pShimData;                             // offset: 0x2d8 ordinal: 0x45
  VOID *AppCompatInfo;                         // offset: 0x2e0 ordinal: 0x46
  struct _UNICODE_STRING CSDVersion;           // offset: 0x2e8 ordinal: 0x47
  struct _ACTIVATION_CONTEXT_DATA
      *ActivationContextData; // offset: 0x2f8 ordinal: 0x48
  struct _ASSEMBLY_STORAGE_MAP
      *ProcessAssemblyStorageMap; // offset: 0x300 ordinal: 0x49
  struct _ACTIVATION_CONTEXT_DATA
      *SystemDefaultActivationContextData; // offset: 0x308 ordinal: 0x4a
  struct _ASSEMBLY_STORAGE_MAP
      *SystemAssemblyStorageMap;          // offset: 0x310 ordinal: 0x4b
  ULONGLONG MinimumStackCommit;           // offset: 0x318 ordinal: 0x4c
  struct _FLS_CALLBACK_INFO *FlsCallback; // offset: 0x320 ordinal: 0x4d
  struct _LIST_ENTRY FlsListHead;         // offset: 0x328 ordinal: 0x4e
  VOID *FlsBitmap;                        // offset: 0x338 ordinal: 0x4f
  ULONG FlsBitmapBits[4];                 // offset: 0x340 ordinal: 0x50
  ULONG FlsHighIndex;                     // offset: 0x350 ordinal: 0x51
  VOID *WerRegistrationData;              // offset: 0x358 ordinal: 0x52
  VOID *WerShipAssertPtr;                 // offset: 0x360 ordinal: 0x53
} _PEB;
...
typedef struct _TEB {
  ...
  USHORT RtlDisableUserStackWalk : 1;    // offset: 0x17ee ordinal: 0x59
  USHORT RtlExceptionAttached : 1;       // offset: 0x17ee ordinal: 0x5a
  USHORT SpareSameTebBits : 6;           // offset: 0x17ee ordinal: 0x5b
  VOID *TxnScopeEnterCallback;           // offset: 0x17f0 ordinal: 0x5c
  VOID *TxnScopeExitCallback;            // offset: 0x17f8 ordinal: 0x5d
  VOID *TxnScopeContext;                 // offset: 0x1800 ordinal: 0x5e
  ULONG LockCount;                       // offset: 0x1808 ordinal: 0x5f
  ULONG ProcessRundown;                  // offset: 0x180c ordinal: 0x60
  ULONGLONG LastSwitchTime;              // offset: 0x1810 ordinal: 0x61
  ULONGLONG TotalSwitchOutTime;          // offset: 0x1818 ordinal: 0x62
  union _LARGE_INTEGER WaitReasonBitMap; // offset: 0x1820 ordinal: 0x63
} _TEB;
...
typedef struct _EPROCESS {
  ...
  VOID *Spare;                                // offset: 0x200 ordinal: 0x25
  ...
  VOID *Wow64Process;                       // offset: 0x278 ordinal: 0x32
  ...
  ULONG AffinityPermanent : 1;          // offset: 0x36c ordinal: 0x57
  ULONG AffinityUpdateEnable : 1;       // offset: 0x36c ordinal: 0x58
  ULONG CrossSessionCreate : 1;         // offset: 0x36c ordinal: 0x59
  union {
    ULONG Flags;              // offset: 0x370 ordinal: 0x5a
    ULONG CreateReported : 1; // offset: 0x370 ordinal: 0x5b
  };
  ULONG NoDebugInherit : 1;                 // offset: 0x370 ordinal: 0x5c
  ULONG ProcessExiting : 1;                 // offset: 0x370 ordinal: 0x5d
  ULONG ProcessDelete : 1;                  // offset: 0x370 ordinal: 0x5e
  ULONG Wow64SplitPages : 1;                // offset: 0x370 ordinal: 0x5f
  ULONG VmDeleted : 1;                      // offset: 0x370 ordinal: 0x60
  ULONG OutswapEnabled : 1;                 // offset: 0x370 ordinal: 0x61
  ULONG Outswapped : 1;                     // offset: 0x370 ordinal: 0x62
  ULONG ForkFailed : 1;                     // offset: 0x370 ordinal: 0x63
  ULONG Wow64VaSpace4Gb : 1;                // offset: 0x370 ordinal: 0x64
  ULONG AddressSpaceInitialized : 2;        // offset: 0x370 ordinal: 0x65
  ULONG SetTimerResolution : 1;             // offset: 0x370 ordinal: 0x66
  ULONG BreakOnTermination : 1;             // offset: 0x370 ordinal: 0x67
  ULONG DeprioritizeViews : 1;              // offset: 0x370 ordinal: 0x68
  ULONG WriteWatch : 1;                     // offset: 0x370 ordinal: 0x69
  ULONG ProcessInSession : 1;               // offset: 0x370 ordinal: 0x6a
  ULONG OverrideAddressSpace : 1;           // offset: 0x370 ordinal: 0x6b
  ULONG HasAddressSpace : 1;                // offset: 0x370 ordinal: 0x6c
  ULONG LaunchPrefetched : 1;               // offset: 0x370 ordinal: 0x6d
  ULONG InjectInpageErrors : 1;             // offset: 0x370 ordinal: 0x6e
  ULONG VmTopDown : 1;                      // offset: 0x370 ordinal: 0x6f
  ULONG ImageNotifyDone : 1;                // offset: 0x370 ordinal: 0x70
  ULONG PdeUpdateNeeded : 1;                // offset: 0x370 ordinal: 0x71
  ULONG VdmAllowed : 1;                     // offset: 0x370 ordinal: 0x72
  ULONG SmapAllowed : 1;                    // offset: 0x370 ordinal: 0x73
  ULONG ProcessInserted : 1;                // offset: 0x370 ordinal: 0x74
  ULONG DefaultIoPriority : 3;              // offset: 0x370 ordinal: 0x75
  ULONG ProcessSelfDelete : 1;              // offset: 0x370 ordinal: 0x76
  ULONG SpareProcessFlags : 1;              // offset: 0x370 ordinal: 0x77
  LONG ExitStatus;                          // offset: 0x374 ordinal: 0x78
  USHORT Spare7;                            // offset: 0x378 ordinal: 0x79
  UCHAR SubSystemMinorVersion;              // offset: 0x37a ordinal: 0x7a
  UCHAR SubSystemMajorVersion;              // offset: 0x37b ordinal: 0x7b
  USHORT SubSystemVersion;                  // offset: 0x37a ordinal: 0x7c
  UCHAR PriorityClass;                      // offset: 0x37c ordinal: 0x7d
  struct _MM_AVL_TABLE VadRoot;             // offset: 0x380 ordinal: 0x7e
  ULONG Cookie;                             // offset: 0x3c0 ordinal: 0x7f
  struct _ALPC_PROCESS_CONTEXT AlpcContext; // offset: 0x3c8 ordinal: 0x80
} _EPROCESS;
...
typedef struct _KALPC_SECURITY_DATA {
  ...
  union __anon_1198 u1;                            // offset: 0x68 ordinal: 0x5
...
typedef struct _KALPC_SECTION {
  union __anon_1159 u1;                   // offset: 0x0 ordinal: 0x0
  VOID *SectionObject;                    // offset: 0x8 ordinal: 0x1
  ULONGLONG Size;                         // offset: 0x10 ordinal: 0x2
  struct _ALPC_HANDLE_TABLE *HandleTable; // offset: 0x18 ordinal: 0x3
  VOID *SectionHandle;                    // offset: 0x20 ordinal: 0x4
  struct _EPROCESS *OwnerProcess;         // offset: 0x28 ordinal: 0x5
  struct _ALPC_PORT *OwnerPort;           // offset: 0x30 ordinal: 0x6
  ULONG NumberOfRegions;                  // offset: 0x38 ordinal: 0x7
  struct _LIST_ENTRY RegionListHead;      // offset: 0x40 ordinal: 0x8
} _KALPC_SECTION;

// 0x60 bytes (sizeof)
typedef struct _KALPC_REGION {
  union __anon_1207 u1;               // offset: 0x0 ordinal: 0x0
  struct _LIST_ENTRY RegionListEntry; // offset: 0x8 ordinal: 0x1
  struct _KALPC_SECTION *Section;     // offset: 0x18 ordinal: 0x2
  ULONGLONG Offset;                   // offset: 0x20 ordinal: 0x3
  ULONGLONG Size;                     // offset: 0x28 ordinal: 0x4
  ULONGLONG ViewSize;                 // offset: 0x30 ordinal: 0x5
  struct _KALPC_VIEW *ReadOnlyView;   // offset: 0x38 ordinal: 0x6
  struct _KALPC_VIEW *ReadWriteView;  // offset: 0x40 ordinal: 0x7
  ULONG NumberOfViews;                // offset: 0x48 ordinal: 0x8
  struct _LIST_ENTRY ViewListHead;    // offset: 0x50 ordinal: 0x9
} _KALPC_REGION;

// 0x68 bytes (sizeof)
typedef struct _KALPC_VIEW {
  struct _LIST_ENTRY ViewListEntry;        // offset: 0x0 ordinal: 0x0
  union __anon_1199 u1;                    // offset: 0x10 ordinal: 0x1
  struct _KALPC_REGION *Region;            // offset: 0x18 ordinal: 0x2
  struct _ALPC_PORT *OwnerPort;            // offset: 0x20 ordinal: 0x3
  struct _EPROCESS *OwnerProcess;          // offset: 0x28 ordinal: 0x4
  VOID *Address;                           // offset: 0x30 ordinal: 0x5
  ULONGLONG Size;                          // offset: 0x38 ordinal: 0x6
  VOID *SecureViewHandle;                  // offset: 0x40 ordinal: 0x7
  VOID *WriteAccessHandle;                 // offset: 0x48 ordinal: 0x8
  ULONG NumberOfOwnerMessages;             // offset: 0x50 ordinal: 0x9
  struct _LIST_ENTRY ProcessViewListEntry; // offset: 0x58 ordinal: 0xa
} _KALPC_VIEW;
...
typedef struct _SEGMENT {
  ...
  struct _EX_PUSH_LOCK SegmentLock; // offset: 0x28 ordinal: 0x7
  union __anon_778 u1;              // offset: 0x30 ordinal: 0x8
  union __anon_779 u2;              // offset: 0x38 ordinal: 0x9
...
typedef struct _CONTROL_AREA {
  ...
  union __anon_752 u;                  // offset: 0x38 ordinal: 0x6
  union __anon_756 u1;                 // offset: 0x3c ordinal: 0x7
  struct _EX_FAST_REF FilePointer;     // offset: 0x40 ordinal: 0x8
  LONG ControlAreaLock;                // offset: 0x48 ordinal: 0x9
  ULONG StartingFrame;                 // offset: 0x4c ordinal: 0xa
  struct _MI_SECTION_CREATION_GATE
      *WaitingForDeletion; // offset: 0x50 ordinal: 0xb
  union __anon_768 u2;     // offset: 0x58 ordinal: 0xc
  LONGLONG LockedPages;    // offset: 0x68 ordinal: 0xd
} _CONTROL_AREA;
...
typedef UCHAR (*__anon_611)(struct _EPROCESS *, VOID *, VOID *, CHAR);

typedef VOID (*__anon_607)(struct _EPROCESS *, VOID *, ULONG, ULONGLONG,
                           ULONGLONG);

typedef LONG (*__anon_606)(enum _OB_OPEN_REASON, CHAR, struct _EPROCESS *,
                           VOID *, ULONG *, ULONG);
...
typedef struct _OBJECT_TYPE {
  ...
  ULONG Index;                              // offset: 0x28 ordinal: 0x3
  ...
  struct _ERESOURCE Mutex;                  // offset: 0xb0 ordinal: 0x9
  struct _EX_PUSH_LOCK TypeLock;            // offset: 0x118 ordinal: 0xa
  ULONG Key;                                // offset: 0x120 ordinal: 0xb
  struct _EX_PUSH_LOCK ObjectLocks[32];     // offset: 0x128 ordinal: 0xc
  struct _LIST_ENTRY CallbackList;          // offset: 0x228 ordinal: 0xd
} _OBJECT_TYPE;
...
typedef struct _OB_DUPLICATE_OBJECT_STATE {
  ...
  struct _OBJECT_TYPE *ObjectType;            // offset: 0x18 ordinal: 0x3
  ULONG TargetAccess;                         // offset: 0x20 ordinal: 0x4
  struct _HANDLE_TABLE_ENTRY_INFO ObjectInfo; // offset: 0x24 ordinal: 0x5
  ULONG HandleAttributes;                     // offset: 0x28 ordinal: 0x6
...
typedef struct _KALPC_MESSAGE {
  ...
  union __anon_1181 u1;                         // offset: 0x2c ordinal: 0x6
  ...
  struct _HANDLE_TABLE_ENTRY *UniqueTableEntry; // offset: 0x78 ordinal: 0xf
  struct _KALPC_MESSAGE_ATTRIBUTES
      MessageAttributes; // offset: 0x80 ordinal: 0x10
  VOID *DataUserVa;      // offset: 0xb8 ordinal: 0x11
  VOID *DataSystemVa;    // offset: 0xc0 ordinal: 0x12
  struct _ALPC_COMMUNICATION_INFO
      *CommunicationInfo;            // offset: 0xc8 ordinal: 0x13
  struct _ALPC_PORT *ConnectionPort; // offset: 0xd0 ordinal: 0x14
  struct _ETHREAD *ServerThread;     // offset: 0xd8 ordinal: 0x15
...
typedef struct _ALPC_DISPATCH_CONTEXT {
  ...
  struct _ETHREAD *TargetThread; // offset: 0x20 ordinal: 0x4
  struct _ALPC_PORT *TargetPort; // offset: 0x28 ordinal: 0x5
  USHORT TotalLength;            // offset: 0x30 ordinal: 0x6
  USHORT Type;                   // offset: 0x32 ordinal: 0x7
  USHORT DataInfoOffset;         // offset: 0x34 ordinal: 0x8
...
typedef struct _ALPC_PORT {
  ...
  ULONG SequenceNo;               // offset: 0x20 ordinal: 0x3
  VOID *CompletionPort;           // offset: 0x28 ordinal: 0x4
  VOID *CompletionKey;            // offset: 0x30 ordinal: 0x5
  struct _ALPC_COMPLETION_PACKET_LOOKASIDE
      *CompletionPacketLookaside;                 // offset: 0x38 ordinal: 0x6
  VOID *PortContext;                              // offset: 0x40 ordinal: 0x7
  struct _SECURITY_CLIENT_CONTEXT StaticSecurity; // offset: 0x48 ordinal: 0x8
  struct _LIST_ENTRY MainQueue;                   // offset: 0x90 ordinal: 0x9
  struct _LIST_ENTRY PendingQueue;                // offset: 0xa0 ordinal: 0xa
  struct _LIST_ENTRY LargeMessageQueue;           // offset: 0xb0 ordinal: 0xb
  struct _LIST_ENTRY WaitQueue;                   // offset: 0xc0 ordinal: 0xc
  union {
    struct _KSEMAPHORE *Semaphore; // offset: 0xd0 ordinal: 0xd
    struct _KEVENT *DummyEvent;    // offset: 0xd0 ordinal: 0xe
  };
  struct _EX_PUSH_LOCK Lock;                    // offset: 0xd8 ordinal: 0xf
  struct _ALPC_PORT_ATTRIBUTES PortAttributes;  // offset: 0xe0 ordinal: 0x10
  struct _EX_PUSH_LOCK ResourceListLock;        // offset: 0x128 ordinal: 0x11
  struct _LIST_ENTRY ResourceListHead;          // offset: 0x130 ordinal: 0x12
  struct _ALPC_COMPLETION_LIST *CompletionList; // offset: 0x140 ordinal: 0x13
  struct _ALPC_MESSAGE_ZONE *MessageZone;       // offset: 0x148 ordinal: 0x14
  struct _LIST_ENTRY CanceledQueue;             // offset: 0x150 ordinal: 0x15
  union __anon_1171 u1;                         // offset: 0x160 ordinal: 0x16
  struct _ALPC_PORT *TargetQueuePort;           // offset: 0x168 ordinal: 0x17
  struct _ALPC_PORT *TargetSequencePort;        // offset: 0x170 ordinal: 0x18
  struct _KALPC_MESSAGE *Message;               // offset: 0x178 ordinal: 0x19
  ULONG MainQueueLength;                        // offset: 0x180 ordinal: 0x1a
  ULONG PendingQueueLength;                     // offset: 0x184 ordinal: 0x1b
  ULONG LargeMessageQueueLength;                // offset: 0x188 ordinal: 0x1c
  ULONG CanceledQueueLength;                    // offset: 0x18c ordinal: 0x1d
  ULONG WaitQueueLength;                        // offset: 0x190 ordinal: 0x1e
} _ALPC_PORT;
...
typedef UCHAR (*__anon_339)(struct _FILE_OBJECT *, struct _EPROCESS *,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);
...
typedef LONG (*__anon_330)(struct _DRIVER_OBJECT *, struct _DEVICE_OBJECT *);
...
typedef struct _MM_SESSION_SPACE {
  ...
  union __anon_1503 u;                            // offset: 0x4 ordinal: 0x1
  ...
  struct _KGATE AttachGate;                       // offset: 0x90 ordinal: 0x13
  ...
  struct _MI_SYSTEM_PTE_TYPE SystemPteInfo; // offset: 0x1d90 ordinal: 0x26
  VOID *PoolTrackTableExpansion;            // offset: 0x1dd8 ordinal: 0x27
  ULONGLONG PoolTrackTableExpansionSize;    // offset: 0x1de0 ordinal: 0x28
  VOID *PoolTrackBigPages;                  // offset: 0x1de8 ordinal: 0x29
  ULONGLONG PoolTrackBigPagesSize;          // offset: 0x1df0 ordinal: 0x2a
} _MM_SESSION_SPACE;
...
typedef struct _MI_PAGEFILE_TRACES {
  ...
  struct __anon_813 MdlHack;        // offset: 0x30 ordinal: 0x8
} _MI_PAGEFILE_TRACES;

// 0xa0 bytes (sizeof)
typedef struct _MMMOD_WRITER_MDL_ENTRY {
  struct _LIST_ENTRY Links;          // offset: 0x0 ordinal: 0x0
  union __anon_791 u;                // offset: 0x10 ordinal: 0x1
  struct _IRP *Irp;                  // offset: 0x20 ordinal: 0x2
  union __anon_792 u1;               // offset: 0x28 ordinal: 0x3
...
typedef struct _LAZY_WRITER {
  struct _LIST_ENTRY WorkQueue; // offset: 0x0 ordinal: 0x0
  struct _KDPC ScanDpc;         // offset: 0x10 ordinal: 0x1
  struct _KTIMER ScanTimer;     // offset: 0x50 ordinal: 0x2
  UCHAR ScanActive;             // offset: 0x90 ordinal: 0x3
  UCHAR OtherWork;              // offset: 0x91 ordinal: 0x4
  UCHAR PendingTeardown;        // offset: 0x92 ordinal: 0x5
} _LAZY_WRITER;
...
typedef struct _KTHREAD {
  ...
  ULONG UserStackWalkActive : 1;  // offset: 0x90 ordinal: 0x17
  ULONG Reserved : 24;            // offset: 0x90 ordinal: 0x18
  LONG MiscFlags;                 // offset: 0x90 ordinal: 0x19
  UCHAR WaitReason;               // offset: 0x94 ordinal: 0x1a
  UCHAR SwapBusy;                 // offset: 0x95 ordinal: 0x1b
  UCHAR Alerted[2];               // offset: 0x96 ordinal: 0x1c
  union {
    struct _LIST_ENTRY WaitListEntry;        // offset: 0x98 ordinal: 0x1d
    struct _SINGLE_LIST_ENTRY SwapListEntry; // offset: 0x98 ordinal: 0x1e
  };
  struct _KQUEUE *Queue; // offset: 0xa8 ordinal: 0x1f
  VOID *Teb;             // offset: 0xb0 ordinal: 0x20
  union {
    struct _KTIMER Timer; // offset: 0xb8 ordinal: 0x21
    UCHAR TimerFill[60];  // offset: 0xb8 ordinal: 0x22
  };
  ULONG AutoAlignment : 1;             // offset: 0xf4 ordinal: 0x23
  ULONG DisableBoost : 1;              // offset: 0xf4 ordinal: 0x24
  ULONG EtwStackTraceApc1Inserted : 1; // offset: 0xf4 ordinal: 0x25
  ULONG EtwStackTraceApc2Inserted : 1; // offset: 0xf4 ordinal: 0x26
  ULONG CycleChargePending : 1;        // offset: 0xf4 ordinal: 0x27
  ULONG CalloutActive : 1;             // offset: 0xf4 ordinal: 0x28
  ULONG ApcQueueable : 1;              // offset: 0xf4 ordinal: 0x29
  ULONG EnableStackSwap : 1;           // offset: 0xf4 ordinal: 0x2a
  ULONG GuiThread : 1;                 // offset: 0xf4 ordinal: 0x2b
  ULONG ReservedFlags : 23;            // offset: 0xf4 ordinal: 0x2c
  LONG ThreadFlags;                    // offset: 0xf4 ordinal: 0x2d
  union {
    struct _KWAIT_BLOCK WaitBlock[4]; // offset: 0xf8 ordinal: 0x2e
    UCHAR WaitBlockFill0[43];         // offset: 0xf8 ordinal: 0x2f
  };
  UCHAR IdealProcessor;              // offset: 0x123 ordinal: 0x30
  UCHAR WaitBlockFill1[91];          // offset: 0xf8 ordinal: 0x31
  CHAR PreviousMode;                 // offset: 0x153 ordinal: 0x32
  UCHAR WaitBlockFill2[139];         // offset: 0xf8 ordinal: 0x33
  UCHAR ResourceIndex;               // offset: 0x183 ordinal: 0x34
  UCHAR WaitBlockFill3[187];         // offset: 0xf8 ordinal: 0x35
  UCHAR LargeStack;                  // offset: 0x1b3 ordinal: 0x36
  UCHAR WaitBlockFill4[44];          // offset: 0xf8 ordinal: 0x37
  ULONG ContextSwitches;             // offset: 0x124 ordinal: 0x38
  UCHAR WaitBlockFill5[92];          // offset: 0xf8 ordinal: 0x39
  UCHAR State;                       // offset: 0x154 ordinal: 0x3a
  UCHAR NpxState;                    // offset: 0x155 ordinal: 0x3b
  UCHAR WaitIrql;                    // offset: 0x156 ordinal: 0x3c
  CHAR WaitMode;                     // offset: 0x157 ordinal: 0x3d
  UCHAR WaitBlockFill6[140];         // offset: 0xf8 ordinal: 0x3e
  ULONG WaitTime;                    // offset: 0x184 ordinal: 0x3f
  UCHAR WaitBlockFill7[188];         // offset: 0xf8 ordinal: 0x40
  SHORT KernelApcDisable;            // offset: 0x1b4 ordinal: 0x41
  SHORT SpecialApcDisable;           // offset: 0x1b6 ordinal: 0x42
  ULONG CombinedApcDisable;          // offset: 0x1b4 ordinal: 0x43
  struct _LIST_ENTRY QueueListEntry; // offset: 0x1b8 ordinal: 0x44
  struct _KTRAP_FRAME *TrapFrame;    // offset: 0x1c8 ordinal: 0x45
  VOID *FirstArgument;               // offset: 0x1d0 ordinal: 0x46
  union {
    VOID *CallbackStack;     // offset: 0x1d8 ordinal: 0x47
    ULONGLONG CallbackDepth; // offset: 0x1d8 ordinal: 0x48
  };
  UCHAR ApcStateIndex;                    // offset: 0x1e0 ordinal: 0x49
  CHAR BasePriority;                      // offset: 0x1e1 ordinal: 0x4a
  CHAR PriorityDecrement;                 // offset: 0x1e2 ordinal: 0x4b
  UCHAR Preempted;                        // offset: 0x1e3 ordinal: 0x4c
  UCHAR AdjustReason;                     // offset: 0x1e4 ordinal: 0x4d
  CHAR AdjustIncrement;                   // offset: 0x1e5 ordinal: 0x4e
  UCHAR Spare01;                          // offset: 0x1e6 ordinal: 0x4f
  CHAR Saturation;                        // offset: 0x1e7 ordinal: 0x50
  ULONG SystemCallNumber;                 // offset: 0x1e8 ordinal: 0x51
  ULONG FreezeCount;                      // offset: 0x1ec ordinal: 0x52
  ULONGLONG UserAffinity;                 // offset: 0x1f0 ordinal: 0x53
  struct _KPROCESS *Process;              // offset: 0x1f8 ordinal: 0x54
  ULONGLONG Affinity;                     // offset: 0x200 ordinal: 0x55
  struct _KAPC_STATE *ApcStatePointer[2]; // offset: 0x208 ordinal: 0x56
  union {
    struct _KAPC_STATE SavedApcState; // offset: 0x218 ordinal: 0x57
    UCHAR SavedApcStateFill[43];      // offset: 0x218 ordinal: 0x58
  };
  UCHAR Spare02;             // offset: 0x243 ordinal: 0x59
  CHAR SuspendCount;         // offset: 0x244 ordinal: 0x5a
  UCHAR UserIdealProcessor;  // offset: 0x245 ordinal: 0x5b
  UCHAR Spare03;             // offset: 0x246 ordinal: 0x5c
  UCHAR CodePatchInProgress; // offset: 0x247 ordinal: 0x5d
  VOID *Win32Thread;         // offset: 0x248 ordinal: 0x5e
  VOID *StackBase;           // offset: 0x250 ordinal: 0x5f
  union {
    struct _KAPC SuspendApc;  // offset: 0x258 ordinal: 0x60
    UCHAR SuspendApcFill0[1]; // offset: 0x258 ordinal: 0x61
  };
  CHAR Spare04;              // offset: 0x259 ordinal: 0x62
  UCHAR SuspendApcFill1[3];  // offset: 0x258 ordinal: 0x63
  UCHAR QuantumReset;        // offset: 0x25b ordinal: 0x64
  UCHAR SuspendApcFill2[4];  // offset: 0x258 ordinal: 0x65
  ULONG KernelTime;          // offset: 0x25c ordinal: 0x66
  UCHAR SuspendApcFill3[64]; // offset: 0x258 ordinal: 0x67
  struct _KPRCB *WaitPrcb;   // offset: 0x298 ordinal: 0x68
  UCHAR SuspendApcFill4[72]; // offset: 0x258 ordinal: 0x69
  VOID *LegoData;            // offset: 0x2a0 ordinal: 0x6a
  UCHAR SuspendApcFill5[83]; // offset: 0x258 ordinal: 0x6b
  UCHAR PowerState;          // offset: 0x2ab ordinal: 0x6c
  ULONG UserTime;            // offset: 0x2ac ordinal: 0x6d
  union {
    struct _KSEMAPHORE SuspendSemaphore; // offset: 0x2b0 ordinal: 0x6e
    UCHAR SuspendSemaphorefill[28];      // offset: 0x2b0 ordinal: 0x6f
  };
  ULONG SListFaultCount;              // offset: 0x2cc ordinal: 0x70
  struct _LIST_ENTRY ThreadListEntry; // offset: 0x2d0 ordinal: 0x71
  struct _LIST_ENTRY MutantListHead;  // offset: 0x2e0 ordinal: 0x72
  VOID *SListFaultAddress;            // offset: 0x2f0 ordinal: 0x73
  LONGLONG ReadOperationCount;        // offset: 0x2f8 ordinal: 0x74
  LONGLONG WriteOperationCount;       // offset: 0x300 ordinal: 0x75
  LONGLONG OtherOperationCount;       // offset: 0x308 ordinal: 0x76
  LONGLONG ReadTransferCount;         // offset: 0x310 ordinal: 0x77
  LONGLONG WriteTransferCount;        // offset: 0x318 ordinal: 0x78
  LONGLONG OtherTransferCount;        // offset: 0x320 ordinal: 0x79
  VOID *MdlForLockedTeb;              // offset: 0x328 ordinal: 0x7a
} _KTHREAD;
...
typedef struct _ETHREAD {
  ...
  UCHAR Spare1 : 8;                           // offset: 0x422 ordinal: 0x45
  UCHAR PriorityRegionActive;                 // offset: 0x423 ordinal: 0x46
  UCHAR CacheManagerActive;                   // offset: 0x424 ordinal: 0x47
  UCHAR DisablePageFaultClustering;           // offset: 0x425 ordinal: 0x48
  UCHAR ActiveFaultCount;                     // offset: 0x426 ordinal: 0x49
  ULONGLONG AlpcMessageId;                    // offset: 0x428 ordinal: 0x4a
  union {
    VOID *AlpcMessage;             // offset: 0x430 ordinal: 0x4b
    ULONG AlpcReceiveAttributeSet; // offset: 0x430 ordinal: 0x4c
  };
  struct _LIST_ENTRY AlpcWaitListEntry; // offset: 0x438 ordinal: 0x4d
  ULONG CacheManagerCount;              // offset: 0x448 ordinal: 0x4e
} _ETHREAD;

// 0x118 bytes (sizeof)
typedef struct _PROCESSOR_POWER_STATE {
  struct _PPM_IDLE_STATES *IdleStates; // offset: 0x0 ordinal: 0x0
  ULONGLONG LastTimeCheck;             // offset: 0x8 ordinal: 0x1
  ULONGLONG IdleTimeAccumulated;       // offset: 0x10 ordinal: 0x2
  union {
    struct __anon_111 Native; // offset: 0x18 ordinal: 0x3
    struct __anon_112 Hv;     // offset: 0x18 ordinal: 0x4
  };
  struct PPM_IDLE_ACCOUNTING *IdleAccounting; // offset: 0x20 ordinal: 0x5
  struct _PPM_PERF_STATES *PerfStates;        // offset: 0x28 ordinal: 0x6
  ULONG LastKernelUserTime;                   // offset: 0x30 ordinal: 0x7
  ULONG LastIdleThreadKTime;                  // offset: 0x34 ordinal: 0x8
  ULONGLONG LastGlobalTimeHv;                 // offset: 0x38 ordinal: 0x9
  ULONGLONG LastProcessorTimeHv;              // offset: 0x40 ordinal: 0xa
  UCHAR ThermalConstraint;                    // offset: 0x48 ordinal: 0xb
  UCHAR LastBusyPercentage;                   // offset: 0x49 ordinal: 0xc
  union __anon_115 Flags;                     // offset: 0x4a ordinal: 0xd
  struct _KTIMER PerfTimer;                   // offset: 0x50 ordinal: 0xe
  struct _KDPC PerfDpc;                       // offset: 0x90 ordinal: 0xf
  ULONG LastSysTime;                          // offset: 0xd0 ordinal: 0x10
  struct _KPRCB *PStateMaster;                // offset: 0xd8 ordinal: 0x11
  ULONGLONG PStateSet;                        // offset: 0xe0 ordinal: 0x12
  ULONG CurrentPState;                        // offset: 0xe8 ordinal: 0x13
  ULONG DesiredPState;                        // offset: 0xec ordinal: 0x14
  ULONG PStateIdleStartTime;                  // offset: 0xf0 ordinal: 0x15
  ULONG PStateIdleTime;                       // offset: 0xf4 ordinal: 0x16
  ULONG LastPStateIdleTime;                   // offset: 0xf8 ordinal: 0x17
  ULONG PStateStartTime;                      // offset: 0xfc ordinal: 0x18
  ULONG DiaIndex;                             // offset: 0x100 ordinal: 0x19
  ULONG Reserved0;                            // offset: 0x104 ordinal: 0x1a
  ULONGLONG WmiDispatchPtr;                   // offset: 0x108 ordinal: 0x1b
  LONG WmiInterfaceEnabled;                   // offset: 0x110 ordinal: 0x1c
...
typedef struct _KPRCB {
  ...
  struct _KSPIN_LOCK_QUEUE LockQueue[49];        // offset: 0x670 ordinal: 0x21
  struct _PP_LOOKASIDE_LIST PPLookasideList[16]; // offset: 0x980 ordinal: 0x22
  struct _GENERAL_LOOKASIDE_POOL
      PPNPagedLookasideList[32]; // offset: 0xa80 ordinal: 0x23
  struct _GENERAL_LOOKASIDE_POOL
      PPPagedLookasideList[32]; // offset: 0x1680 ordinal: 0x24
  ULONGLONG PacketBarrier;      // offset: 0x2280 ordinal: 0x25
  struct _SINGLE_LIST_ENTRY
      DeferredReadyListHead;                  // offset: 0x2288 ordinal: 0x26
  LONG MmPageFaultCount;                      // offset: 0x2290 ordinal: 0x27
  LONG MmCopyOnWriteCount;                    // offset: 0x2294 ordinal: 0x28
  LONG MmTransitionCount;                     // offset: 0x2298 ordinal: 0x29
  LONG MmDemandZeroCount;                     // offset: 0x229c ordinal: 0x2a
  LONG MmPageReadCount;                       // offset: 0x22a0 ordinal: 0x2b
  LONG MmPageReadIoCount;                     // offset: 0x22a4 ordinal: 0x2c
  LONG MmDirtyPagesWriteCount;                // offset: 0x22a8 ordinal: 0x2d
  LONG MmDirtyWriteIoCount;                   // offset: 0x22ac ordinal: 0x2e
  LONG MmMappedPagesWriteCount;               // offset: 0x22b0 ordinal: 0x2f
  LONG MmMappedWriteIoCount;                  // offset: 0x22b4 ordinal: 0x30
  ULONG KeSystemCalls;                        // offset: 0x22b8 ordinal: 0x31
  ULONG KeContextSwitches;                    // offset: 0x22bc ordinal: 0x32
  ULONG CcFastReadNoWait;                     // offset: 0x22c0 ordinal: 0x33
  ULONG CcFastReadWait;                       // offset: 0x22c4 ordinal: 0x34
  ULONG CcFastReadNotPossible;                // offset: 0x22c8 ordinal: 0x35
  ULONG CcCopyReadNoWait;                     // offset: 0x22cc ordinal: 0x36
  ULONG CcCopyReadWait;                       // offset: 0x22d0 ordinal: 0x37
  ULONG CcCopyReadNoWaitMiss;                 // offset: 0x22d4 ordinal: 0x38
  LONG LookasideIrpFloat;                     // offset: 0x22d8 ordinal: 0x39
  LONG IoReadOperationCount;                  // offset: 0x22dc ordinal: 0x3a
  LONG IoWriteOperationCount;                 // offset: 0x22e0 ordinal: 0x3b
  LONG IoOtherOperationCount;                 // offset: 0x22e4 ordinal: 0x3c
  union _LARGE_INTEGER IoReadTransferCount;   // offset: 0x22e8 ordinal: 0x3d
  union _LARGE_INTEGER IoWriteTransferCount;  // offset: 0x22f0 ordinal: 0x3e
  union _LARGE_INTEGER IoOtherTransferCount;  // offset: 0x22f8 ordinal: 0x3f
  ULONGLONG TargetSet;                        // offset: 0x2300 ordinal: 0x40
  ULONG IpiFrozen;                            // offset: 0x2308 ordinal: 0x41
  UCHAR PrcbPad3[116];                        // offset: 0x230c ordinal: 0x42
  struct _REQUEST_MAILBOX RequestMailbox[64]; // offset: 0x2380 ordinal: 0x43
  ULONGLONG SenderSummary;                    // offset: 0x3380 ordinal: 0x44
  UCHAR PrcbPad4[120];                        // offset: 0x3388 ordinal: 0x45
  struct _KDPC_DATA DpcData[2];               // offset: 0x3400 ordinal: 0x46
  VOID *DpcStack;                             // offset: 0x3440 ordinal: 0x47
  VOID *SparePtr0;                            // offset: 0x3448 ordinal: 0x48
  LONG MaximumDpcQueueDepth;                  // offset: 0x3450 ordinal: 0x49
  ULONG DpcRequestRate;                       // offset: 0x3454 ordinal: 0x4a
  ULONG MinimumDpcRate;                       // offset: 0x3458 ordinal: 0x4b
  UCHAR DpcInterruptRequested;                // offset: 0x345c ordinal: 0x4c
  UCHAR DpcThreadRequested;                   // offset: 0x345d ordinal: 0x4d
  UCHAR DpcRoutineActive;                     // offset: 0x345e ordinal: 0x4e
  UCHAR DpcThreadActive;                      // offset: 0x345f ordinal: 0x4f
  union {
    ULONGLONG TimerHand;    // offset: 0x3460 ordinal: 0x50
    ULONGLONG TimerRequest; // offset: 0x3460 ordinal: 0x51
  };
  LONG TickOffset;                 // offset: 0x3468 ordinal: 0x52
  LONG MasterOffset;               // offset: 0x346c ordinal: 0x53
  ULONG DpcLastCount;              // offset: 0x3470 ordinal: 0x54
  UCHAR ThreadDpcEnable;           // offset: 0x3474 ordinal: 0x55
  UCHAR QuantumEnd;                // offset: 0x3475 ordinal: 0x56
  UCHAR PrcbPad50;                 // offset: 0x3476 ordinal: 0x57
  UCHAR IdleSchedule;              // offset: 0x3477 ordinal: 0x58
  LONG DpcSetEventRequest;         // offset: 0x3478 ordinal: 0x59
  ULONG KeExceptionDispatchCount;  // offset: 0x347c ordinal: 0x5a
  struct _KEVENT DpcEvent;         // offset: 0x3480 ordinal: 0x5b
  VOID *PrcbPad51;                 // offset: 0x3498 ordinal: 0x5c
  struct _KDPC CallDpc;            // offset: 0x34a0 ordinal: 0x5d
  LONG ClockKeepAlive;             // offset: 0x34e0 ordinal: 0x5e
  UCHAR ClockCheckSlot;            // offset: 0x34e4 ordinal: 0x5f
  UCHAR ClockPollCycle;            // offset: 0x34e5 ordinal: 0x60
  UCHAR PrcbPad6[2];               // offset: 0x34e6 ordinal: 0x61
  LONG DpcWatchdogPeriod;          // offset: 0x34e8 ordinal: 0x62
  LONG DpcWatchdogCount;           // offset: 0x34ec ordinal: 0x63
  ULONGLONG PrcbPad70[2];          // offset: 0x34f0 ordinal: 0x64
  struct _LIST_ENTRY WaitListHead; // offset: 0x3500 ordinal: 0x65
  ULONGLONG WaitLock;              // offset: 0x3510 ordinal: 0x66
  ULONG ReadySummary;              // offset: 0x3518 ordinal: 0x67
  ULONG QueueIndex;                // offset: 0x351c ordinal: 0x68
  ULONGLONG PrcbPad71[12];         // offset: 0x3520 ordinal: 0x69
  struct _LIST_ENTRY
      DispatcherReadyListHead[32];          // offset: 0x3580 ordinal: 0x6a
  ULONG InterruptCount;                     // offset: 0x3780 ordinal: 0x6b
  ULONG KernelTime;                         // offset: 0x3784 ordinal: 0x6c
  ULONG UserTime;                           // offset: 0x3788 ordinal: 0x6d
  ULONG DpcTime;                            // offset: 0x378c ordinal: 0x6e
  ULONG InterruptTime;                      // offset: 0x3790 ordinal: 0x6f
  ULONG AdjustDpcThreshold;                 // offset: 0x3794 ordinal: 0x70
  UCHAR SkipTick;                           // offset: 0x3798 ordinal: 0x71
  UCHAR DebuggerSavedIRQL;                  // offset: 0x3799 ordinal: 0x72
  UCHAR PollSlot;                           // offset: 0x379a ordinal: 0x73
  UCHAR PrcbPad80[5];                       // offset: 0x379b ordinal: 0x74
  ULONG DpcTimeCount;                       // offset: 0x37a0 ordinal: 0x75
  ULONG DpcTimeLimit;                       // offset: 0x37a4 ordinal: 0x76
  ULONG PeriodicCount;                      // offset: 0x37a8 ordinal: 0x77
  ULONG PeriodicBias;                       // offset: 0x37ac ordinal: 0x78
  ULONGLONG PrcbPad81[2];                   // offset: 0x37b0 ordinal: 0x79
  struct _KNODE *ParentNode;                // offset: 0x37c0 ordinal: 0x7a
  ULONGLONG MultiThreadProcessorSet;        // offset: 0x37c8 ordinal: 0x7b
  struct _KPRCB *MultiThreadSetMaster;      // offset: 0x37d0 ordinal: 0x7c
  ULONGLONG StartCycles;                    // offset: 0x37d8 ordinal: 0x7d
  LONG MmSpinLockOrdering;                  // offset: 0x37e0 ordinal: 0x7e
  ULONG PageColor;                          // offset: 0x37e4 ordinal: 0x7f
  ULONG NodeColor;                          // offset: 0x37e8 ordinal: 0x80
  ULONG NodeShiftedColor;                   // offset: 0x37ec ordinal: 0x81
  ULONG SecondaryColorMask;                 // offset: 0x37f0 ordinal: 0x82
  LONG Sleeping;                            // offset: 0x37f4 ordinal: 0x83
  ULONGLONG CycleTime;                      // offset: 0x37f8 ordinal: 0x84
  ULONG CcFastMdlReadNoWait;                // offset: 0x3800 ordinal: 0x85
  ULONG CcFastMdlReadWait;                  // offset: 0x3804 ordinal: 0x86
  ULONG CcFastMdlReadNotPossible;           // offset: 0x3808 ordinal: 0x87
  ULONG CcMapDataNoWait;                    // offset: 0x380c ordinal: 0x88
  ULONG CcMapDataWait;                      // offset: 0x3810 ordinal: 0x89
  ULONG CcPinMappedDataCount;               // offset: 0x3814 ordinal: 0x8a
  ULONG CcPinReadNoWait;                    // offset: 0x3818 ordinal: 0x8b
  ULONG CcPinReadWait;                      // offset: 0x381c ordinal: 0x8c
  ULONG CcMdlReadNoWait;                    // offset: 0x3820 ordinal: 0x8d
  ULONG CcMdlReadWait;                      // offset: 0x3824 ordinal: 0x8e
  ULONG CcLazyWriteHotSpots;                // offset: 0x3828 ordinal: 0x8f
  ULONG CcLazyWriteIos;                     // offset: 0x382c ordinal: 0x90
  ULONG CcLazyWritePages;                   // offset: 0x3830 ordinal: 0x91
  ULONG CcDataFlushes;                      // offset: 0x3834 ordinal: 0x92
  ULONG CcDataPages;                        // offset: 0x3838 ordinal: 0x93
  ULONG CcLostDelayedWrites;                // offset: 0x383c ordinal: 0x94
  ULONG CcFastReadResourceMiss;             // offset: 0x3840 ordinal: 0x95
  ULONG CcCopyReadWaitMiss;                 // offset: 0x3844 ordinal: 0x96
  ULONG CcFastMdlReadResourceMiss;          // offset: 0x3848 ordinal: 0x97
  ULONG CcMapDataNoWaitMiss;                // offset: 0x384c ordinal: 0x98
  ULONG CcMapDataWaitMiss;                  // offset: 0x3850 ordinal: 0x99
  ULONG CcPinReadNoWaitMiss;                // offset: 0x3854 ordinal: 0x9a
  ULONG CcPinReadWaitMiss;                  // offset: 0x3858 ordinal: 0x9b
  ULONG CcMdlReadNoWaitMiss;                // offset: 0x385c ordinal: 0x9c
  ULONG CcMdlReadWaitMiss;                  // offset: 0x3860 ordinal: 0x9d
  ULONG CcReadAheadIos;                     // offset: 0x3864 ordinal: 0x9e
  LONG MmCacheTransitionCount;              // offset: 0x3868 ordinal: 0x9f
  LONG MmCacheReadCount;                    // offset: 0x386c ordinal: 0xa0
  LONG MmCacheIoCount;                      // offset: 0x3870 ordinal: 0xa1
  ULONG PrcbPad91[3];                       // offset: 0x3874 ordinal: 0xa2
  struct _PROCESSOR_POWER_STATE PowerState; // offset: 0x3880 ordinal: 0xa3
  ULONG KeAlignmentFixupCount;              // offset: 0x3998 ordinal: 0xa4
  UCHAR VendorString[13];                   // offset: 0x399c ordinal: 0xa5
  UCHAR PrcbPad10[3];                       // offset: 0x39a9 ordinal: 0xa6
  ULONG FeatureBits;                        // offset: 0x39ac ordinal: 0xa7
  union _LARGE_INTEGER UpdateSignature;     // offset: 0x39b0 ordinal: 0xa8
  struct _KDPC DpcWatchdogDpc;              // offset: 0x39b8 ordinal: 0xa9
  struct _KTIMER DpcWatchdogTimer;          // offset: 0x39f8 ordinal: 0xaa
  struct _CACHE_DESCRIPTOR Cache[5];        // offset: 0x3a38 ordinal: 0xab
  ULONG CacheCount;                         // offset: 0x3a74 ordinal: 0xac
  ULONG CachedCommit;                       // offset: 0x3a78 ordinal: 0xad
  ULONG CachedResidentAvailable;            // offset: 0x3a7c ordinal: 0xae
  VOID *HyperPte;                           // offset: 0x3a80 ordinal: 0xaf
  VOID *WheaInfo;                           // offset: 0x3a88 ordinal: 0xb0
  VOID *EtwSupport;                         // offset: 0x3a90 ordinal: 0xb1
  union _SLIST_HEADER InterruptObjectPool;  // offset: 0x3aa0 ordinal: 0xb2
  union _SLIST_HEADER HypercallPageList;    // offset: 0x3ab0 ordinal: 0xb3
  VOID *HypercallPageVirtual;               // offset: 0x3ac0 ordinal: 0xb4
  VOID *VirtualApicAssist;                  // offset: 0x3ac8 ordinal: 0xb5
  ULONGLONG *StatisticsPage;                // offset: 0x3ad0 ordinal: 0xb6
  VOID *RateControl;                        // offset: 0x3ad8 ordinal: 0xb7
  ULONGLONG CacheProcessorMask[5];          // offset: 0x3ae0 ordinal: 0xb8
  ULONGLONG PackageProcessorSet;            // offset: 0x3b08 ordinal: 0xb9
  ULONGLONG CoreProcessorSet;               // offset: 0x3b10 ordinal: 0xba
} _KPRCB;
...
typedef struct _PEB64 {
  ...
  ULONG ReservedBits0 : 28;      // offset: 0x50 ordinal: 0x18
  union {
    ULONGLONG KernelCallbackTable; // offset: 0x58 ordinal: 0x19
    ULONGLONG UserSharedInfoPtr;   // offset: 0x58 ordinal: 0x1a
  };
  ULONG SystemReserved[1];                      // offset: 0x60 ordinal: 0x1b
  ULONG SpareUlong;                             // offset: 0x64 ordinal: 0x1c
  ULONGLONG SparePebPtr0;                       // offset: 0x68 ordinal: 0x1d
  ULONG TlsExpansionCounter;                    // offset: 0x70 ordinal: 0x1e
  ULONGLONG TlsBitmap;                          // offset: 0x78 ordinal: 0x1f
  ULONG TlsBitmapBits[2];                       // offset: 0x80 ordinal: 0x20
  ULONGLONG ReadOnlySharedMemoryBase;           // offset: 0x88 ordinal: 0x21
  ULONGLONG HotpatchInformation;                // offset: 0x90 ordinal: 0x22
  ULONGLONG ReadOnlyStaticServerData;           // offset: 0x98 ordinal: 0x23
  ULONGLONG AnsiCodePageData;                   // offset: 0xa0 ordinal: 0x24
  ULONGLONG OemCodePageData;                    // offset: 0xa8 ordinal: 0x25
  ULONGLONG UnicodeCaseTableData;               // offset: 0xb0 ordinal: 0x26
  ULONG NumberOfProcessors;                     // offset: 0xb8 ordinal: 0x27
  ULONG NtGlobalFlag;                           // offset: 0xbc ordinal: 0x28
  union _LARGE_INTEGER CriticalSectionTimeout;  // offset: 0xc0 ordinal: 0x29
  ULONGLONG HeapSegmentReserve;                 // offset: 0xc8 ordinal: 0x2a
  ...
  ULONG NumberOfHeaps;                          // offset: 0xe8 ordinal: 0x2e
  ULONG MaximumNumberOfHeaps;                   // offset: 0xec ordinal: 0x2f
  ULONGLONG ProcessHeaps;                       // offset: 0xf0 ordinal: 0x30
  ULONGLONG GdiSharedHandleTable;               // offset: 0xf8 ordinal: 0x31
  ULONGLONG ProcessStarterHelper;               // offset: 0x100 ordinal: 0x32
  ULONG GdiDCAttributeList;                     // offset: 0x108 ordinal: 0x33
  ULONGLONG LoaderLock;                         // offset: 0x110 ordinal: 0x34
  ULONG OSMajorVersion;                         // offset: 0x118 ordinal: 0x35
  ULONG OSMinorVersion;                         // offset: 0x11c ordinal: 0x36
  USHORT OSBuildNumber;                         // offset: 0x120 ordinal: 0x37
  USHORT OSCSDVersion;                          // offset: 0x122 ordinal: 0x38
  ...
  ULONGLONG ActiveProcessAffinityMask;          // offset: 0x138 ordinal: 0x3d
  ULONG GdiHandleBuffer[60];                    // offset: 0x140 ordinal: 0x3e
  ULONGLONG PostProcessInitRoutine;             // offset: 0x230 ordinal: 0x3f
  ULONGLONG TlsExpansionBitmap;                 // offset: 0x238 ordinal: 0x40
  ULONG TlsExpansionBitmapBits[32];             // offset: 0x240 ordinal: 0x41
  ULONG SessionId;                              // offset: 0x2c0 ordinal: 0x42
  union _ULARGE_INTEGER AppCompatFlags;         // offset: 0x2c8 ordinal: 0x43
  union _ULARGE_INTEGER AppCompatFlagsUser;     // offset: 0x2d0 ordinal: 0x44
  ULONGLONG pShimData;                          // offset: 0x2d8 ordinal: 0x45
  ULONGLONG AppCompatInfo;                      // offset: 0x2e0 ordinal: 0x46
  struct _STRING64 CSDVersion;                  // offset: 0x2e8 ordinal: 0x47
  ULONGLONG ActivationContextData;              // offset: 0x2f8 ordinal: 0x48
  ULONGLONG ProcessAssemblyStorageMap;          // offset: 0x300 ordinal: 0x49
  ULONGLONG SystemDefaultActivationContextData; // offset: 0x308 ordinal: 0x4a
  ULONGLONG SystemAssemblyStorageMap;           // offset: 0x310 ordinal: 0x4b
  ULONGLONG MinimumStackCommit;                 // offset: 0x318 ordinal: 0x4c
  ULONGLONG FlsCallback;                        // offset: 0x320 ordinal: 0x4d
  struct LIST_ENTRY64 FlsListHead;              // offset: 0x328 ordinal: 0x4e
  ULONGLONG FlsBitmap;                          // offset: 0x338 ordinal: 0x4f
  ULONG FlsBitmapBits[4];                       // offset: 0x340 ordinal: 0x50
  ULONG FlsHighIndex;                           // offset: 0x350 ordinal: 0x51
  ULONGLONG WerRegistrationData;                // offset: 0x358 ordinal: 0x52
  ULONGLONG WerShipAssertPtr;                   // offset: 0x360 ordinal: 0x53
} _PEB64;
...
typedef struct _TEB64 {
  ...
  USHORT RtlExceptionAttached : 1;       // offset: 0x17ee ordinal: 0x5a
  USHORT SpareSameTebBits : 6;           // offset: 0x17ee ordinal: 0x5b
  ULONGLONG TxnScopeEnterCallback;       // offset: 0x17f0 ordinal: 0x5c
  ULONGLONG TxnScopeExitCallback;        // offset: 0x17f8 ordinal: 0x5d
  ULONGLONG TxnScopeContext;             // offset: 0x1800 ordinal: 0x5e
  ULONG LockCount;                       // offset: 0x1808 ordinal: 0x5f
  ULONG ProcessRundown;                  // offset: 0x180c ordinal: 0x60
  ULONGLONG LastSwitchTime;              // offset: 0x1810 ordinal: 0x61
  ULONGLONG TotalSwitchOutTime;          // offset: 0x1818 ordinal: 0x62
