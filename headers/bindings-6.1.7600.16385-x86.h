...
struct _PPM_IDLE_STATES {
  ...
  UCHAR NewlyUnparked;                   // offset: 0x14 (20)
  struct _KAFFINITY_EX TargetProcessors; // offset: 0x18 (24)
  struct _PPM_IDLE_STATE State[1];       // offset: 0x28 (40)
};
...
struct _KTHREAD {
  ...
  union {
    struct {
      ...
      ULONG Reserved : 19;               // offset: 0x3c (60)
    };
  ...
  union {
    struct {
      ...
      volatile ULONG ReservedFlags : 23;            // offset: 0xb8 (184)
    };
...
struct _ETHREAD {
  ...
  union {
    ...
    struct {
      ...
      ULONG SystemThread : 1;            // offset: 0x280 (640)
