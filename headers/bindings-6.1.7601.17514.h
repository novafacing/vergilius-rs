...
typedef struct _SHARED_CACHE_MAP {
  ...
  ULONG PipelinedReadAheadSize;                // offset: 0x1f0 ordinal: 0x28
} _SHARED_CACHE_MAP;
...
typedef struct _CMHIVE {
  ...
  union _LARGE_INTEGER LastWriteTime;          // offset: 0xbe0 ordinal: 0x3c
} _CMHIVE;
...
typedef struct _PPM_IDLE_STATES {
  ...
  struct _KAFFINITY_EX TargetProcessors; // offset: 0x18 ordinal: 0x5
  struct _PPM_IDLE_STATE State[1];       // offset: 0x40 ordinal: 0x6
} _PPM_IDLE_STATES;
...
typedef struct _UMS_CONTROL_BLOCK {
  ...
  ULONG UmsPerformingSingleStep : 1;    // offset: 0x58 ordinal: 0x15
  USHORT TebSelector;                   // offset: 0x90 ordinal: 0x16
} _UMS_CONTROL_BLOCK;
...
typedef struct _KTHREAD {
  ...
  ULONG SystemThread : 1;                    // offset: 0x4c ordinal: 0x17
  ULONG Reserved : 18;                       // offset: 0x4c ordinal: 0x18
  LONG MiscFlags;                            // offset: 0x4c ordinal: 0x19
  union {
    struct _KAPC_STATE ApcState; // offset: 0x50 ordinal: 0x1a
    UCHAR ApcStateFill[43];      // offset: 0x50 ordinal: 0x1b
  };
  CHAR Priority;                      // offset: 0x7b ordinal: 0x1c
  ULONG NextProcessor;                // offset: 0x7c ordinal: 0x1d
  ULONG DeferredProcessor;            // offset: 0x80 ordinal: 0x1e
  ULONGLONG ApcQueueLock;             // offset: 0x88 ordinal: 0x1f
  LONGLONG WaitStatus;                // offset: 0x90 ordinal: 0x20
  struct _KWAIT_BLOCK *WaitBlockList; // offset: 0x98 ordinal: 0x21
  union {
    struct _LIST_ENTRY WaitListEntry;        // offset: 0xa0 ordinal: 0x22
    struct _SINGLE_LIST_ENTRY SwapListEntry; // offset: 0xa0 ordinal: 0x23
  };
  struct _KQUEUE *Queue;               // offset: 0xb0 ordinal: 0x24
  VOID *Teb;                           // offset: 0xb8 ordinal: 0x25
  struct _KTIMER Timer;                // offset: 0xc0 ordinal: 0x26
  ULONG AutoAlignment : 1;             // offset: 0x100 ordinal: 0x27
  ULONG DisableBoost : 1;              // offset: 0x100 ordinal: 0x28
  ULONG EtwStackTraceApc1Inserted : 1; // offset: 0x100 ordinal: 0x29
  ULONG EtwStackTraceApc2Inserted : 1; // offset: 0x100 ordinal: 0x2a
  ULONG CalloutActive : 1;             // offset: 0x100 ordinal: 0x2b
  ULONG ApcQueueable : 1;              // offset: 0x100 ordinal: 0x2c
  ULONG EnableStackSwap : 1;           // offset: 0x100 ordinal: 0x2d
  ULONG GuiThread : 1;                 // offset: 0x100 ordinal: 0x2e
  ULONG UmsPerformingSyscall : 1;      // offset: 0x100 ordinal: 0x2f
  ULONG VdmSafe : 1;                   // offset: 0x100 ordinal: 0x30
  ULONG UmsDispatched : 1;             // offset: 0x100 ordinal: 0x31
  ULONG ReservedFlags : 21;            // offset: 0x100 ordinal: 0x32
  LONG ThreadFlags;                    // offset: 0x100 ordinal: 0x33
  ULONG Spare0;                        // offset: 0x104 ordinal: 0x34
  union {
    struct _KWAIT_BLOCK WaitBlock[4]; // offset: 0x108 ordinal: 0x35
    UCHAR WaitBlockFill4[44];         // offset: 0x108 ordinal: 0x36
  };
  ULONG ContextSwitches;             // offset: 0x134 ordinal: 0x37
  UCHAR WaitBlockFill5[92];          // offset: 0x108 ordinal: 0x38
  UCHAR State;                       // offset: 0x164 ordinal: 0x39
  CHAR NpxState;                     // offset: 0x165 ordinal: 0x3a
  UCHAR WaitIrql;                    // offset: 0x166 ordinal: 0x3b
  CHAR WaitMode;                     // offset: 0x167 ordinal: 0x3c
  UCHAR WaitBlockFill6[140];         // offset: 0x108 ordinal: 0x3d
  ULONG WaitTime;                    // offset: 0x194 ordinal: 0x3e
  UCHAR WaitBlockFill7[168];         // offset: 0x108 ordinal: 0x3f
  VOID *TebMappedLowVa;              // offset: 0x1b0 ordinal: 0x40
  struct _UMS_CONTROL_BLOCK *Ucb;    // offset: 0x1b8 ordinal: 0x41
  UCHAR WaitBlockFill8[188];         // offset: 0x108 ordinal: 0x42
  SHORT KernelApcDisable;            // offset: 0x1c4 ordinal: 0x43
  SHORT SpecialApcDisable;           // offset: 0x1c6 ordinal: 0x44
  ULONG CombinedApcDisable;          // offset: 0x1c4 ordinal: 0x45
  struct _LIST_ENTRY QueueListEntry; // offset: 0x1c8 ordinal: 0x46
  struct _KTRAP_FRAME *TrapFrame;    // offset: 0x1d8 ordinal: 0x47
  VOID *FirstArgument;               // offset: 0x1e0 ordinal: 0x48
  union {
    VOID *CallbackStack;     // offset: 0x1e8 ordinal: 0x49
    ULONGLONG CallbackDepth; // offset: 0x1e8 ordinal: 0x4a
  };
  UCHAR ApcStateIndex; // offset: 0x1f0 ordinal: 0x4b
  CHAR BasePriority;   // offset: 0x1f1 ordinal: 0x4c
  union {
    CHAR PriorityDecrement;    // offset: 0x1f2 ordinal: 0x4d
    UCHAR ForegroundBoost : 4; // offset: 0x1f2 ordinal: 0x4e
  };
  UCHAR UnusualBoost : 4;                 // offset: 0x1f2 ordinal: 0x4f
  UCHAR Preempted;                        // offset: 0x1f3 ordinal: 0x50
  UCHAR AdjustReason;                     // offset: 0x1f4 ordinal: 0x51
  CHAR AdjustIncrement;                   // offset: 0x1f5 ordinal: 0x52
  CHAR PreviousMode;                      // offset: 0x1f6 ordinal: 0x53
  CHAR Saturation;                        // offset: 0x1f7 ordinal: 0x54
  ULONG SystemCallNumber;                 // offset: 0x1f8 ordinal: 0x55
  ULONG FreezeCount;                      // offset: 0x1fc ordinal: 0x56
  struct _GROUP_AFFINITY UserAffinity;    // offset: 0x200 ordinal: 0x57
  struct _KPROCESS *Process;              // offset: 0x210 ordinal: 0x58
  struct _GROUP_AFFINITY Affinity;        // offset: 0x218 ordinal: 0x59
  ULONG IdealProcessor;                   // offset: 0x228 ordinal: 0x5a
  ULONG UserIdealProcessor;               // offset: 0x22c ordinal: 0x5b
  struct _KAPC_STATE *ApcStatePointer[2]; // offset: 0x230 ordinal: 0x5c
  union {
    struct _KAPC_STATE SavedApcState; // offset: 0x240 ordinal: 0x5d
    UCHAR SavedApcStateFill[43];      // offset: 0x240 ordinal: 0x5e
  };
  UCHAR WaitReason;          // offset: 0x26b ordinal: 0x5f
  CHAR SuspendCount;         // offset: 0x26c ordinal: 0x60
  CHAR Spare1;               // offset: 0x26d ordinal: 0x61
  UCHAR CodePatchInProgress; // offset: 0x26e ordinal: 0x62
  VOID *Win32Thread;         // offset: 0x270 ordinal: 0x63
  VOID *StackBase;           // offset: 0x278 ordinal: 0x64
  union {
    struct _KAPC SuspendApc;  // offset: 0x280 ordinal: 0x65
    UCHAR SuspendApcFill0[1]; // offset: 0x280 ordinal: 0x66
  };
  UCHAR ResourceIndex;       // offset: 0x281 ordinal: 0x67
  UCHAR SuspendApcFill1[3];  // offset: 0x280 ordinal: 0x68
  UCHAR QuantumReset;        // offset: 0x283 ordinal: 0x69
  UCHAR SuspendApcFill2[4];  // offset: 0x280 ordinal: 0x6a
  ULONG KernelTime;          // offset: 0x284 ordinal: 0x6b
  UCHAR SuspendApcFill3[64]; // offset: 0x280 ordinal: 0x6c
  struct _KPRCB *WaitPrcb;   // offset: 0x2c0 ordinal: 0x6d
  UCHAR SuspendApcFill4[72]; // offset: 0x280 ordinal: 0x6e
  VOID *LegoData;            // offset: 0x2c8 ordinal: 0x6f
  UCHAR SuspendApcFill5[83]; // offset: 0x280 ordinal: 0x70
  UCHAR LargeStack;          // offset: 0x2d3 ordinal: 0x71
  ULONG UserTime;            // offset: 0x2d4 ordinal: 0x72
  union {
    struct _KSEMAPHORE SuspendSemaphore; // offset: 0x2d8 ordinal: 0x73
    UCHAR SuspendSemaphorefill[28];      // offset: 0x2d8 ordinal: 0x74
  };
  ULONG SListFaultCount;                    // offset: 0x2f4 ordinal: 0x75
  struct _LIST_ENTRY ThreadListEntry;       // offset: 0x2f8 ordinal: 0x76
  struct _LIST_ENTRY MutantListHead;        // offset: 0x308 ordinal: 0x77
  VOID *SListFaultAddress;                  // offset: 0x318 ordinal: 0x78
  LONGLONG ReadOperationCount;              // offset: 0x320 ordinal: 0x79
  LONGLONG WriteOperationCount;             // offset: 0x328 ordinal: 0x7a
  LONGLONG OtherOperationCount;             // offset: 0x330 ordinal: 0x7b
  LONGLONG ReadTransferCount;               // offset: 0x338 ordinal: 0x7c
  LONGLONG WriteTransferCount;              // offset: 0x340 ordinal: 0x7d
  LONGLONG OtherTransferCount;              // offset: 0x348 ordinal: 0x7e
  struct _KTHREAD_COUNTERS *ThreadCounters; // offset: 0x350 ordinal: 0x7f
  struct _XSTATE_SAVE *XStateSave;          // offset: 0x358 ordinal: 0x80
} _KTHREAD;
...
typedef struct _ETHREAD {
  ...
  ULONG Reserved : 1;                // offset: 0x448 ordinal: 0x21
