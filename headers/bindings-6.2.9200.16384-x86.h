...
struct _PROCESSOR_IDLE_DEPENDENCY {
  struct _PROCESSOR_NUMBER Processor; // offset: 0x0 (0)
...
struct _PNP_RESERVED_PROVIDER_INFO {
  ...
  struct _LIST_ENTRY DependentList;     // offset: 0x8 (8)
  struct _UNICODE_STRING ReservationId; // offset: 0x10 (16)
...
struct _PNP_PROVIDER_INFO {
  struct _LIST_ENTRY ListEntry; // offset: 0x0 (0)
  UCHAR ProviderType;           // offset: 0x8 (8)
  UCHAR Satisfied;              // offset: 0x9 (9)
  USHORT Flags;                 // offset: 0xa (10)
  union {
    struct _DEVICE_OBJECT *ProviderPdo;                      // offset: 0xc (12)
    struct _PNP_RESERVED_PROVIDER_INFO *ProviderReservation; // offset: 0xc (12)
...
struct _MM_AVL_NODE {
  union {
    ...
    struct _MM_AVL_NODE *Parent; // offset: 0x0 (0)

  } u1;                            // offset: 0x0 (0)
  struct _MM_AVL_NODE *LeftChild;  // offset: 0x4 (4)
  struct _MM_AVL_NODE *RightChild; // offset: 0x8 (8)
};
...
struct _HIVE_WAIT_PACKET {
  ...
  UCHAR PrimaryFileWritten;       // offset: 0x18 (24)
};
...
struct _MI_TRIAGE_DUMP_DATA {
  ...
  ULONG FeatureBits;                      // offset: 0x14 (20)
  ULONG TimeZoneId;                       // offset: 0x18 (24)
};
...
struct _MM_AVL_TABLE {
  struct _MM_AVL_NODE BalancedRoot;      // offset: 0x0 (0)
  ULONG DepthOfTree : 5;                 // offset: 0xc (12)
  ULONG TableType : 3;                   // offset: 0xc (12)
  ULONG NumberGenericTableElements : 24; // offset: 0xc (12)
  VOID *NodeHint;                        // offset: 0x10 (16)
  VOID *NodeFreeHint;                    // offset: 0x14 (20)
};
...
// 0x28 (40) bytes
struct _MMVAD_SHORT {
  struct _MM_AVL_NODE VadNode;   // offset: 0x0 (0)
  ULONG StartingVpn;             // offset: 0xc (12)
  ULONG EndingVpn;               // offset: 0x10 (16)
  struct _EX_PUSH_LOCK PushLock; // offset: 0x14 (20)
  union {
    ULONG LongFlags;              // offset: 0x18 (24)
    struct _MMVAD_FLAGS VadFlags; // offset: 0x18 (24)

  } u; // offset: 0x18 (24)
  union {
    ULONG LongFlags1;               // offset: 0x1c (28)
    struct _MMVAD_FLAGS1 VadFlags1; // offset: 0x1c (28)

  } u1;                                  // offset: 0x1c (28)
  struct _MI_VAD_EVENT_BLOCK *EventList; // offset: 0x20 (32)
...
struct _MI_USER_VA_INFO {
  ...
  struct _KEVENT *LastVadDeletionEvent;  // offset: 0x24 (36)
  ULONG *VadBitBuffer;                   // offset: 0x28 (40)
  VOID *LowestBottomUpAllocationAddress; // offset: 0x2c (44)
  VOID *HighestTopDownAllocationAddress; // offset: 0x30 (48)
  VOID *FreeTebHint;                     // offset: 0x34 (52)
  ULONG PrivateFixupVadCount;            // offset: 0x38 (56)
  USHORT UsedPageTableEntries[1536];     // offset: 0x3c (60)
  ULONG CommittedPageTables[48];         // offset: 0xc3c (3132)
};
...
struct _EX_WORK_QUEUE {
  ...
  volatile ULONG WorkItemsProcessed; // offset: 0x28 (40)
  ULONG WorkItemsProcessedLastPass;  // offset: 0x2c (44)
  volatile LONG ThreadCount;         // offset: 0x30 (48)
  volatile UCHAR TryFailed;          // offset: 0x34 (52)
};
...
struct _KTRAP_FRAME {
  ...
  UCHAR FrameType;                                      // offset: 0x13 (19)
...
struct _PROC_PERF_HISTORY {
  ...
  struct _PROC_PERF_HISTORY_ENTRY HistoryList[1]; // offset: 0x14 (20)
};
...
struct _KNODE {
  ...
  UCHAR NodePad0;                  // offset: 0x4b (75)
  struct _GROUP_AFFINITY Affinity; // offset: 0x4c (76)
  ULONG IdleCpuSet;                // offset: 0x58 (88)
  ULONG IdleSmtSet;                // offset: 0x5c (92)
  ULONG Seed;                      // offset: 0x80 (128)
  ULONG Lowest;                    // offset: 0x84 (132)
  ULONG Highest;                   // offset: 0x88 (136)
  LONG ParkLock;                   // offset: 0x8c (140)
  ULONG NonParkedSet;              // offset: 0x90 (144)
};

// 0x280 (640) bytes
struct _ENODE {
  struct _KNODE Ncb;                                 // offset: 0x0 (0)
  struct _EX_WORK_QUEUE ExWorkerQueues[7];           // offset: 0xc0 (192)
  struct _KEVENT ExpThreadSetManagerEvent;           // offset: 0x248 (584)
  struct _ETHREAD *ExpWorkerThreadBalanceManagerPtr; // offset: 0x258 (600)
  ULONG ExpWorkerSeed;                               // offset: 0x25c (604)
  union {
    struct {
      volatile ULONG ExWorkerFullInit : 1;   // offset: 0x260 (608)
      volatile ULONG ExWorkerStructInit : 1; // offset: 0x260 (608)
    };
    volatile ULONG ExWorkerFlags; // offset: 0x260 (608)
  };
};
...
struct _MMWSL {
  ...
  ULONG ActiveWsleCounts[8];                        // offset: 0x3c (60)
  struct _MI_ACTIVE_WSLE ActiveWsles[8];            // offset: 0x5c (92)
  struct _MMWSLE *Wsle;                             // offset: 0x9c (156)
  struct _MI_USER_VA_INFO UserVaInfo;               // offset: 0xa0 (160)
};
...
struct _MMSUPPORT {
  ...
  ULONG TrimmedPageCount;                      // offset: 0x60 (96)
  ULONG ForceTrimPages;                        // offset: 0x64 (100)
  struct _MMSUPPORT_FLAGS Flags;               // offset: 0x68 (104)
  VOID *WsSwapSupport;                         // offset: 0x6c (108)
};
...
struct _KALPC_MESSAGE {
  ...
  VOID *DataSystemVa;                                 // offset: 0x58 (88)
...
struct _LDR_DATA_TABLE_ENTRY {
  ...
  union {
    ...
    struct {
      ...
      ULONG ReservedFlags3 : 3;          // offset: 0x34 (52)
...
struct _IOP_IRP_EXTENSION {
  union {
    ...
    struct {
      ...
      USHORT SpareBits : 5;   // offset: 0x0 (0)
    };
  };
  USHORT TypesAllocated;          // offset: 0x2 (2)
  struct _GUID ActivityId;        // offset: 0x4 (4)
...
struct _LOG_HANDLE_CONTEXT {
  ...
  ULONG AdditionalPagesToWrite;                      // offset: 0x28 (40)
  ULONG CcLWScanDPThreshold;                         // offset: 0x2c (44)
  union _LARGE_INTEGER LargestLsnForCurrentLWScan;   // offset: 0x30 (48)
  struct _FILE_OBJECT *RelatedFileObject;            // offset: 0x38 (56)
  ULONG LargestLsnFileObjectKey;                     // offset: 0x3c (60)
  union _LARGE_INTEGER LastLWTimeStamp;              // offset: 0x40 (64)
  ULONG Flags;                                       // offset: 0x48 (72)
};
...
struct _VOLUME_CACHE_MAP {
  ...
  ULONG PagesQueuedToDisk;                     // offset: 0x6c (108)
  ULONG LoggedPagesQueuedToDisk;               // offset: 0x70 (112)
};
...
struct _MMMOD_WRITER_MDL_ENTRY {
  ...
  ULONG ByteCount;                   // offset: 0x18 (24)
  struct _MMPAGING_FILE *PagingFile; // offset: 0x1c (28)
  struct _FILE_OBJECT *File;         // offset: 0x20 (32)
  struct _CONTROL_AREA *ControlArea; // offset: 0x24 (36)
  struct _ERESOURCE *FileResource;   // offset: 0x28 (40)
  union _LARGE_INTEGER WriteOffset;  // offset: 0x30 (48)
  union _LARGE_INTEGER IssueTime;    // offset: 0x38 (56)
  struct _MDL *PointerMdl;           // offset: 0x40 (64)
  struct _MDL Mdl;                   // offset: 0x44 (68)
  ULONG Page[1];                     // offset: 0x60 (96)
};
...
struct _MMPAGING_FILE {
  ...
  struct _UNICODE_STRING PageFileName;           // offset: 0x2c (44)
  struct _MI_PAGING_FILE_SPACE_BITMAPS *Bitmaps; // offset: 0x34 (52)
  ULONG AllocationBitmapHint;                    // offset: 0x38 (56)
  ULONG ReservationBitmapHint;                   // offset: 0x3c (60)
  ULONG LargestNonReservedClusterSize;           // offset: 0x40 (64)
  ULONG RefreshClusterSize;                      // offset: 0x44 (68)
  ULONG LastRefreshClusterSize;                  // offset: 0x48 (72)
  ULONG ReservedClusterSizeAggregate;            // offset: 0x4c (76)
  ULONG ToBeEvictedCount;                        // offset: 0x50 (80)
  USHORT PageFileNumber : 4;                     // offset: 0x54 (84)
  USHORT BootPartition : 1;                      // offset: 0x54 (84)
  USHORT WsSwapPagefile : 1;                     // offset: 0x54 (84)
  USHORT NoReservations : 1;                     // offset: 0x54 (84)
  USHORT Spare0 : 9;                             // offset: 0x54 (84)
  UCHAR AdriftMdls : 1;                          // offset: 0x56 (86)
  UCHAR Spare1 : 7;                              // offset: 0x56 (86)
  UCHAR Spare2 : 8;                              // offset: 0x57 (87)
  VOID *FileHandle;                              // offset: 0x58 (88)
  ULONG Lock;                                    // offset: 0x5c (92)
  struct _ETHREAD *LockOwner;                    // offset: 0x60 (96)
};
...
struct _PPM_IDLE_STATE {
  ...
  ULONG Power;                        // offset: 0x10 (16)
  ULONG StateFlags;                   // offset: 0x14 (20)
  UCHAR StateType;                    // offset: 0x18 (24)
  UCHAR InterruptsEnabled;            // offset: 0x19 (25)
  UCHAR Interruptible;                // offset: 0x1a (26)
  UCHAR ContextRetained;              // offset: 0x1b (27)
  UCHAR CacheCoherent;                // offset: 0x1c (28)
};
...
struct _ETW_GUID_ENTRY {
  ...
  struct _EVENT_FILTER_HEADER **FilterData;     // offset: 0x158 (344)
};
...
struct _TOKEN {
  ...
  ULONG VariablePart;    // offset: 0x280 (640)
};
...
struct _ALPC_PORT {
  ...
  struct _ALPC_MESSAGE_ZONE *MessageZone;       // offset: 0xcc (204)
  struct _CALLBACK_OBJECT *CallbackObject;      // offset: 0xd0 (208)
  VOID *CallbackContext;                        // offset: 0xd4 (212)
  struct _LIST_ENTRY CanceledQueue;             // offset: 0xd8 (216)
  LONG SequenceNo;                              // offset: 0xe0 (224)
  union {
    struct {
      ULONG Initialized : 1;          // offset: 0x0 (0)
    ...
    ULONG State;                      // offset: 0xe4 (228)

  } u1;                                  // offset: 0xe4 (228)
  struct _ALPC_PORT *TargetQueuePort;    // offset: 0xe8 (232)
  struct _ALPC_PORT *TargetSequencePort; // offset: 0xec (236)
  struct _KALPC_MESSAGE *CachedMessage;  // offset: 0xf0 (240)
  ULONG MainQueueLength;                 // offset: 0xf4 (244)
  ULONG LargeMessageQueueLength;         // offset: 0xf8 (248)
  ULONG PendingQueueLength;              // offset: 0xfc (252)
  ULONG CanceledQueueLength;             // offset: 0x100 (256)
  ULONG WaitQueueLength;                 // offset: 0x104 (260)
};
...
struct _POP_FX_PLUGIN {
  ...
  struct _KQUEUE WorkQueue;            // offset: 0x2c (44)
  UCHAR (*AcceptDeviceNotification)
  (ULONG arg1, VOID *arg2); // offset: 0x54 (84)
  UCHAR (*AcceptProcessorNotification)
  (struct PEPHANDLE__ *arg1, ULONG arg2, VOID *arg3); // offset: 0x58 (88)
};
...
struct _HHIVE {
  ...
  ULONG BaseBlockAlloc;           // offset: 0x30 (48)
  ULONG Cluster;                  // offset: 0x34 (52)
  UCHAR Flat;                     // offset: 0x38 (56)
  UCHAR ReadOnly;                 // offset: 0x39 (57)
  UCHAR DirtyFlag;                // offset: 0x3a (58)
  ULONG HvBinHeadersUse;          // offset: 0x3c (60)
  ULONG HvFreeCellsUse;           // offset: 0x40 (64)
  ULONG HvUsedCellsUse;           // offset: 0x44 (68)
  ULONG CmUsedCellsUse;           // offset: 0x48 (72)
  ULONG HiveFlags;                // offset: 0x4c (76)
  ULONG CurrentLog;               // offset: 0x50 (80)
  ULONG LogSize[2];               // offset: 0x54 (84)
  ULONG RefreshCount;             // offset: 0x5c (92)
  ULONG StorageTypeCount;         // offset: 0x60 (96)
  ULONG Version;                  // offset: 0x64 (100)
  struct _DUAL Storage[2];        // offset: 0x68 (104)
};

// 0x908 (2312) bytes
struct _CMHIVE {
  struct _HHIVE Hive;                                 // offset: 0x0 (0)
  VOID *FileHandles[6];                               // offset: 0x3a0 (928)
  struct _LIST_ENTRY NotifyList;                      // offset: 0x3b8 (952)
  struct _LIST_ENTRY HiveList;                        // offset: 0x3c0 (960)
  struct _LIST_ENTRY PreloadedHiveList;               // offset: 0x3c8 (968)
  struct _EX_RUNDOWN_REF HiveRundown;                 // offset: 0x3d0 (976)
  struct _LIST_ENTRY ParseCacheEntries;               // offset: 0x3d4 (980)
  struct _CM_KEY_HASH_TABLE_ENTRY *KcbCacheTable;     // offset: 0x3dc (988)
  ULONG KcbCacheTableSize;                            // offset: 0x3e0 (992)
  struct _CM_KEY_HASH_TABLE_ENTRY *DeletedKcbTable;   // offset: 0x3e4 (996)
  ULONG DeletedKcbTableSize;                          // offset: 0x3e8 (1000)
  ULONG Identity;                                     // offset: 0x3ec (1004)
  struct _FAST_MUTEX *HiveLock;                       // offset: 0x3f0 (1008)
  struct _FAST_MUTEX *WriterLock;                     // offset: 0x3f4 (1012)
  struct _ERESOURCE *FlusherLock;                     // offset: 0x3f8 (1016)
  struct _RTL_BITMAP FlushDirtyVector;                // offset: 0x3fc (1020)
  struct CMP_OFFSET_ARRAY *FlushOffsetArray;          // offset: 0x404 (1028)
  ULONG FlushOffsetArrayCount;                        // offset: 0x408 (1032)
  struct _HBASE_BLOCK *FlushBaseBlock;                // offset: 0x40c (1036)
  ULONG FlushHiveTruncated;                           // offset: 0x410 (1040)
  struct _EX_PUSH_LOCK SecurityLock;                  // offset: 0x414 (1044)
  ULONG UseCount;                                     // offset: 0x418 (1048)
  ULONG LastShrinkHiveSize;                           // offset: 0x41c (1052)
  union _LARGE_INTEGER ActualFileSize;                // offset: 0x420 (1056)
  union _LARGE_INTEGER LogFileSizes[2];               // offset: 0x428 (1064)
  struct _UNICODE_STRING FileFullPath;                // offset: 0x438 (1080)
  struct _UNICODE_STRING FileUserName;                // offset: 0x440 (1088)
  struct _UNICODE_STRING HiveRootPath;                // offset: 0x448 (1096)
  ULONG SecurityCount;                                // offset: 0x450 (1104)
  ULONG SecurityCacheSize;                            // offset: 0x454 (1108)
  LONG SecurityHitHint;                               // offset: 0x458 (1112)
  struct _CM_KEY_SECURITY_CACHE_ENTRY *SecurityCache; // offset: 0x45c (1116)
  struct _LIST_ENTRY SecurityHash[64];                // offset: 0x460 (1120)
  ULONG UnloadEventCount;                             // offset: 0x660 (1632)
  struct _KEVENT **UnloadEventArray;                  // offset: 0x664 (1636)
  struct _CM_KEY_CONTROL_BLOCK *RootKcb;              // offset: 0x668 (1640)
  UCHAR Frozen;                                       // offset: 0x66c (1644)
  struct _CM_WORKITEM *UnloadWorkItem;                // offset: 0x670 (1648)
  struct _CM_WORKITEM UnloadWorkItemHolder;           // offset: 0x674 (1652)
  UCHAR GrowOnlyMode;                                 // offset: 0x688 (1672)
  ULONG GrowOffset;                                   // offset: 0x68c (1676)
  struct _LIST_ENTRY KcbConvertListHead;              // offset: 0x690 (1680)
  struct _LIST_ENTRY KnodeConvertListHead;            // offset: 0x698 (1688)
  struct _CM_CELL_REMAP_BLOCK *CellRemapArray;        // offset: 0x6a0 (1696)
  ULONG Flags;                                        // offset: 0x6a4 (1700)
  struct _LIST_ENTRY TrustClassEntry;                 // offset: 0x6a8 (1704)
  ULONGLONG DirtyTime;                                // offset: 0x6b0 (1712)
  struct _CM_RM *CmRm;                                // offset: 0x6b8 (1720)
  ULONG CmRmInitFailPoint;                            // offset: 0x6bc (1724)
  LONG CmRmInitFailStatus;                            // offset: 0x6c0 (1728)
  struct _KTHREAD *CreatorOwner;                      // offset: 0x6c4 (1732)
  struct _KTHREAD *RundownThread;                     // offset: 0x6c8 (1736)
  struct _ETHREAD *ActiveFlushThread;                 // offset: 0x6cc (1740)
  struct _EX_PUSH_LOCK FlushBoostLock;                // offset: 0x6d0 (1744)
  union _LARGE_INTEGER LastWriteTime;                 // offset: 0x6d8 (1752)
  volatile LONG ReferenceCount;                       // offset: 0x6e0 (1760)
  union {
    ULONG FlushFlags; // offset: 0x6e4 (1764)
    struct {
      ULONG FlushActive : 1;         // offset: 0x6e4 (1764)
      ULONG DiskFileBad : 1;         // offset: 0x6e4 (1764)
      ULONG FlushBoosted : 1;        // offset: 0x6e4 (1764)
      ULONG PrimaryWritePending : 1; // offset: 0x6e4 (1764)
      ULONG PriorPurgeComplete : 1;  // offset: 0x6e4 (1764)
    };
  };
  struct _HIVE_WAIT_PACKET *FlushWaitList;      // offset: 0x6e8 (1768)
  LONG UnloadHistoryIndex;                      // offset: 0x6ec (1772)
  ULONG UnloadHistory[128];                     // offset: 0x6f0 (1776)
  ULONG BootStart;                              // offset: 0x8f0 (2288)
  ULONG UnaccessedStart;                        // offset: 0x8f4 (2292)
  ULONG UnaccessedEnd;                          // offset: 0x8f8 (2296)
  ULONG LoadedKeyCount;                         // offset: 0x8fc (2300)
  volatile ULONG HandleClosePending;            // offset: 0x900 (2304)
  struct _EX_PUSH_LOCK HandleClosePendingEvent; // offset: 0x904 (2308)
};
...
struct tagSWITCH_CONTEXT_DATA {
  struct _GUID guPlatform;         // offset: 0x0 (0)
  struct _GUID guMinPlatform;      // offset: 0x10 (16)
  ULONG ulElementCount;            // offset: 0x20 (32)
  USHORT ulContextMinimum;         // offset: 0x24 (36)
  ULONGLONG ullOsMaxVersionTested; // offset: 0x28 (40)
  struct _GUID guElements[1];      // offset: 0x30 (48)
};
...
struct _MMPTE_SOFTWARE {
  ...
  ULONGLONG DbgCrc : 17;           // offset: 0x0 (0)
...
struct _MSUBSECTION {
  ...
  struct _MM_AVL_NODE SubsectionNode; // offset: 0x20 (32)
  struct _LIST_ENTRY DereferenceList; // offset: 0x2c (44)
  ULONG NumberOfMappedViews;          // offset: 0x34 (52)
  ULONG NumberOfPfnReferences;        // offset: 0x38 (56)
};
...
struct _MMVAD {
  ...
  union {
    ...
    struct _MSUBSECTION *MappedSubsection; // offset: 0x2c (44)
  };
...
struct _MM_PAGED_POOL_INFO {
  ...
  ULONG AllocatedPagedPool;                  // offset: 0x30 (48)
};
...
struct _CONTROL_AREA {
  ...
  struct _MI_CONTROL_AREA_WAIT_BLOCK *WaitList; // offset: 0x30 (48)
  union {
    struct {
      union {
      ...
      union {
        ...
        struct {
          ...
          ULONG Unused : 13;                   // offset: 0x4 (4)
          ULONG BitMap : 2;                    // offset: 0x4 (4)
          ULONG ImageActive : 1;               // offset: 0x4 (4)
        };
      };
      union {
        struct _MM_AVL_TABLE *SubsectionRoot;             // offset: 0x8 (8)
...
struct _MI_SYSTEM_PTE_TYPE {
  ...
  union {
    ...
    struct _FAST_MUTEX *GlobalMutex; // offset: 0x2c (44)
  };
  struct _MI_CACHED_PTE *CachedPtes; // offset: 0x30 (48)
};
...
struct _MMPFN {
  ...
  union {
    ULONG PteFrame : 25;    // offset: 0x18 (24)
    ULONG PageIdentity : 2; // offset: 0x18 (24)
...
struct _MMINPAGE_SUPPORT {
  struct _LIST_ENTRY ListEntry;     // offset: 0x0 (0)
  struct _ETHREAD *Thread;          // offset: 0x8 (8)
  struct _LIST_ENTRY ListHead;      // offset: 0xc (12)
  struct _KEVENT Event;             // offset: 0x18 (24)
  struct _KEVENT CollidedEvent;     // offset: 0x28 (40)
  struct _IO_STATUS_BLOCK IoStatus; // offset: 0x38 (56)
  union _LARGE_INTEGER ReadOffset;  // offset: 0x40 (64)
  struct _MMPTE PteContents;        // offset: 0x48 (72)
  struct _MMPFN *LockedProtoPfn;    // offset: 0x50 (80)
  volatile LONG WaitCount;          // offset: 0x54 (84)
  ULONG ByteCount;                  // offset: 0x58 (88)
  union {
    ULONG ImagePteOffset; // offset: 0x5c (92)
    ULONG TossPage;       // offset: 0x5c (92)

  } u3; // offset: 0x5c (92)
  union {
    struct _MMINPAGE_FLAGS e1; // offset: 0x60 (96)
    ULONG LongFlags;           // offset: 0x60 (96)

  } u1;                              // offset: 0x60 (96)
  struct _FILE_OBJECT *FilePointer;  // offset: 0x64 (100)
  struct _CONTROL_AREA *ControlArea; // offset: 0x68 (104)
...
struct _PS_WAKE_INFORMATION {
  ...
  ULONGLONG WakeCounters[8];     // offset: 0x8 (8)
};
...
struct _EJOB {
  ...
  struct _JOBOBJECT_WAKE_FILTER WakeFilter;               // offset: 0x1f0 (496)
  ULONG LowEdgeLatchFilter;                               // offset: 0x1f8 (504)
  ULONG OwnedHighEdgeFilters;                             // offset: 0x1fc (508)
  struct _EJOB *NotificationLink;                         // offset: 0x200 (512)
  ...
  struct _EX_PUSH_LOCK MemoryLimitsLock;        // offset: 0x224 (548)
  struct _LIST_ENTRY SiblingJobLinks;           // offset: 0x228 (552)
  struct _LIST_ENTRY ChildJobListHead;          // offset: 0x230 (560)
  struct _EJOB *ParentJob;                      // offset: 0x238 (568)
  struct _EJOB *volatile RootJob;               // offset: 0x23c (572)
  struct _LIST_ENTRY IteratorListHead;          // offset: 0x240 (576)
  struct _EPROCESS_VALUES Accounting;           // offset: 0x248 (584)
  ULONG ShadowActiveProcessCount;               // offset: 0x298 (664)
  ULONG SequenceNumber;                         // offset: 0x29c (668)
  ULONG TimerListLock;                          // offset: 0x2a0 (672)
  struct _LIST_ENTRY TimerListHead;             // offset: 0x2a4 (676)
  union {
    ULONG JobFlags; // offset: 0x2ac (684)
    struct {
      ULONG CloseDone : 1;                     // offset: 0x2ac (684)
      ULONG MultiGroup : 1;                    // offset: 0x2ac (684)
      ULONG OutstandingNotification : 1;       // offset: 0x2ac (684)
      ULONG NotificationInProgress : 1;        // offset: 0x2ac (684)
      ULONG UILimits : 1;                      // offset: 0x2ac (684)
      ULONG CpuRateControlActive : 1;          // offset: 0x2ac (684)
      ULONG OwnCpuRateControl : 1;             // offset: 0x2ac (684)
      ULONG Terminating : 1;                   // offset: 0x2ac (684)
      ULONG WorkingSetLock : 1;                // offset: 0x2ac (684)
      ULONG JobFrozen : 1;                     // offset: 0x2ac (684)
      ULONG Background : 1;                    // offset: 0x2ac (684)
      ULONG WakeNotificationAllocated : 1;     // offset: 0x2ac (684)
      ULONG WakeNotificationEnabled : 1;       // offset: 0x2ac (684)
      ULONG WakeNotificationPending : 1;       // offset: 0x2ac (684)
      ULONG LimitNotificationRequired : 1;     // offset: 0x2ac (684)
      ULONG ZeroCountNotificationRequired : 1; // offset: 0x2ac (684)
      ULONG CycleTimeNotificationRequired : 1; // offset: 0x2ac (684)
      ULONG CycleTimeNotificationPending : 1;  // offset: 0x2ac (684)
      ULONG TimersVirtualized : 1;             // offset: 0x2ac (684)
      ULONG JobSwapped : 1;                    // offset: 0x2ac (684)
      ULONG ViolationDetected : 1;             // offset: 0x2ac (684)
      ULONG EmptyJobNotified : 1;              // offset: 0x2ac (684)
      ULONG NoSystemCharge : 1;                // offset: 0x2ac (684)
      ULONG SpareJobFlags : 9;                 // offset: 0x2ac (684)
    };
  };
  ULONG EffectiveHighEdgeFilters; // offset: 0x2b0 (688)
};
...
struct _KSCB {
  ...
  struct _LIST_ENTRY PerProcessorList;  // offset: 0x30 (48)
  struct _RTL_BALANCED_NODE QueueNode;  // offset: 0x38 (56)
  UCHAR Inserted : 1;                   // offset: 0x44 (68)
  UCHAR OverQuota : 1;                  // offset: 0x44 (68)
  UCHAR HardCap : 1;                    // offset: 0x44 (68)
  UCHAR RankBias : 1;                   // offset: 0x44 (68)
  UCHAR Spare1 : 4;                     // offset: 0x44 (68)
  UCHAR Spare2;                         // offset: 0x45 (69)
  USHORT ReadySummary;                  // offset: 0x46 (70)
  ULONG Rank;                           // offset: 0x48 (72)
  struct _LIST_ENTRY ReadyListHead[16]; // offset: 0x4c (76)
};
...
struct _XSAVE_FORMAT {
  ...
  UCHAR Reserved4[220];            // offset: 0x120 (288)
...
struct _PLATFORM_IDLE_STATE_ACCOUNTING {
  ...
  struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26]; // offset: 0x30 (48)
};
...
struct _PROC_IDLE_STATE_ACCOUNTING {
  ...
  struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26]; // offset: 0x28 (40)
};
...
struct _PROCESSOR_IDLE_CONSTRAINTS {
  ...
  ULONG MaxIdleDuration;          // offset: 0x18 (24)
  ULONG OverrideState;            // offset: 0x1c (28)
  ULONG TimeCheck;                // offset: 0x20 (32)
  UCHAR PromotePercent;           // offset: 0x24 (36)
  UCHAR DemotePercent;            // offset: 0x25 (37)
  UCHAR Parked;                   // offset: 0x26 (38)
  UCHAR Interruptible;            // offset: 0x27 (39)
  UCHAR PlatformIdle;             // offset: 0x28 (40)
};
...
struct _PPM_IDLE_STATES {
  UCHAR ForceIdle;                             // offset: 0x0 (0)
  UCHAR EstimateIdleDuration;                  // offset: 0x1 (1)
  UCHAR ExitLatencyTraceEnabled;               // offset: 0x2 (2)
  ULONG ExitLatencyCountdown;                  // offset: 0x4 (4)
  ULONG TargetState;                           // offset: 0x8 (8)
  ULONG ActualState;                           // offset: 0xc (12)
  ULONG ActualPlatformState;                   // offset: 0x10 (16)
  ULONG OldState;                              // offset: 0x14 (20)
  ULONG OverrideIndex;                         // offset: 0x18 (24)
  ULONG PlatformIdleCount;                     // offset: 0x1c (28)
  ULONG ProcessorIdleCount;                    // offset: 0x20 (32)
  ULONG Type;                                  // offset: 0x24 (36)
  ULONG ReasonFlags;                           // offset: 0x28 (40)
  volatile LONGLONG InitiateWakeStamp;         // offset: 0x30 (48)
  LONG PreviousStatus;                         // offset: 0x38 (56)
  struct _KAFFINITY_EX PrimaryProcessorMask;   // offset: 0x3c (60)
  struct _KAFFINITY_EX SecondaryProcessorMask; // offset: 0x48 (72)
  VOID (*IdlePrepare)
  (struct _PROCESSOR_IDLE_PREPARE_INFO *arg1);     // offset: 0x54 (84)
  LONG (*IdleExecute)(VOID *arg1);                 // offset: 0x58 (88)
  VOID (*IdleComplete)(VOID *arg1);                // offset: 0x5c (92)
  VOID (*IdleCancel)(VOID *arg1, ULONG arg2);      // offset: 0x60 (96)
  UCHAR (*IdleIsHalted)(VOID *arg1);               // offset: 0x64 (100)
  UCHAR (*IdleInitiateWake)(VOID *arg1);           // offset: 0x68 (104)
  struct _PROCESSOR_IDLE_PREPARE_INFO PrepareInfo; // offset: 0x70 (112)
  struct _PPM_IDLE_STATE State[1];                 // offset: 0xc0 (192)
};
...
struct _KPROCESS {
  ...
  union {
    struct {
      ...
      LONG ReservedFlags : 25;       // offset: 0x5c (92)
    };
...
struct _KSPECIAL_REGISTERS {
  ...
  ULONG Reserved[4];       // offset: 0x44 (68)
};
...
struct _MM_SESSION_SPACE {
  ...
  struct _MMSUPPORT Vm;                          // offset: 0xcec (3308)
  struct _MMWSLE *Wsle;                          // offset: 0xd5c (3420)
  struct _MI_SESSION_DRIVER_UNLOAD DriverUnload; // offset: 0xd60 (3424)
  struct _POOL_DESCRIPTOR PagedPool;             // offset: 0xd80 (3456)
  struct _MMPTE *PageTables;                     // offset: 0x1ec0 (7872)
  struct _MI_SPECIAL_POOL SpecialPool;           // offset: 0x1ec8 (7880)
  struct _FAST_MUTEX SessionPteLock;             // offset: 0x1f10 (7952)
  LONG PoolBigEntriesInUse;                      // offset: 0x1f30 (7984)
  ULONG PagedPoolPdeCount;                       // offset: 0x1f34 (7988)
  ULONG SpecialPoolPdeCount;                     // offset: 0x1f38 (7992)
  ULONG DynamicSessionPdeCount;                  // offset: 0x1f3c (7996)
  struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;      // offset: 0x1f40 (8000)
  VOID *PoolTrackTableExpansion;                 // offset: 0x1f74 (8052)
  ULONG PoolTrackTableExpansionSize;             // offset: 0x1f78 (8056)
  VOID *PoolTrackBigPages;                       // offset: 0x1f7c (8060)
  ULONG PoolTrackBigPagesSize;                   // offset: 0x1f80 (8064)
  enum _IO_SESSION_STATE IoState;                // offset: 0x1f84 (8068)
  ULONG IoStateSequence;                         // offset: 0x1f88 (8072)
  struct _KEVENT IoNotificationEvent;            // offset: 0x1f8c (8076)
  struct _RTL_BITMAP SessionPoolPdes;            // offset: 0x1f9c (8092)
};
...
struct _PROCESSOR_POWER_STATE {
  ...
  struct _PLATFORM_IDLE_ACCOUNTING *PlatformIdleAccounting; // offset: 0x8 (8)
  ...
  enum _PROC_HYPERVISOR_STATE Hypervisor; // offset: 0xa8 (168)
  ULONG LastSysTime;                      // offset: 0xac (172)
  ULONG WmiDispatchPtr;                   // offset: 0xb0 (176)
  LONG WmiInterfaceEnabled;               // offset: 0xb4 (180)
  struct _PPM_FFH_THROTTLE_STATE_INFO
      FFHThrottleStateInfo;                        // offset: 0xb8 (184)
  struct _KDPC PerfActionDpc;                      // offset: 0xd8 (216)
  volatile LONG PerfActionMask;                    // offset: 0xf8 (248)
  struct _PROC_IDLE_SNAP HvIdleCheck;              // offset: 0x100 (256)
  struct _PROC_PERF_SNAP PerfCheck;                // offset: 0x110 (272)
  struct _PROC_PERF_DOMAIN *Domain;                // offset: 0x150 (336)
  struct _PROC_PERF_CONSTRAINT *PerfConstraint;    // offset: 0x154 (340)
  struct _PPM_CONCURRENCY_ACCOUNTING *Concurrency; // offset: 0x158 (344)
  struct _PROC_PERF_LOAD *Load;                    // offset: 0x15c (348)
  struct _PROC_PERF_HISTORY *PerfHistory;          // offset: 0x160 (352)
  UCHAR GuaranteedPerformancePercent;              // offset: 0x164 (356)
  UCHAR HvTargetState;                             // offset: 0x165 (357)
  UCHAR Parked;                                    // offset: 0x166 (358)
  UCHAR OverUtilized;                              // offset: 0x167 (359)
  ULONG LatestPerformancePercent;                  // offset: 0x168 (360)
  ULONG AveragePerformancePercent;                 // offset: 0x16c (364)
  ULONG LatestAffinitizedPercent;                  // offset: 0x170 (368)
  ULONG Utility;                                   // offset: 0x174 (372)
  ULONG AffinitizedUtility;                        // offset: 0x178 (376)
};
...
struct _POP_THERMAL_ZONE {
  ...
  LONG HighPrecisionThrottle;               // offset: 0x10 (16)
  LONG Throttle;                            // offset: 0x14 (20)
  LONG PendingThrottle;                     // offset: 0x18 (24)
  ULONGLONG ThrottleStartTime;              // offset: 0x20 (32)
  ULONGLONG LastTime;                       // offset: 0x28 (40)
  ULONG SampleRate;                         // offset: 0x30 (48)
  ULONG LastTemp;                           // offset: 0x34 (52)
  struct _KTIMER PassiveTimer;              // offset: 0x38 (56)
  struct _KDPC PassiveDpc;                  // offset: 0x60 (96)
  struct _POP_ACTION_TRIGGER OverThrottled; // offset: 0x80 (128)
  struct _IRP *Irp;                         // offset: 0x90 (144)
  struct _THERMAL_INFORMATION_EX Info;      // offset: 0x94 (148)
...
struct _WMI_LOGGER_CONTEXT {
  ...
  ULONG BuffersWritten;                              // offset: 0xac (172)
  ULONG LogBuffersLost;                              // offset: 0xb0 (176)
  ULONG RealTimeBuffersDelivered;                    // offset: 0xb4 (180)
  ULONG RealTimeBuffersLost;                         // offset: 0xb8 (184)
  LONG *SequencePtr;                                 // offset: 0xbc (188)
  ULONG LocalSequence;                               // offset: 0xc0 (192)
  struct _GUID InstanceGuid;                         // offset: 0xc4 (196)
  ULONG MaximumFileSize;                             // offset: 0xd4 (212)
  LONG FileCounter;                                  // offset: 0xd8 (216)
  enum _POOL_TYPE PoolType;                          // offset: 0xdc (220)
  ...
  struct _EX_FAST_REF SecurityDescriptor;                // offset: 0x22c (556)
  union _LARGE_INTEGER StartTime;                        // offset: 0x230 (560)
  VOID *LogFileHandle;                                   // offset: 0x238 (568)
  LONGLONG BufferSequenceNumber;                         // offset: 0x240 (576)
  union {
    ULONG Flags; // offset: 0x248 (584)
    struct {
      ULONG Persistent : 1;                 // offset: 0x248 (584)
      ULONG AutoLogger : 1;                 // offset: 0x248 (584)
      ULONG FsReady : 1;                    // offset: 0x248 (584)
      ULONG RealTime : 1;                   // offset: 0x248 (584)
      ULONG Wow : 1;                        // offset: 0x248 (584)
      ULONG KernelTrace : 1;                // offset: 0x248 (584)
      ULONG NoMoreEnable : 1;               // offset: 0x248 (584)
      ULONG StackTracing : 1;               // offset: 0x248 (584)
      ULONG ErrorLogged : 1;                // offset: 0x248 (584)
      ULONG RealtimeLoggerContextFreed : 1; // offset: 0x248 (584)
      ULONG PebsTracing : 1;                // offset: 0x248 (584)
      ULONG PmcCounters : 1;                // offset: 0x248 (584)
      ULONG PageAlignBuffers : 1;           // offset: 0x248 (584)
      ULONG SpareFlags1 : 3;                // offset: 0x248 (584)
      ULONG SystemLoggerIndex : 8;          // offset: 0x248 (584)
      ULONG StackCaching : 1;               // offset: 0x248 (584)
      ULONG SpareFlags2 : 7;                // offset: 0x248 (584)
    };
  };
  union {
    volatile ULONG RequestFlag; // offset: 0x24c (588)
    struct {
      ULONG DbgRequestNewFie : 1;             // offset: 0x24c (588)
      ULONG DbgRequestUpdateFile : 1;         // offset: 0x24c (588)
      ULONG DbgRequestFlush : 1;              // offset: 0x24c (588)
      ULONG DbgRequestDisableRealtime : 1;    // offset: 0x24c (588)
      ULONG DbgRequestDisconnectConsumer : 1; // offset: 0x24c (588)
      ULONG DbgRequestConnectConsumer : 1;    // offset: 0x24c (588)
      ULONG DbgRequestNotifyConsumer : 1;     // offset: 0x24c (588)
      ULONG DbgRequestUpdateHeader : 1;       // offset: 0x24c (588)
      ULONG DbgRequestDefferdFlush : 1;       // offset: 0x24c (588)
      ULONG DbgRequestDefferdFlushTimer : 1;  // offset: 0x24c (588)
      ULONG DbgRequestFlushTimer : 1;         // offset: 0x24c (588)
      ULONG DbgRequestUpdateDebugger : 1;     // offset: 0x24c (588)
      ULONG DbgSpareRequestFlags : 20;        // offset: 0x24c (588)
    };
  };
  struct _RTL_BITMAP HookIdMap;               // offset: 0x250 (592)
  struct _ETW_STACK_CACHE *StackCache;        // offset: 0x258 (600)
  struct _ETW_PMC_SUPPORT *PmcData;           // offset: 0x25c (604)
  struct _LIST_ENTRY WinRtProviderBinaryList; // offset: 0x260 (608)
  struct _WMI_BUFFER_HEADER **ScratchArray;   // offset: 0x268 (616)
};

// 0x108 (264) bytes
struct _POP_FX_DEVICE {
  struct _LIST_ENTRY Link;                     // offset: 0x0 (0)
  struct _POP_FX_PLUGIN *Plugin;               // offset: 0x8 (8)
  struct PEPHANDLE__ *PluginHandle;            // offset: 0xc (12)
  struct _POP_FX_PLUGIN *MiniPlugin;           // offset: 0x10 (16)
  struct PEPHANDLE__ *MiniPluginHandle;        // offset: 0x14 (20)
  struct _DEVICE_NODE *DevNode;                // offset: 0x18 (24)
  struct _DEVICE_OBJECT *DeviceObject;         // offset: 0x1c (28)
  struct _DEVICE_OBJECT *TargetDevice;         // offset: 0x20 (32)
  struct _POP_FX_DRIVER_CALLBACKS Callbacks;   // offset: 0x24 (36)
  VOID *DriverContext;                         // offset: 0x40 (64)
  struct _IO_REMOVE_LOCK RemoveLock;           // offset: 0x44 (68)
  struct _POP_FX_WORK_ORDER WorkOrder;         // offset: 0x5c (92)
  union _POP_FX_DEVICE_STATUS volatile Status; // offset: 0x70 (112)
  volatile LONG PowerReqCall;                  // offset: 0x74 (116)
  volatile LONG PowerNotReqCall;               // offset: 0x78 (120)
  ULONG IdleLock;                              // offset: 0x7c (124)
  struct _KTIMER IdleTimer;                    // offset: 0x80 (128)
  struct _KDPC IdleDpc;                        // offset: 0xa8 (168)
  ULONGLONG IdleTimeout;                       // offset: 0xc8 (200)
  ULONGLONG IdleStamp;                         // offset: 0xd0 (208)
  struct _IRP *Irp;                            // offset: 0xd8 (216)
  struct _POP_IRP_DATA *IrpData;               // offset: 0xdc (220)
  struct _DEVICE_OBJECT *NextIrpDeviceObject;  // offset: 0xe0 (224)
  union _POWER_STATE NextIrpPowerState;        // offset: 0xe4 (228)
  VOID (*NextIrpCallerCompletion)
  (struct _DEVICE_OBJECT *arg1, UCHAR arg2, union _POWER_STATE arg3, VOID *arg4,
   struct _IO_STATUS_BLOCK *arg5);         // offset: 0xe8 (232)
  VOID *NextIrpCallerContext;              // offset: 0xec (236)
  struct _KEVENT IrpCompleteEvent;         // offset: 0xf0 (240)
  ULONG ComponentCount;                    // offset: 0x100 (256)
  struct _POP_FX_COMPONENT *Components[1]; // offset: 0x104 (260)
};
...
struct _POP_FX_COMPONENT {
  ...
  struct _POP_FX_DEVICE *Device;                // offset: 0x28 (40)
  union _POP_FX_COMPONENT_FLAGS volatile Flags; // offset: 0x2c (44)
  volatile LONG Resident;                       // offset: 0x34 (52)
  struct _KEVENT ActiveEvent;                   // offset: 0x38 (56)
  ULONG IdleLock;                               // offset: 0x48 (72)
  volatile LONG IdleConditionComplete;          // offset: 0x4c (76)
  volatile LONG IdleStateComplete;              // offset: 0x50 (80)
  ULONGLONG IdleStamp;                          // offset: 0x58 (88)
  volatile ULONG CurrentIdleState;              // offset: 0x60 (96)
  ULONG IdleStateCount;                         // offset: 0x64 (100)
  struct _POP_FX_IDLE_STATE *IdleStates;        // offset: 0x68 (104)
  ULONG DeepestWakeableIdleState;               // offset: 0x6c (108)
  ULONG ProviderCount;                          // offset: 0x70 (112)
  struct _POP_FX_PROVIDER *Providers;           // offset: 0x74 (116)
  ULONG IdleProviderCount;                      // offset: 0x78 (120)
  ULONG DependentCount;                         // offset: 0x7c (124)
  struct _POP_FX_DEPENDENT *Dependents;         // offset: 0x80 (128)
};
...
struct _DEVICE_NODE {
  ...
  union _POWER_STATE CurrentPowerState;             // offset: 0x2c (44)
  struct _PO_DEVICE_NOTIFY Notify;                  // offset: 0x30 (48)
  struct _PO_IRP_MANAGER PoIrpManager;              // offset: 0x6c (108)
  struct _POP_FX_DEVICE *FxDevice;                  // offset: 0x7c (124)
  volatile LONG FxDeviceLock;                       // offset: 0x80 (128)
  struct _KEVENT FxRemoveEvent;                     // offset: 0x84 (132)
  volatile LONG FxActivationCount;                  // offset: 0x94 (148)
  volatile LONG FxSleepCount;                       // offset: 0x98 (152)
  struct _POP_FX_PLUGIN *Plugin;                    // offset: 0x9c (156)
...
struct _KTHREAD {
  ...
  union {
    struct {
      ULONG KernelStackResident : 1;     // offset: 0x58 (88)
      ...
      ULONG CodePatchInProgress : 1;     // offset: 0x58 (88)
      ...
      ULONG Reserved : 13;               // offset: 0x58 (88)
    };
  ...
  union {
    struct {
      ...
      ULONG ChargeOnlyGroup : 1;          // offset: 0x5c (92)
      ...
      ULONG ExplicitIdealProcessor : 1;   // offset: 0x5c (92)
      ULONG FreezeCount : 1;              // offset: 0x5c (92)
      ULONG EtwStackTraceApcInserted : 8; // offset: 0x5c (92)
      ULONG ReservedFlags : 10;           // offset: 0x5c (92)
    };
  ...
  struct _KQUEUE *volatile Queue; // offset: 0xa4 (164)
  ...
  volatile ULONG DeferredProcessor;  // offset: 0x14c (332)
  struct _KPROCESS *Process;         // offset: 0x150 (336)
  union {
    volatile struct _GROUP_AFFINITY UserAffinity; // offset: 0x154 (340)
    struct {
  ...
  union {
    volatile struct _GROUP_AFFINITY Affinity; // offset: 0x160 (352)
    struct {
...
struct _KINTERRUPT {
  ...
  ULONG DispatchCode[145];                            // offset: 0x54 (84)
  VOID *DisconnectData;                               // offset: 0x298 (664)
  struct _KTHREAD *volatile ServiceThread;            // offset: 0x29c (668)
};
...
struct _ETHREAD {
  ...
  union _LARGE_INTEGER CreateTime; // offset: 0x1e8 (488)
  union {
    union _LARGE_INTEGER ExitTime;     // offset: 0x1f0 (496)
    struct _LIST_ENTRY KeyedWaitChain; // offset: 0x1f0 (496)
  };
  VOID *ChargeOnlySession; // offset: 0x1f8 (504)
  union {
    struct _LIST_ENTRY PostBlockList; // offset: 0x1fc (508)
    struct {
      VOID *ForwardLinkShadow; // offset: 0x1fc (508)
      VOID *StartAddress;      // offset: 0x200 (512)
    };
  };
  union {
    struct _TERMINATION_PORT *TerminationPort; // offset: 0x204 (516)
    struct _ETHREAD *ReaperLink;               // offset: 0x204 (516)
    VOID *KeyedWaitValue;                      // offset: 0x204 (516)
  };
  ULONG ActiveTimerListLock;              // offset: 0x208 (520)
  struct _LIST_ENTRY ActiveTimerListHead; // offset: 0x20c (524)
  struct _CLIENT_ID Cid;                  // offset: 0x214 (532)
  union {
    struct _KSEMAPHORE KeyedWaitSemaphore; // offset: 0x21c (540)
    struct _KSEMAPHORE AlpcWaitSemaphore;  // offset: 0x21c (540)
  };
  union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity; // offset: 0x230 (560)
  struct _LIST_ENTRY IrpList;                       // offset: 0x234 (564)
  ULONG TopLevelIrp;                                // offset: 0x23c (572)
  struct _DEVICE_OBJECT *DeviceToVerify;            // offset: 0x240 (576)
  VOID *Win32StartAddress;                          // offset: 0x244 (580)
  VOID *LegacyPowerObject;                          // offset: 0x248 (584)
  struct _LIST_ENTRY ThreadListEntry;               // offset: 0x24c (588)
  struct _EX_RUNDOWN_REF RundownProtect;            // offset: 0x254 (596)
  struct _EX_PUSH_LOCK ThreadLock;                  // offset: 0x258 (600)
  ULONG ReadClusterSize;                            // offset: 0x25c (604)
  volatile LONG MmLockOrdering;                     // offset: 0x260 (608)
  volatile LONG CmLockOrdering;                     // offset: 0x264 (612)
  union {
    ULONG CrossThreadFlags; // offset: 0x268 (616)
    struct {
      ULONG Terminated : 1;                // offset: 0x268 (616)
      ULONG ThreadInserted : 1;            // offset: 0x268 (616)
      ULONG HideFromDebugger : 1;          // offset: 0x268 (616)
      ULONG ActiveImpersonationInfo : 1;   // offset: 0x268 (616)
      ULONG HardErrorsAreDisabled : 1;     // offset: 0x268 (616)
      ULONG BreakOnTermination : 1;        // offset: 0x268 (616)
      ULONG SkipCreationMsg : 1;           // offset: 0x268 (616)
      ULONG SkipTerminationMsg : 1;        // offset: 0x268 (616)
      ULONG CopyTokenOnOpen : 1;           // offset: 0x268 (616)
      ULONG ThreadIoPriority : 3;          // offset: 0x268 (616)
      ULONG ThreadPagePriority : 3;        // offset: 0x268 (616)
      ULONG RundownFail : 1;               // offset: 0x268 (616)
      ULONG UmsForceQueueTermination : 1;  // offset: 0x268 (616)
      ULONG ReservedCrossThreadFlags : 15; // offset: 0x268 (616)
    };
  };
  union {
    ULONG SameThreadPassiveFlags; // offset: 0x26c (620)
    struct {
      ULONG ActiveExWorker : 1;  // offset: 0x26c (620)
      ULONG MemoryMaker : 1;     // offset: 0x26c (620)
      ULONG ClonedThread : 1;    // offset: 0x26c (620)
      ULONG KeyedEventInUse : 1; // offset: 0x26c (620)
      ULONG SelfTerminate : 1;   // offset: 0x26c (620)
    };
  };
  union {
    ULONG SameThreadApcFlags; // offset: 0x270 (624)
    struct {
      UCHAR Spare : 1;                              // offset: 0x270 (624)
      volatile UCHAR StartAddressInvalid : 1;       // offset: 0x270 (624)
      UCHAR EtwCalloutActive : 1;                   // offset: 0x270 (624)
      UCHAR OwnsProcessWorkingSetExclusive : 1;     // offset: 0x270 (624)
      UCHAR OwnsProcessWorkingSetShared : 1;        // offset: 0x270 (624)
      UCHAR OwnsSystemCacheWorkingSetExclusive : 1; // offset: 0x270 (624)
      UCHAR OwnsSystemCacheWorkingSetShared : 1;    // offset: 0x270 (624)
      UCHAR OwnsSessionWorkingSetExclusive : 1;     // offset: 0x270 (624)
      UCHAR OwnsSessionWorkingSetShared : 1;        // offset: 0x271 (625)
      UCHAR OwnsProcessAddressSpaceExclusive : 1;   // offset: 0x271 (625)
      UCHAR OwnsProcessAddressSpaceShared : 1;      // offset: 0x271 (625)
      UCHAR SuppressSymbolLoad : 1;                 // offset: 0x271 (625)
      UCHAR Prefetching : 1;                        // offset: 0x271 (625)
      UCHAR OwnsVadExclusive : 1;                   // offset: 0x271 (625)
      UCHAR OwnsChangeControlAreaExclusive : 1;     // offset: 0x271 (625)
      UCHAR OwnsChangeControlAreaShared : 1;        // offset: 0x271 (625)
      UCHAR OwnsPagedPoolWorkingSetExclusive : 1;   // offset: 0x272 (626)
      UCHAR OwnsPagedPoolWorkingSetShared : 1;      // offset: 0x272 (626)
      UCHAR OwnsSystemPtesWorkingSetExclusive : 1;  // offset: 0x272 (626)
      UCHAR OwnsSystemPtesWorkingSetShared : 1;     // offset: 0x272 (626)
      UCHAR TrimTrigger : 2;                        // offset: 0x272 (626)
      UCHAR Spare2 : 2;                             // offset: 0x272 (626)
      UCHAR PriorityRegionActive;                   // offset: 0x273 (627)
    };
  };
  UCHAR CacheManagerActive;         // offset: 0x274 (628)
  UCHAR DisablePageFaultClustering; // offset: 0x275 (629)
  UCHAR ActiveFaultCount;           // offset: 0x276 (630)
  UCHAR LockOrderState;             // offset: 0x277 (631)
  ULONG AlpcMessageId;              // offset: 0x278 (632)
  union {
    VOID *AlpcMessage;             // offset: 0x27c (636)
    ULONG AlpcReceiveAttributeSet; // offset: 0x27c (636)
  };
  LONG ExitStatus;                              // offset: 0x280 (640)
  struct _LIST_ENTRY AlpcWaitListEntry;         // offset: 0x284 (644)
  ULONG CacheManagerCount;                      // offset: 0x28c (652)
  ULONG IoBoostCount;                           // offset: 0x290 (656)
  struct _LIST_ENTRY BoostList;                 // offset: 0x294 (660)
  struct _LIST_ENTRY DeboostList;               // offset: 0x29c (668)
  ULONG BoostListLock;                          // offset: 0x2a4 (676)
  ...
  struct _GUID *ActivityId;                     // offset: 0x2b4 (692)
  VOID *WnfContext;                             // offset: 0x2b8 (696)
  ULONG KernelStackReference;                   // offset: 0x2bc (700)
};
...
struct _KPRCB {
  ...
  UCHAR PendingTick;                             // offset: 0x3d1 (977)
  UCHAR PrcbPad1[70];                            // offset: 0x3d2 (978)
  ...
  UCHAR PrcbPad50[48];                              // offset: 0x21a8 (8616)
  ULONG InterruptLastCount;                         // offset: 0x21d8 (8664)
  ULONG InterruptRate;                              // offset: 0x21dc (8668)
  struct _KDPC_DATA DpcData[2];                     // offset: 0x21e0 (8672)
  VOID *DpcStack;                                   // offset: 0x2208 (8712)
  LONG MaximumDpcQueueDepth;                        // offset: 0x220c (8716)
  ULONG DpcRequestRate;                             // offset: 0x2210 (8720)
  ULONG MinimumDpcRate;                             // offset: 0x2214 (8724)
  ULONG DpcLastCount;                               // offset: 0x2218 (8728)
  ULONG PrcbLock;                                   // offset: 0x221c (8732)
  struct _KGATE DpcGate;                            // offset: 0x2220 (8736)
  UCHAR ThreadDpcEnable;                            // offset: 0x2230 (8752)
  volatile UCHAR QuantumEnd;                        // offset: 0x2231 (8753)
  volatile UCHAR DpcRoutineActive;                  // offset: 0x2232 (8754)
  volatile UCHAR IdleSchedule;                      // offset: 0x2233 (8755)
  union {
    volatile LONG DpcRequestSummary; // offset: 0x2234 (8756)
    SHORT DpcRequestSlot[2];         // offset: 0x2234 (8756)
    struct {
      SHORT NormalDpcState; // offset: 0x2234 (8756)
      SHORT ThreadDpcState; // offset: 0x2236 (8758)
    };
    struct {
      ULONG DpcNormalProcessingActive : 1;    // offset: 0x2234 (8756)
      ULONG DpcNormalProcessingRequested : 1; // offset: 0x2234 (8756)
      ULONG DpcNormalThreadSignal : 1;        // offset: 0x2234 (8756)
      ULONG DpcNormalTimerExpiration : 1;     // offset: 0x2234 (8756)
      ULONG DpcNormalDpcPresent : 1;          // offset: 0x2234 (8756)
      ULONG DpcNormalLocalInterrupt : 1;      // offset: 0x2234 (8756)
      ULONG DpcNormalSpare : 10;              // offset: 0x2234 (8756)
      ULONG DpcThreadActive : 1;              // offset: 0x2234 (8756)
      ULONG DpcThreadRequested : 1;           // offset: 0x2234 (8756)
      ULONG DpcThreadSpare : 14;              // offset: 0x2234 (8756)
    };
  };
  ULONG LastTimerHand;                             // offset: 0x2238 (8760)
  ULONG LastTick;                                  // offset: 0x223c (8764)
  ULONG PeriodicCount;                             // offset: 0x2240 (8768)
  ULONG PeriodicBias;                              // offset: 0x2244 (8772)
  ULONG ClockInterrupts;                           // offset: 0x2248 (8776)
  ULONG ReadyScanTick;                             // offset: 0x224c (8780)
  UCHAR BalanceState;                              // offset: 0x2250 (8784)
  UCHAR GroupSchedulingOverQuota;                  // offset: 0x2251 (8785)
  UCHAR PrcbPad41[10];                             // offset: 0x2252 (8786)
  ...
  struct _LIST_ENTRY WaitListHead;                 // offset: 0x3ae0 (15072)
  ULONG WaitLock;                                  // offset: 0x3ae8 (15080)
  ULONG ReadySummary;                              // offset: 0x3aec (15084)
  ULONG ReadyQueueWeight;                          // offset: 0x3af0 (15088)
  struct _KPRCB *BuddyPrcb;                        // offset: 0x3af4 (15092)
  ...
  volatile ULONG HighCycleTime;                    // offset: 0x3b10 (15120)
  ULONG ScbOffset;                                 // offset: 0x3b14 (15124)
  ULONGLONG AffinitizedCycles;                     // offset: 0x3b18 (15128)
  ...
  ULONG Stride;                                    // offset: 0x3ca8 (15528)
  ULONG PrcbPad90;                                 // offset: 0x3cac (15532)
  struct _PROCESSOR_POWER_STATE PowerState;        // offset: 0x3cb0 (15536)
  ULONG PrcbPad91[1];                              // offset: 0x3e30 (15920)
  struct _KDPC DpcWatchdogDpc;                     // offset: 0x3e34 (15924)
  struct _KTIMER DpcWatchdogTimer;                 // offset: 0x3e58 (15960)
  union _SLIST_HEADER HypercallPageList;           // offset: 0x3e80 (16000)
  VOID *HypercallPageVirtual;                      // offset: 0x3e88 (16008)
  VOID *VirtualApicAssist;                         // offset: 0x3e8c (16012)
  ULONGLONG *StatisticsPage;                       // offset: 0x3e90 (16016)
  struct _CACHE_DESCRIPTOR Cache[5];               // offset: 0x3e94 (16020)
  ULONG CacheCount;                                // offset: 0x3ed0 (16080)
  struct _KAFFINITY_EX PackageProcessorSet;        // offset: 0x3ed4 (16084)
  ULONG CacheProcessorMask[5];                     // offset: 0x3ee0 (16096)
  ULONG ScanSiblingMask;                           // offset: 0x3ef4 (16116)
  ULONG CoreProcessorSet;                          // offset: 0x3ef8 (16120)
  ULONG ScanSiblingIndex;                          // offset: 0x3efc (16124)
  ULONG LLCLevel;                                  // offset: 0x3f00 (16128)
  VOID *WheaInfo;                                  // offset: 0x3f04 (16132)
  VOID *EtwSupport;                                // offset: 0x3f08 (16136)
  union _SLIST_HEADER InterruptObjectPool;         // offset: 0x3f10 (16144)
  ULONG PrcbPad92[8];                              // offset: 0x3f18 (16152)
  struct _PROCESSOR_PROFILE_CONTROL_AREA
      *ProcessorProfileControlArea;                 // offset: 0x3f38 (16184)
  VOID *ProfileEventIndexAddress;                   // offset: 0x3f3c (16188)
  struct _KDPC TimerExpirationDpc;                  // offset: 0x3f40 (16192)
  struct _SYNCH_COUNTERS SynchCounters;             // offset: 0x3f60 (16224)
  struct _FILESYSTEM_DISK_COUNTERS FsCounters;      // offset: 0x4018 (16408)
  struct _CONTEXT *Context;                         // offset: 0x4028 (16424)
  ULONG ContextFlagsInit;                           // offset: 0x402c (16428)
  struct _XSAVE_AREA *ExtendedState;                // offset: 0x4030 (16432)
  struct _KENTROPY_TIMING_STATE EntropyTimingState; // offset: 0x4034 (16436)
};
...
struct _EPROCESS {
  ...
  union {
    ...
    struct {
      ...
      ULONG NoWakeCharge : 1;                 // offset: 0xc0 (192)
      ULONG HandleTableRundown : 1;           // offset: 0xc0 (192)
      ULONG NeedsHandleRundown : 1;           // offset: 0xc0 (192)
      ULONG RefTraceEnabled : 1;              // offset: 0xc0 (192)
      ULONG NumaAware : 1;                    // offset: 0xc0 (192)
  ...
  union {
    ...
    struct {
      ...
      ULONG Wow64SplitPages : 1;         // offset: 0xc4 (196)
      ...
      ULONG CrossSessionCreate : 1;      // offset: 0xc4 (196)
  ...
  struct _ETHREAD *RotateInProgress;          // offset: 0xf8 (248)
  struct _ETHREAD *ForkInProgress;            // offset: 0xfc (252)
  ULONG HardwareTrigger;                      // offset: 0x100 (256)
  struct _EJOB *volatile CommitChargeJob;     // offset: 0x104 (260)
  struct _MM_AVL_TABLE *CloneRoot;            // offset: 0x108 (264)
  ...
  union {
    struct _EPROCESS *CreatorProcess; // offset: 0x13c (316)
    ULONG ConsoleHostProcess;         // offset: 0x13c (316)
  };
  ...
  struct _MM_AVL_TABLE *LockedPagesList;    // offset: 0x1b0 (432)
  ...
  struct _MM_AVL_TABLE VadRoot;             // offset: 0x274 (628)
  volatile ULONG VadPhysicalPages;          // offset: 0x28c (652)
  ULONG VadPhysicalPagesLimit;              // offset: 0x290 (656)
  struct _ALPC_PROCESS_CONTEXT AlpcContext; // offset: 0x294 (660)
  struct _LIST_ENTRY TimerResolutionLink;   // offset: 0x2a4 (676)
  struct _PO_DIAG_STACK_RECORD
      *TimerResolutionStackRecord;             // offset: 0x2ac (684)
  ULONG RequestedTimerResolution;              // offset: 0x2b0 (688)
  ULONG SmallestTimerResolution;               // offset: 0x2b4 (692)
  union _LARGE_INTEGER ExitTime;               // offset: 0x2b8 (696)
  ULONG ActiveThreadsHighWatermark;            // offset: 0x2c0 (704)
  ULONG LargePrivateVadCount;                  // offset: 0x2c4 (708)
  struct _EX_PUSH_LOCK ThreadListLock;         // offset: 0x2c8 (712)
  VOID *WnfContext;                            // offset: 0x2cc (716)
  ULONG SectionMappingSize;                    // offset: 0x2d0 (720)
  UCHAR SignatureLevel;                        // offset: 0x2d4 (724)
  UCHAR SectionSignatureLevel;                 // offset: 0x2d5 (725)
  UCHAR SpareByte20[2];                        // offset: 0x2d6 (726)
  ULONG KeepAliveCounter;                      // offset: 0x2d8 (728)
  struct _PROCESS_DISK_COUNTERS *DiskCounters; // offset: 0x2dc (732)
...
struct _KUSER_SHARED_DATA {
  ...
  volatile ULONGLONG TimeUpdateSequence;      // offset: 0x340 (832)
  ...
  union {
    USHORT TscQpcData; // offset: 0x3c6 (966)
    struct {
      volatile UCHAR TscQpcEnabled; // offset: 0x3c6 (966)
      UCHAR TscQpcShift;            // offset: 0x3c7 (967)
    };
  };
