...
// 0x10 bytes (sizeof)
typedef struct __anon_1862 {
  struct _LIST_ENTRY ListHead; // offset: 0x0 ordinal: 0x0
} __anon_1862;

typedef VOID (*__anon_524)(struct _DEVICE_OBJECT *, struct _DEVICE_OBJECT *);

typedef VOID (*__anon_523)(struct _FILE_OBJECT *);

typedef VOID (*__anon_470)(struct _DRIVER_OBJECT *);

typedef VOID (*__anon_105)();

// 0x10 bytes (sizeof)
typedef struct __anon_1861 {
...
typedef VOID (*__anon_475)(struct _DEVICE_OBJECT *, VOID *);
...
typedef VOID (*__anon_380)(VOID *, VOID *, VOID *, VOID *);

typedef VOID (*__anon_363)(VOID *, VOID *, VOID *);

typedef VOID (*__anon_326)(VOID *);
...
typedef enum _WOW64_SHARED_INFORMATION {
  ...
  SharedNtdll32RtlpWnfNotificationThread = 12,          // ordinal: 0xc
  SharedNtdll32LdrSystemDllInitBlock = 13,              // ordinal: 0xd
  Wow64SharedPageEntriesCount = 14,                     // ordinal: 0xe
...
typedef enum _PS_WAKE_REASON {
  ...
  PsMaxWakeReasons = 4,              // ordinal: 0x4
} _PS_WAKE_REASON;
...
typedef enum _WORK_QUEUE_TYPE {
  CriticalWorkQueue = 0,        // ordinal: 0x0
  DelayedWorkQueue = 1,         // ordinal: 0x1
  HyperCriticalWorkQueue = 2,   // ordinal: 0x2
  NormalWorkQueue = 3,          // ordinal: 0x3
  BackgroundWorkQueue = 4,      // ordinal: 0x4
  RealTimeWorkQueue = 5,        // ordinal: 0x5
  SuperCriticalWorkQueue = 6,   // ordinal: 0x6
  MaximumWorkQueue = 7,         // ordinal: 0x7
  CustomPriorityWorkQueue = 32, // ordinal: 0x8
} _WORK_QUEUE_TYPE;
...
typedef enum _DEVPROP_OPERATOR {
  ...
  DEVPROP_OPERATOR_LIST_CONTAINS = 4096,               // ordinal: 0xe
  DEVPROP_OPERATOR_LIST_CONTAINS_IGNORE_CASE = 135168, // ordinal: 0xf
  DEVPROP_OPERATOR_AND_OPEN = 1048576,                 // ordinal: 0x10
  DEVPROP_OPERATOR_AND_CLOSE = 2097152,                // ordinal: 0x11
  DEVPROP_OPERATOR_OR_OPEN = 3145728,                  // ordinal: 0x12
  DEVPROP_OPERATOR_OR_CLOSE = 4194304,                 // ordinal: 0x13
  DEVPROP_OPERATOR_NOT_OPEN = 5242880,                 // ordinal: 0x14
  DEVPROP_OPERATOR_NOT_CLOSE = 6291456,                // ordinal: 0x15
  DEVPROP_OPERATOR_MASK_EVAL = 4095,                   // ordinal: 0x16
  DEVPROP_OPERATOR_MASK_LIST = 61440,                  // ordinal: 0x17
  DEVPROP_OPERATOR_MASK_MODIFIER = 983040,             // ordinal: 0x18
  DEVPROP_OPERATOR_MASK_NOT_LOGICAL = 1048575,         // ordinal: 0x19
  DEVPROP_OPERATOR_MASK_LOGICAL = -1048576,            // ordinal: 0x1a
} _DEVPROP_OPERATOR;
...
typedef enum _JOBOBJECTINFOCLASS {
  ...
  JobObjectReserved1Information = 18,              // ordinal: 0x19
  JobObjectReserved2Information = 19,              // ordinal: 0x1a
  JobObjectReserved3Information = 20,              // ordinal: 0x1b
  JobObjectReserved4Information = 21,              // ordinal: 0x1c
  JobObjectReserved5Information = 22,              // ordinal: 0x1d
  JobObjectReserved6Information = 23,              // ordinal: 0x1e
  JobObjectReserved7Information = 24,              // ordinal: 0x1f
  JobObjectReserved8Information = 25,              // ordinal: 0x20
  MaxJobObjectInfoClass = 26,                      // ordinal: 0x21
} _JOBOBJECTINFOCLASS;
...
typedef enum _DPFLTR_TYPE {
  ...
  DPFLTR_POWER_ID = 146,         // ordinal: 0x92
  DPFLTR_CRASHDUMPXHCI_ID = 147, // ordinal: 0x93
  DPFLTR_GPIO_ID = 148,          // ordinal: 0x94
  DPFLTR_REFS_ID = 149,          // ordinal: 0x95
  DPFLTR_ENDOFTABLE_ID = 150,    // ordinal: 0x96
} _DPFLTR_TYPE;
...
typedef enum _TRACE_INFORMATION_CLASS {
  ...
  HypervisorStackwalkRoutineClass = 14, // ordinal: 0x10
  WdfNotifyRoutinesClass = 15,          // ordinal: 0x11
  MaxTraceInformationClass = 16,        // ordinal: 0x12
...
typedef enum _POWER_REQUEST_TYPE_INTERNAL {
  ...
  PowerRequestAudioAnyInternal = 5,          // ordinal: 0x5
  PowerRequestAudioOffloadInternal = 6,      // ordinal: 0x6
  PowerRequestVideoBatchingInternal = 7,     // ordinal: 0x7
  PowerRequestFullScreenVideoInternal = 8,   // ordinal: 0x8
  PowerRequestInternalInvalid = 9,           // ordinal: 0x9
...
typedef enum _TOKEN_INFORMATION_CLASS {
  ...
  MaxTokenInfoClass = 41,                    // ordinal: 0x28
...
typedef enum _ETW_NOTIFICATION_TYPE {
  ...
  EtwNotificationTypeMax = 10,          // ordinal: 0x9
...
typedef enum _FILE_INFORMATION_CLASS {
  ...
  FileMaximumInformation = 61,                  // ordinal: 0x3c
...
// 0x2 bytes (sizeof)
typedef struct __anon_1059 {
  WCHAR DeviceId[1]; // offset: 0x0 ordinal: 0x0
} __anon_1059;

typedef LONGLONG (*__anon_1326)();

// 0x8 bytes (sizeof)
typedef union __anon_642 {
  LONGLONG Balance : 2;        // offset: 0x0 ordinal: 0x0
  struct _MM_AVL_NODE *Parent; // offset: 0x0 ordinal: 0x1
} __anon_642;

// 0x18 bytes (sizeof)
typedef struct _MM_AVL_NODE {
  union __anon_642 u1;             // offset: 0x0 ordinal: 0x0
  struct _MM_AVL_NODE *LeftChild;  // offset: 0x8 ordinal: 0x1
  struct _MM_AVL_NODE *RightChild; // offset: 0x10 ordinal: 0x2
} _MM_AVL_NODE;
...
typedef struct _MMINPAGE_FLAGS {
  ...
  UCHAR Spare1 : 2;                  // offset: 0x3 ordinal: 0x13
} _MMINPAGE_FLAGS;

// 0x1 bytes (sizeof)
typedef union __anon_1699 {
...
typedef UCHAR (*__anon_1282)(struct _EPROCESS *, VOID *, VOID *, CHAR);
...
// 0x1 bytes (sizeof)
typedef union __anon_1207 {
  struct __anon_1206 s1; // offset: 0x0 ordinal: 0x0
  UCHAR Flags;           // offset: 0x0 ordinal: 0x1
} __anon_1207;

typedef UCHAR (*__anon_1158)(VOID *, UCHAR);
...
typedef struct _MMSUPPORT_FLAGS {
  ...
  UCHAR MemoryPriority : 8;        // offset: 0x2 ordinal: 0x8
  ...
  UCHAR Available : 5;             // offset: 0x3 ordinal: 0xc
} _MMSUPPORT_FLAGS;

typedef UCHAR (*__anon_528)(struct _FILE_OBJECT *, struct _MDL *,
                            struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_368)(VOID *);
...
typedef VOID (*__anon_290)(struct _KDPC *, VOID *, VOID *, VOID *);
...
typedef struct _SEGMENT_FLAGS {
  ...
  USHORT Spare1 : 1;                 // offset: 0x0 ordinal: 0x3
  ...
  UCHAR ILOnly : 1;                  // offset: 0x3 ordinal: 0xb
  UCHAR Spare : 3;                   // offset: 0x3 ordinal: 0xc
  UCHAR ImageSigningLevel : 4;       // offset: 0x3 ordinal: 0xd
} _SEGMENT_FLAGS;

// 0x4 bytes (sizeof)
typedef struct __anon_846 {
  union {
...
// 0x4 bytes (sizeof)
typedef union __anon_848 {
  USHORT ReferenceCount; // offset: 0x0 ordinal: 0x0
  struct _MMPFNENTRY e1; // offset: 0x2 ordinal: 0x1
  struct __anon_846 e2;  // offset: 0x0 ordinal: 0x2
} __anon_848;
...
typedef VOID (*__anon_1135)(VOID *, USHORT *);
...
typedef struct _PROCESSOR_IDLE_DEPENDENCY {
  struct _PROCESSOR_NUMBER Processor; // offset: 0x0 ordinal: 0x0
...
typedef struct _PNP_RESERVED_PROVIDER_INFO {
  ...
  struct _LIST_ENTRY DependentList;     // offset: 0x10 ordinal: 0x1
  struct _UNICODE_STRING ReservationId; // offset: 0x20 ordinal: 0x2
  LONG ReferenceCount;                  // offset: 0x30 ordinal: 0x3
} _PNP_RESERVED_PROVIDER_INFO;

// 0x8 bytes (sizeof)
typedef union __anon_1707 {
  struct _DEVICE_OBJECT *ProviderPdo; // offset: 0x0 ordinal: 0x0
  struct _PNP_RESERVED_PROVIDER_INFO
      *ProviderReservation; // offset: 0x0 ordinal: 0x1
} __anon_1707;

// 0x20 bytes (sizeof)
typedef struct _PNP_PROVIDER_INFO {
  struct _LIST_ENTRY ListEntry; // offset: 0x0 ordinal: 0x0
  UCHAR ProviderType;           // offset: 0x10 ordinal: 0x1
  UCHAR Satisfied;              // offset: 0x11 ordinal: 0x2
  USHORT Flags;                 // offset: 0x12 ordinal: 0x3
  union __anon_1707 u;          // offset: 0x18 ordinal: 0x4
} _PNP_PROVIDER_INFO;
...
typedef LONG (*__anon_533)(struct _FILE_OBJECT *, struct _DEVICE_OBJECT *);

typedef LONG (*__anon_511)(struct _DRIVER_OBJECT *, struct _DEVICE_OBJECT *);

typedef LONG (*__anon_468)(struct _DRIVER_OBJECT *, struct _UNICODE_STRING *);
...
typedef struct _DISPATCHER_HEADER {
  ...
  union {
    UCHAR Abandoned;  // offset: 0x1 ordinal: 0x5
    UCHAR Signalling; // offset: 0x1 ordinal: 0x6
  };
  union {
    UCHAR ThreadControlFlags; // offset: 0x2 ordinal: 0x7
    UCHAR CycleProfiling : 1; // offset: 0x2 ordinal: 0x8
  };
  UCHAR CounterProfiling : 1; // offset: 0x2 ordinal: 0x9
  UCHAR GroupScheduling : 1;  // offset: 0x2 ordinal: 0xa
  UCHAR AffinitySet : 1;      // offset: 0x2 ordinal: 0xb
  UCHAR Reserved : 4;         // offset: 0x2 ordinal: 0xc
  union {
  ...
  union {
    ...
    LONG LockNV; // offset: 0x0 ordinal: 0x1b
  };
  LONG SignalState;                // offset: 0x4 ordinal: 0x1c
  struct _LIST_ENTRY WaitListHead; // offset: 0x8 ordinal: 0x1d
} _DISPATCHER_HEADER;
...
typedef struct _HIVE_WAIT_PACKET {
  ...
  UCHAR PrimaryFileWritten;       // offset: 0x28 ordinal: 0x3
} _HIVE_WAIT_PACKET;
...
typedef struct _VI_DEADLOCK_NODE {
  ...
  union __anon_1854 u1;                    // offset: 0x48 ordinal: 0x7
...
// 0x4 bytes (sizeof)
typedef union __anon_1823 {
  ULONG LongFlags;                      // offset: 0x0 ordinal: 0x0
  struct _MM_SESSION_SPACE_FLAGS Flags; // offset: 0x0 ordinal: 0x1
} __anon_1823;

typedef VOID (*__anon_1812)(enum _DUMP_EVENTS, VOID *, ULONG);

typedef LONG (*__anon_1810)(ULONG, ULONG, VOID *, ULONG);

// 0x8 bytes (sizeof)
typedef struct __anon_1807 {
  ULONG Signature; // offset: 0x0 ordinal: 0x0
...
typedef struct _MMSECURE_FLAGS {
  ...
  ULONG Spare : 9;       // offset: 0x0 ordinal: 0x3
} _MMSECURE_FLAGS;

// 0x8 bytes (sizeof)
typedef union __anon_1739 {
...
typedef struct _MMADDRESS_LIST {
  union __anon_1739 u1; // offset: 0x0 ordinal: 0x0
...
typedef struct _IMAGE_SECTION_HEADER {
  ...
  union __anon_1716 Misc;     // offset: 0x8 ordinal: 0x1
...
typedef struct PROCESSOR_PERFSTATE_POLICY {
  ...
  union {
    ...
    union __anon_1699 Flags; // offset: 0x7 ordinal: 0x5
  };
...
// 0x4 bytes (sizeof)
typedef union __anon_1696 {
  struct __anon_1698 Flags; // offset: 0x0 ordinal: 0x0
  ULONG Whole;              // offset: 0x0 ordinal: 0x1
} __anon_1696;

// 0x4 bytes (sizeof)
typedef struct __anon_1686 {
  ULONG SnapSharedExportsFailed : 1; // offset: 0x0 ordinal: 0x0
  ULONG Spare : 31;                  // offset: 0x0 ordinal: 0x1
} __anon_1686;

// 0x20 bytes (sizeof)
typedef union __anon_1687 {
  struct _VF_TARGET_ALL_SHARED_EXPORT_THUNKS
      AllSharedExportThunks; // offset: 0x0 ordinal: 0x0
  struct __anon_1686 Flags;  // offset: 0x0 ordinal: 0x1
} __anon_1687;

// 0x4 bytes (sizeof)
typedef struct __anon_1682 {
  ULONG Type; // offset: 0x0 ordinal: 0x0
} __anon_1682;

// 0x4 bytes (sizeof)
typedef struct __anon_1681 {
...
typedef struct _POP_ACTION_TRIGGER {
  ...
  union {
    struct __anon_1681 Battery; // offset: 0x10 ordinal: 0x3
    struct __anon_1682 Button;  // offset: 0x10 ordinal: 0x4
  };
} _POP_ACTION_TRIGGER;
...
typedef struct _KTRANSACTION_HISTORY {
  enum __anon_1522 RecordType; // offset: 0x0 ordinal: 0x0
  ULONG Payload;               // offset: 0x4 ordinal: 0x1
} _KTRANSACTION_HISTORY;

// 0x8 bytes (sizeof)
typedef struct __anon_1516 {
...
typedef VOID (*__anon_1525)(struct _RTL_AVL_TABLE *, VOID *);

typedef VOID *(*__anon_1524)(struct _RTL_AVL_TABLE *, ULONG);

typedef enum _RTL_GENERIC_COMPARE_RESULTS (*__anon_1523)(
...
// 0x4 bytes (sizeof)
typedef struct __anon_1418 {
  ULONG PollInterval; // offset: 0x0 ordinal: 0x0
} __anon_1418;

// 0x18 bytes (sizeof)
typedef union __anon_1415 {
  struct __anon_1418 Polled;         // offset: 0x0 ordinal: 0x0
  struct __anon_1419 Interrupt;      // offset: 0x0 ordinal: 0x1
  struct __anon_1419 LocalInterrupt; // offset: 0x0 ordinal: 0x2
  struct __anon_1419 Sci;            // offset: 0x0 ordinal: 0x3
  struct __anon_1419 Nmi;            // offset: 0x0 ordinal: 0x4
} __anon_1415;
...
typedef struct _WHEA_NOTIFICATION_DESCRIPTOR {
  ...
  union __anon_1415 u;                  // offset: 0x4 ordinal: 0x3
} _WHEA_NOTIFICATION_DESCRIPTOR;

// 0x4 bytes (sizeof)
typedef union __anon_1416 {
  struct __anon_1420 bits; // offset: 0x0 ordinal: 0x0
  ULONG AsULONG;           // offset: 0x0 ordinal: 0x1
} __anon_1416;

// 0x4 bytes (sizeof)
typedef struct _WHEA_PCI_SLOT_NUMBER {
  union __anon_1416 u; // offset: 0x0 ordinal: 0x0
...
typedef VOID (*__anon_1276)(VOID *, struct _OBJECT_DUMP_CONTROL *);
...
// 0x4 bytes (sizeof)
typedef struct __anon_1265 {
  ULONG Secure : 1; // offset: 0x0 ordinal: 0x0
} __anon_1265;

// 0x4 bytes (sizeof)
typedef union __anon_1264 {
  struct __anon_1265 s1; // offset: 0x0 ordinal: 0x0
} __anon_1264;
...
typedef union __anon_1256 {
  struct __anon_1261 s1; // offset: 0x0 ordinal: 0x0
} __anon_1256;

// 0x4 bytes (sizeof)
typedef struct __anon_1259 {
...
typedef union __anon_1254 {
  struct __anon_1259 s1; // offset: 0x0 ordinal: 0x0
} __anon_1254;
...
// 0x4 bytes (sizeof)
typedef union __anon_1237 {
  struct __anon_1243 s1; // offset: 0x0 ordinal: 0x0
...
// 0x4 bytes (sizeof)
typedef union __anon_1224 {
  struct __anon_1232 s1; // offset: 0x0 ordinal: 0x0
  ULONG State;           // offset: 0x0 ordinal: 0x1
} __anon_1224;
...
// 0x4 bytes (sizeof)
typedef union __anon_1210 {
  struct __anon_1209 s1; // offset: 0x0 ordinal: 0x0
} __anon_1210;
...
// 0x4 bytes (sizeof)
typedef union __anon_1198 {
  struct __anon_1197 s2; // offset: 0x0 ordinal: 0x0
  ULONG ZeroInit;        // offset: 0x0 ordinal: 0x1
} __anon_1198;

// 0x4 bytes (sizeof)
typedef union __anon_1196 {
  struct __anon_1195 s1; // offset: 0x0 ordinal: 0x0
  ULONG Length;          // offset: 0x0 ordinal: 0x1
} __anon_1196;

// 0x18 bytes (sizeof)
typedef struct _PORT_MESSAGE32 {
  union __anon_1196 u1; // offset: 0x0 ordinal: 0x0
  union __anon_1198 u2; // offset: 0x4 ordinal: 0x1
  union {
...
typedef ULONG (*__anon_1054)(VOID *);

typedef ULONG (*__anon_1053)(VOID *, enum PROFILE_DEPARTURE_STYLE);
...
typedef VOID (*__anon_1035)(VOID *, ULONG, UCHAR);

typedef VOID (*__anon_1033)(VOID *, ULONG, ULONG);
...
typedef UCHAR (*__anon_1029)(struct PEPHANDLE__ *, ULONG, VOID *);

typedef UCHAR (*__anon_1028)(ULONG, VOID *);
...
// 0x4 bytes (sizeof)
typedef struct __anon_946 {
  union __anon_947 u; // offset: 0x0 ordinal: 0x0
} __anon_946;

// 0x4 bytes (sizeof)
typedef union __anon_945 {
  struct __anon_946 NewCell; // offset: 0x0 ordinal: 0x0
} __anon_945;

// 0x8 bytes (sizeof)
typedef struct _HCELL {
  LONG Size;          // offset: 0x0 ordinal: 0x0
  union __anon_945 u; // offset: 0x4 ordinal: 0x1
} _HCELL;
...
typedef VOID *(*__anon_920)(ULONG, UCHAR, ULONG);
...
typedef union _MM_PAGE_ACCESS_INFO_FLAGS {
  struct __anon_803 File;    // offset: 0x0 ordinal: 0x0
  struct __anon_804 Private; // offset: 0x0 ordinal: 0x1
...
// 0x10 bytes (sizeof)
typedef struct __anon_597 {
  ULONG Length;                         // offset: 0x0 ordinal: 0x0
  enum _FSINFOCLASS FsInformationClass; // offset: 0x8 ordinal: 0x1
} __anon_597;

// 0x4 bytes (sizeof)
typedef struct __anon_596 {
  ULONG Length; // offset: 0x0 ordinal: 0x0
} __anon_596;

// 0x20 bytes (sizeof)
typedef struct __anon_595 {
  ULONG Length;       // offset: 0x0 ordinal: 0x0
...
// 0x10 bytes (sizeof)
typedef struct __anon_593 {
  ULONG Length;                                      // offset: 0x0 ordinal: 0x0
  enum _FILE_INFORMATION_CLASS FileInformationClass; // offset: 0x8 ordinal: 0x1
} __anon_593;

// 0x10 bytes (sizeof)
typedef struct __anon_592 {
  ULONG Length;           // offset: 0x0 ordinal: 0x0
  ULONG CompletionFilter; // offset: 0x8 ordinal: 0x1
} __anon_592;

// 0x20 bytes (sizeof)
typedef struct __anon_591 {
  ULONG Length;                     // offset: 0x0 ordinal: 0x0
...
typedef union __anon_510 {
  struct __anon_538 Disk; // offset: 0x0 ordinal: 0x0
} __anon_510;
...
typedef struct _DEVICE_OBJECT_POWER_EXTENSION {
  ...
  union __anon_510 Specific;             // offset: 0x50 ordinal: 0xc
...
typedef VOID (*__anon_376)(ULONG);

typedef VOID (*__anon_367)(VOID *, ULONG);
...
typedef struct _EX_WORK_QUEUE {
  ...
  ULONG WorkItemsProcessed;         // offset: 0x40 ordinal: 0x1
  ULONG WorkItemsProcessedLastPass; // offset: 0x44 ordinal: 0x2
  LONG ThreadCount;                 // offset: 0x48 ordinal: 0x3
  UCHAR TryFailed;                  // offset: 0x4c ordinal: 0x4
} _EX_WORK_QUEUE;
...
typedef struct _PROC_PERF_HISTORY {
  ...
  struct _PROC_PERF_HISTORY_ENTRY HistoryList[1]; // offset: 0x14 ordinal: 0x5
} _PROC_PERF_HISTORY;
...
// 0x58 bytes (sizeof)
typedef union __anon_460 {
  struct __anon_474 Overlay; // offset: 0x0 ordinal: 0x0
  struct _KAPC Apc;          // offset: 0x0 ordinal: 0x1
  VOID *CompletionKey;       // offset: 0x0 ordinal: 0x2
} __anon_460;

typedef VOID (*__anon_362)(struct _KAPC *);

typedef VOID (*__anon_361)(struct _KAPC *, VOID (**)(VOID *, VOID *, VOID *),
                           VOID **, VOID **, VOID **);
...
typedef union _KGDTENTRY64 {
  ...
  struct __anon_210 Bytes; // offset: 0x4 ordinal: 0x2
  struct __anon_211 Bits;  // offset: 0x4 ordinal: 0x3
...
typedef struct _ACCESS_STATE {
  ...
  union __anon_736 Privileges;           // offset: 0x50 ordinal: 0xc
...
typedef LONG (*__anon_1279)(VOID *, VOID *, struct _ACCESS_STATE *, CHAR, ULONG,
...
typedef VOID (*__anon_1811)(ULONG *, ULONG *);

typedef LONG (*__anon_1281)(VOID *, UCHAR, struct _OBJECT_NAME_INFORMATION *,
                            ULONG, ULONG *, CHAR);

typedef LONG (*__anon_1280)(VOID *, enum _SECURITY_OPERATION_CODE, ULONG *,
                            VOID *, ULONG *, VOID **, enum _POOL_TYPE,
                            struct _GENERIC_MAPPING *, CHAR);

typedef LONG (*__anon_1277)(enum _OB_OPEN_REASON, CHAR, struct _EPROCESS *,
                            VOID *, ULONG *, ULONG);
...
// 0x10 bytes (sizeof)
typedef struct __anon_1808 {
  struct _GUID DiskId; // offset: 0x0 ordinal: 0x0
} __anon_1808;

// 0x10 bytes (sizeof)
typedef union __anon_1798 {
  struct __anon_1807 Mbr; // offset: 0x0 ordinal: 0x0
  struct __anon_1808 Gpt; // offset: 0x0 ordinal: 0x1
} __anon_1798;
...
typedef VOID (*__anon_1554)(VOID *, VOID *, struct _IO_WORKITEM *);
...
// 0x10 bytes (sizeof)
typedef struct __anon_1064 {
  struct _GUID BlockedDriverGuid; // offset: 0x0 ordinal: 0x0
} __anon_1064;

// 0x14 bytes (sizeof)
typedef struct __anon_1058 {
  struct _GUID ClassGuid;    // offset: 0x0 ordinal: 0x0
  WCHAR SymbolicLinkName[1]; // offset: 0x10 ordinal: 0x1
} __anon_1058;

// 0x20 bytes (sizeof)
typedef union __anon_1051 {
  struct __anon_1058 DeviceClass;                // offset: 0x0 ordinal: 0x0
  struct __anon_1059 TargetDevice;               // offset: 0x0 ordinal: 0x1
  struct __anon_1059 InstallDevice;              // offset: 0x0 ordinal: 0x2
  struct __anon_1060 CustomNotification;         // offset: 0x0 ordinal: 0x3
  struct __anon_1061 ProfileNotification;        // offset: 0x0 ordinal: 0x4
  struct __anon_1062 PowerNotification;          // offset: 0x0 ordinal: 0x5
  struct __anon_1063 VetoNotification;           // offset: 0x0 ordinal: 0x6
  struct __anon_1064 BlockedDriverNotification;  // offset: 0x0 ordinal: 0x7
  struct __anon_1065 InvalidIDNotification;      // offset: 0x0 ordinal: 0x8
  struct __anon_1066 PowerSettingNotification;   // offset: 0x0 ordinal: 0x9
  struct __anon_1059 PropertyChangeNotification; // offset: 0x0 ordinal: 0xa
  struct __anon_1059 DeviceInstanceNotification; // offset: 0x0 ordinal: 0xb
} __anon_1051;
...
typedef struct _PLUGPLAY_EVENT_BLOCK {
  ...
  union __anon_1051 u;                         // offset: 0x30 ordinal: 0x6
...
typedef UCHAR (*__anon_1803)(union _LARGE_INTEGER);
...
typedef struct _TRACE_LOGFILE_HEADER {
  ...
  union {
    ...
    struct __anon_1310 VersionDetail; // offset: 0x4 ordinal: 0x2
  };
...
typedef struct _IOP_IRP_EXTENSION {
  ...
  USHORT SpareBits : 5;           // offset: 0x0 ordinal: 0x4
  USHORT TypesAllocated;          // offset: 0x2 ordinal: 0x5
  struct _GUID ActivityId;        // offset: 0x4 ordinal: 0x6
  union _LARGE_INTEGER Timestamp; // offset: 0x18 ordinal: 0x7
} _IOP_IRP_EXTENSION;

// 0x10 bytes (sizeof)
typedef union __anon_1156 {
...
typedef VOID (*__anon_1134)(VOID *, union _LARGE_INTEGER);
...
// 0xc bytes (sizeof)
typedef struct __anon_764 {
  union _LARGE_INTEGER Start; // offset: 0x0 ordinal: 0x0
  ULONG Length;               // offset: 0x8 ordinal: 0x1
} __anon_764;

// 0x18 bytes (sizeof)
typedef struct __anon_760 {
...
typedef LONG (*__anon_1809)(LONG, union _LARGE_INTEGER *, struct _MDL *);

typedef LONG (*__anon_1806)(LONG, union _LARGE_INTEGER *, struct _MDL *,
                            VOID *);

typedef LONG (*__anon_1804)(union _LARGE_INTEGER *, struct _MDL *);
...
typedef struct _DUMP_INITIALIZATION_CONTEXT {
  ...
  union __anon_1798 DiskInfo; // offset: 0x8c ordinal: 0x15
  LONG(*ReadRoutine)
...
typedef LONG (*__anon_1513)(struct _KENLISTMENT *, VOID *, VOID *, ULONG,
                            union _LARGE_INTEGER *, ULONG, VOID *);

// 0x18 bytes (sizeof)
typedef struct __anon_599 {
  union _LARGE_INTEGER *Length;    // offset: 0x0 ordinal: 0x0
  ULONG Key;                       // offset: 0x8 ordinal: 0x1
  union _LARGE_INTEGER ByteOffset; // offset: 0x10 ordinal: 0x2
} __anon_599;

typedef UCHAR (*__anon_529)(struct _FILE_OBJECT *, union _LARGE_INTEGER *,
...
typedef struct _ETW_GUID_ENTRY {
  ...
  struct _EVENT_FILTER_HEADER **FilterData;     // offset: 0x170 ordinal: 0x9
} _ETW_GUID_ENTRY;
...
typedef struct _RTLP_RANGE_LIST_ENTRY {
  ...
  union {
    struct __anon_1861 Allocated; // offset: 0x10 ordinal: 0x2
    struct __anon_1862 Merged;    // offset: 0x10 ordinal: 0x3
  };
...
typedef struct _MI_REVERSE_VIEW_MAP {
  ...
  ULONGLONG SectionOffset;        // offset: 0x20 ordinal: 0x6
...
typedef struct _MI_TRIAGE_DUMP_DATA {
  ...
  ULONG FeatureBits;                      // offset: 0x18 ordinal: 0x5
  ULONG TimeZoneId;                       // offset: 0x1c ordinal: 0x6
...
typedef struct _VF_AVL_TREE {
  ...
  union __anon_1916 u1;         // offset: 0x1c ordinal: 0x4
} _VF_AVL_TREE;
...
typedef UCHAR (*__anon_1640)(VOID *, struct _RTL_RANGE *);
...
typedef union _CLS_LSN {
  struct __anon_1516 offset; // offset: 0x0 ordinal: 0x0
...
typedef struct _WHEA_ERROR_SOURCE_DESCRIPTOR {
  ...
  union __anon_1393 Info;              // offset: 0x28 ordinal: 0xa
...
typedef VOID (*__anon_1387)(struct _WHEAP_WORK_QUEUE *, struct _LIST_ENTRY *);
...
typedef VOID (*__anon_1278)(struct _EPROCESS *, VOID *, ULONGLONG, ULONGLONG);
...
// 0x8 bytes (sizeof)
typedef union __anon_1253 {
  struct __anon_1258 s1; // offset: 0x0 ordinal: 0x0
  LONGLONG Value;        // offset: 0x0 ordinal: 0x1
} __anon_1253;

// 0x8 bytes (sizeof)
typedef struct _ALPC_COMPLETION_LIST_STATE {
  union __anon_1253 u1; // offset: 0x0 ordinal: 0x0
...
typedef struct _HEAP_FREE_ENTRY {
  ...
  ULONG Code234;                // offset: 0xc ordinal: 0x15
  ULONGLONG AgregateCode;       // offset: 0x8 ordinal: 0x16
  struct _LIST_ENTRY FreeList;  // offset: 0x10 ordinal: 0x17
} _HEAP_FREE_ENTRY;
...
typedef VOID (*__anon_1168)(VOID *, ULONGLONG, ULONG);
...
typedef struct _LOG_HANDLE_CONTEXT {
  ...
  ULONG AdditionalPagesToWrite;                    // offset: 0x50 ordinal: 0x5
  ULONG CcLWScanDPThreshold;                       // offset: 0x54 ordinal: 0x6
  union _LARGE_INTEGER LargestLsnForCurrentLWScan; // offset: 0x58 ordinal: 0x7
  struct _FILE_OBJECT *RelatedFileObject;          // offset: 0x60 ordinal: 0x8
  ULONGLONG LargestLsnFileObjectKey;               // offset: 0x68 ordinal: 0x9
  union _LARGE_INTEGER LastLWTimeStamp;            // offset: 0x70 ordinal: 0xa
  ULONG Flags;                                     // offset: 0x78 ordinal: 0xb
} _LOG_HANDLE_CONTEXT;
...
typedef struct _VOLUME_CACHE_MAP {
  ...
  ULONG Flags;                                 // offset: 0xa8 ordinal: 0x7
  ULONG PagesQueuedToDisk;                     // offset: 0xac ordinal: 0x8
  ULONG LoggedPagesQueuedToDisk;               // offset: 0xb0 ordinal: 0x9
} _VOLUME_CACHE_MAP;
...
typedef struct _DBGKD_MANIPULATE_STATE32 {
  ...
  union __anon_1119 u;   // offset: 0xc ordinal: 0x4
} _DBGKD_MANIPULATE_STATE32;

// 0x28 bytes (sizeof)
typedef union __anon_1094 {
...
typedef struct _DBGKD_MANIPULATE_STATE64 {
  ...
  USHORT Processor;      // offset: 0x6 ordinal: 0x2
  LONG ReturnStatus;     // offset: 0x8 ordinal: 0x3
  union __anon_1094 u;   // offset: 0x10 ordinal: 0x4
...
typedef struct _POP_FX_PLUGIN {
  ...
  struct _POP_FX_WORK_ORDER WorkOrder;              // offset: 0x20 ordinal: 0x3
  struct _KQUEUE WorkQueue;                         // offset: 0x48 ordinal: 0x4
  UCHAR (*AcceptDeviceNotification)(ULONG, VOID *); // offset: 0x88 ordinal: 0x5
  UCHAR(*AcceptProcessorNotification)
  (struct PEPHANDLE__ *, ULONG, VOID *); // offset: 0x90 ordinal: 0x6
} _POP_FX_PLUGIN;
...
typedef LONG (*__anon_957)(enum _PCW_CALLBACK_TYPE,
...
typedef struct _HHIVE {
  ...
  ULONG BaseBlockAlloc;                             // offset: 0x58 ordinal: 0xb
  ULONG Cluster;                                    // offset: 0x5c ordinal: 0xc
  UCHAR Flat;                                       // offset: 0x60 ordinal: 0xd
  UCHAR ReadOnly;                                   // offset: 0x61 ordinal: 0xe
  UCHAR DirtyFlag;                                  // offset: 0x62 ordinal: 0xf
  ULONG HvBinHeadersUse;   // offset: 0x64 ordinal: 0x10
  ULONG HvFreeCellsUse;    // offset: 0x68 ordinal: 0x11
  ULONG HvUsedCellsUse;    // offset: 0x6c ordinal: 0x12
  ULONG CmUsedCellsUse;    // offset: 0x70 ordinal: 0x13
  ULONG HiveFlags;         // offset: 0x74 ordinal: 0x14
  ULONG CurrentLog;        // offset: 0x78 ordinal: 0x15
  ULONG LogSize[2];        // offset: 0x7c ordinal: 0x16
  ULONG RefreshCount;      // offset: 0x84 ordinal: 0x17
  ULONG StorageTypeCount;  // offset: 0x88 ordinal: 0x18
  ULONG Version;           // offset: 0x8c ordinal: 0x19
  struct _DUAL Storage[2]; // offset: 0x90 ordinal: 0x1a
} _HHIVE;
...
typedef UCHAR (*__anon_922)(struct _HHIVE *, ULONG, ULONG *, VOID *, ULONG);

typedef UCHAR (*__anon_921)(struct _HHIVE *, ULONG, struct CMP_OFFSET_ARRAY *,
                            ULONG, ULONG *, ULONG);
...
typedef struct _CELL_DATA *(*__anon_919)(struct _HHIVE *, ULONG);

// 0x20 bytes (sizeof)
typedef struct __anon_898 {
  ULONG Cell;                   // offset: 0x0 ordinal: 0x0
...
typedef struct _HIVE_LOAD_FAILURE {
  ...
  struct __anon_894 Locations[8];            // offset: 0x10 ordinal: 0x3
  struct __anon_894 RecoverableLocations[8]; // offset: 0x70 ordinal: 0x4
  struct __anon_896 RegistryIO;              // offset: 0xd0 ordinal: 0x5
  struct __anon_897 CheckRegistry2;          // offset: 0xe8 ordinal: 0x6
  struct __anon_898 CheckKey;                // offset: 0xf0 ordinal: 0x7
  struct __anon_938 CheckValueList;          // offset: 0x110 ordinal: 0x8
  struct __anon_939 CheckHive;               // offset: 0x128 ordinal: 0x9
  struct __anon_939 CheckHive1;              // offset: 0x138 ordinal: 0xa
  struct __anon_942 CheckBin;                // offset: 0x148 ordinal: 0xb
  struct __anon_948 RecoverData;             // offset: 0x158 ordinal: 0xc
} _HIVE_LOAD_FAILURE;

// 0x40 bytes (sizeof)
typedef struct tagSWITCH_CONTEXT_DATA {
  struct _GUID guPlatform;         // offset: 0x0 ordinal: 0x0
  struct _GUID guMinPlatform;      // offset: 0x10 ordinal: 0x1
  ULONG ulElementCount;            // offset: 0x20 ordinal: 0x2
  USHORT ulContextMinimum;         // offset: 0x24 ordinal: 0x3
  ULONGLONG ullOsMaxVersionTested; // offset: 0x28 ordinal: 0x4
  struct _GUID guElements[1];      // offset: 0x30 ordinal: 0x5
...
// 0x8 bytes (sizeof)
typedef union __anon_850 {
  ULONGLONG PteFrame : 36;    // offset: 0x0 ordinal: 0x0
  ULONGLONG Channel : 2;      // offset: 0x0 ordinal: 0x1
  ULONGLONG Unused : 16;      // offset: 0x0 ordinal: 0x2
  ULONGLONG PfnExists : 1;    // offset: 0x0 ordinal: 0x3
  ULONGLONG PageIdentity : 2; // offset: 0x0 ordinal: 0x4
  ULONGLONG PrototypePte : 1; // offset: 0x0 ordinal: 0x5
  ULONGLONG PageColor : 6;    // offset: 0x0 ordinal: 0x6
  ULONGLONG EntireField;      // offset: 0x0 ordinal: 0x7
} __anon_850;

// 0x8 bytes (sizeof)
typedef union __anon_843 {
  ULONGLONG Flink : 36;                   // offset: 0x0 ordinal: 0x0
  ULONGLONG NodeFlinkHigh : 28;           // offset: 0x0 ordinal: 0x1
  ULONG WsIndex;                          // offset: 0x0 ordinal: 0x2
...
typedef struct _MMPTE_SOFTWARE {
  ...
  ULONGLONG DbgCrc : 7;                // offset: 0x0 ordinal: 0x9
...
typedef struct _MMPTE {
  union __anon_828 u; // offset: 0x0 ordinal: 0x0
} _MMPTE;
...
typedef struct _MM_PAGED_POOL_INFO {
  ...
  ULONGLONG AllocatedPagedPool;              // offset: 0x58 ordinal: 0x4
} _MM_PAGED_POOL_INFO;
...
typedef struct _MMPFN {
  union __anon_843 u1; // offset: 0x0 ordinal: 0x0
  union __anon_844 u2; // offset: 0x8 ordinal: 0x1
  union {
  ...
  union __anon_848 u3; // offset: 0x18 ordinal: 0x6
  ...
  union __anon_850 u4;       // offset: 0x28 ordinal: 0xd
} _MMPFN;
...
// 0x10 bytes (sizeof)
typedef struct __anon_766 {
  union {
    struct __anon_774 Raw;        // offset: 0x0 ordinal: 0x0
    struct __anon_765 Translated; // offset: 0x0 ordinal: 0x1
  };
} __anon_766;

// 0x10 bytes (sizeof)
typedef union __anon_762 {
  struct __anon_764 Generic;            // offset: 0x0 ordinal: 0x0
  struct __anon_764 Port;               // offset: 0x0 ordinal: 0x1
  struct __anon_765 Interrupt;          // offset: 0x0 ordinal: 0x2
  struct __anon_766 MessageInterrupt;   // offset: 0x0 ordinal: 0x3
  struct __anon_764 Memory;             // offset: 0x0 ordinal: 0x4
  struct __anon_767 Dma;                // offset: 0x0 ordinal: 0x5
  struct __anon_768 DmaV3;              // offset: 0x0 ordinal: 0x6
  struct __anon_755 DevicePrivate;      // offset: 0x0 ordinal: 0x7
  struct __anon_769 BusNumber;          // offset: 0x0 ordinal: 0x8
  struct __anon_770 DeviceSpecificData; // offset: 0x0 ordinal: 0x9
  struct __anon_771 Memory40;           // offset: 0x0 ordinal: 0xa
  struct __anon_772 Memory48;           // offset: 0x0 ordinal: 0xb
  struct __anon_773 Memory64;           // offset: 0x0 ordinal: 0xc
  struct __anon_761 Connection;         // offset: 0x0 ordinal: 0xd
} __anon_762;
...
typedef struct _CM_PARTIAL_RESOURCE_DESCRIPTOR {
  ...
  union __anon_762 u;     // offset: 0x4 ordinal: 0x3
...
// 0x18 bytes (sizeof)
typedef union __anon_748 {
  struct __anon_751 Port;          // offset: 0x0 ordinal: 0x0
  struct __anon_751 Memory;        // offset: 0x0 ordinal: 0x1
  struct __anon_752 Interrupt;     // offset: 0x0 ordinal: 0x2
  struct __anon_753 Dma;           // offset: 0x0 ordinal: 0x3
  struct __anon_754 DmaV3;         // offset: 0x0 ordinal: 0x4
  struct __anon_751 Generic;       // offset: 0x0 ordinal: 0x5
  struct __anon_755 DevicePrivate; // offset: 0x0 ordinal: 0x6
  struct __anon_756 BusNumber;     // offset: 0x0 ordinal: 0x7
  struct __anon_757 ConfigData;    // offset: 0x0 ordinal: 0x8
  struct __anon_758 Memory40;      // offset: 0x0 ordinal: 0x9
  struct __anon_759 Memory48;      // offset: 0x0 ordinal: 0xa
  struct __anon_760 Memory64;      // offset: 0x0 ordinal: 0xb
  struct __anon_761 Connection;    // offset: 0x0 ordinal: 0xc
} __anon_748;
...
typedef struct _IO_RESOURCE_DESCRIPTOR {
  ...
  union __anon_748 u;     // offset: 0x8 ordinal: 0x6
...
typedef struct _ARBITER_PARAMETERS {
  union __anon_1671 Parameters; // offset: 0x0 ordinal: 0x0
} _ARBITER_PARAMETERS;

typedef LONG (*__anon_1655)(VOID *, enum _ARBITER_ACTION,
...
typedef LONG (*__anon_1627)(struct _IO_RESOURCE_DESCRIPTOR *);

typedef LONG (*__anon_1625)(struct _IO_RESOURCE_DESCRIPTOR *, ULONGLONG,
                            struct _CM_PARTIAL_RESOURCE_DESCRIPTOR *);
...
typedef struct _IMAGE_RUNTIME_FUNCTION_ENTRY *(*__anon_741)(ULONGLONG, VOID *);
...
typedef struct _MMWSLE {
  union __anon_717 u1; // offset: 0x0 ordinal: 0x0
} _MMWSLE;
...
typedef struct _HANDLE_TABLE_ENTRY {
  ...
  ULONGLONG RefCnt : 19;            // offset: 0x0 ordinal: 0x4
  ULONGLONG Attributes : 3;         // offset: 0x0 ordinal: 0x5
  ULONGLONG ObjectPointerBits : 41; // offset: 0x0 ordinal: 0x6
  union {
  ...
  ULONG Spare : 7; // offset: 0x8 ordinal: 0xb
  ULONG TypeInfo;  // offset: 0xc ordinal: 0xc
} _HANDLE_TABLE_ENTRY;
...
typedef VOID (*__anon_714)(struct _IO_MINI_COMPLETION_PACKET_USER *, VOID *);
...
// 0x20 bytes (sizeof)
typedef union __anon_563 {
  struct __anon_587 Create;                     // offset: 0x0 ordinal: 0x0
  struct __anon_588 CreatePipe;                 // offset: 0x0 ordinal: 0x1
  struct __anon_589 CreateMailslot;             // offset: 0x0 ordinal: 0x2
  struct __anon_590 Read;                       // offset: 0x0 ordinal: 0x3
  struct __anon_590 Write;                      // offset: 0x0 ordinal: 0x4
  struct __anon_591 QueryDirectory;             // offset: 0x0 ordinal: 0x5
  struct __anon_592 NotifyDirectory;            // offset: 0x0 ordinal: 0x6
  struct __anon_593 QueryFile;                  // offset: 0x0 ordinal: 0x7
  struct __anon_594 SetFile;                    // offset: 0x0 ordinal: 0x8
  struct __anon_595 QueryEa;                    // offset: 0x0 ordinal: 0x9
  struct __anon_596 SetEa;                      // offset: 0x0 ordinal: 0xa
  struct __anon_597 QueryVolume;                // offset: 0x0 ordinal: 0xb
  struct __anon_597 SetVolume;                  // offset: 0x0 ordinal: 0xc
  struct __anon_598 FileSystemControl;          // offset: 0x0 ordinal: 0xd
  struct __anon_599 LockControl;                // offset: 0x0 ordinal: 0xe
  struct __anon_600 DeviceIoControl;            // offset: 0x0 ordinal: 0xf
  struct __anon_601 QuerySecurity;              // offset: 0x0 ordinal: 0x10
  struct __anon_602 SetSecurity;                // offset: 0x0 ordinal: 0x11
  struct __anon_603 MountVolume;                // offset: 0x0 ordinal: 0x12
  struct __anon_603 VerifyVolume;               // offset: 0x0 ordinal: 0x13
  struct __anon_604 Scsi;                       // offset: 0x0 ordinal: 0x14
  struct __anon_605 QueryQuota;                 // offset: 0x0 ordinal: 0x15
  struct __anon_596 SetQuota;                   // offset: 0x0 ordinal: 0x16
  struct __anon_606 QueryDeviceRelations;       // offset: 0x0 ordinal: 0x17
  struct __anon_607 QueryInterface;             // offset: 0x0 ordinal: 0x18
  struct __anon_608 DeviceCapabilities;         // offset: 0x0 ordinal: 0x19
  struct __anon_609 FilterResourceRequirements; // offset: 0x0 ordinal: 0x1a
  struct __anon_610 ReadWriteConfig;            // offset: 0x0 ordinal: 0x1b
  struct __anon_611 SetLock;                    // offset: 0x0 ordinal: 0x1c
  struct __anon_612 QueryId;                    // offset: 0x0 ordinal: 0x1d
  struct __anon_613 QueryDeviceText;            // offset: 0x0 ordinal: 0x1e
  struct __anon_614 UsageNotification;          // offset: 0x0 ordinal: 0x1f
  struct __anon_615 WaitWake;                   // offset: 0x0 ordinal: 0x20
  struct __anon_616 PowerSequence;              // offset: 0x0 ordinal: 0x21
  struct __anon_617 Power;                      // offset: 0x0 ordinal: 0x22
  struct __anon_618 StartDevice;                // offset: 0x0 ordinal: 0x23
  struct __anon_619 WMI;                        // offset: 0x0 ordinal: 0x24
  struct __anon_620 Others;                     // offset: 0x0 ordinal: 0x25
} __anon_563;
...
typedef union _FS_FILTER_PARAMETERS {
  struct __anon_709 AcquireForModifiedPageWriter; // offset: 0x0 ordinal: 0x0
  struct __anon_710 ReleaseForModifiedPageWriter; // offset: 0x0 ordinal: 0x1
  struct __anon_711
      AcquireForSectionSynchronization;     // offset: 0x0 ordinal: 0x2
  struct __anon_712 NotifyStreamFileObject; // offset: 0x0 ordinal: 0x3
  struct __anon_713 Others;                 // offset: 0x0 ordinal: 0x4
...
typedef VOID (*__anon_568)(struct _FS_FILTER_CALLBACK_DATA *, LONG, VOID *);

typedef LONG (*__anon_567)(struct _FS_FILTER_CALLBACK_DATA *, VOID **);
...
typedef LONG (*__anon_526)(struct _FILE_OBJECT *, union _LARGE_INTEGER *,
                           struct _ERESOURCE **, struct _DEVICE_OBJECT *);

typedef LONG (*__anon_532)(struct _FILE_OBJECT *, struct _ERESOURCE *,
                           struct _DEVICE_OBJECT *);

// 0x30 bytes (sizeof)
typedef struct _MM_AVL_TABLE {
  struct _MM_AVL_NODE BalancedRoot;          // offset: 0x0 ordinal: 0x0
  ULONGLONG DepthOfTree : 5;                 // offset: 0x18 ordinal: 0x1
  ULONGLONG TableType : 3;                   // offset: 0x18 ordinal: 0x2
  ULONGLONG NumberGenericTableElements : 56; // offset: 0x18 ordinal: 0x3
  VOID *NodeHint;                            // offset: 0x20 ordinal: 0x4
  VOID *NodeFreeHint;                        // offset: 0x28 ordinal: 0x5
} _MM_AVL_TABLE;
...
typedef struct _MSUBSECTION {
  ...
  union __anon_1572 u;                // offset: 0x28 ordinal: 0x7
  ULONG StartingSector;               // offset: 0x2c ordinal: 0x8
  ULONG NumberOfFullSectors;          // offset: 0x30 ordinal: 0x9
  struct _MM_AVL_NODE SubsectionNode; // offset: 0x38 ordinal: 0xa
  struct _LIST_ENTRY DereferenceList; // offset: 0x50 ordinal: 0xb
  ULONGLONG NumberOfMappedViews;      // offset: 0x60 ordinal: 0xc
  ULONGLONG NumberOfPfnReferences;    // offset: 0x68 ordinal: 0xd
} _MSUBSECTION;
...
typedef struct _SUBSECTION {
  ...
  union __anon_1572 u;       // offset: 0x28 ordinal: 0x6
...
typedef struct __anon_859 {
  ...
  ULONG Unused : 13;     // offset: 0x4 ordinal: 0x4
  ULONG BitMap : 2;      // offset: 0x4 ordinal: 0x5
  ULONG ImageActive : 1; // offset: 0x4 ordinal: 0x6
  union {
    struct _MM_AVL_TABLE *SubsectionRoot; // offset: 0x8 ordinal: 0x7
...
typedef union __anon_863 {
  struct __anon_859 e2; // offset: 0x0 ordinal: 0x0
} __anon_863;
...
typedef struct _MMVAD_SHORT {
  struct _MM_AVL_NODE VadNode;           // offset: 0x0 ordinal: 0x0
  ULONG StartingVpn;                     // offset: 0x18 ordinal: 0x1
  ULONG EndingVpn;                       // offset: 0x1c ordinal: 0x2
  struct _EX_PUSH_LOCK PushLock;         // offset: 0x20 ordinal: 0x3
  union __anon_1727 u;                   // offset: 0x28 ordinal: 0x4
  union __anon_1729 u1;                  // offset: 0x2c ordinal: 0x5
  struct _MI_VAD_EVENT_BLOCK *EventList; // offset: 0x30 ordinal: 0x6
  LONG ReferenceCount;                   // offset: 0x38 ordinal: 0x7
} _MMVAD_SHORT;
...
typedef struct _MMVAD {
  ...
  union __anon_1836 u2;     // offset: 0x40 ordinal: 0x1
  union {
    struct _SUBSECTION *Subsection;        // offset: 0x48 ordinal: 0x2
    struct _MSUBSECTION *MappedSubsection; // offset: 0x48 ordinal: 0x3
  };
  struct _MMPTE *FirstPrototypePte; // offset: 0x50 ordinal: 0x4
  struct _MMPTE *LastContiguousPte; // offset: 0x58 ordinal: 0x5
  struct _LIST_ENTRY ViewLinks;     // offset: 0x60 ordinal: 0x6
  struct _EPROCESS *VadsProcess;    // offset: 0x70 ordinal: 0x7
  union __anon_1838 u4;             // offset: 0x78 ordinal: 0x8
} _MMVAD;
...
typedef struct _CMHIVE {
  struct _HHIVE Hive;                             // offset: 0x0 ordinal: 0x0
  VOID *FileHandles[6];                           // offset: 0x580 ordinal: 0x1
  struct _LIST_ENTRY NotifyList;                  // offset: 0x5b0 ordinal: 0x2
  struct _LIST_ENTRY HiveList;                    // offset: 0x5c0 ordinal: 0x3
  struct _LIST_ENTRY PreloadedHiveList;           // offset: 0x5d0 ordinal: 0x4
  struct _EX_RUNDOWN_REF HiveRundown;             // offset: 0x5e0 ordinal: 0x5
  struct _LIST_ENTRY ParseCacheEntries;           // offset: 0x5e8 ordinal: 0x6
  struct _CM_KEY_HASH_TABLE_ENTRY *KcbCacheTable; // offset: 0x5f8 ordinal: 0x7
  ULONG KcbCacheTableSize;                        // offset: 0x600 ordinal: 0x8
  struct _CM_KEY_HASH_TABLE_ENTRY
      *DeletedKcbTable;                      // offset: 0x608 ordinal: 0x9
  ULONG DeletedKcbTableSize;                 // offset: 0x610 ordinal: 0xa
  ULONG Identity;                            // offset: 0x614 ordinal: 0xb
  struct _FAST_MUTEX *HiveLock;              // offset: 0x618 ordinal: 0xc
  struct _FAST_MUTEX *WriterLock;            // offset: 0x620 ordinal: 0xd
  struct _ERESOURCE *FlusherLock;            // offset: 0x628 ordinal: 0xe
  struct _RTL_BITMAP FlushDirtyVector;       // offset: 0x630 ordinal: 0xf
  struct CMP_OFFSET_ARRAY *FlushOffsetArray; // offset: 0x640 ordinal: 0x10
  ULONG FlushOffsetArrayCount;               // offset: 0x648 ordinal: 0x11
  struct _HBASE_BLOCK *FlushBaseBlock;       // offset: 0x650 ordinal: 0x12
  ULONG FlushHiveTruncated;                  // offset: 0x658 ordinal: 0x13
  struct _EX_PUSH_LOCK SecurityLock;         // offset: 0x660 ordinal: 0x14
  ULONG UseCount;                            // offset: 0x668 ordinal: 0x15
  ULONG LastShrinkHiveSize;                  // offset: 0x66c ordinal: 0x16
  union _LARGE_INTEGER ActualFileSize;       // offset: 0x670 ordinal: 0x17
  union _LARGE_INTEGER LogFileSizes[2];      // offset: 0x678 ordinal: 0x18
  struct _UNICODE_STRING FileFullPath;       // offset: 0x688 ordinal: 0x19
  struct _UNICODE_STRING FileUserName;       // offset: 0x698 ordinal: 0x1a
  struct _UNICODE_STRING HiveRootPath;       // offset: 0x6a8 ordinal: 0x1b
  ULONG SecurityCount;                       // offset: 0x6b8 ordinal: 0x1c
  ULONG SecurityCacheSize;                   // offset: 0x6bc ordinal: 0x1d
  LONG SecurityHitHint;                      // offset: 0x6c0 ordinal: 0x1e
  struct _CM_KEY_SECURITY_CACHE_ENTRY
      *SecurityCache;                          // offset: 0x6c8 ordinal: 0x1f
  struct _LIST_ENTRY SecurityHash[64];         // offset: 0x6d0 ordinal: 0x20
  ULONG UnloadEventCount;                      // offset: 0xad0 ordinal: 0x21
  struct _KEVENT **UnloadEventArray;           // offset: 0xad8 ordinal: 0x22
  struct _CM_KEY_CONTROL_BLOCK *RootKcb;       // offset: 0xae0 ordinal: 0x23
  UCHAR Frozen;                                // offset: 0xae8 ordinal: 0x24
  struct _CM_WORKITEM *UnloadWorkItem;         // offset: 0xaf0 ordinal: 0x25
  struct _CM_WORKITEM UnloadWorkItemHolder;    // offset: 0xaf8 ordinal: 0x26
  UCHAR GrowOnlyMode;                          // offset: 0xb20 ordinal: 0x27
  ULONG GrowOffset;                            // offset: 0xb24 ordinal: 0x28
  struct _LIST_ENTRY KcbConvertListHead;       // offset: 0xb28 ordinal: 0x29
  struct _LIST_ENTRY KnodeConvertListHead;     // offset: 0xb38 ordinal: 0x2a
  struct _CM_CELL_REMAP_BLOCK *CellRemapArray; // offset: 0xb48 ordinal: 0x2b
  ULONG Flags;                                 // offset: 0xb50 ordinal: 0x2c
  struct _LIST_ENTRY TrustClassEntry;          // offset: 0xb58 ordinal: 0x2d
  ULONGLONG DirtyTime;                         // offset: 0xb68 ordinal: 0x2e
  struct _CM_RM *CmRm;                         // offset: 0xb70 ordinal: 0x2f
  ULONG CmRmInitFailPoint;                     // offset: 0xb78 ordinal: 0x30
  LONG CmRmInitFailStatus;                     // offset: 0xb7c ordinal: 0x31
  struct _KTHREAD *CreatorOwner;               // offset: 0xb80 ordinal: 0x32
  struct _KTHREAD *RundownThread;              // offset: 0xb88 ordinal: 0x33
  struct _ETHREAD *ActiveFlushThread;          // offset: 0xb90 ordinal: 0x34
  struct _EX_PUSH_LOCK FlushBoostLock;         // offset: 0xb98 ordinal: 0x35
  union _LARGE_INTEGER LastWriteTime;          // offset: 0xba0 ordinal: 0x36
  LONG ReferenceCount;                         // offset: 0xba8 ordinal: 0x37
  union {
    ULONG FlushFlags;      // offset: 0xbac ordinal: 0x38
    ULONG FlushActive : 1; // offset: 0xbac ordinal: 0x39
  };
  ULONG DiskFileBad : 1;                        // offset: 0xbac ordinal: 0x3a
  ULONG FlushBoosted : 1;                       // offset: 0xbac ordinal: 0x3b
  ULONG PrimaryWritePending : 1;                // offset: 0xbac ordinal: 0x3c
  ULONG PriorPurgeComplete : 1;                 // offset: 0xbac ordinal: 0x3d
  struct _HIVE_WAIT_PACKET *FlushWaitList;      // offset: 0xbb0 ordinal: 0x3e
  LONG UnloadHistoryIndex;                      // offset: 0xbb8 ordinal: 0x3f
  ULONG UnloadHistory[128];                     // offset: 0xbbc ordinal: 0x40
  ULONG BootStart;                              // offset: 0xdbc ordinal: 0x41
  ULONG UnaccessedStart;                        // offset: 0xdc0 ordinal: 0x42
  ULONG UnaccessedEnd;                          // offset: 0xdc4 ordinal: 0x43
  ULONG LoadedKeyCount;                         // offset: 0xdc8 ordinal: 0x44
  ULONG HandleClosePending;                     // offset: 0xdcc ordinal: 0x45
  struct _EX_PUSH_LOCK HandleClosePendingEvent; // offset: 0xdd0 ordinal: 0x46
} _CMHIVE;
...
typedef struct _SEP_LOGON_SESSION_REFERENCES {
  ...
  struct _SEP_LOWBOX_HANDLES_TABLE
      LowBoxHandlesTable; // offset: 0x50 ordinal: 0x9
...
typedef struct _OBJECT_HEADER {
  ...
  ULONG Spare;                 // offset: 0x1c ordinal: 0xa
  union {
    struct _OBJECT_CREATE_INFORMATION
        *ObjectCreateInfo;   // offset: 0x20 ordinal: 0xb
    VOID *QuotaBlockCharged; // offset: 0x20 ordinal: 0xc
  };
  VOID *SecurityDescriptor; // offset: 0x28 ordinal: 0xd
  struct _QUAD Body;        // offset: 0x30 ordinal: 0xe
} _OBJECT_HEADER;
...
typedef struct _ALPC_PORT {
  ...
  struct _ALPC_MESSAGE_ZONE *MessageZone;       // offset: 0x158 ordinal: 0x16
  struct _CALLBACK_OBJECT *CallbackObject;      // offset: 0x160 ordinal: 0x17
  VOID *CallbackContext;                        // offset: 0x168 ordinal: 0x18
  struct _LIST_ENTRY CanceledQueue;             // offset: 0x170 ordinal: 0x19
  LONG SequenceNo;                              // offset: 0x180 ordinal: 0x1a
  union __anon_1224 u1;                         // offset: 0x184 ordinal: 0x1b
  struct _ALPC_PORT *TargetQueuePort;           // offset: 0x188 ordinal: 0x1c
  struct _ALPC_PORT *TargetSequencePort;        // offset: 0x190 ordinal: 0x1d
  struct _KALPC_MESSAGE *CachedMessage;         // offset: 0x198 ordinal: 0x1e
  ULONG MainQueueLength;                        // offset: 0x1a0 ordinal: 0x1f
  ULONG LargeMessageQueueLength;                // offset: 0x1a4 ordinal: 0x20
  ULONG PendingQueueLength;                     // offset: 0x1a8 ordinal: 0x21
  ULONG CanceledQueueLength;                    // offset: 0x1ac ordinal: 0x22
  ULONG WaitQueueLength;                        // offset: 0x1b0 ordinal: 0x23
} _ALPC_PORT;
...
typedef struct _KALPC_SECURITY_DATA {
  ...
  union __anon_1254 u1;                            // offset: 0x68 ordinal: 0x5
...
typedef struct _KALPC_MESSAGE {
  ...
  union __anon_1237 u1;           // offset: 0x28 ordinal: 0x4
  ...
  VOID *DataSystemVa;    // offset: 0xa8 ordinal: 0xf
  struct _ALPC_COMMUNICATION_INFO
      *CommunicationInfo;            // offset: 0xb0 ordinal: 0x10
  struct _ALPC_PORT *ConnectionPort; // offset: 0xb8 ordinal: 0x11
  struct _ETHREAD *ServerThread;     // offset: 0xc0 ordinal: 0x12
  VOID *WakeReference;               // offset: 0xc8 ordinal: 0x13
  VOID *ExtensionBuffer;             // offset: 0xd0 ordinal: 0x14
  ULONGLONG ExtensionBufferSize;     // offset: 0xd8 ordinal: 0x15
  struct _PORT_MESSAGE PortMessage;  // offset: 0xe0 ordinal: 0x16
} _KALPC_MESSAGE;
...
typedef struct _KALPC_SECTION {
  ...
  union __anon_1210 u1;                   // offset: 0x30 ordinal: 0x6
...
typedef struct _KALPC_REGION {
  ...
  union __anon_1264 u1;               // offset: 0x30 ordinal: 0x5
...
typedef struct _KALPC_VIEW {
  ...
  union __anon_1256 u1;                    // offset: 0x48 ordinal: 0x8
...
typedef struct _BLOB {
  ...
  union __anon_1207 u1;      // offset: 0x10 ordinal: 0x2
...
typedef union __anon_1164 {
  struct __anon_1160 Read;         // offset: 0x0 ordinal: 0x0
  struct __anon_1161 Write;        // offset: 0x0 ordinal: 0x1
  struct __anon_1162 Event;        // offset: 0x0 ordinal: 0x2
  struct __anon_1163 Notification; // offset: 0x0 ordinal: 0x3
} __anon_1164;

// 0x20 bytes (sizeof)
typedef struct _WORK_QUEUE_ENTRY {
  struct _LIST_ENTRY WorkQueueLinks; // offset: 0x0 ordinal: 0x0
  union __anon_1164 Parameters;      // offset: 0x10 ordinal: 0x1
...
typedef struct _VACB {
  ...
  union __anon_1156 Overlay;                // offset: 0x10 ordinal: 0x2
...
typedef struct _SEGMENT {
  ...
  struct _EX_PUSH_LOCK SegmentLock; // offset: 0x28 ordinal: 0x7
  union __anon_872 u1;              // offset: 0x30 ordinal: 0x8
  union __anon_873 u2;              // offset: 0x38 ordinal: 0x9
...
typedef struct _CONTROL_AREA {
  ...
  union __anon_856 u;                           // offset: 0x38 ordinal: 0x6
  ...
  union __anon_863 u2;                          // offset: 0x58 ordinal: 0xc
...
typedef struct _MMINPAGE_SUPPORT {
  ...
  struct _LIST_ENTRY ListHead;       // offset: 0x18 ordinal: 0x2
  struct _KEVENT Event;              // offset: 0x28 ordinal: 0x3
  struct _KEVENT CollidedEvent;      // offset: 0x40 ordinal: 0x4
  struct _IO_STATUS_BLOCK IoStatus;  // offset: 0x58 ordinal: 0x5
  union _LARGE_INTEGER ReadOffset;   // offset: 0x68 ordinal: 0x6
  struct _MMPTE PteContents;         // offset: 0x70 ordinal: 0x7
  ...
  union __anon_1745 u3;              // offset: 0x88 ordinal: 0xb
  union __anon_1746 u1;              // offset: 0x8c ordinal: 0xc
  struct _FILE_OBJECT *FilePointer;  // offset: 0x90 ordinal: 0xd
  struct _CONTROL_AREA *ControlArea; // offset: 0x98 ordinal: 0xe
  VOID *FaultingAddress;             // offset: 0xa0 ordinal: 0xf
  struct _MMPTE *PointerPte;         // offset: 0xa8 ordinal: 0x10
  struct _MMPTE *BasePte;            // offset: 0xb0 ordinal: 0x11
  struct _MMPFN *Pfn;                // offset: 0xb8 ordinal: 0x12
  struct _MDL *PrefetchMdl;          // offset: 0xc0 ordinal: 0x13
  struct _MDL Mdl;                   // offset: 0xc8 ordinal: 0x14
  ULONGLONG Page[16];                // offset: 0xf8 ordinal: 0x15
} _MMINPAGE_SUPPORT;

// 0x10 bytes (sizeof)
typedef union __anon_887 {
  struct _IO_STATUS_BLOCK IoStatus; // offset: 0x0 ordinal: 0x0
} __anon_887;

typedef VOID (*__anon_1026)(struct _DEVICE_OBJECT *, UCHAR, union _POWER_STATE,
                            VOID *, struct _IO_STATUS_BLOCK *);

// 0x20 bytes (sizeof)
typedef struct __anon_1036 {
...
typedef VOID (*__anon_535)(VOID *, struct _IO_STATUS_BLOCK *, ULONG);

// 0x10 bytes (sizeof)
typedef struct __anon_473 {
  union {
    VOID(*UserApcRoutine)
...
// 0x10 bytes (sizeof)
typedef union __anon_459 {
  struct __anon_473 AsynchronousParameters; // offset: 0x0 ordinal: 0x0
  union _LARGE_INTEGER AllocationSize;      // offset: 0x0 ordinal: 0x1
} __anon_459;

typedef UCHAR (*__anon_530)(struct _FILE_OBJECT *, union _LARGE_INTEGER *,
                            ULONG, ULONG, VOID *, struct _MDL **,
                            struct _IO_STATUS_BLOCK *,
                            struct _COMPRESSED_DATA_INFO *, ULONG,
                            struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_527)(struct _FILE_OBJECT *, union _LARGE_INTEGER *,
                            ULONG, ULONG, struct _MDL **,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_525)(struct _FILE_OBJECT *, UCHAR,
                            struct _FILE_NETWORK_OPEN_INFORMATION *,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_522)(struct _FILE_OBJECT *, UCHAR, VOID *, ULONG, VOID *,
                            ULONG, ULONG, struct _IO_STATUS_BLOCK *,
                            struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_521)(struct _FILE_OBJECT *, VOID *, ULONG,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_520)(struct _FILE_OBJECT *, struct _EPROCESS *,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_519)(struct _FILE_OBJECT *, union _LARGE_INTEGER *,
                            union _LARGE_INTEGER *, struct _EPROCESS *, ULONG,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_518)(struct _FILE_OBJECT *, union _LARGE_INTEGER *,
                            union _LARGE_INTEGER *, struct _EPROCESS *, ULONG,
                            UCHAR, UCHAR, struct _IO_STATUS_BLOCK *,
                            struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_517)(struct _FILE_OBJECT *, UCHAR,
                            struct _FILE_STANDARD_INFORMATION *,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_516)(struct _FILE_OBJECT *, UCHAR,
                            struct _FILE_BASIC_INFORMATION *,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_515)(struct _FILE_OBJECT *, union _LARGE_INTEGER *,
                            ULONG, UCHAR, ULONG, VOID *,
                            struct _IO_STATUS_BLOCK *, struct _DEVICE_OBJECT *);

typedef UCHAR (*__anon_514)(struct _FILE_OBJECT *, union _LARGE_INTEGER *,
...
typedef struct _IRP {
  ...
  union __anon_457 AssociatedIrp;     // offset: 0x18 ordinal: 0x6
...
typedef LONG (*__anon_621)(struct _DEVICE_OBJECT *, struct _IRP *, VOID *);
...
typedef struct _IO_STACK_LOCATION {
  ...
  union __anon_563 Parameters;         // offset: 0x8 ordinal: 0x4
  struct _DEVICE_OBJECT *DeviceObject; // offset: 0x28 ordinal: 0x5
...
typedef UCHAR (*__anon_531)(struct _IRP *,
                            struct _FILE_NETWORK_OPEN_INFORMATION *,
                            struct _DEVICE_OBJECT *);
...
typedef LONG (*__anon_501)(struct _DEVICE_OBJECT *, struct _IRP *);
...
typedef enum _IO_ALLOCATION_ACTION (*__anon_476)(struct _DEVICE_OBJECT *,
...
// 0x48 bytes (sizeof)
typedef union __anon_440 {
  struct _LIST_ENTRY ListEntry;   // offset: 0x0 ordinal: 0x0
  struct _WAIT_CONTEXT_BLOCK Wcb; // offset: 0x0 ordinal: 0x1
} __anon_440;

typedef VOID (*__anon_469)(struct _DEVICE_OBJECT *, struct _IRP *);
...
typedef struct _DEVICE_OBJECT {
  ...
  union __anon_440 Queue;                // offset: 0x50 ordinal: 0xe
...
typedef VOID (*__anon_397)(ULONGLONG, ULONG *);
...
typedef VOID (*__anon_378)(ULONGLONG, ULONGLONG, ULONG, ULONG, ULONG, ULONG,
                           UCHAR, UCHAR);
...
typedef struct _PLATFORM_IDLE_STATE_ACCOUNTING {
  ...
  struct _PROC_IDLE_STATE_BUCKET
      IdleTimeBuckets[26]; // offset: 0x30 ordinal: 0x7
...
typedef struct _PROC_IDLE_STATE_ACCOUNTING {
  ...
  struct _PROC_IDLE_STATE_BUCKET
      IdleTimeBuckets[26]; // offset: 0x28 ordinal: 0x7
...
typedef struct _PROCESSOR_IDLE_CONSTRAINTS {
  ...
  ULONG MaxIdleDuration;          // offset: 0x18 ordinal: 0x3
  ULONG OverrideState;            // offset: 0x1c ordinal: 0x4
  ULONG TimeCheck;                // offset: 0x20 ordinal: 0x5
  UCHAR PromotePercent;           // offset: 0x24 ordinal: 0x6
  UCHAR DemotePercent;            // offset: 0x25 ordinal: 0x7
  UCHAR Parked;                   // offset: 0x26 ordinal: 0x8
  UCHAR Interruptible;            // offset: 0x27 ordinal: 0x9
  UCHAR PlatformIdle;             // offset: 0x28 ordinal: 0xa
...
typedef VOID (*__anon_365)(struct _PROCESSOR_IDLE_PREPARE_INFO *);
...
typedef struct _CM_CACHED_VALUE_INDEX {
  ...
  union __anon_1718 Data; // offset: 0x8 ordinal: 0x1
} _CM_CACHED_VALUE_INDEX;

// 0xa0 bytes (sizeof)
typedef struct _MMMOD_WRITER_MDL_ENTRY {
  struct _LIST_ENTRY Links;          // offset: 0x0 ordinal: 0x0
  union __anon_887 u;                // offset: 0x10 ordinal: 0x1
...
typedef struct _MMPAGING_FILE {
  ...
  struct _UNICODE_STRING PageFileName;           // offset: 0x58 ordinal: 0xa
  struct _MI_PAGING_FILE_SPACE_BITMAPS *Bitmaps; // offset: 0x68 ordinal: 0xb
  ULONG AllocationBitmapHint;                    // offset: 0x70 ordinal: 0xc
  ULONG ReservationBitmapHint;                   // offset: 0x74 ordinal: 0xd
  ULONG LargestNonReservedClusterSize;           // offset: 0x78 ordinal: 0xe
  ULONG RefreshClusterSize;                      // offset: 0x7c ordinal: 0xf
  ULONG LastRefreshClusterSize;                  // offset: 0x80 ordinal: 0x10
  ULONG ReservedClusterSizeAggregate;            // offset: 0x84 ordinal: 0x11
  ULONG ToBeEvictedCount;                        // offset: 0x88 ordinal: 0x12
  USHORT PageFileNumber : 4;                     // offset: 0x8c ordinal: 0x13
  USHORT BootPartition : 1;                      // offset: 0x8c ordinal: 0x14
  USHORT WsSwapPagefile : 1;                     // offset: 0x8c ordinal: 0x15
  USHORT NoReservations : 1;                     // offset: 0x8c ordinal: 0x16
  USHORT Spare0 : 9;                             // offset: 0x8c ordinal: 0x17
  UCHAR AdriftMdls : 1;                          // offset: 0x8e ordinal: 0x18
  UCHAR Spare1 : 7;                              // offset: 0x8e ordinal: 0x19
  UCHAR Spare2 : 8;                              // offset: 0x8f ordinal: 0x1a
  VOID *FileHandle;                              // offset: 0x90 ordinal: 0x1b
  ULONGLONG Lock;                                // offset: 0x98 ordinal: 0x1c
  struct _ETHREAD *LockOwner;                    // offset: 0xa0 ordinal: 0x1d
} _MMPAGING_FILE;
...
typedef struct _MI_USER_VA_INFO {
  ...
  struct _KEVENT *LastVadDeletionEvent;       // offset: 0x28 ordinal: 0x9
  ULONG *VadBitBuffer;                        // offset: 0x30 ordinal: 0xa
  VOID *LowestBottomUpAllocationAddress;      // offset: 0x38 ordinal: 0xb
  VOID *HighestTopDownAllocationAddress;      // offset: 0x40 ordinal: 0xc
  VOID *FreeTebHint;                          // offset: 0x48 ordinal: 0xd
  ULONGLONG PrivateFixupVadCount;             // offset: 0x50 ordinal: 0xe
  VOID *FreeUmsTebHint;                       // offset: 0x58 ordinal: 0xf
  ULONG *CommittedPageTables;                 // offset: 0x60 ordinal: 0x10
  ULONG PageTableBitmapPages;                 // offset: 0x68 ordinal: 0x11
  ULONGLONG CommittedPageDirectories[128];    // offset: 0x70 ordinal: 0x12
  ULONGLONG CommittedPageDirectoryParents[1]; // offset: 0x470 ordinal: 0x13
} _MI_USER_VA_INFO;
...
typedef struct _MMWSL {
  ...
  ULONG LastInitializedWsle;                        // offset: 0x10 ordinal: 0x4
  ULONG NextAgingSlot;                              // offset: 0x14 ordinal: 0x5
  ULONG NextAccessClearingSlot;                     // offset: 0x18 ordinal: 0x6
  ULONG LastAccessClearingRemainder;                // offset: 0x1c ordinal: 0x7
  ULONG LastAgingRemainder;                         // offset: 0x20 ordinal: 0x8
  ULONG WsleSize;                                   // offset: 0x24 ordinal: 0x9
  ULONG NonDirectCount;                             // offset: 0x28 ordinal: 0xa
  VOID *LowestPagableAddress;                       // offset: 0x30 ordinal: 0xb
  struct _MMWSLE_NONDIRECT_HASH *NonDirectHash;     // offset: 0x38 ordinal: 0xc
  struct _MMWSLE_HASH *HashTableStart;              // offset: 0x40 ordinal: 0xd
  struct _MMWSLE_HASH *HighestPermittedHashAddress; // offset: 0x48 ordinal: 0xe
  ULONG ActiveWsleCounts[8];                        // offset: 0x50 ordinal: 0xf
  struct _MI_ACTIVE_WSLE ActiveWsles[8]; // offset: 0x70 ordinal: 0x10
  struct _MMWSLE *Wsle;                  // offset: 0xb0 ordinal: 0x11
  struct _MI_USER_VA_INFO UserVaInfo;    // offset: 0xb8 ordinal: 0x12
} _MMWSL;
...
typedef struct _MMSUPPORT {
  ...
  ULONG TrimmedPageCount;                      // offset: 0x78 ordinal: 0x12
  ULONG Spare;                                 // offset: 0x7c ordinal: 0x13
  ULONG ForceTrimPages;                        // offset: 0x80 ordinal: 0x14
  struct _MMSUPPORT_FLAGS Flags;               // offset: 0x84 ordinal: 0x15
  VOID *WsSwapSupport;                         // offset: 0x88 ordinal: 0x16
} _MMSUPPORT;
...
typedef struct _MI_SYSTEM_PTE_TYPE {
  ...
  union {
    ...
    struct _FAST_MUTEX *GlobalMutex; // offset: 0x40 ordinal: 0xb
  };
  struct _MI_CACHED_PTE *CachedPtes; // offset: 0x48 ordinal: 0xc
} _MI_SYSTEM_PTE_TYPE;

typedef VOID *(*__anon_324)(enum _POOL_TYPE, ULONGLONG, ULONG);
...
typedef struct _PPM_IDLE_STATE {
  ...
  ULONG Power;                        // offset: 0xac ordinal: 0x2
  ULONG StateFlags;                   // offset: 0xb0 ordinal: 0x3
  UCHAR StateType;                    // offset: 0xb4 ordinal: 0x4
  UCHAR InterruptsEnabled;            // offset: 0xb5 ordinal: 0x5
  UCHAR Interruptible;                // offset: 0xb6 ordinal: 0x6
  UCHAR ContextRetained;              // offset: 0xb7 ordinal: 0x7
  UCHAR CacheCoherent;                // offset: 0xb8 ordinal: 0x8
} _PPM_IDLE_STATE;

// 0x2d8 bytes (sizeof)
typedef struct _PPM_IDLE_STATES {
  UCHAR ForceIdle;                             // offset: 0x0 ordinal: 0x0
  UCHAR EstimateIdleDuration;                  // offset: 0x1 ordinal: 0x1
  UCHAR ExitLatencyTraceEnabled;               // offset: 0x2 ordinal: 0x2
  ULONG ExitLatencyCountdown;                  // offset: 0x4 ordinal: 0x3
  ULONG TargetState;                           // offset: 0x8 ordinal: 0x4
  ULONG ActualState;                           // offset: 0xc ordinal: 0x5
  ULONG ActualPlatformState;                   // offset: 0x10 ordinal: 0x6
  ULONG OldState;                              // offset: 0x14 ordinal: 0x7
  ULONG OverrideIndex;                         // offset: 0x18 ordinal: 0x8
  ULONG PlatformIdleCount;                     // offset: 0x1c ordinal: 0x9
  ULONG ProcessorIdleCount;                    // offset: 0x20 ordinal: 0xa
  ULONG Type;                                  // offset: 0x24 ordinal: 0xb
  ULONG ReasonFlags;                           // offset: 0x28 ordinal: 0xc
  LONGLONG InitiateWakeStamp;                  // offset: 0x30 ordinal: 0xd
  LONG PreviousStatus;                         // offset: 0x38 ordinal: 0xe
  struct _KAFFINITY_EX PrimaryProcessorMask;   // offset: 0x40 ordinal: 0xf
  struct _KAFFINITY_EX SecondaryProcessorMask; // offset: 0xe8 ordinal: 0x10
  VOID(*IdlePrepare)
  (struct _PROCESSOR_IDLE_PREPARE_INFO *); // offset: 0x190 ordinal: 0x11
  LONG (*IdleExecute)(VOID *);             // offset: 0x198 ordinal: 0x12
  VOID (*IdleComplete)(VOID *);            // offset: 0x1a0 ordinal: 0x13
  VOID (*IdleCancel)(VOID *, ULONG);       // offset: 0x1a8 ordinal: 0x14
  UCHAR (*IdleIsHalted)(VOID *);           // offset: 0x1b0 ordinal: 0x15
  UCHAR (*IdleInitiateWake)(VOID *);       // offset: 0x1b8 ordinal: 0x16
  struct _PROCESSOR_IDLE_PREPARE_INFO
      PrepareInfo;                 // offset: 0x1c0 ordinal: 0x17
  struct _PPM_IDLE_STATE State[1]; // offset: 0x218 ordinal: 0x18
} _PPM_IDLE_STATES;
...
typedef struct _KNODE {
  ...
  ULONG ProximityId;               // offset: 0x40 ordinal: 0x1
  USHORT NodeNumber;               // offset: 0x44 ordinal: 0x2
  USHORT PrimaryNodeNumber;        // offset: 0x46 ordinal: 0x3
  UCHAR MaximumProcessors;         // offset: 0x48 ordinal: 0x4
  struct _flags Flags;             // offset: 0x49 ordinal: 0x5
  UCHAR Stride;                    // offset: 0x4a ordinal: 0x6
  UCHAR NodePad0;                  // offset: 0x4b ordinal: 0x7
  struct _GROUP_AFFINITY Affinity; // offset: 0x50 ordinal: 0x8
  ULONGLONG IdleCpuSet;            // offset: 0x60 ordinal: 0x9
  ULONGLONG IdleSmtSet;            // offset: 0x68 ordinal: 0xa
  ULONG Seed;                      // offset: 0x80 ordinal: 0xb
  ULONG Lowest;                    // offset: 0x84 ordinal: 0xc
  ULONG Highest;                   // offset: 0x88 ordinal: 0xd
  LONG ParkLock;                   // offset: 0x8c ordinal: 0xe
  ULONGLONG NonParkedSet;          // offset: 0x90 ordinal: 0xf
} _KNODE;

// 0x340 bytes (sizeof)
typedef struct _ENODE {
  struct _KNODE Ncb;                       // offset: 0x0 ordinal: 0x0
  struct _EX_WORK_QUEUE ExWorkerQueues[7]; // offset: 0xc0 ordinal: 0x1
  struct _KEVENT ExpThreadSetManagerEvent; // offset: 0x2f0 ordinal: 0x2
  struct _ETHREAD
      *ExpWorkerThreadBalanceManagerPtr; // offset: 0x308 ordinal: 0x3
  ULONG ExpWorkerSeed;                   // offset: 0x310 ordinal: 0x4
  ULONG ExWorkerFullInit : 1;            // offset: 0x314 ordinal: 0x5
  ULONG ExWorkerStructInit : 1;          // offset: 0x314 ordinal: 0x6
  ULONG ExWorkerFlags;                   // offset: 0x314 ordinal: 0x7
} _ENODE;
...
typedef LONG (*__anon_1626)(struct _CM_PARTIAL_RESOURCE_DESCRIPTOR *,
                            ULONGLONG *, ULONGLONG *);

typedef LONG (*__anon_1624)(struct _IO_RESOURCE_DESCRIPTOR *, ULONGLONG *,
...
typedef LONG (*__anon_1639)(struct _ARBITER_INSTANCE *, ULONG,
                            struct _CM_PARTIAL_RESOURCE_DESCRIPTOR *,
                            struct _RTL_RANGE_LIST *);

typedef VOID (*__anon_1638)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_ALLOCATION_STATE *);

typedef UCHAR (*__anon_1637)(struct _ARBITER_INSTANCE *,
                             struct _ARBITER_ALLOCATION_STATE *);

typedef LONG (*__anon_1636)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_ALLOCATION_STATE *);

typedef LONG (*__anon_1635)(struct _ARBITER_INSTANCE *,
                            struct _CM_RESOURCE_LIST *);

typedef LONG (*__anon_1634)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_ADD_RESERVED_PARAMETERS *);

typedef LONG (*__anon_1633)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_QUERY_CONFLICT_PARAMETERS *);

typedef LONG (*__anon_1632)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_QUERY_ARBITRATE_PARAMETERS *);

typedef LONG (*__anon_1631)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_BOOT_ALLOCATION_PARAMETERS *);

typedef LONG (*__anon_1630)(struct _ARBITER_INSTANCE *);

typedef LONG (*__anon_1629)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_RETEST_ALLOCATION_PARAMETERS *);

typedef LONG (*__anon_1628)(struct _ARBITER_INSTANCE *,
                            struct _ARBITER_TEST_ALLOCATION_PARAMETERS *);

typedef LONG (*__anon_1188)(VOID *, VOID **, ULONGLONG *);

typedef LONG (*__anon_1034)(VOID *, struct _GUID *, VOID *, ULONGLONG, VOID *,
                            ULONGLONG, ULONGLONG *);
...
typedef VOID (*__anon_398)(ULONGLONG, UCHAR, ULONGLONG *, ULONGLONG *);
...
typedef ULONG (*__anon_377)(ULONGLONG, ULONG, ULONG, ULONG, ULONG, ULONG *,
                            ULONGLONG *);

typedef VOID (*__anon_375)(ULONGLONG *);
...
typedef union _SLIST_HEADER {
  ...
  struct __anon_241 Header8;   // offset: 0x0 ordinal: 0x2
  struct __anon_242 HeaderX64; // offset: 0x0 ordinal: 0x3
} _SLIST_HEADER;
...
typedef struct _VF_TARGET_VERIFIED_DRIVER_DATA {
  ...
  union __anon_1696 u1;                        // offset: 0x20 ordinal: 0x3
...
typedef struct _VF_TARGET_DRIVER {
  ...
  union __anon_1687 u1;              // offset: 0x10 ordinal: 0x1
...
typedef struct _MM_SESSION_SPACE {
  ...
  union __anon_1823 u;                           // offset: 0x4 ordinal: 0x1
  ...
  struct _MMSUPPORT Vm;                          // offset: 0xbf8 ordinal: 0x15
  struct _MMWSLE *Wsle;                          // offset: 0xc88 ordinal: 0x16
  struct _MI_SESSION_DRIVER_UNLOAD DriverUnload; // offset: 0xc90 ordinal: 0x17
  struct _POOL_DESCRIPTOR PagedPool;             // offset: 0xcc0 ordinal: 0x18
  struct _MMPTE PageDirectory;                   // offset: 0x1e00 ordinal: 0x19
  struct _FAST_MUTEX SessionVaLock;              // offset: 0x1e08 ordinal: 0x1a
  struct _RTL_BITMAP DynamicVaBitMap;            // offset: 0x1e40 ordinal: 0x1b
  ULONG DynamicVaHint;                           // offset: 0x1e50 ordinal: 0x1c
  struct _MI_SPECIAL_POOL SpecialPool;           // offset: 0x1e58 ordinal: 0x1d
  struct _FAST_MUTEX SessionPteLock;             // offset: 0x1ea8 ordinal: 0x1e
  LONG PoolBigEntriesInUse;                      // offset: 0x1ee0 ordinal: 0x1f
  ULONG PagedPoolPdeCount;                       // offset: 0x1ee4 ordinal: 0x20
  ULONG SpecialPoolPdeCount;                     // offset: 0x1ee8 ordinal: 0x21
  ULONG DynamicSessionPdeCount;                  // offset: 0x1eec ordinal: 0x22
  struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;      // offset: 0x1ef0 ordinal: 0x23
  VOID *PoolTrackTableExpansion;                 // offset: 0x1f40 ordinal: 0x24
  ULONGLONG PoolTrackTableExpansionSize;         // offset: 0x1f48 ordinal: 0x25
  VOID *PoolTrackBigPages;                       // offset: 0x1f50 ordinal: 0x26
  ULONGLONG PoolTrackBigPagesSize;               // offset: 0x1f58 ordinal: 0x27
  enum _IO_SESSION_STATE IoState;                // offset: 0x1f60 ordinal: 0x28
  ULONG IoStateSequence;                         // offset: 0x1f64 ordinal: 0x29
  struct _KEVENT IoNotificationEvent;            // offset: 0x1f68 ordinal: 0x2a
} _MM_SESSION_SPACE;
...
typedef VOID (*__anon_325)(VOID *, struct _LOOKASIDE_LIST_EX *);

typedef VOID *(*__anon_323)(enum _POOL_TYPE, ULONGLONG, ULONG,
                            struct _LOOKASIDE_LIST_EX *);

// 0x48 bytes (sizeof)
typedef struct _PS_WAKE_INFORMATION {
  ULONGLONG NotificationChannel; // offset: 0x0 ordinal: 0x0
  ULONGLONG WakeCounters[8];     // offset: 0x8 ordinal: 0x1
...
typedef struct _EJOB {
  ...
  struct _JOBOBJECT_WAKE_FILTER WakeFilter; // offset: 0x3a0 ordinal: 0x3c
  ULONG LowEdgeLatchFilter;                 // offset: 0x3a8 ordinal: 0x3d
  ULONG OwnedHighEdgeFilters;               // offset: 0x3ac ordinal: 0x3e
  struct _EJOB *NotificationLink;           // offset: 0x3b0 ordinal: 0x3f
  ULONGLONG CurrentJobMemoryUsed;           // offset: 0x3b8 ordinal: 0x40
  struct _JOB_NOTIFICATION_INFORMATION
      *NotificationInfo;                // offset: 0x3c0 ordinal: 0x41
  VOID *NotificationInfoQuotaReference; // offset: 0x3c8 ordinal: 0x42
  struct _IO_MINI_COMPLETION_PACKET_USER
      *NotificationPacket;                      // offset: 0x3d0 ordinal: 0x43
  struct _JOB_CPU_RATE_CONTROL *CpuRateControl; // offset: 0x3d8 ordinal: 0x44
  VOID *EffectiveSchedulingGroup;               // offset: 0x3e0 ordinal: 0x45
  struct _EX_PUSH_LOCK MemoryLimitsLock;        // offset: 0x3e8 ordinal: 0x46
  struct _LIST_ENTRY SiblingJobLinks;           // offset: 0x3f0 ordinal: 0x47
  struct _LIST_ENTRY ChildJobListHead;          // offset: 0x400 ordinal: 0x48
  struct _EJOB *ParentJob;                      // offset: 0x410 ordinal: 0x49
  struct _EJOB *RootJob;                        // offset: 0x418 ordinal: 0x4a
  struct _LIST_ENTRY IteratorListHead;          // offset: 0x420 ordinal: 0x4b
  struct _EPROCESS_VALUES Accounting;           // offset: 0x430 ordinal: 0x4c
  ULONG ShadowActiveProcessCount;               // offset: 0x480 ordinal: 0x4d
  ULONG SequenceNumber;                         // offset: 0x484 ordinal: 0x4e
  ULONGLONG TimerListLock;                      // offset: 0x488 ordinal: 0x4f
  struct _LIST_ENTRY TimerListHead;             // offset: 0x490 ordinal: 0x50
  union {
    ULONG JobFlags;      // offset: 0x4a0 ordinal: 0x51
    ULONG CloseDone : 1; // offset: 0x4a0 ordinal: 0x52
  };
  ULONG MultiGroup : 1;                    // offset: 0x4a0 ordinal: 0x53
  ULONG OutstandingNotification : 1;       // offset: 0x4a0 ordinal: 0x54
  ULONG NotificationInProgress : 1;        // offset: 0x4a0 ordinal: 0x55
  ULONG UILimits : 1;                      // offset: 0x4a0 ordinal: 0x56
  ULONG CpuRateControlActive : 1;          // offset: 0x4a0 ordinal: 0x57
  ULONG OwnCpuRateControl : 1;             // offset: 0x4a0 ordinal: 0x58
  ULONG Terminating : 1;                   // offset: 0x4a0 ordinal: 0x59
  ULONG WorkingSetLock : 1;                // offset: 0x4a0 ordinal: 0x5a
  ULONG JobFrozen : 1;                     // offset: 0x4a0 ordinal: 0x5b
  ULONG Background : 1;                    // offset: 0x4a0 ordinal: 0x5c
  ULONG WakeNotificationAllocated : 1;     // offset: 0x4a0 ordinal: 0x5d
  ULONG WakeNotificationEnabled : 1;       // offset: 0x4a0 ordinal: 0x5e
  ULONG WakeNotificationPending : 1;       // offset: 0x4a0 ordinal: 0x5f
  ULONG LimitNotificationRequired : 1;     // offset: 0x4a0 ordinal: 0x60
  ULONG ZeroCountNotificationRequired : 1; // offset: 0x4a0 ordinal: 0x61
  ULONG CycleTimeNotificationRequired : 1; // offset: 0x4a0 ordinal: 0x62
  ULONG CycleTimeNotificationPending : 1;  // offset: 0x4a0 ordinal: 0x63
  ULONG TimersVirtualized : 1;             // offset: 0x4a0 ordinal: 0x64
  ULONG JobSwapped : 1;                    // offset: 0x4a0 ordinal: 0x65
  ULONG ViolationDetected : 1;             // offset: 0x4a0 ordinal: 0x66
  ULONG EmptyJobNotified : 1;              // offset: 0x4a0 ordinal: 0x67
  ULONG NoSystemCharge : 1;                // offset: 0x4a0 ordinal: 0x68
  ULONG SpareJobFlags : 9;                 // offset: 0x4a0 ordinal: 0x69
  ULONG EffectiveHighEdgeFilters;          // offset: 0x4a4 ordinal: 0x6a
} _EJOB;
...
typedef struct _PROCESSOR_POWER_STATE {
  ...
  struct _PLATFORM_IDLE_ACCOUNTING
      *PlatformIdleAccounting;         // offset: 0x10 ordinal: 0x2
  ULONGLONG IdleTimeLast;              // offset: 0x18 ordinal: 0x3
  ULONGLONG IdleTimeTotal;             // offset: 0x20 ordinal: 0x4
  ULONGLONG IdleTimeEntry;             // offset: 0x28 ordinal: 0x5
  ULONGLONG Reserved;                  // offset: 0x30 ordinal: 0x6
  struct _PROC_IDLE_POLICY IdlePolicy; // offset: 0x38 ordinal: 0x7
  union _PPM_IDLE_SYNCHRONIZATION_STATE
      Synchronization;                    // offset: 0x40 ordinal: 0x8
  struct _PROC_FEEDBACK PerfFeedback;     // offset: 0x48 ordinal: 0x9
  enum _PROC_HYPERVISOR_STATE Hypervisor; // offset: 0xb8 ordinal: 0xa
  ULONG LastSysTime;                      // offset: 0xbc ordinal: 0xb
  ULONGLONG WmiDispatchPtr;               // offset: 0xc0 ordinal: 0xc
  LONG WmiInterfaceEnabled;               // offset: 0xc8 ordinal: 0xd
  struct _PPM_FFH_THROTTLE_STATE_INFO
      FFHThrottleStateInfo;                     // offset: 0xd0 ordinal: 0xe
  struct _KDPC PerfActionDpc;                   // offset: 0xf0 ordinal: 0xf
  LONG PerfActionMask;                          // offset: 0x130 ordinal: 0x10
  struct _PROC_IDLE_SNAP HvIdleCheck;           // offset: 0x138 ordinal: 0x11
  struct _PROC_PERF_SNAP PerfCheck;             // offset: 0x148 ordinal: 0x12
  struct _PROC_PERF_DOMAIN *Domain;             // offset: 0x188 ordinal: 0x13
  struct _PROC_PERF_CONSTRAINT *PerfConstraint; // offset: 0x190 ordinal: 0x14
  struct _PPM_CONCURRENCY_ACCOUNTING
      *Concurrency;                       // offset: 0x198 ordinal: 0x15
  struct _PROC_PERF_LOAD *Load;           // offset: 0x1a0 ordinal: 0x16
  struct _PROC_PERF_HISTORY *PerfHistory; // offset: 0x1a8 ordinal: 0x17
  UCHAR GuaranteedPerformancePercent;     // offset: 0x1b0 ordinal: 0x18
  UCHAR HvTargetState;                    // offset: 0x1b1 ordinal: 0x19
  UCHAR Parked;                           // offset: 0x1b2 ordinal: 0x1a
  UCHAR OverUtilized;                     // offset: 0x1b3 ordinal: 0x1b
  ULONG LatestPerformancePercent;         // offset: 0x1b4 ordinal: 0x1c
  ULONG AveragePerformancePercent;        // offset: 0x1b8 ordinal: 0x1d
  ULONG LatestAffinitizedPercent;         // offset: 0x1bc ordinal: 0x1e
  ULONG Utility;                          // offset: 0x1c0 ordinal: 0x1f
  ULONG AffinitizedUtility;               // offset: 0x1c4 ordinal: 0x20
...
typedef struct _LDR_DATA_TABLE_ENTRY {
  ...
  VOID *PatchInformation;                         // offset: 0x90 ordinal: 0x2a
...
typedef struct _KSCB {
  ...
  struct _LIST_ENTRY PerProcessorList;  // offset: 0x30 ordinal: 0x6
  struct _RTL_BALANCED_NODE QueueNode;  // offset: 0x40 ordinal: 0x7
  UCHAR Inserted : 1;                   // offset: 0x58 ordinal: 0x8
  UCHAR OverQuota : 1;                  // offset: 0x58 ordinal: 0x9
  UCHAR HardCap : 1;                    // offset: 0x58 ordinal: 0xa
  UCHAR RankBias : 1;                   // offset: 0x58 ordinal: 0xb
  UCHAR Spare1 : 4;                     // offset: 0x58 ordinal: 0xc
  UCHAR Spare2;                         // offset: 0x59 ordinal: 0xd
  USHORT ReadySummary;                  // offset: 0x5a ordinal: 0xe
  ULONG Rank;                           // offset: 0x5c ordinal: 0xf
  struct _LIST_ENTRY ReadyListHead[16]; // offset: 0x60 ordinal: 0x10
} _KSCB;
...
typedef struct _KPROCESS {
  ...
  ULONG ActiveGroupsMask : 20;                // offset: 0x1b0 ordinal: 0x10
  LONG ReservedFlags : 6;                     // offset: 0x1b0 ordinal: 0x11
  LONG ProcessFlags;                          // offset: 0x1b0 ordinal: 0x12
  CHAR BasePriority;                          // offset: 0x1b4 ordinal: 0x13
  CHAR QuantumReset;                          // offset: 0x1b5 ordinal: 0x14
  UCHAR Visited;                              // offset: 0x1b6 ordinal: 0x15
  union _KEXECUTE_OPTIONS Flags;              // offset: 0x1b7 ordinal: 0x16
  ULONG ThreadSeed[20];                       // offset: 0x1b8 ordinal: 0x17
  USHORT IdealNode[20];                       // offset: 0x208 ordinal: 0x18
  USHORT IdealGlobalNode;                     // offset: 0x230 ordinal: 0x19
  USHORT Spare1;                              // offset: 0x232 ordinal: 0x1a
  union _KSTACK_COUNT StackCount;             // offset: 0x234 ordinal: 0x1b
  struct _LIST_ENTRY ProcessListEntry;        // offset: 0x238 ordinal: 0x1c
  ULONGLONG CycleTime;                        // offset: 0x248 ordinal: 0x1d
  ULONGLONG ContextSwitches;                  // offset: 0x250 ordinal: 0x1e
  struct _KSCHEDULING_GROUP *SchedulingGroup; // offset: 0x258 ordinal: 0x1f
  ULONG FreezeCount;                          // offset: 0x260 ordinal: 0x20
  ULONG KernelTime;                           // offset: 0x264 ordinal: 0x21
  ULONG UserTime;                             // offset: 0x268 ordinal: 0x22
  USHORT LdtFreeSelectorHint;                 // offset: 0x26c ordinal: 0x23
  USHORT LdtTableLength;                      // offset: 0x26e ordinal: 0x24
  union _KGDTENTRY64 LdtSystemDescriptor;     // offset: 0x270 ordinal: 0x25
  VOID *LdtBaseAddress;                       // offset: 0x280 ordinal: 0x26
  struct _FAST_MUTEX LdtProcessLock;          // offset: 0x288 ordinal: 0x27
  VOID *InstrumentationCallback;              // offset: 0x2c0 ordinal: 0x28
} _KPROCESS;
...
typedef struct _TOKEN {
  ...
  ULONGLONG VariablePart; // offset: 0x450 ordinal: 0x27
} _TOKEN;
...
typedef struct _POP_POWER_ACTION {
  ...
  struct __anon_1762 WakeAlarm[3];                 // offset: 0x60 ordinal: 0x15
...
typedef enum _EXCEPTION_DISPOSITION (*__anon_111)(struct _EXCEPTION_RECORD *,
...
typedef struct _HEAP_LOCK {
  union __anon_1190 Lock; // offset: 0x0 ordinal: 0x0
} _HEAP_LOCK;
...
typedef struct _PEB32 {
  ...
  UCHAR IsPackagedProcess : 1;            // offset: 0x3 ordinal: 0x9
  UCHAR IsAppContainer : 1;               // offset: 0x3 ordinal: 0xa
  ...
  ULONG HotpatchInformation;                   // offset: 0x50 ordinal: 0x25
...
typedef struct _POP_THERMAL_ZONE {
  ...
  LONG HighPrecisionThrottle;               // offset: 0x18 ordinal: 0x7
  LONG Throttle;                            // offset: 0x1c ordinal: 0x8
  LONG PendingThrottle;                     // offset: 0x20 ordinal: 0x9
  ULONGLONG ThrottleStartTime;              // offset: 0x28 ordinal: 0xa
  ULONGLONG LastTime;                       // offset: 0x30 ordinal: 0xb
  ULONG SampleRate;                         // offset: 0x38 ordinal: 0xc
  ULONG LastTemp;                           // offset: 0x3c ordinal: 0xd
  struct _KTIMER PassiveTimer;              // offset: 0x40 ordinal: 0xe
  struct _KDPC PassiveDpc;                  // offset: 0x80 ordinal: 0xf
  struct _POP_ACTION_TRIGGER OverThrottled; // offset: 0xc0 ordinal: 0x10
  struct _IRP *Irp;                         // offset: 0xd8 ordinal: 0x11
  struct _THERMAL_INFORMATION_EX Info;      // offset: 0xe0 ordinal: 0x12
  union _LARGE_INTEGER InfoLastUpdateTime;  // offset: 0x130 ordinal: 0x13
  struct _POP_THERMAL_ZONE_METRICS Metrics; // offset: 0x138 ordinal: 0x14
} _POP_THERMAL_ZONE;
...
typedef struct _WMI_LOGGER_CONTEXT {
  ...
  ULONG BuffersWritten;                  // offset: 0x104 ordinal: 0x20
  ULONG LogBuffersLost;                  // offset: 0x108 ordinal: 0x21
  ULONG RealTimeBuffersDelivered;        // offset: 0x10c ordinal: 0x22
  ULONG RealTimeBuffersLost;             // offset: 0x110 ordinal: 0x23
  LONG *SequencePtr;                     // offset: 0x118 ordinal: 0x24
  ULONG LocalSequence;                   // offset: 0x120 ordinal: 0x25
  struct _GUID InstanceGuid;             // offset: 0x124 ordinal: 0x26
  ULONG MaximumFileSize;                 // offset: 0x134 ordinal: 0x27
  LONG FileCounter;                      // offset: 0x138 ordinal: 0x28
  enum _POOL_TYPE PoolType;              // offset: 0x13c ordinal: 0x29
  struct _ETW_REF_CLOCK ReferenceTime;   // offset: 0x140 ordinal: 0x2a
  LONG CollectionOn;                     // offset: 0x150 ordinal: 0x2b
  ULONG ProviderInfoSize;                // offset: 0x154 ordinal: 0x2c
  struct _LIST_ENTRY Consumers;          // offset: 0x158 ordinal: 0x2d
  ULONG NumConsumers;                    // offset: 0x168 ordinal: 0x2e
  struct _ETW_REALTIME_CONSUMER
      *TransitionConsumer;                     // offset: 0x170 ordinal: 0x2f
  VOID *RealtimeLogfileHandle;                 // offset: 0x178 ordinal: 0x30
  struct _UNICODE_STRING RealtimeLogfileName;  // offset: 0x180 ordinal: 0x31
  union _LARGE_INTEGER RealtimeWriteOffset;    // offset: 0x190 ordinal: 0x32
  union _LARGE_INTEGER RealtimeReadOffset;     // offset: 0x198 ordinal: 0x33
  union _LARGE_INTEGER RealtimeLogfileSize;    // offset: 0x1a0 ordinal: 0x34
  ULONGLONG RealtimeLogfileUsage;              // offset: 0x1a8 ordinal: 0x35
  ULONGLONG RealtimeMaximumFileSize;           // offset: 0x1b0 ordinal: 0x36
  ULONG RealtimeBuffersSaved;                  // offset: 0x1b8 ordinal: 0x37
  struct _ETW_REF_CLOCK RealtimeReferenceTime; // offset: 0x1c0 ordinal: 0x38
  enum _ETW_RT_EVENT_LOSS NewRTEventsLost;     // offset: 0x1d0 ordinal: 0x39
  struct _KEVENT LoggerEvent;                  // offset: 0x1d8 ordinal: 0x3a
  struct _KEVENT FlushEvent;                   // offset: 0x1f0 ordinal: 0x3b
  struct _KTIMER FlushTimeOutTimer;            // offset: 0x208 ordinal: 0x3c
  struct _KDPC LoggerDpc;                      // offset: 0x248 ordinal: 0x3d
  struct _KMUTANT LoggerMutex;                 // offset: 0x288 ordinal: 0x3e
  struct _EX_PUSH_LOCK LoggerLock;             // offset: 0x2c0 ordinal: 0x3f
  union {
    ULONGLONG BufferListSpinLock;            // offset: 0x2c8 ordinal: 0x40
    struct _EX_PUSH_LOCK BufferListPushLock; // offset: 0x2c8 ordinal: 0x41
  };
  struct _SECURITY_CLIENT_CONTEXT
      ClientSecurityContext;              // offset: 0x2d0 ordinal: 0x42
  struct _EX_FAST_REF SecurityDescriptor; // offset: 0x318 ordinal: 0x43
  union _LARGE_INTEGER StartTime;         // offset: 0x320 ordinal: 0x44
  VOID *LogFileHandle;                    // offset: 0x328 ordinal: 0x45
  LONGLONG BufferSequenceNumber;          // offset: 0x330 ordinal: 0x46
  union {
    ULONG Flags;          // offset: 0x338 ordinal: 0x47
    ULONG Persistent : 1; // offset: 0x338 ordinal: 0x48
  };
  ULONG AutoLogger : 1;                 // offset: 0x338 ordinal: 0x49
  ULONG FsReady : 1;                    // offset: 0x338 ordinal: 0x4a
  ULONG RealTime : 1;                   // offset: 0x338 ordinal: 0x4b
  ULONG Wow : 1;                        // offset: 0x338 ordinal: 0x4c
  ULONG KernelTrace : 1;                // offset: 0x338 ordinal: 0x4d
  ULONG NoMoreEnable : 1;               // offset: 0x338 ordinal: 0x4e
  ULONG StackTracing : 1;               // offset: 0x338 ordinal: 0x4f
  ULONG ErrorLogged : 1;                // offset: 0x338 ordinal: 0x50
  ULONG RealtimeLoggerContextFreed : 1; // offset: 0x338 ordinal: 0x51
  ULONG PebsTracing : 1;                // offset: 0x338 ordinal: 0x52
  ULONG PmcCounters : 1;                // offset: 0x338 ordinal: 0x53
  ULONG PageAlignBuffers : 1;           // offset: 0x338 ordinal: 0x54
  ULONG SpareFlags1 : 3;                // offset: 0x338 ordinal: 0x55
  ULONG SystemLoggerIndex : 8;          // offset: 0x338 ordinal: 0x56
  ULONG StackCaching : 1;               // offset: 0x338 ordinal: 0x57
  ULONG SpareFlags2 : 7;                // offset: 0x338 ordinal: 0x58
  union {
    ULONG RequestFlag;          // offset: 0x33c ordinal: 0x59
    ULONG DbgRequestNewFie : 1; // offset: 0x33c ordinal: 0x5a
  };
  ULONG DbgRequestUpdateFile : 1;             // offset: 0x33c ordinal: 0x5b
  ULONG DbgRequestFlush : 1;                  // offset: 0x33c ordinal: 0x5c
  ULONG DbgRequestDisableRealtime : 1;        // offset: 0x33c ordinal: 0x5d
  ULONG DbgRequestDisconnectConsumer : 1;     // offset: 0x33c ordinal: 0x5e
  ULONG DbgRequestConnectConsumer : 1;        // offset: 0x33c ordinal: 0x5f
  ULONG DbgRequestNotifyConsumer : 1;         // offset: 0x33c ordinal: 0x60
  ULONG DbgRequestUpdateHeader : 1;           // offset: 0x33c ordinal: 0x61
  ULONG DbgRequestDefferdFlush : 1;           // offset: 0x33c ordinal: 0x62
  ULONG DbgRequestDefferdFlushTimer : 1;      // offset: 0x33c ordinal: 0x63
  ULONG DbgRequestFlushTimer : 1;             // offset: 0x33c ordinal: 0x64
  ULONG DbgRequestUpdateDebugger : 1;         // offset: 0x33c ordinal: 0x65
  ULONG DbgSpareRequestFlags : 20;            // offset: 0x33c ordinal: 0x66
  struct _RTL_BITMAP HookIdMap;               // offset: 0x340 ordinal: 0x67
  struct _ETW_STACK_CACHE *StackCache;        // offset: 0x350 ordinal: 0x68
  struct _ETW_PMC_SUPPORT *PmcData;           // offset: 0x358 ordinal: 0x69
  struct _LIST_ENTRY WinRtProviderBinaryList; // offset: 0x360 ordinal: 0x6a
  struct _WMI_BUFFER_HEADER **ScratchArray;   // offset: 0x370 ordinal: 0x6b
} _WMI_LOGGER_CONTEXT;

// 0x1d0 bytes (sizeof)
typedef struct _POP_FX_DEVICE {
  struct _LIST_ENTRY Link;                    // offset: 0x0 ordinal: 0x0
  struct _POP_FX_PLUGIN *Plugin;              // offset: 0x10 ordinal: 0x1
  struct PEPHANDLE__ *PluginHandle;           // offset: 0x18 ordinal: 0x2
  struct _POP_FX_PLUGIN *MiniPlugin;          // offset: 0x20 ordinal: 0x3
  struct PEPHANDLE__ *MiniPluginHandle;       // offset: 0x28 ordinal: 0x4
  struct _DEVICE_NODE *DevNode;               // offset: 0x30 ordinal: 0x5
  struct _DEVICE_OBJECT *DeviceObject;        // offset: 0x38 ordinal: 0x6
  struct _DEVICE_OBJECT *TargetDevice;        // offset: 0x40 ordinal: 0x7
  struct _POP_FX_DRIVER_CALLBACKS Callbacks;  // offset: 0x48 ordinal: 0x8
  VOID *DriverContext;                        // offset: 0x80 ordinal: 0x9
  struct _IO_REMOVE_LOCK RemoveLock;          // offset: 0x88 ordinal: 0xa
  struct _POP_FX_WORK_ORDER WorkOrder;        // offset: 0xa8 ordinal: 0xb
  union _POP_FX_DEVICE_STATUS Status;         // offset: 0xd0 ordinal: 0xc
  LONG PowerReqCall;                          // offset: 0xd4 ordinal: 0xd
  LONG PowerNotReqCall;                       // offset: 0xd8 ordinal: 0xe
  ULONGLONG IdleLock;                         // offset: 0xe0 ordinal: 0xf
  struct _KTIMER IdleTimer;                   // offset: 0xe8 ordinal: 0x10
  struct _KDPC IdleDpc;                       // offset: 0x128 ordinal: 0x11
  ULONGLONG IdleTimeout;                      // offset: 0x168 ordinal: 0x12
  ULONGLONG IdleStamp;                        // offset: 0x170 ordinal: 0x13
  struct _IRP *Irp;                           // offset: 0x178 ordinal: 0x14
  struct _POP_IRP_DATA *IrpData;              // offset: 0x180 ordinal: 0x15
  struct _DEVICE_OBJECT *NextIrpDeviceObject; // offset: 0x188 ordinal: 0x16
  union _POWER_STATE NextIrpPowerState;       // offset: 0x190 ordinal: 0x17
  VOID(*NextIrpCallerCompletion)
  (struct _DEVICE_OBJECT *, UCHAR, union _POWER_STATE, VOID *,
   struct _IO_STATUS_BLOCK *);             // offset: 0x198 ordinal: 0x18
  VOID *NextIrpCallerContext;              // offset: 0x1a0 ordinal: 0x19
  struct _KEVENT IrpCompleteEvent;         // offset: 0x1a8 ordinal: 0x1a
  ULONG ComponentCount;                    // offset: 0x1c0 ordinal: 0x1b
  struct _POP_FX_COMPONENT *Components[1]; // offset: 0x1c8 ordinal: 0x1c
} _POP_FX_DEVICE;
...
typedef struct _POP_FX_COMPONENT {
  ...
  struct _POP_FX_DEVICE *Device;         // offset: 0x40 ordinal: 0x3
  union _POP_FX_COMPONENT_FLAGS Flags;   // offset: 0x48 ordinal: 0x4
  LONG Resident;                         // offset: 0x50 ordinal: 0x5
  struct _KEVENT ActiveEvent;            // offset: 0x58 ordinal: 0x6
  ULONGLONG IdleLock;                    // offset: 0x70 ordinal: 0x7
  LONG IdleConditionComplete;            // offset: 0x78 ordinal: 0x8
  LONG IdleStateComplete;                // offset: 0x7c ordinal: 0x9
  ULONGLONG IdleStamp;                   // offset: 0x80 ordinal: 0xa
  ULONG CurrentIdleState;                // offset: 0x88 ordinal: 0xb
  ULONG IdleStateCount;                  // offset: 0x8c ordinal: 0xc
  struct _POP_FX_IDLE_STATE *IdleStates; // offset: 0x90 ordinal: 0xd
  ULONG DeepestWakeableIdleState;        // offset: 0x98 ordinal: 0xe
  ULONG ProviderCount;                   // offset: 0x9c ordinal: 0xf
  struct _POP_FX_PROVIDER *Providers;    // offset: 0xa0 ordinal: 0x10
  ULONG IdleProviderCount;               // offset: 0xa8 ordinal: 0x11
  ULONG DependentCount;                  // offset: 0xac ordinal: 0x12
  struct _POP_FX_DEPENDENT *Dependents;  // offset: 0xb0 ordinal: 0x13
} _POP_FX_COMPONENT;
...
typedef struct _POP_IRP_DATA {
  ...
  union {
    struct __anon_1036 Device; // offset: 0xd8 ordinal: 0xf
    struct __anon_1037 System; // offset: 0xd8 ordinal: 0x10
  };
} _POP_IRP_DATA;
...
typedef struct _DEVICE_NODE {
  ...
  union _POWER_STATE CurrentPowerState;        // offset: 0x54 ordinal: 0x9
  struct _PO_DEVICE_NOTIFY Notify;             // offset: 0x58 ordinal: 0xa
  struct _PO_IRP_MANAGER PoIrpManager;         // offset: 0xc0 ordinal: 0xb
  struct _POP_FX_DEVICE *FxDevice;             // offset: 0xe0 ordinal: 0xc
  LONG FxDeviceLock;                           // offset: 0xe8 ordinal: 0xd
  struct _KEVENT FxRemoveEvent;                // offset: 0xf0 ordinal: 0xe
  LONG FxActivationCount;                      // offset: 0x108 ordinal: 0xf
  LONG FxSleepCount;                           // offset: 0x10c ordinal: 0x10
  struct _POP_FX_PLUGIN *Plugin;               // offset: 0x110 ordinal: 0x11
  ...
  union __anon_986 OverUsed1;              // offset: 0x210 ordinal: 0x2f
  union __anon_997 OverUsed2;              // offset: 0x218 ordinal: 0x30
  ...
  struct __anon_998 DockInfo;                 // offset: 0x238 ordinal: 0x34
...
typedef struct _KPRCB {
  ...
  UCHAR PendingTick;                       // offset: 0x22 ordinal: 0xa
  UCHAR PrcbPad00[1];                      // offset: 0x23 ordinal: 0xb
  ULONG Number;                            // offset: 0x24 ordinal: 0xc
  ULONGLONG RspBase;                       // offset: 0x28 ordinal: 0xd
  ULONGLONG PrcbLock;                      // offset: 0x30 ordinal: 0xe
  ULONGLONG PrcbPad01;                     // offset: 0x38 ordinal: 0xf
  struct _KPROCESSOR_STATE ProcessorState; // offset: 0x40 ordinal: 0x10
  CHAR CpuType;                            // offset: 0x5f0 ordinal: 0x11
  CHAR CpuID;                              // offset: 0x5f1 ordinal: 0x12
  union {
    USHORT CpuStep;    // offset: 0x5f2 ordinal: 0x13
    UCHAR CpuStepping; // offset: 0x5f2 ordinal: 0x14
  };
  UCHAR CpuModel;                                // offset: 0x5f3 ordinal: 0x15
  ULONG MHz;                                     // offset: 0x5f4 ordinal: 0x16
  ULONGLONG HalReserved[8];                      // offset: 0x5f8 ordinal: 0x17
  USHORT MinorVersion;                           // offset: 0x638 ordinal: 0x18
  USHORT MajorVersion;                           // offset: 0x63a ordinal: 0x19
  UCHAR BuildType;                               // offset: 0x63c ordinal: 0x1a
  UCHAR CpuVendor;                               // offset: 0x63d ordinal: 0x1b
  UCHAR CoresPerPhysicalProcessor;               // offset: 0x63e ordinal: 0x1c
  UCHAR LogicalProcessorsPerCore;                // offset: 0x63f ordinal: 0x1d
  ULONG ApicMask;                                // offset: 0x640 ordinal: 0x1e
  ULONG CFlushSize;                              // offset: 0x644 ordinal: 0x1f
  VOID *AcpiReserved;                            // offset: 0x648 ordinal: 0x20
  ULONG InitialApicId;                           // offset: 0x650 ordinal: 0x21
  ULONG Stride;                                  // offset: 0x654 ordinal: 0x22
  USHORT Group;                                  // offset: 0x658 ordinal: 0x23
  ULONGLONG GroupSetMember;                      // offset: 0x660 ordinal: 0x24
  UCHAR GroupIndex;                              // offset: 0x668 ordinal: 0x25
  struct _KSPIN_LOCK_QUEUE LockQueue[17];        // offset: 0x670 ordinal: 0x26
  struct _PP_LOOKASIDE_LIST PPLookasideList[16]; // offset: 0x780 ordinal: 0x27
  struct _GENERAL_LOOKASIDE_POOL
      PPNxPagedLookasideList[32]; // offset: 0x880 ordinal: 0x28
  struct _GENERAL_LOOKASIDE_POOL
      PPNPagedLookasideList[32]; // offset: 0x1480 ordinal: 0x29
  struct _GENERAL_LOOKASIDE_POOL
      PPPagedLookasideList[32]; // offset: 0x2080 ordinal: 0x2a
  ULONGLONG PrcbPad20;          // offset: 0x2c80 ordinal: 0x2b
  struct _SINGLE_LIST_ENTRY
      DeferredReadyListHead;                 // offset: 0x2c88 ordinal: 0x2c
  LONG MmPageFaultCount;                     // offset: 0x2c90 ordinal: 0x2d
  LONG MmCopyOnWriteCount;                   // offset: 0x2c94 ordinal: 0x2e
  LONG MmTransitionCount;                    // offset: 0x2c98 ordinal: 0x2f
  LONG MmDemandZeroCount;                    // offset: 0x2c9c ordinal: 0x30
  LONG MmPageReadCount;                      // offset: 0x2ca0 ordinal: 0x31
  LONG MmPageReadIoCount;                    // offset: 0x2ca4 ordinal: 0x32
  LONG MmDirtyPagesWriteCount;               // offset: 0x2ca8 ordinal: 0x33
  LONG MmDirtyWriteIoCount;                  // offset: 0x2cac ordinal: 0x34
  LONG MmMappedPagesWriteCount;              // offset: 0x2cb0 ordinal: 0x35
  LONG MmMappedWriteIoCount;                 // offset: 0x2cb4 ordinal: 0x36
  ULONG KeSystemCalls;                       // offset: 0x2cb8 ordinal: 0x37
  ULONG KeContextSwitches;                   // offset: 0x2cbc ordinal: 0x38
  ULONG CcFastReadNoWait;                    // offset: 0x2cc0 ordinal: 0x39
  ULONG CcFastReadWait;                      // offset: 0x2cc4 ordinal: 0x3a
  ULONG CcFastReadNotPossible;               // offset: 0x2cc8 ordinal: 0x3b
  ULONG CcCopyReadNoWait;                    // offset: 0x2ccc ordinal: 0x3c
  ULONG CcCopyReadWait;                      // offset: 0x2cd0 ordinal: 0x3d
  ULONG CcCopyReadNoWaitMiss;                // offset: 0x2cd4 ordinal: 0x3e
  LONG LookasideIrpFloat;                    // offset: 0x2cd8 ordinal: 0x3f
  LONG IoReadOperationCount;                 // offset: 0x2cdc ordinal: 0x40
  LONG IoWriteOperationCount;                // offset: 0x2ce0 ordinal: 0x41
  LONG IoOtherOperationCount;                // offset: 0x2ce4 ordinal: 0x42
  union _LARGE_INTEGER IoReadTransferCount;  // offset: 0x2ce8 ordinal: 0x43
  union _LARGE_INTEGER IoWriteTransferCount; // offset: 0x2cf0 ordinal: 0x44
  union _LARGE_INTEGER IoOtherTransferCount; // offset: 0x2cf8 ordinal: 0x45
  LONG PacketBarrier;                        // offset: 0x2d00 ordinal: 0x46
  LONG TargetCount;                          // offset: 0x2d04 ordinal: 0x47
  ULONG IpiFrozen;                           // offset: 0x2d08 ordinal: 0x48
  ULONG PrcbPad40[29];                       // offset: 0x2d0c ordinal: 0x49
  struct _KDPC_DATA DpcData[2];              // offset: 0x2d80 ordinal: 0x4a
  VOID *DpcStack;                            // offset: 0x2dc0 ordinal: 0x4b
  LONG MaximumDpcQueueDepth;                 // offset: 0x2dc8 ordinal: 0x4c
  ULONG DpcRequestRate;                      // offset: 0x2dcc ordinal: 0x4d
  ULONG MinimumDpcRate;                      // offset: 0x2dd0 ordinal: 0x4e
  ULONG DpcLastCount;                        // offset: 0x2dd4 ordinal: 0x4f
  UCHAR ThreadDpcEnable;                     // offset: 0x2dd8 ordinal: 0x50
  UCHAR QuantumEnd;                          // offset: 0x2dd9 ordinal: 0x51
  UCHAR DpcRoutineActive;                    // offset: 0x2dda ordinal: 0x52
  UCHAR IdleSchedule;                        // offset: 0x2ddb ordinal: 0x53
  union {
    LONG DpcRequestSummary;  // offset: 0x2ddc ordinal: 0x54
    SHORT DpcRequestSlot[2]; // offset: 0x2ddc ordinal: 0x55
    SHORT NormalDpcState;    // offset: 0x2ddc ordinal: 0x56
  };
  SHORT ThreadDpcState;                   // offset: 0x2dde ordinal: 0x57
  ULONG DpcNormalProcessingActive : 1;    // offset: 0x2ddc ordinal: 0x58
  ULONG DpcNormalProcessingRequested : 1; // offset: 0x2ddc ordinal: 0x59
  ULONG DpcNormalThreadSignal : 1;        // offset: 0x2ddc ordinal: 0x5a
  ULONG DpcNormalTimerExpiration : 1;     // offset: 0x2ddc ordinal: 0x5b
  ULONG DpcNormalDpcPresent : 1;          // offset: 0x2ddc ordinal: 0x5c
  ULONG DpcNormalLocalInterrupt : 1;      // offset: 0x2ddc ordinal: 0x5d
  ULONG DpcNormalSpare : 10;              // offset: 0x2ddc ordinal: 0x5e
  ULONG DpcThreadActive : 1;              // offset: 0x2ddc ordinal: 0x5f
  ULONG DpcThreadRequested : 1;           // offset: 0x2ddc ordinal: 0x60
  ULONG DpcThreadSpare : 14;              // offset: 0x2ddc ordinal: 0x61
  ULONG LastTimerHand;                    // offset: 0x2de0 ordinal: 0x62
  ULONG LastTick;                         // offset: 0x2de4 ordinal: 0x63
  ULONG ClockInterrupts;                  // offset: 0x2de8 ordinal: 0x64
  ULONG ReadyScanTick;                    // offset: 0x2dec ordinal: 0x65
  UCHAR BalanceState;                     // offset: 0x2df0 ordinal: 0x66
  UCHAR PrcbPad50[7];                     // offset: 0x2df1 ordinal: 0x67
  ULONG InterruptLastCount;               // offset: 0x2df8 ordinal: 0x68
  ULONG InterruptRate;                    // offset: 0x2dfc ordinal: 0x69
  struct _KTIMER_TABLE TimerTable;        // offset: 0x2e00 ordinal: 0x6a
  struct _KGATE DpcGate;                  // offset: 0x5000 ordinal: 0x6b
  VOID *PrcbPad52;                        // offset: 0x5018 ordinal: 0x6c
  struct _KDPC CallDpc;                   // offset: 0x5020 ordinal: 0x6d
  LONG ClockKeepAlive;                    // offset: 0x5060 ordinal: 0x6e
  UCHAR PrcbPad60[2];                     // offset: 0x5064 ordinal: 0x6f
  USHORT NmiActive;                       // offset: 0x5066 ordinal: 0x70
  LONG DpcWatchdogPeriod;                 // offset: 0x5068 ordinal: 0x71
  LONG DpcWatchdogCount;                  // offset: 0x506c ordinal: 0x72
  LONG KeSpinLockOrdering;                // offset: 0x5070 ordinal: 0x73
  ULONG PrcbPad70[1];                     // offset: 0x5074 ordinal: 0x74
  VOID *CachedPtes;                       // offset: 0x5078 ordinal: 0x75
  struct _LIST_ENTRY WaitListHead;        // offset: 0x5080 ordinal: 0x76
  ULONGLONG WaitLock;                     // offset: 0x5090 ordinal: 0x77
  ULONG ReadySummary;                     // offset: 0x5098 ordinal: 0x78
  ULONG QueueIndex;                       // offset: 0x509c ordinal: 0x79
  ULONG ReadyQueueWeight;                 // offset: 0x50a0 ordinal: 0x7a
  ULONG PrcbPad75;                        // offset: 0x50a4 ordinal: 0x7b
  struct _KDPC TimerExpirationDpc;        // offset: 0x50a8 ordinal: 0x7c
  struct _KPRCB *BuddyPrcb;               // offset: 0x50e8 ordinal: 0x7d
  struct _RTL_RB_TREE ScbQueue;           // offset: 0x50f0 ordinal: 0x7e
  struct _LIST_ENTRY
      DispatcherReadyListHead[32];          // offset: 0x5100 ordinal: 0x7f
  ULONG InterruptCount;                     // offset: 0x5300 ordinal: 0x80
  ULONG KernelTime;                         // offset: 0x5304 ordinal: 0x81
  ULONG UserTime;                           // offset: 0x5308 ordinal: 0x82
  ULONG DpcTime;                            // offset: 0x530c ordinal: 0x83
  ULONG InterruptTime;                      // offset: 0x5310 ordinal: 0x84
  ULONG AdjustDpcThreshold;                 // offset: 0x5314 ordinal: 0x85
  UCHAR DebuggerSavedIRQL;                  // offset: 0x5318 ordinal: 0x86
  UCHAR GroupSchedulingOverQuota;           // offset: 0x5319 ordinal: 0x87
  UCHAR DeepSleep;                          // offset: 0x531a ordinal: 0x88
  UCHAR PrcbPad80[1];                       // offset: 0x531b ordinal: 0x89
  ULONG ScbOffset;                          // offset: 0x531c ordinal: 0x8a
  ULONG DpcTimeCount;                       // offset: 0x5320 ordinal: 0x8b
  ULONG DpcTimeLimit;                       // offset: 0x5324 ordinal: 0x8c
  ULONG PeriodicCount;                      // offset: 0x5328 ordinal: 0x8d
  ULONG PeriodicBias;                       // offset: 0x532c ordinal: 0x8e
  ULONG AvailableTime;                      // offset: 0x5330 ordinal: 0x8f
  ULONG KeExceptionDispatchCount;           // offset: 0x5334 ordinal: 0x90
  struct _KNODE *ParentNode;                // offset: 0x5338 ordinal: 0x91
  ULONGLONG StartCycles;                    // offset: 0x5340 ordinal: 0x92
  ULONGLONG GenerationTarget;               // offset: 0x5348 ordinal: 0x93
  ULONGLONG AffinitizedCycles;              // offset: 0x5350 ordinal: 0x94
  ULONGLONG PrcbPad81;                      // offset: 0x5358 ordinal: 0x95
  LONG MmSpinLockOrdering;                  // offset: 0x5360 ordinal: 0x96
  ULONG PageColor;                          // offset: 0x5364 ordinal: 0x97
  ULONG NodeColor;                          // offset: 0x5368 ordinal: 0x98
  ULONG NodeShiftedColor;                   // offset: 0x536c ordinal: 0x99
  ULONG SecondaryColorMask;                 // offset: 0x5370 ordinal: 0x9a
  ULONG PrcbPad83;                          // offset: 0x5374 ordinal: 0x9b
  ULONGLONG CycleTime;                      // offset: 0x5378 ordinal: 0x9c
  ULONG CcFastMdlReadNoWait;                // offset: 0x5380 ordinal: 0x9d
  ULONG CcFastMdlReadWait;                  // offset: 0x5384 ordinal: 0x9e
  ULONG CcFastMdlReadNotPossible;           // offset: 0x5388 ordinal: 0x9f
  ULONG CcMapDataNoWait;                    // offset: 0x538c ordinal: 0xa0
  ULONG CcMapDataWait;                      // offset: 0x5390 ordinal: 0xa1
  ULONG CcPinMappedDataCount;               // offset: 0x5394 ordinal: 0xa2
  ULONG CcPinReadNoWait;                    // offset: 0x5398 ordinal: 0xa3
  ULONG CcPinReadWait;                      // offset: 0x539c ordinal: 0xa4
  ULONG CcMdlReadNoWait;                    // offset: 0x53a0 ordinal: 0xa5
  ULONG CcMdlReadWait;                      // offset: 0x53a4 ordinal: 0xa6
  ULONG CcLazyWriteHotSpots;                // offset: 0x53a8 ordinal: 0xa7
  ULONG CcLazyWriteIos;                     // offset: 0x53ac ordinal: 0xa8
  ULONG CcLazyWritePages;                   // offset: 0x53b0 ordinal: 0xa9
  ULONG CcDataFlushes;                      // offset: 0x53b4 ordinal: 0xaa
  ULONG CcDataPages;                        // offset: 0x53b8 ordinal: 0xab
  ULONG CcLostDelayedWrites;                // offset: 0x53bc ordinal: 0xac
  ULONG CcFastReadResourceMiss;             // offset: 0x53c0 ordinal: 0xad
  ULONG CcCopyReadWaitMiss;                 // offset: 0x53c4 ordinal: 0xae
  ULONG CcFastMdlReadResourceMiss;          // offset: 0x53c8 ordinal: 0xaf
  ULONG CcMapDataNoWaitMiss;                // offset: 0x53cc ordinal: 0xb0
  ULONG CcMapDataWaitMiss;                  // offset: 0x53d0 ordinal: 0xb1
  ULONG CcPinReadNoWaitMiss;                // offset: 0x53d4 ordinal: 0xb2
  ULONG CcPinReadWaitMiss;                  // offset: 0x53d8 ordinal: 0xb3
  ULONG CcMdlReadNoWaitMiss;                // offset: 0x53dc ordinal: 0xb4
  ULONG CcMdlReadWaitMiss;                  // offset: 0x53e0 ordinal: 0xb5
  ULONG CcReadAheadIos;                     // offset: 0x53e4 ordinal: 0xb6
  LONG MmCacheTransitionCount;              // offset: 0x53e8 ordinal: 0xb7
  LONG MmCacheReadCount;                    // offset: 0x53ec ordinal: 0xb8
  LONG MmCacheIoCount;                      // offset: 0x53f0 ordinal: 0xb9
  ULONG PrcbPad91[3];                       // offset: 0x53f4 ordinal: 0xba
  struct _PROCESSOR_POWER_STATE PowerState; // offset: 0x5400 ordinal: 0xbb
  struct _LIST_ENTRY ScbList;               // offset: 0x55c8 ordinal: 0xbc
  ULONG PrcbPad92[22];                      // offset: 0x55d8 ordinal: 0xbd
  ULONG KeAlignmentFixupCount;              // offset: 0x5630 ordinal: 0xbe
  struct _KDPC DpcWatchdogDpc;              // offset: 0x5638 ordinal: 0xbf
  struct _KTIMER DpcWatchdogTimer;          // offset: 0x5678 ordinal: 0xc0
  struct _CACHE_DESCRIPTOR Cache[5];        // offset: 0x56b8 ordinal: 0xc1
  ULONG CacheCount;                         // offset: 0x56f4 ordinal: 0xc2
  ULONG CachedCommit;                       // offset: 0x56f8 ordinal: 0xc3
  ULONG CachedResidentAvailable;            // offset: 0x56fc ordinal: 0xc4
  VOID *HyperPte;                           // offset: 0x5700 ordinal: 0xc5
  VOID *WheaInfo;                           // offset: 0x5708 ordinal: 0xc6
  VOID *EtwSupport;                         // offset: 0x5710 ordinal: 0xc7
  union _SLIST_HEADER InterruptObjectPool;  // offset: 0x5720 ordinal: 0xc8
  union _SLIST_HEADER HypercallPageList;    // offset: 0x5730 ordinal: 0xc9
  VOID *HypercallPageVirtual;               // offset: 0x5740 ordinal: 0xca
  VOID *VirtualApicAssist;                  // offset: 0x5748 ordinal: 0xcb
  ULONGLONG *StatisticsPage;                // offset: 0x5750 ordinal: 0xcc
  struct _KAFFINITY_EX PackageProcessorSet; // offset: 0x5758 ordinal: 0xcd
  ULONGLONG CacheProcessorMask[5];          // offset: 0x5800 ordinal: 0xce
  ULONGLONG ScanSiblingMask;                // offset: 0x5828 ordinal: 0xcf
  ULONG ScanSiblingIndex;                   // offset: 0x5830 ordinal: 0xd0
  ULONG LLCLevel;                           // offset: 0x5834 ordinal: 0xd1
  ULONGLONG CoreProcessorSet;               // offset: 0x5838 ordinal: 0xd2
  struct _PROCESSOR_PROFILE_CONTROL_AREA
      *ProcessorProfileControlArea;            // offset: 0x5840 ordinal: 0xd3
  VOID *ProfileEventIndexAddress;              // offset: 0x5848 ordinal: 0xd4
  ULONGLONG PrcbPad94[6];                      // offset: 0x5850 ordinal: 0xd5
  struct _SYNCH_COUNTERS SynchCounters;        // offset: 0x5880 ordinal: 0xd6
  struct _FILESYSTEM_DISK_COUNTERS FsCounters; // offset: 0x5938 ordinal: 0xd7
  UCHAR VendorString[13];                      // offset: 0x5948 ordinal: 0xd8
  UCHAR PrcbPad10[3];                          // offset: 0x5955 ordinal: 0xd9
  ULONG FeatureBits;                           // offset: 0x5958 ordinal: 0xda
  union _LARGE_INTEGER UpdateSignature;        // offset: 0x5960 ordinal: 0xdb
  struct _CONTEXT *Context;                    // offset: 0x5968 ordinal: 0xdc
  ULONG ContextFlagsInit;                      // offset: 0x5970 ordinal: 0xdd
  struct _XSAVE_AREA *ExtendedState;           // offset: 0x5978 ordinal: 0xde
  struct _KENTROPY_TIMING_STATE
      EntropyTimingState;                    // offset: 0x5980 ordinal: 0xdf
  struct _REQUEST_MAILBOX *Mailbox;          // offset: 0x5b00 ordinal: 0xe0
  struct _REQUEST_MAILBOX RequestMailbox[1]; // offset: 0x5b40 ordinal: 0xe1
} _KPRCB;
...
typedef struct _KTHREAD {
  ...
  ULONG CodePatchInProgress : 1;              // offset: 0x74 ordinal: 0x16
  ULONG UserStackWalkActive : 1;              // offset: 0x74 ordinal: 0x17
  ULONG ApcInterruptRequest : 1;              // offset: 0x74 ordinal: 0x18
  ULONG QuantumEndMigrate : 1;                // offset: 0x74 ordinal: 0x19
  ULONG UmsDirectedSwitchEnable : 1;          // offset: 0x74 ordinal: 0x1a
  ULONG TimerActive : 1;                      // offset: 0x74 ordinal: 0x1b
  ULONG SystemThread : 1;                     // offset: 0x74 ordinal: 0x1c
  ULONG ProcessDetachActive : 1;              // offset: 0x74 ordinal: 0x1d
  ULONG CalloutActive : 1;                    // offset: 0x74 ordinal: 0x1e
  ULONG ScbReadyQueue : 1;                    // offset: 0x74 ordinal: 0x1f
  ULONG ApcQueueable : 1;                     // offset: 0x74 ordinal: 0x20
  ULONG ReservedStackInUse : 1;               // offset: 0x74 ordinal: 0x21
  ULONG UmsPerformingSyscall : 1;             // offset: 0x74 ordinal: 0x22
  ...
  ULONG ChargeOnlyGroup : 1;                  // offset: 0x78 ordinal: 0x2d
  ...
  ULONG ExplicitIdealProcessor : 1;           // offset: 0x78 ordinal: 0x31
  ULONG FreezeCount : 1;                      // offset: 0x78 ordinal: 0x32
  ULONG EtwStackTraceApcInserted : 8;         // offset: 0x78 ordinal: 0x33
  ULONG ReservedFlags : 10;                   // offset: 0x78 ordinal: 0x34
  LONG ThreadFlags;                           // offset: 0x78 ordinal: 0x35
  ULONG Spare0;                               // offset: 0x7c ordinal: 0x36
  ULONG SystemCallNumber;                     // offset: 0x80 ordinal: 0x37
  ULONG Spare1;                               // offset: 0x84 ordinal: 0x38
  VOID *FirstArgument;                        // offset: 0x88 ordinal: 0x39
  struct _KTRAP_FRAME *TrapFrame;             // offset: 0x90 ordinal: 0x3a
  union {
    struct _KAPC_STATE ApcState; // offset: 0x98 ordinal: 0x3b
    UCHAR ApcStateFill[43];      // offset: 0x98 ordinal: 0x3c
  };
  CHAR Priority;                      // offset: 0xc3 ordinal: 0x3d
  ULONG UserIdealProcessor;           // offset: 0xc4 ordinal: 0x3e
  LONGLONG WaitStatus;                // offset: 0xc8 ordinal: 0x3f
  struct _KWAIT_BLOCK *WaitBlockList; // offset: 0xd0 ordinal: 0x40
  union {
    struct _LIST_ENTRY WaitListEntry;        // offset: 0xd8 ordinal: 0x41
    struct _SINGLE_LIST_ENTRY SwapListEntry; // offset: 0xd8 ordinal: 0x42
  };
  struct _KQUEUE *Queue;       // offset: 0xe8 ordinal: 0x43
  VOID *Teb;                   // offset: 0xf0 ordinal: 0x44
  ULONGLONG RelativeTimerBias; // offset: 0xf8 ordinal: 0x45
  struct _KTIMER Timer;        // offset: 0x100 ordinal: 0x46
  union {
    struct _KWAIT_BLOCK WaitBlock[4]; // offset: 0x140 ordinal: 0x47
    UCHAR WaitBlockFill4[20];         // offset: 0x140 ordinal: 0x48
  };
  ULONG ContextSwitches;                    // offset: 0x154 ordinal: 0x49
  UCHAR WaitBlockFill5[68];                 // offset: 0x140 ordinal: 0x4a
  UCHAR State;                              // offset: 0x184 ordinal: 0x4b
  CHAR NpxState;                            // offset: 0x185 ordinal: 0x4c
  UCHAR WaitIrql;                           // offset: 0x186 ordinal: 0x4d
  CHAR WaitMode;                            // offset: 0x187 ordinal: 0x4e
  UCHAR WaitBlockFill6[116];                // offset: 0x140 ordinal: 0x4f
  ULONG WaitTime;                           // offset: 0x1b4 ordinal: 0x50
  UCHAR WaitBlockFill7[164];                // offset: 0x140 ordinal: 0x51
  SHORT KernelApcDisable;                   // offset: 0x1e4 ordinal: 0x52
  SHORT SpecialApcDisable;                  // offset: 0x1e6 ordinal: 0x53
  ULONG CombinedApcDisable;                 // offset: 0x1e4 ordinal: 0x54
  UCHAR WaitBlockFill8[40];                 // offset: 0x140 ordinal: 0x55
  struct _KTHREAD_COUNTERS *ThreadCounters; // offset: 0x168 ordinal: 0x56
  UCHAR WaitBlockFill9[88];                 // offset: 0x140 ordinal: 0x57
  struct _XSTATE_SAVE *XStateSave;          // offset: 0x198 ordinal: 0x58
  UCHAR WaitBlockFill10[136];               // offset: 0x140 ordinal: 0x59
  VOID *Win32Thread;                        // offset: 0x1c8 ordinal: 0x5a
  UCHAR WaitBlockFill11[176];               // offset: 0x140 ordinal: 0x5b
  struct _UMS_CONTROL_BLOCK *Ucb;           // offset: 0x1f0 ordinal: 0x5c
  struct _KUMS_CONTEXT_HEADER *Uch;         // offset: 0x1f8 ordinal: 0x5d
  VOID *TebMappedLowVa;                     // offset: 0x200 ordinal: 0x5e
  struct _LIST_ENTRY QueueListEntry;        // offset: 0x208 ordinal: 0x5f
  ULONG NextProcessor;                      // offset: 0x218 ordinal: 0x60
  ULONG DeferredProcessor;                  // offset: 0x21c ordinal: 0x61
  struct _KPROCESS *Process;                // offset: 0x220 ordinal: 0x62
  union {
    struct _GROUP_AFFINITY UserAffinity; // offset: 0x228 ordinal: 0x63
    UCHAR UserAffinityFill[10];          // offset: 0x228 ordinal: 0x64
  };
  CHAR PreviousMode; // offset: 0x232 ordinal: 0x65
  CHAR BasePriority; // offset: 0x233 ordinal: 0x66
  union {
    CHAR PriorityDecrement;    // offset: 0x234 ordinal: 0x67
    UCHAR ForegroundBoost : 4; // offset: 0x234 ordinal: 0x68
  };
  UCHAR UnusualBoost : 4; // offset: 0x234 ordinal: 0x69
  UCHAR Preempted;        // offset: 0x235 ordinal: 0x6a
  UCHAR AdjustReason;     // offset: 0x236 ordinal: 0x6b
  CHAR AdjustIncrement;   // offset: 0x237 ordinal: 0x6c
  union {
    struct _GROUP_AFFINITY Affinity; // offset: 0x238 ordinal: 0x6d
    UCHAR AffinityFill[10];          // offset: 0x238 ordinal: 0x6e
  };
  UCHAR ApcStateIndex;                    // offset: 0x242 ordinal: 0x6f
  UCHAR WaitBlockCount;                   // offset: 0x243 ordinal: 0x70
  ULONG IdealProcessor;                   // offset: 0x244 ordinal: 0x71
  struct _KAPC_STATE *ApcStatePointer[2]; // offset: 0x248 ordinal: 0x72
  union {
    struct _KAPC_STATE SavedApcState; // offset: 0x258 ordinal: 0x73
    UCHAR SavedApcStateFill[43];      // offset: 0x258 ordinal: 0x74
  };
  UCHAR WaitReason;       // offset: 0x283 ordinal: 0x75
  CHAR SuspendCount;      // offset: 0x284 ordinal: 0x76
  CHAR Saturation;        // offset: 0x285 ordinal: 0x77
  USHORT SListFaultCount; // offset: 0x286 ordinal: 0x78
  union {
    struct _KAPC SchedulerApc;  // offset: 0x288 ordinal: 0x79
    UCHAR SchedulerApcFill0[1]; // offset: 0x288 ordinal: 0x7a
  };
  UCHAR ResourceIndex;                // offset: 0x289 ordinal: 0x7b
  UCHAR SchedulerApcFill1[3];         // offset: 0x288 ordinal: 0x7c
  UCHAR QuantumReset;                 // offset: 0x28b ordinal: 0x7d
  UCHAR SchedulerApcFill2[4];         // offset: 0x288 ordinal: 0x7e
  ULONG KernelTime;                   // offset: 0x28c ordinal: 0x7f
  UCHAR SchedulerApcFill3[64];        // offset: 0x288 ordinal: 0x80
  struct _KPRCB *WaitPrcb;            // offset: 0x2c8 ordinal: 0x81
  UCHAR SchedulerApcFill4[72];        // offset: 0x288 ordinal: 0x82
  VOID *LegoData;                     // offset: 0x2d0 ordinal: 0x83
  UCHAR SchedulerApcFill5[83];        // offset: 0x288 ordinal: 0x84
  UCHAR CallbackNestingLevel;         // offset: 0x2db ordinal: 0x85
  ULONG UserTime;                     // offset: 0x2dc ordinal: 0x86
  struct _KEVENT SuspendEvent;        // offset: 0x2e0 ordinal: 0x87
  struct _LIST_ENTRY ThreadListEntry; // offset: 0x2f8 ordinal: 0x88
  struct _LIST_ENTRY MutantListHead;  // offset: 0x308 ordinal: 0x89
  LONGLONG ReadOperationCount;        // offset: 0x318 ordinal: 0x8a
  LONGLONG WriteOperationCount;       // offset: 0x320 ordinal: 0x8b
  LONGLONG OtherOperationCount;       // offset: 0x328 ordinal: 0x8c
  LONGLONG ReadTransferCount;         // offset: 0x330 ordinal: 0x8d
  LONGLONG WriteTransferCount;        // offset: 0x338 ordinal: 0x8e
  LONGLONG OtherTransferCount;        // offset: 0x340 ordinal: 0x8f
} _KTHREAD;
...
typedef struct _KINTERRUPT {
  ...
  USHORT ActiveCount;                    // offset: 0x66 ordinal: 0x12
  LONG InternalState;                    // offset: 0x68 ordinal: 0x13
  enum _KINTERRUPT_MODE Mode;            // offset: 0x6c ordinal: 0x14
  enum _KINTERRUPT_POLARITY Polarity;    // offset: 0x70 ordinal: 0x15
  ULONG ServiceCount;                    // offset: 0x74 ordinal: 0x16
  ULONG DispatchCount;                   // offset: 0x78 ordinal: 0x17
  struct _KEVENT *PassiveEvent;          // offset: 0x80 ordinal: 0x18
  struct _KTRAP_FRAME *TrapFrame;        // offset: 0x88 ordinal: 0x19
  ULONG DispatchCode[4];                 // offset: 0x90 ordinal: 0x1a
  VOID *DisconnectData;                  // offset: 0xa0 ordinal: 0x1b
  struct _KTHREAD *ServiceThread;        // offset: 0xa8 ordinal: 0x1c
} _KINTERRUPT;

typedef UCHAR (*__anon_1430)(struct _KINTERRUPT *, VOID *, ULONG);

typedef UCHAR (*__anon_1429)(struct _KINTERRUPT *, VOID *);
...
typedef struct _ETHREAD {
  ...
  union _LARGE_INTEGER CreateTime; // offset: 0x348 ordinal: 0x1
  union {
    union _LARGE_INTEGER ExitTime;     // offset: 0x350 ordinal: 0x2
    struct _LIST_ENTRY KeyedWaitChain; // offset: 0x350 ordinal: 0x3
  };
  VOID *ChargeOnlySession; // offset: 0x360 ordinal: 0x4
  union {
    struct _LIST_ENTRY PostBlockList; // offset: 0x368 ordinal: 0x5
    VOID *ForwardLinkShadow;          // offset: 0x368 ordinal: 0x6
  };
  VOID *StartAddress; // offset: 0x370 ordinal: 0x7
  union {
    struct _TERMINATION_PORT *TerminationPort; // offset: 0x378 ordinal: 0x8
    struct _ETHREAD *ReaperLink;               // offset: 0x378 ordinal: 0x9
    VOID *KeyedWaitValue;                      // offset: 0x378 ordinal: 0xa
  };
  ULONGLONG ActiveTimerListLock;          // offset: 0x380 ordinal: 0xb
  struct _LIST_ENTRY ActiveTimerListHead; // offset: 0x388 ordinal: 0xc
  struct _CLIENT_ID Cid;                  // offset: 0x398 ordinal: 0xd
  union {
    struct _KSEMAPHORE KeyedWaitSemaphore; // offset: 0x3a8 ordinal: 0xe
    struct _KSEMAPHORE AlpcWaitSemaphore;  // offset: 0x3a8 ordinal: 0xf
  };
  union _PS_CLIENT_SECURITY_CONTEXT
      ClientSecurity;                    // offset: 0x3c8 ordinal: 0x10
  struct _LIST_ENTRY IrpList;            // offset: 0x3d0 ordinal: 0x11
  ULONGLONG TopLevelIrp;                 // offset: 0x3e0 ordinal: 0x12
  struct _DEVICE_OBJECT *DeviceToVerify; // offset: 0x3e8 ordinal: 0x13
  VOID *Win32StartAddress;               // offset: 0x3f0 ordinal: 0x14
  VOID *LegacyPowerObject;               // offset: 0x3f8 ordinal: 0x15
  struct _LIST_ENTRY ThreadListEntry;    // offset: 0x400 ordinal: 0x16
  struct _EX_RUNDOWN_REF RundownProtect; // offset: 0x410 ordinal: 0x17
  struct _EX_PUSH_LOCK ThreadLock;       // offset: 0x418 ordinal: 0x18
  ULONG ReadClusterSize;                 // offset: 0x420 ordinal: 0x19
  LONG MmLockOrdering;                   // offset: 0x424 ordinal: 0x1a
  LONG CmLockOrdering;                   // offset: 0x428 ordinal: 0x1b
  union {
    ULONG CrossThreadFlags; // offset: 0x42c ordinal: 0x1c
    ULONG Terminated : 1;   // offset: 0x42c ordinal: 0x1d
  };
  ULONG ThreadInserted : 1;            // offset: 0x42c ordinal: 0x1e
  ULONG HideFromDebugger : 1;          // offset: 0x42c ordinal: 0x1f
  ULONG ActiveImpersonationInfo : 1;   // offset: 0x42c ordinal: 0x20
  ULONG HardErrorsAreDisabled : 1;     // offset: 0x42c ordinal: 0x21
  ULONG BreakOnTermination : 1;        // offset: 0x42c ordinal: 0x22
  ULONG SkipCreationMsg : 1;           // offset: 0x42c ordinal: 0x23
  ULONG SkipTerminationMsg : 1;        // offset: 0x42c ordinal: 0x24
  ULONG CopyTokenOnOpen : 1;           // offset: 0x42c ordinal: 0x25
  ULONG ThreadIoPriority : 3;          // offset: 0x42c ordinal: 0x26
  ULONG ThreadPagePriority : 3;        // offset: 0x42c ordinal: 0x27
  ULONG RundownFail : 1;               // offset: 0x42c ordinal: 0x28
  ULONG UmsForceQueueTermination : 1;  // offset: 0x42c ordinal: 0x29
  ULONG ReservedCrossThreadFlags : 15; // offset: 0x42c ordinal: 0x2a
  union {
    ULONG SameThreadPassiveFlags; // offset: 0x430 ordinal: 0x2b
    ULONG ActiveExWorker : 1;     // offset: 0x430 ordinal: 0x2c
  };
  ULONG MemoryMaker : 1;     // offset: 0x430 ordinal: 0x2d
  ULONG ClonedThread : 1;    // offset: 0x430 ordinal: 0x2e
  ULONG KeyedEventInUse : 1; // offset: 0x430 ordinal: 0x2f
  ULONG SelfTerminate : 1;   // offset: 0x430 ordinal: 0x30
  union {
    ULONG SameThreadApcFlags; // offset: 0x434 ordinal: 0x31
    UCHAR Spare : 1;          // offset: 0x434 ordinal: 0x32
  };
  UCHAR StartAddressInvalid : 1;                // offset: 0x434 ordinal: 0x33
  UCHAR EtwCalloutActive : 1;                   // offset: 0x434 ordinal: 0x34
  UCHAR OwnsProcessWorkingSetExclusive : 1;     // offset: 0x434 ordinal: 0x35
  UCHAR OwnsProcessWorkingSetShared : 1;        // offset: 0x434 ordinal: 0x36
  UCHAR OwnsSystemCacheWorkingSetExclusive : 1; // offset: 0x434 ordinal: 0x37
  UCHAR OwnsSystemCacheWorkingSetShared : 1;    // offset: 0x434 ordinal: 0x38
  UCHAR OwnsSessionWorkingSetExclusive : 1;     // offset: 0x434 ordinal: 0x39
  UCHAR OwnsSessionWorkingSetShared : 1;        // offset: 0x435 ordinal: 0x3a
  UCHAR OwnsProcessAddressSpaceExclusive : 1;   // offset: 0x435 ordinal: 0x3b
  UCHAR OwnsProcessAddressSpaceShared : 1;      // offset: 0x435 ordinal: 0x3c
  UCHAR SuppressSymbolLoad : 1;                 // offset: 0x435 ordinal: 0x3d
  UCHAR Prefetching : 1;                        // offset: 0x435 ordinal: 0x3e
  UCHAR OwnsVadExclusive : 1;                   // offset: 0x435 ordinal: 0x3f
  UCHAR OwnsChangeControlAreaExclusive : 1;     // offset: 0x435 ordinal: 0x40
  UCHAR OwnsChangeControlAreaShared : 1;        // offset: 0x435 ordinal: 0x41
  UCHAR OwnsPagedPoolWorkingSetExclusive : 1;   // offset: 0x436 ordinal: 0x42
  UCHAR OwnsPagedPoolWorkingSetShared : 1;      // offset: 0x436 ordinal: 0x43
  UCHAR OwnsSystemPtesWorkingSetExclusive : 1;  // offset: 0x436 ordinal: 0x44
  UCHAR OwnsSystemPtesWorkingSetShared : 1;     // offset: 0x436 ordinal: 0x45
  UCHAR TrimTrigger : 2;                        // offset: 0x436 ordinal: 0x46
  UCHAR Spare2 : 2;                             // offset: 0x436 ordinal: 0x47
  UCHAR PriorityRegionActive;                   // offset: 0x437 ordinal: 0x48
  UCHAR CacheManagerActive;                     // offset: 0x438 ordinal: 0x49
  UCHAR DisablePageFaultClustering;             // offset: 0x439 ordinal: 0x4a
  UCHAR ActiveFaultCount;                       // offset: 0x43a ordinal: 0x4b
  UCHAR LockOrderState;                         // offset: 0x43b ordinal: 0x4c
  ULONGLONG AlpcMessageId;                      // offset: 0x440 ordinal: 0x4d
  union {
    VOID *AlpcMessage;             // offset: 0x448 ordinal: 0x4e
    ULONG AlpcReceiveAttributeSet; // offset: 0x448 ordinal: 0x4f
  };
  LONG ExitStatus;                              // offset: 0x450 ordinal: 0x50
  struct _LIST_ENTRY AlpcWaitListEntry;         // offset: 0x458 ordinal: 0x51
  ULONG CacheManagerCount;                      // offset: 0x468 ordinal: 0x52
  ULONG IoBoostCount;                           // offset: 0x46c ordinal: 0x53
  struct _LIST_ENTRY BoostList;                 // offset: 0x470 ordinal: 0x54
  struct _LIST_ENTRY DeboostList;               // offset: 0x480 ordinal: 0x55
  ULONGLONG BoostListLock;                      // offset: 0x490 ordinal: 0x56
  ULONGLONG IrpListLock;                        // offset: 0x498 ordinal: 0x57
  VOID *ReservedForSynchTracking;               // offset: 0x4a0 ordinal: 0x58
  struct _SINGLE_LIST_ENTRY CmCallbackListHead; // offset: 0x4a8 ordinal: 0x59
  struct _GUID *ActivityId;                     // offset: 0x4b0 ordinal: 0x5a
  VOID *WnfContext;                             // offset: 0x4b8 ordinal: 0x5b
  ULONG KernelStackReference;                   // offset: 0x4c0 ordinal: 0x5c
} _ETHREAD;
...
typedef struct _PEB {
  ...
  UCHAR IsAppContainer : 1;               // offset: 0x3 ordinal: 0xa
  UCHAR SpareBits : 1;                    // offset: 0x3 ordinal: 0xb
  VOID *Mutant;                           // offset: 0x8 ordinal: 0xc
  VOID *ImageBaseAddress;                 // offset: 0x10 ordinal: 0xd
  struct _PEB_LDR_DATA *Ldr;              // offset: 0x18 ordinal: 0xe
  struct _RTL_USER_PROCESS_PARAMETERS
      *ProcessParameters;                    // offset: 0x20 ordinal: 0xf
  VOID *SubSystemData;                       // offset: 0x28 ordinal: 0x10
  VOID *ProcessHeap;                         // offset: 0x30 ordinal: 0x11
  struct _RTL_CRITICAL_SECTION *FastPebLock; // offset: 0x38 ordinal: 0x12
  VOID *AtlThunkSListPtr;                    // offset: 0x40 ordinal: 0x13
  VOID *IFEOKey;                             // offset: 0x48 ordinal: 0x14
  union {
    ULONG CrossProcessFlags; // offset: 0x50 ordinal: 0x15
    ULONG ProcessInJob : 1;  // offset: 0x50 ordinal: 0x16
  };
  ULONG ProcessInitializing : 1; // offset: 0x50 ordinal: 0x17
  ULONG ProcessUsingVEH : 1;     // offset: 0x50 ordinal: 0x18
  ULONG ProcessUsingVCH : 1;     // offset: 0x50 ordinal: 0x19
  ULONG ProcessUsingFTH : 1;     // offset: 0x50 ordinal: 0x1a
  ULONG ReservedBits0 : 27;      // offset: 0x50 ordinal: 0x1b
  union {
    VOID *KernelCallbackTable; // offset: 0x58 ordinal: 0x1c
    VOID *UserSharedInfoPtr;   // offset: 0x58 ordinal: 0x1d
  };
  ULONG SystemReserved[1];                     // offset: 0x60 ordinal: 0x1e
  ULONG AtlThunkSListPtr32;                    // offset: 0x64 ordinal: 0x1f
  VOID *ApiSetMap;                             // offset: 0x68 ordinal: 0x20
  ULONG TlsExpansionCounter;                   // offset: 0x70 ordinal: 0x21
  VOID *TlsBitmap;                             // offset: 0x78 ordinal: 0x22
  ULONG TlsBitmapBits[2];                      // offset: 0x80 ordinal: 0x23
  VOID *ReadOnlySharedMemoryBase;              // offset: 0x88 ordinal: 0x24
  VOID *HotpatchInformation;                   // offset: 0x90 ordinal: 0x25
  VOID **ReadOnlyStaticServerData;             // offset: 0x98 ordinal: 0x26
  VOID *AnsiCodePageData;                      // offset: 0xa0 ordinal: 0x27
  VOID *OemCodePageData;                       // offset: 0xa8 ordinal: 0x28
  VOID *UnicodeCaseTableData;                  // offset: 0xb0 ordinal: 0x29
  ULONG NumberOfProcessors;                    // offset: 0xb8 ordinal: 0x2a
  ULONG NtGlobalFlag;                          // offset: 0xbc ordinal: 0x2b
  union _LARGE_INTEGER CriticalSectionTimeout; // offset: 0xc0 ordinal: 0x2c
  ULONGLONG HeapSegmentReserve;                // offset: 0xc8 ordinal: 0x2d
  ULONGLONG HeapSegmentCommit;                 // offset: 0xd0 ordinal: 0x2e
  ULONGLONG HeapDeCommitTotalFreeThreshold;    // offset: 0xd8 ordinal: 0x2f
  ULONGLONG HeapDeCommitFreeBlockThreshold;    // offset: 0xe0 ordinal: 0x30
  ULONG NumberOfHeaps;                         // offset: 0xe8 ordinal: 0x31
  ULONG MaximumNumberOfHeaps;                  // offset: 0xec ordinal: 0x32
  VOID **ProcessHeaps;                         // offset: 0xf0 ordinal: 0x33
  VOID *GdiSharedHandleTable;                  // offset: 0xf8 ordinal: 0x34
  VOID *ProcessStarterHelper;                  // offset: 0x100 ordinal: 0x35
  ULONG GdiDCAttributeList;                    // offset: 0x108 ordinal: 0x36
  struct _RTL_CRITICAL_SECTION *LoaderLock;    // offset: 0x110 ordinal: 0x37
  ULONG OSMajorVersion;                        // offset: 0x118 ordinal: 0x38
  ULONG OSMinorVersion;                        // offset: 0x11c ordinal: 0x39
  USHORT OSBuildNumber;                        // offset: 0x120 ordinal: 0x3a
  USHORT OSCSDVersion;                         // offset: 0x122 ordinal: 0x3b
  ULONG OSPlatformId;                          // offset: 0x124 ordinal: 0x3c
  ULONG ImageSubsystem;                        // offset: 0x128 ordinal: 0x3d
  ULONG ImageSubsystemMajorVersion;            // offset: 0x12c ordinal: 0x3e
  ULONG ImageSubsystemMinorVersion;            // offset: 0x130 ordinal: 0x3f
  ULONGLONG ActiveProcessAffinityMask;         // offset: 0x138 ordinal: 0x40
  ULONG GdiHandleBuffer[60];                   // offset: 0x140 ordinal: 0x41
  VOID (*PostProcessInitRoutine)();            // offset: 0x230 ordinal: 0x42
  VOID *TlsExpansionBitmap;                    // offset: 0x238 ordinal: 0x43
  ULONG TlsExpansionBitmapBits[32];            // offset: 0x240 ordinal: 0x44
  ULONG SessionId;                             // offset: 0x2c0 ordinal: 0x45
  union _ULARGE_INTEGER AppCompatFlags;        // offset: 0x2c8 ordinal: 0x46
  union _ULARGE_INTEGER AppCompatFlagsUser;    // offset: 0x2d0 ordinal: 0x47
  VOID *pShimData;                             // offset: 0x2d8 ordinal: 0x48
  VOID *AppCompatInfo;                         // offset: 0x2e0 ordinal: 0x49
  struct _UNICODE_STRING CSDVersion;           // offset: 0x2e8 ordinal: 0x4a
  struct _ACTIVATION_CONTEXT_DATA
      *ActivationContextData; // offset: 0x2f8 ordinal: 0x4b
  struct _ASSEMBLY_STORAGE_MAP
      *ProcessAssemblyStorageMap; // offset: 0x300 ordinal: 0x4c
  struct _ACTIVATION_CONTEXT_DATA
      *SystemDefaultActivationContextData; // offset: 0x308 ordinal: 0x4d
  struct _ASSEMBLY_STORAGE_MAP
      *SystemAssemblyStorageMap;          // offset: 0x310 ordinal: 0x4e
  ULONGLONG MinimumStackCommit;           // offset: 0x318 ordinal: 0x4f
  struct _FLS_CALLBACK_INFO *FlsCallback; // offset: 0x320 ordinal: 0x50
  struct _LIST_ENTRY FlsListHead;         // offset: 0x328 ordinal: 0x51
  VOID *FlsBitmap;                        // offset: 0x338 ordinal: 0x52
  ULONG FlsBitmapBits[4];                 // offset: 0x340 ordinal: 0x53
  ULONG FlsHighIndex;                     // offset: 0x350 ordinal: 0x54
  VOID *WerRegistrationData;              // offset: 0x358 ordinal: 0x55
  VOID *WerShipAssertPtr;                 // offset: 0x360 ordinal: 0x56
  VOID *pUnused;                          // offset: 0x368 ordinal: 0x57
  VOID *pImageHeaderHash;                 // offset: 0x370 ordinal: 0x58
  union {
    ULONG TracingFlags;           // offset: 0x378 ordinal: 0x59
    ULONG HeapTracingEnabled : 1; // offset: 0x378 ordinal: 0x5a
  };
  ULONG CritSecTracingEnabled : 1;             // offset: 0x378 ordinal: 0x5b
  ULONG LibLoaderTracingEnabled : 1;           // offset: 0x378 ordinal: 0x5c
  ULONG SpareTracingBits : 29;                 // offset: 0x378 ordinal: 0x5d
  ULONGLONG CsrServerReadOnlySharedMemoryBase; // offset: 0x380 ordinal: 0x5e
} _PEB;
...
typedef struct _EPROCESS {
  ...
  ULONG NoWakeCharge : 1;                 // offset: 0x2f8 ordinal: 0xd
  ULONG HandleTableRundown : 1;           // offset: 0x2f8 ordinal: 0xe
  ULONG NeedsHandleRundown : 1;           // offset: 0x2f8 ordinal: 0xf
  ULONG RefTraceEnabled : 1;              // offset: 0x2f8 ordinal: 0x10
  ULONG NumaAware : 1;                    // offset: 0x2f8 ordinal: 0x11
  ...
  ULONG Wow64SplitPages : 1;              // offset: 0x2fc ordinal: 0x28
  ...
  ULONG CrossSessionCreate : 1;           // offset: 0x2fc ordinal: 0x3c
  ...
  struct _ETHREAD *RotateInProgress;          // offset: 0x360 ordinal: 0x4c
  struct _ETHREAD *ForkInProgress;            // offset: 0x368 ordinal: 0x4d
  ULONGLONG HardwareTrigger;                  // offset: 0x370 ordinal: 0x4e
  struct _EJOB *CommitChargeJob;              // offset: 0x378 ordinal: 0x4f
  struct _MM_AVL_TABLE *CloneRoot;            // offset: 0x380 ordinal: 0x50
  ...
  union {
    struct _EPROCESS *CreatorProcess; // offset: 0x3e0 ordinal: 0x5c
    ULONGLONG ConsoleHostProcess;     // offset: 0x3e0 ordinal: 0x5d
  };
  struct _PEB *Peb;                         // offset: 0x3e8 ordinal: 0x5e
  VOID *Session;                            // offset: 0x3f0 ordinal: 0x5f
  VOID *AweInfo;                            // offset: 0x3f8 ordinal: 0x60
  struct _EPROCESS_QUOTA_BLOCK *QuotaBlock; // offset: 0x400 ordinal: 0x61
  struct _HANDLE_TABLE *ObjectTable;        // offset: 0x408 ordinal: 0x62
  VOID *DebugPort;                          // offset: 0x410 ordinal: 0x63
  VOID *Wow64Process;                       // offset: 0x418 ordinal: 0x64
  VOID *DeviceMap;                          // offset: 0x420 ordinal: 0x65
  VOID *EtwDataSource;                      // offset: 0x428 ordinal: 0x66
  ULONGLONG PageDirectoryPte;               // offset: 0x430 ordinal: 0x67
  UCHAR ImageFileName[15];                  // offset: 0x438 ordinal: 0x68
  UCHAR PriorityClass;                      // offset: 0x447 ordinal: 0x69
  VOID *SecurityPort;                       // offset: 0x448 ordinal: 0x6a
  struct _SE_AUDIT_PROCESS_CREATION_INFO
      SeAuditProcessCreationInfo;           // offset: 0x450 ordinal: 0x6b
  struct _LIST_ENTRY JobLinks;              // offset: 0x458 ordinal: 0x6c
  VOID *HighestUserAddress;                 // offset: 0x468 ordinal: 0x6d
  struct _LIST_ENTRY ThreadListHead;        // offset: 0x470 ordinal: 0x6e
  ULONG ActiveThreads;                      // offset: 0x480 ordinal: 0x6f
  ULONG ImagePathHash;                      // offset: 0x484 ordinal: 0x70
  ULONG DefaultHardErrorProcessing;         // offset: 0x488 ordinal: 0x71
  LONG LastThreadExitStatus;                // offset: 0x48c ordinal: 0x72
  struct _EX_FAST_REF PrefetchTrace;        // offset: 0x490 ordinal: 0x73
  struct _MM_AVL_TABLE *LockedPagesList;    // offset: 0x498 ordinal: 0x74
  union _LARGE_INTEGER ReadOperationCount;  // offset: 0x4a0 ordinal: 0x75
  union _LARGE_INTEGER WriteOperationCount; // offset: 0x4a8 ordinal: 0x76
  union _LARGE_INTEGER OtherOperationCount; // offset: 0x4b0 ordinal: 0x77
  union _LARGE_INTEGER ReadTransferCount;   // offset: 0x4b8 ordinal: 0x78
  union _LARGE_INTEGER WriteTransferCount;  // offset: 0x4c0 ordinal: 0x79
  union _LARGE_INTEGER OtherTransferCount;  // offset: 0x4c8 ordinal: 0x7a
  ULONGLONG CommitChargeLimit;              // offset: 0x4d0 ordinal: 0x7b
  ULONGLONG CommitCharge;                   // offset: 0x4d8 ordinal: 0x7c
  ULONGLONG CommitChargePeak;               // offset: 0x4e0 ordinal: 0x7d
  struct _MMSUPPORT Vm;                     // offset: 0x4e8 ordinal: 0x7e
  struct _LIST_ENTRY MmProcessLinks;        // offset: 0x578 ordinal: 0x7f
  ULONG ModifiedPageCount;                  // offset: 0x588 ordinal: 0x80
  LONG ExitStatus;                          // offset: 0x58c ordinal: 0x81
  struct _MM_AVL_TABLE VadRoot;             // offset: 0x590 ordinal: 0x82
  ULONGLONG VadPhysicalPages;               // offset: 0x5c0 ordinal: 0x83
  ULONGLONG VadPhysicalPagesLimit;          // offset: 0x5c8 ordinal: 0x84
  struct _ALPC_PROCESS_CONTEXT AlpcContext; // offset: 0x5d0 ordinal: 0x85
  struct _LIST_ENTRY TimerResolutionLink;   // offset: 0x5f0 ordinal: 0x86
  struct _PO_DIAG_STACK_RECORD
      *TimerResolutionStackRecord; // offset: 0x600 ordinal: 0x87
  ULONG RequestedTimerResolution;  // offset: 0x608 ordinal: 0x88
  ULONG SmallestTimerResolution;   // offset: 0x60c ordinal: 0x89
  union _LARGE_INTEGER ExitTime;   // offset: 0x610 ordinal: 0x8a
  struct _INVERTED_FUNCTION_TABLE
      *InvertedFunctionTable;                     // offset: 0x618 ordinal: 0x8b
  struct _EX_PUSH_LOCK InvertedFunctionTableLock; // offset: 0x620 ordinal: 0x8c
  ULONG ActiveThreadsHighWatermark;               // offset: 0x628 ordinal: 0x8d
  ULONG LargePrivateVadCount;                     // offset: 0x62c ordinal: 0x8e
  struct _EX_PUSH_LOCK ThreadListLock;            // offset: 0x630 ordinal: 0x8f
  VOID *WnfContext;                               // offset: 0x638 ordinal: 0x90
  ULONGLONG SectionMappingSize;                   // offset: 0x640 ordinal: 0x91
  UCHAR SignatureLevel;                           // offset: 0x648 ordinal: 0x92
  UCHAR SectionSignatureLevel;                    // offset: 0x649 ordinal: 0x93
  UCHAR SpareByte20[2];                           // offset: 0x64a ordinal: 0x94
  ULONG KeepAliveCounter;                         // offset: 0x64c ordinal: 0x95
  struct _PROCESS_DISK_COUNTERS *DiskCounters;    // offset: 0x650 ordinal: 0x96
  ULONGLONG LastFreezeInterruptTime;              // offset: 0x658 ordinal: 0x97
} _EPROCESS;
...
typedef struct _TEB {
  ...
  VOID *PerflibData;                          // offset: 0x1728 ordinal: 0x30
  ...
  ULONGLONG ReservedForCodeCoverage;     // offset: 0x1770 ordinal: 0x3f
  ...
  USHORT HeapVirtualAffinity;            // offset: 0x17b0 ordinal: 0x48
  USHORT LowFragHeapDataSlot;            // offset: 0x17b2 ordinal: 0x49
  VOID *CurrentTransactionHandle;        // offset: 0x17b8 ordinal: 0x4a
  struct _TEB_ACTIVE_FRAME *ActiveFrame; // offset: 0x17c0 ordinal: 0x4b
  VOID *FlsData;                         // offset: 0x17c8 ordinal: 0x4c
  VOID *PreferredLanguages;              // offset: 0x17d0 ordinal: 0x4d
  VOID *UserPrefLanguages;               // offset: 0x17d8 ordinal: 0x4e
  VOID *MergedPrefLanguages;             // offset: 0x17e0 ordinal: 0x4f
  ULONG MuiImpersonation;                // offset: 0x17e8 ordinal: 0x50
  union {
    USHORT CrossTebFlags;          // offset: 0x17ec ordinal: 0x51
    USHORT SpareCrossTebBits : 16; // offset: 0x17ec ordinal: 0x52
  };
  union {
    USHORT SameTebFlags;      // offset: 0x17ee ordinal: 0x53
    USHORT SafeThunkCall : 1; // offset: 0x17ee ordinal: 0x54
  };
  USHORT InDebugPrint : 1;         // offset: 0x17ee ordinal: 0x55
  USHORT HasFiberData : 1;         // offset: 0x17ee ordinal: 0x56
  USHORT SkipThreadAttach : 1;     // offset: 0x17ee ordinal: 0x57
  USHORT WerInShipAssertCode : 1;  // offset: 0x17ee ordinal: 0x58
  USHORT RanProcessInit : 1;       // offset: 0x17ee ordinal: 0x59
  USHORT ClonedThread : 1;         // offset: 0x17ee ordinal: 0x5a
  USHORT SuppressDebugMsg : 1;     // offset: 0x17ee ordinal: 0x5b
  USHORT DisableUserStackWalk : 1; // offset: 0x17ee ordinal: 0x5c
  USHORT RtlExceptionAttached : 1; // offset: 0x17ee ordinal: 0x5d
  USHORT InitialThread : 1;        // offset: 0x17ee ordinal: 0x5e
  USHORT SessionAware : 1;         // offset: 0x17ee ordinal: 0x5f
  USHORT SpareSameTebBits : 4;     // offset: 0x17ee ordinal: 0x60
  VOID *TxnScopeEnterCallback;     // offset: 0x17f0 ordinal: 0x61
  VOID *TxnScopeExitCallback;      // offset: 0x17f8 ordinal: 0x62
  VOID *TxnScopeContext;           // offset: 0x1800 ordinal: 0x63
  ULONG LockCount;                 // offset: 0x1808 ordinal: 0x64
  ULONG SpareUlong0;               // offset: 0x180c ordinal: 0x65
  VOID *ResourceRetValue;          // offset: 0x1810 ordinal: 0x66
  VOID *ReservedForWdf;            // offset: 0x1818 ordinal: 0x67
} _TEB;
...
typedef struct _KUSER_SHARED_DATA {
  ...
  ULONGLONG TimeUpdateSequence;               // offset: 0x340 ordinal: 0x43
  ...
  ULONGLONG TscQpcBias;                       // offset: 0x3b8 ordinal: 0x52
  ...
  union {
    USHORT TscQpcData;   // offset: 0x3c6 ordinal: 0x56
    UCHAR TscQpcEnabled; // offset: 0x3c6 ordinal: 0x57
  };
  UCHAR TscQpcShift; // offset: 0x3c7 ordinal: 0x58
  union _LARGE_INTEGER
...
typedef struct _PEB64 {
  ...
  UCHAR IsAppContainer : 1;               // offset: 0x3 ordinal: 0xa
  UCHAR SpareBits : 1;                    // offset: 0x3 ordinal: 0xb
  ULONGLONG Mutant;                       // offset: 0x8 ordinal: 0xc
  ULONGLONG ImageBaseAddress;             // offset: 0x10 ordinal: 0xd
  ULONGLONG Ldr;                          // offset: 0x18 ordinal: 0xe
  ULONGLONG ProcessParameters;            // offset: 0x20 ordinal: 0xf
  ULONGLONG SubSystemData;                // offset: 0x28 ordinal: 0x10
  ULONGLONG ProcessHeap;                  // offset: 0x30 ordinal: 0x11
  ULONGLONG FastPebLock;                  // offset: 0x38 ordinal: 0x12
  ULONGLONG AtlThunkSListPtr;             // offset: 0x40 ordinal: 0x13
  ULONGLONG IFEOKey;                      // offset: 0x48 ordinal: 0x14
  union {
    ULONG CrossProcessFlags; // offset: 0x50 ordinal: 0x15
    ULONG ProcessInJob : 1;  // offset: 0x50 ordinal: 0x16
  };
  ...
  ULONG ReservedBits0 : 27;      // offset: 0x50 ordinal: 0x1b
  union {
    ULONGLONG KernelCallbackTable; // offset: 0x58 ordinal: 0x1c
    ULONGLONG UserSharedInfoPtr;   // offset: 0x58 ordinal: 0x1d
  };
  ULONG SystemReserved[1];                      // offset: 0x60 ordinal: 0x1e
  ULONG AtlThunkSListPtr32;                     // offset: 0x64 ordinal: 0x1f
  ULONGLONG ApiSetMap;                          // offset: 0x68 ordinal: 0x20
  ULONG TlsExpansionCounter;                    // offset: 0x70 ordinal: 0x21
  ULONGLONG TlsBitmap;                          // offset: 0x78 ordinal: 0x22
  ULONG TlsBitmapBits[2];                       // offset: 0x80 ordinal: 0x23
  ULONGLONG ReadOnlySharedMemoryBase;           // offset: 0x88 ordinal: 0x24
  ULONGLONG HotpatchInformation;                // offset: 0x90 ordinal: 0x25
  ULONGLONG ReadOnlyStaticServerData;           // offset: 0x98 ordinal: 0x26
  ULONGLONG AnsiCodePageData;                   // offset: 0xa0 ordinal: 0x27
  ULONGLONG OemCodePageData;                    // offset: 0xa8 ordinal: 0x28
  ULONGLONG UnicodeCaseTableData;               // offset: 0xb0 ordinal: 0x29
  ULONG NumberOfProcessors;                     // offset: 0xb8 ordinal: 0x2a
  ULONG NtGlobalFlag;                           // offset: 0xbc ordinal: 0x2b
  union _LARGE_INTEGER CriticalSectionTimeout;  // offset: 0xc0 ordinal: 0x2c
  ULONGLONG HeapSegmentReserve;                 // offset: 0xc8 ordinal: 0x2d
  ...
  ULONG NumberOfHeaps;                          // offset: 0xe8 ordinal: 0x31
  ULONG MaximumNumberOfHeaps;                   // offset: 0xec ordinal: 0x32
  ULONGLONG ProcessHeaps;                       // offset: 0xf0 ordinal: 0x33
  ULONGLONG GdiSharedHandleTable;               // offset: 0xf8 ordinal: 0x34
  ULONGLONG ProcessStarterHelper;               // offset: 0x100 ordinal: 0x35
  ULONG GdiDCAttributeList;                     // offset: 0x108 ordinal: 0x36
  ULONGLONG LoaderLock;                         // offset: 0x110 ordinal: 0x37
  ULONG OSMajorVersion;                         // offset: 0x118 ordinal: 0x38
  ULONG OSMinorVersion;                         // offset: 0x11c ordinal: 0x39
  USHORT OSBuildNumber;                         // offset: 0x120 ordinal: 0x3a
  USHORT OSCSDVersion;                          // offset: 0x122 ordinal: 0x3b
  ...
  ULONGLONG ActiveProcessAffinityMask;          // offset: 0x138 ordinal: 0x40
  ULONG GdiHandleBuffer[60];                    // offset: 0x140 ordinal: 0x41
  ULONGLONG PostProcessInitRoutine;             // offset: 0x230 ordinal: 0x42
  ULONGLONG TlsExpansionBitmap;                 // offset: 0x238 ordinal: 0x43
  ULONG TlsExpansionBitmapBits[32];             // offset: 0x240 ordinal: 0x44
  ULONG SessionId;                              // offset: 0x2c0 ordinal: 0x45
  union _ULARGE_INTEGER AppCompatFlags;         // offset: 0x2c8 ordinal: 0x46
  union _ULARGE_INTEGER AppCompatFlagsUser;     // offset: 0x2d0 ordinal: 0x47
  ULONGLONG pShimData;                          // offset: 0x2d8 ordinal: 0x48
  ULONGLONG AppCompatInfo;                      // offset: 0x2e0 ordinal: 0x49
  struct _STRING64 CSDVersion;                  // offset: 0x2e8 ordinal: 0x4a
  ULONGLONG ActivationContextData;              // offset: 0x2f8 ordinal: 0x4b
  ULONGLONG ProcessAssemblyStorageMap;          // offset: 0x300 ordinal: 0x4c
  ULONGLONG SystemDefaultActivationContextData; // offset: 0x308 ordinal: 0x4d
  ULONGLONG SystemAssemblyStorageMap;           // offset: 0x310 ordinal: 0x4e
  ULONGLONG MinimumStackCommit;                 // offset: 0x318 ordinal: 0x4f
  ULONGLONG FlsCallback;                        // offset: 0x320 ordinal: 0x50
  struct LIST_ENTRY64 FlsListHead;              // offset: 0x328 ordinal: 0x51
  ULONGLONG FlsBitmap;                          // offset: 0x338 ordinal: 0x52
  ULONG FlsBitmapBits[4];                       // offset: 0x340 ordinal: 0x53
  ULONG FlsHighIndex;                           // offset: 0x350 ordinal: 0x54
  ULONGLONG WerRegistrationData;                // offset: 0x358 ordinal: 0x55
  ULONGLONG WerShipAssertPtr;                   // offset: 0x360 ordinal: 0x56
  ULONGLONG pUnused;                            // offset: 0x368 ordinal: 0x57
  ULONGLONG pImageHeaderHash;                   // offset: 0x370 ordinal: 0x58
  union {
    ULONG TracingFlags;           // offset: 0x378 ordinal: 0x59
    ULONG HeapTracingEnabled : 1; // offset: 0x378 ordinal: 0x5a
  };
...
typedef struct _TEB64 {
  ...
  ULONGLONG PerflibData;                   // offset: 0x1728 ordinal: 0x30
  ...
  USHORT HeapVirtualAffinity;         // offset: 0x17b0 ordinal: 0x48
  USHORT LowFragHeapDataSlot;         // offset: 0x17b2 ordinal: 0x49
  ULONGLONG CurrentTransactionHandle; // offset: 0x17b8 ordinal: 0x4a
  ULONGLONG ActiveFrame;              // offset: 0x17c0 ordinal: 0x4b
  ULONGLONG FlsData;                  // offset: 0x17c8 ordinal: 0x4c
  ULONGLONG PreferredLanguages;       // offset: 0x17d0 ordinal: 0x4d
  ULONGLONG UserPrefLanguages;        // offset: 0x17d8 ordinal: 0x4e
  ULONGLONG MergedPrefLanguages;      // offset: 0x17e0 ordinal: 0x4f
  ULONG MuiImpersonation;             // offset: 0x17e8 ordinal: 0x50
  union {
    USHORT CrossTebFlags;          // offset: 0x17ec ordinal: 0x51
    USHORT SpareCrossTebBits : 16; // offset: 0x17ec ordinal: 0x52
  ...
  USHORT SessionAware : 1;         // offset: 0x17ee ordinal: 0x5f
  USHORT SpareSameTebBits : 4;     // offset: 0x17ee ordinal: 0x60
  ULONGLONG TxnScopeEnterCallback; // offset: 0x17f0 ordinal: 0x61
  ULONGLONG TxnScopeExitCallback;  // offset: 0x17f8 ordinal: 0x62
  ULONGLONG TxnScopeContext;       // offset: 0x1800 ordinal: 0x63
  ULONG LockCount;                 // offset: 0x1808 ordinal: 0x64
  ULONG SpareUlong0;               // offset: 0x180c ordinal: 0x65
  ULONGLONG ResourceRetValue;      // offset: 0x1810 ordinal: 0x66
  ULONGLONG ReservedForWdf;        // offset: 0x1818 ordinal: 0x67
} _TEB64;
