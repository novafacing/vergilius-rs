...
struct _EX_WORK_QUEUE {
  ...
  volatile ULONG WorkItemsProcessed; // offset: 0x19c (412)
  ULONG WorkItemsProcessedLastPass;  // offset: 0x1a0 (416)
  volatile LONG ThreadCount;         // offset: 0x1a4 (420)
  volatile UCHAR TryFailed;          // offset: 0x1a8 (424)
};
...
struct _TOKEN {
  ...
  ULONG VariablePart;              // offset: 0x288 (648)
};
...
struct _HHIVE {
  ...
  UCHAR LogDataPresent[2];               // offset: 0x6c (108)
  UCHAR PrimaryFileValid;                // offset: 0x6e (110)
  UCHAR BaseBlockDirty;                  // offset: 0x6f (111)
  union {
    struct {
      USHORT FirstLogFile : 3;                // offset: 0x70 (112)
      USHORT SecondLogFile : 3;               // offset: 0x70 (112)
      USHORT HeaderRecovered : 1;             // offset: 0x70 (112)
      USHORT LegacyRecoveryIndicated : 1;     // offset: 0x70 (112)
      USHORT RecoveryInformationReserved : 8; // offset: 0x70 (112)
    };
    USHORT RecoveryInformation; // offset: 0x70 (112)
  };
  UCHAR LogEntriesRecovered[2]; // offset: 0x72 (114)
  ULONG RefreshCount;           // offset: 0x74 (116)
  ULONG StorageTypeCount;       // offset: 0x78 (120)
  ULONG Version;                // offset: 0x7c (124)
  struct _DUAL Storage[2];      // offset: 0x80 (128)
};

// 0xc20 (3104) bytes
struct _CMHIVE {
  struct _HHIVE Hive;                                 // offset: 0x0 (0)
  VOID *FileHandles[6];                               // offset: 0x3b8 (952)
  struct _LIST_ENTRY NotifyList;                      // offset: 0x3d0 (976)
  struct _LIST_ENTRY HiveList;                        // offset: 0x3d8 (984)
  struct _LIST_ENTRY PreloadedHiveList;               // offset: 0x3e0 (992)
  struct _EX_RUNDOWN_REF HiveRundown;                 // offset: 0x3e8 (1000)
  struct _LIST_ENTRY ParseCacheEntries;               // offset: 0x3ec (1004)
  struct _CM_KEY_HASH_TABLE_ENTRY *KcbCacheTable;     // offset: 0x3f4 (1012)
  ULONG KcbCacheTableSize;                            // offset: 0x3f8 (1016)
  struct _CM_KEY_HASH_TABLE_ENTRY *DeletedKcbTable;   // offset: 0x3fc (1020)
  ULONG DeletedKcbTableSize;                          // offset: 0x400 (1024)
  ULONG Identity;                                     // offset: 0x404 (1028)
  struct _FAST_MUTEX *HiveLock;                       // offset: 0x408 (1032)
  struct _FAST_MUTEX *WriterLock;                     // offset: 0x40c (1036)
  struct _ERESOURCE *FlusherLock;                     // offset: 0x410 (1040)
  struct _RTL_BITMAP FlushDirtyVector;                // offset: 0x414 (1044)
  ULONG FlushDirtyVectorSize;                         // offset: 0x41c (1052)
  UCHAR *FlushLogEntry;                               // offset: 0x420 (1056)
  ULONG FlushLogEntrySize;                            // offset: 0x424 (1060)
  ULONG FlushHiveTruncated;                           // offset: 0x428 (1064)
  UCHAR FlushBaseBlockDirty;                          // offset: 0x42c (1068)
  struct _RTL_BITMAP CapturedUnreconciledVector;      // offset: 0x430 (1072)
  ULONG CapturedUnreconciledVectorSize;               // offset: 0x438 (1080)
  struct CMP_OFFSET_ARRAY *UnreconciledOffsetArray;   // offset: 0x43c (1084)
  ULONG UnreconciledOffsetArrayCount;                 // offset: 0x440 (1088)
  struct _HBASE_BLOCK *UnreconciledBaseBlock;         // offset: 0x444 (1092)
  struct _EX_PUSH_LOCK SecurityLock;                  // offset: 0x448 (1096)
  ULONG UseCount;                                     // offset: 0x44c (1100)
  ULONG LastShrinkHiveSize;                           // offset: 0x450 (1104)
...
struct _MM_SESSION_SPACE {
  ...
  struct _MMWSLE *Wsle;                          // offset: 0xd60 (3424)
  struct _MI_SESSION_DRIVER_UNLOAD DriverUnload; // offset: 0xd64 (3428)
  ...
  ULONG PoolTrackTableExpansionSize;             // offset: 0x1f7c (8060)
  VOID *PoolTrackBigPages;                       // offset: 0x1f80 (8064)
  ULONG PoolTrackBigPagesSize;                   // offset: 0x1f84 (8068)
  enum _IO_SESSION_STATE IoState;                // offset: 0x1f88 (8072)
  ULONG IoStateSequence;                         // offset: 0x1f8c (8076)
  struct _KEVENT IoNotificationEvent;            // offset: 0x1f90 (8080)
};
...
struct _ENODE {
  ...
  struct _KEVENT ExpThreadSetManagerEvent;           // offset: 0x418 (1048)
  struct _KEVENT ExpBalancerExitEvent;               // offset: 0x428 (1064)
  struct _KTIMER ExpDeadlockTimer;                   // offset: 0x438 (1080)
  struct _KEVENT ExpThreadReaperEvent;               // offset: 0x460 (1120)
  struct _KWAIT_BLOCK WaitBlocks[4];                 // offset: 0x470 (1136)
  struct _ETHREAD *ExpWorkerThreadBalanceManagerPtr; // offset: 0x4d0 (1232)
  ULONG ExpWorkerSeed;                               // offset: 0x4d4 (1236)
  union {
    struct {
      volatile ULONG ExWorkerFullInit : 1;   // offset: 0x4d8 (1240)
      volatile ULONG ExWorkerStructInit : 1; // offset: 0x4d8 (1240)
    };
    volatile ULONG ExWorkerFlags; // offset: 0x4d8 (1240)
  };
};
...
struct _KTHREAD {
  ...
  union {
    struct {
      ...
      ULONG ReservedFlags : 8;             // offset: 0x5c (92)
    };
...
struct _MMWSL {
  ...
  struct _MI_ACTIVE_WSLE_LISTHEAD ActiveWsles[8];   // offset: 0x5c (92)
