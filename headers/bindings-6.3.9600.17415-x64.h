...
struct _HHIVE {
  ...
  ULONG LogFileSizeCap;                  // offset: 0x9c (156)
  UCHAR LogDataPresent[2];               // offset: 0xa0 (160)
  UCHAR PrimaryFileValid;                // offset: 0xa2 (162)
  UCHAR BaseBlockDirty;                  // offset: 0xa3 (163)
  union {
    struct {
      USHORT FirstLogFile : 3;                // offset: 0xa4 (164)
      USHORT SecondLogFile : 3;               // offset: 0xa4 (164)
      USHORT HeaderRecovered : 1;             // offset: 0xa4 (164)
      USHORT LegacyRecoveryIndicated : 1;     // offset: 0xa4 (164)
      USHORT RecoveryInformationReserved : 8; // offset: 0xa4 (164)
    };
    USHORT RecoveryInformation; // offset: 0xa4 (164)
  };
  UCHAR LogEntriesRecovered[2]; // offset: 0xa6 (166)
  ULONG RefreshCount;           // offset: 0xa8 (168)
  ULONG StorageTypeCount;       // offset: 0xac (172)
  ULONG Version;                // offset: 0xb0 (176)
  struct _DUAL Storage[2];      // offset: 0xb8 (184)
};
...
struct _CMHIVE {
  struct _HHIVE Hive;                                 // offset: 0x0 (0)
  VOID *FileHandles[6];                               // offset: 0x5a8 (1448)
  struct _LIST_ENTRY NotifyList;                      // offset: 0x5d8 (1496)
  struct _LIST_ENTRY HiveList;                        // offset: 0x5e8 (1512)
  struct _LIST_ENTRY PreloadedHiveList;               // offset: 0x5f8 (1528)
  struct _EX_RUNDOWN_REF HiveRundown;                 // offset: 0x608 (1544)
  struct _LIST_ENTRY ParseCacheEntries;               // offset: 0x610 (1552)
  struct _CM_KEY_HASH_TABLE_ENTRY *KcbCacheTable;     // offset: 0x620 (1568)
  ULONG KcbCacheTableSize;                            // offset: 0x628 (1576)
  struct _CM_KEY_HASH_TABLE_ENTRY *DeletedKcbTable;   // offset: 0x630 (1584)
  ULONG DeletedKcbTableSize;                          // offset: 0x638 (1592)
  ULONG Identity;                                     // offset: 0x63c (1596)
  struct _FAST_MUTEX *HiveLock;                       // offset: 0x640 (1600)
  struct _FAST_MUTEX *WriterLock;                     // offset: 0x648 (1608)
  struct _ERESOURCE *FlusherLock;                     // offset: 0x650 (1616)
  struct _RTL_BITMAP FlushDirtyVector;                // offset: 0x658 (1624)
  ULONG FlushDirtyVectorSize;                         // offset: 0x668 (1640)
  UCHAR *FlushLogEntry;                               // offset: 0x670 (1648)
  ULONG FlushLogEntrySize;                            // offset: 0x678 (1656)
  ULONG FlushHiveTruncated;                           // offset: 0x67c (1660)
  UCHAR FlushBaseBlockDirty;                          // offset: 0x680 (1664)
  struct _RTL_BITMAP CapturedUnreconciledVector;      // offset: 0x688 (1672)
  ULONG CapturedUnreconciledVectorSize;               // offset: 0x698 (1688)
  struct CMP_OFFSET_ARRAY *UnreconciledOffsetArray;   // offset: 0x6a0 (1696)
  ULONG UnreconciledOffsetArrayCount;                 // offset: 0x6a8 (1704)
  struct _HBASE_BLOCK *UnreconciledBaseBlock;         // offset: 0x6b0 (1712)
  struct _EX_PUSH_LOCK SecurityLock;                  // offset: 0x6b8 (1720)
  ULONG UseCount;                                     // offset: 0x6c0 (1728)
  ULONG LastShrinkHiveSize;                           // offset: 0x6c4 (1732)
  union _LARGE_INTEGER ActualFileSize;                // offset: 0x6c8 (1736)
  union _LARGE_INTEGER LogFileSizes[2];               // offset: 0x6d0 (1744)
  struct _UNICODE_STRING FileFullPath;                // offset: 0x6e0 (1760)
  struct _UNICODE_STRING FileUserName;                // offset: 0x6f0 (1776)
  struct _UNICODE_STRING HiveRootPath;                // offset: 0x700 (1792)
  ULONG SecurityCount;                                // offset: 0x710 (1808)
  ULONG SecurityCacheSize;                            // offset: 0x714 (1812)
  LONG SecurityHitHint;                               // offset: 0x718 (1816)
  struct _CM_KEY_SECURITY_CACHE_ENTRY *SecurityCache; // offset: 0x720 (1824)
  struct _LIST_ENTRY SecurityHash[64];                // offset: 0x728 (1832)
  ULONG UnloadEventCount;                             // offset: 0xb28 (2856)
  struct _KEVENT **UnloadEventArray;                  // offset: 0xb30 (2864)
  struct _CM_KEY_CONTROL_BLOCK *RootKcb;              // offset: 0xb38 (2872)
  UCHAR Frozen;                                       // offset: 0xb40 (2880)
  struct _CM_WORKITEM *UnloadWorkItem;                // offset: 0xb48 (2888)
  struct _CM_WORKITEM UnloadWorkItemHolder;           // offset: 0xb50 (2896)
  UCHAR GrowOnlyMode;                                 // offset: 0xb78 (2936)
  ULONG GrowOffset;                                   // offset: 0xb7c (2940)
  struct _LIST_ENTRY KcbConvertListHead;              // offset: 0xb80 (2944)
  struct _LIST_ENTRY KnodeConvertListHead;            // offset: 0xb90 (2960)
  struct _CM_CELL_REMAP_BLOCK *CellRemapArray;        // offset: 0xba0 (2976)
  struct _CM_DIRTY_VECTOR_LOG DirtyVectorLog;         // offset: 0xba8 (2984)
  ULONG Flags;                                        // offset: 0x10b0 (4272)
  struct _LIST_ENTRY TrustClassEntry;                 // offset: 0x10b8 (4280)
  ULONGLONG DirtyTime;                                // offset: 0x10c8 (4296)
  ULONGLONG UnreconciledTime;                         // offset: 0x10d0 (4304)
  struct _CM_RM *CmRm;                                // offset: 0x10d8 (4312)
  ULONG CmRmInitFailPoint;                            // offset: 0x10e0 (4320)
  LONG CmRmInitFailStatus;                            // offset: 0x10e4 (4324)
  struct _KTHREAD *CreatorOwner;                      // offset: 0x10e8 (4328)
  struct _KTHREAD *RundownThread;                     // offset: 0x10f0 (4336)
  union _LARGE_INTEGER LastWriteTime;                 // offset: 0x10f8 (4344)
  struct _HIVE_WRITE_WAIT_QUEUE FlushQueue;           // offset: 0x1100 (4352)
  struct _HIVE_WRITE_WAIT_QUEUE ReconcileQueue;       // offset: 0x1118 (4376)
  union {
    ULONG FlushFlags; // offset: 0x1130 (4400)
    struct {
      ULONG FlushActive : 1;       // offset: 0x1130 (4400)
      ULONG ReconcileActive : 1;   // offset: 0x1130 (4400)
      ULONG PrimaryFilePurged : 1; // offset: 0x1130 (4400)
      ULONG DiskFileBad : 1;       // offset: 0x1130 (4400)
    };
  };
  ULONG PrimaryFileSizeBeforeLastFlush;         // offset: 0x1134 (4404)
  volatile LONG ReferenceCount;                 // offset: 0x1138 (4408)
  LONG UnloadHistoryIndex;                      // offset: 0x113c (4412)
  ULONG UnloadHistory[128];                     // offset: 0x1140 (4416)
  ULONG BootStart;                              // offset: 0x1340 (4928)
  ULONG UnaccessedStart;                        // offset: 0x1344 (4932)
  ULONG UnaccessedEnd;                          // offset: 0x1348 (4936)
  ULONG LoadedKeyCount;                         // offset: 0x134c (4940)
  volatile ULONG HandleClosePending;            // offset: 0x1350 (4944)
  struct _EX_PUSH_LOCK HandleClosePendingEvent; // offset: 0x1358 (4952)
};
...
struct _MMSUPPORT {
  ...
  struct _EX_PUSH_LOCK WorkingSetMutex;        // offset: 0x10 (16)
  ...
  VOID *WsSwapSupport;                         // offset: 0xe0 (224)
};
...
struct _MM_SESSION_SPACE {
  ...
  struct _MMWSLE *Wsle;                          // offset: 0xce8 (3304)
  struct _MI_SESSION_DRIVER_UNLOAD DriverUnload; // offset: 0xcf0 (3312)
...
struct _ENODE {
  ...
  struct _EX_WORK_QUEUE ExWorkQueue;                 // offset: 0x100 (256)
  struct _KEVENT ExpThreadSetManagerEvent;           // offset: 0x3d0 (976)
  struct _KTIMER ExpDeadlockTimer;                   // offset: 0x3e8 (1000)
  struct _KEVENT ExpThreadReaperEvent;               // offset: 0x428 (1064)
  struct _KWAIT_BLOCK WaitBlocks[3];                 // offset: 0x440 (1088)
  struct _ETHREAD *ExpWorkerThreadBalanceManagerPtr; // offset: 0x4d0 (1232)
  ULONG ExpWorkerSeed;                               // offset: 0x4d8 (1240)
  union {
    struct {
      volatile ULONG ExWorkerFullInit : 1;   // offset: 0x4dc (1244)
      volatile ULONG ExWorkerStructInit : 1; // offset: 0x4dc (1244)
    };
    volatile ULONG ExWorkerFlags; // offset: 0x4dc (1244)
  };
};
...
struct _EPROCESS {
  ...
  volatile ULONGLONG CommitCharge;          // offset: 0x4d0 (1232)
  struct _MMSUPPORT Vm;                     // offset: 0x4d8 (1240)
  ...
  ULONGLONG DeepFreezeStartTime;               // offset: 0x6b8 (1720)
  ULONGLONG CommitChargeLimit;                 // offset: 0x6c0 (1728)
  volatile ULONGLONG CommitChargePeak;         // offset: 0x6c8 (1736)
  ULONG HighPriorityFaultsAllowed;             // offset: 0x6d0 (1744)
};
...
struct _MMMOD_WRITER_MDL_ENTRY {
  ...
  struct _MDL *PointerMdl;              // offset: 0xc0 (192)
  struct _MDL Mdl;                      // offset: 0xc8 (200)
  ULONGLONG Page[1];                    // offset: 0xf8 (248)
};
...
struct _KPRCB {
  ...
  struct _IOP_IRP_STACK_PROFILER
      IoIrpStackProfilerCurrent; // offset: 0x5b40 (23360)
  struct _IOP_IRP_STACK_PROFILER
      IoIrpStackProfilerPrevious; // offset: 0x5b94 (23444)
  struct _KTIMER_EXPIRATION_TRACE
      TimerExpirationTrace[16];              // offset: 0x5be8 (23528)
  ULONG TimerExpirationTraceCount;           // offset: 0x5ce8 (23784)
  struct _REQUEST_MAILBOX *Mailbox;          // offset: 0x5d00 (23808)
  struct _REQUEST_MAILBOX RequestMailbox[1]; // offset: 0x5d40 (23872)
};
...
struct _KTHREAD {
  ...
  union {
    struct {
      ULONG SpareMiscFlag0 : 1;          // offset: 0x74 (116)
      ...
      ULONG Reserved : 11;               // offset: 0x74 (116)
    };
  ...
  union {
    struct {
      ...
      ULONG ReservedFlags : 7;             // offset: 0x78 (120)
    };
